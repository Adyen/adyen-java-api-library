...
public class CheckoutTest extends BaseTest {
    ...
    public void testPaymentsRequestWithXidAndCavv() throws Exception {
        ...
        when(clientInterface.request(anyString(), anyString(), eq(config), anyBoolean(), nullable(RequestOptions.class), anyString())).thenReturn("{\"pspReference\": \"12345\"}");
        ...
        verify(clientInterface).request(anyString(), captor.capture(), any(Config.class), anyBoolean(), nullable(RequestOptions.class), anyString());
        //html escaped
