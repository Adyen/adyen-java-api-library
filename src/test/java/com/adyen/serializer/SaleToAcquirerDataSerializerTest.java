...
public class SaleToAcquirerDataSerializerTest {
  ...
  public void testSerialize() {
    SaleToAcquirerDataSerializer saleToAcquirerDataModelAdapter =
        new SaleToAcquirerDataSerializer();
    ...
    String serialized =
        saleToAcquirerDataModelAdapter.serialize(saleToAcquirerData, null, null).getAsString();
    SaleToAcquirerData saleToAcquirerDataDecoded =
        new Gson().fromJson(new String(Base64.decodeBase64(serialized)), SaleToAcquirerData.class);
