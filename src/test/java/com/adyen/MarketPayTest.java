...
public class MarketPayTest extends BaseTest {
  ...
  public void testConfigurationApi() throws IOException, ApiException, HTTPClientException {
    CreateNotificationConfigurationRequest request =
        CreateNotificationConfigurationRequest.fromJson(
            "{\n"
    ...
    GetNotificationConfigurationResponse response =
  ...
  public void testHopApi() throws IOException, ApiException, HTTPClientException {
    GetOnboardingUrlRequest request =
        GetOnboardingUrlRequest.fromJson(
            "{\n"
                + "  \"accountHolderCode\": \"CODE_OF_ACCOUNT_HOLDER\",\n"
                + "  \"returnUrl\": \"https://your.return-url.com/?submerchant=123\"\n"
                + "}");
    String jsonRequest = request.toJson();
    GetOnboardingUrlResponse response =
        GetOnboardingUrlResponse.fromJson(
            "{\n"
                + "  \"invalidFields\": [],\n"
  ...
  public void testAccountApi() throws IOException, ApiException, HTTPClientException {
    GetTaxFormRequest request =
        GetTaxFormRequest.fromJson(
            "{\n"
                + "  \"accountHolderCode\": \"CODE_OF_ACCOUNT_HOLDER\",\n"
                + "  \"formType\": \"1099-K\",\n"
                + "  \"year\": 2020\n"
                + "}");
    String jsonRequest = request.toJson();
    GetTaxFormResponse response =
        GetTaxFormResponse.fromJson(
            "{\n"
  ...
  public void testAccountApiInvalidValue() throws IOException {
    ...
    try {
      ...
      assertEquals(
          "AccountHolderDetails.PhoneNumber.fullPhoneNumber", error.getFieldType().getField());
  ...
  public void testFundApi() throws IOException, ApiException, HTTPClientException {
    PayoutAccountHolderRequest request =
        PayoutAccountHolderRequest.fromJson(
            "{\n"
                ...
                + "}");
    String jsonRequest = request.toJson();
    PayoutAccountHolderResponse response =
        PayoutAccountHolderResponse.fromJson(
            "{\n"
