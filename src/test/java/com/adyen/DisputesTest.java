...
public class DisputesTest extends BaseTest {
  ...
  public void acceptDispute() throws IOException, ApiException, HTTPClientException {
    Client client =
        createMockClientFromFile("mocks/disputes/post-acceptDispute-accept-dispute-200.json");
  ...
  public void defendDispute() throws IOException, ApiException, HTTPClientException {
    Client client =
        createMockClientFromFile("mocks/disputes/post-defendDispute-defend-dispute-200.json");
    client.setEnvironment(Environment.TEST, null);
    DisputesApi disputesApiService = new DisputesApi(client);
  ...
  public void deleteDisputeDefenseDocument() throws IOException, ApiException, HTTPClientException {
    Client client =
        createMockClientFromFile(
            "mocks/disputes/post-deleteDisputeDefenseDocument-delete-dispute-defense-document-200.json");
    client.setEnvironment(Environment.TEST, null);
    DisputesApi disputesApiService = new DisputesApi(client);
    ...
    request.setDisputePspReference("DZ4DPSHB4WD2WN82");
    request.setMerchantAccountCode("YOUR_MERCHANT_ACCOUNT");
    DeleteDefenseDocumentResponse response =
        disputesApiService.deleteDisputeDefenseDocument(request);
  ...
  @Test
  public void retrieveApplicableDefenseReasons()
      throws IOException, ApiException, HTTPClientException {
    Client client =
        createMockClientFromFile(
            "mocks/disputes/post-retrieveApplicableDefenseReasons-retrieve-defense-reasons-200.json");
    client.setEnvironment(Environment.TEST, null);
    DisputesApi disputesApiService = new DisputesApi(client);
    ...
    assertFalse(
        response.getDefenseReasons().get(0).getDefenseDocumentTypes().get(0).getAvailable());
    assertEquals(
        "TIDorInvoice",
        response
            .getDefenseReasons()
    ...
    assertEquals(
        "Optional",
        response.getDefenseReasons().get(0).getDefenseDocumentTypes().get(0).getRequirementLevel());
    assertFalse(response.getDefenseReasons().get(0).getSatisfied());

    assertNotNull(response.getDefenseReasons().get(1));
    assertEquals(
        "GoodsRepairedOrReplaced", response.getDefenseReasons().get(1).getDefenseReasonCode());
    ...
    assertEquals(
        "GoodsWereAsDescribed", response.getDefenseReasons().get(2).getDefenseReasonCode());
    ...
    assertEquals(
        "SupplyDefenseMaterial", response.getDefenseReasons().get(3).getDefenseReasonCode());
  ...
  public void supplyDefenseDocument() throws IOException, ApiException, HTTPClientException {
    Client client =
        createMockClientFromFile(
            "mocks/disputes/post-supplyDefenseDocument-supply-defense-document-200.json");
    client.setEnvironment(Environment.TEST, null);
    DisputesApi disputesApiService = new DisputesApi(client);
