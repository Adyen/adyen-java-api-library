...
//        storedValueIssueRequest.setPaymentMethod(new
// CardDetails().type(CardDetails.TypeEnum.GIFTCARD));
//
...
// storedValue.issue(storedValueIssueRequest);
...
//        assertEquals(StoredValueIssueResponse.ResultCodeEnum.SUCCESS,
// storedValueIssueResponse.getResultCode());
//        assertEquals("6036280000000000000",
// storedValueIssueResponse.getPaymentMethod().get("number"));
...
//        Client client =
// createMockClientFromFile("mocks/storedvalue/change-status-active-success.json");
//        StoredValue storedValue = new StoredValue(client);
//
//        StoredValueStatusChangeRequest storedValueStatusChangeRequest = new
...
//        storedValueStatusChangeRequest.setPaymentMethod(new
// CardDetails().type("givex").number("6036280000000000000").cvc("1111"));
...
// storedValue.changeStatus(storedValueStatusChangeRequest);
//        assertEquals("EUR", storedValueStatusChangeResponse.getCurrentBalance().getCurrency());
//        assertEquals(new Long(1000),
// storedValueStatusChangeResponse.getCurrentBalance().getValue());
//        assertEquals("851591629631298F", storedValueStatusChangeResponse.getPspReference());
//        assertEquals(StoredValueStatusChangeResponse.ResultCodeEnum.SUCCESS,
// storedValueStatusChangeResponse.getResultCode());
...
//        storedValueLoadRequest.setPaymentMethod(new
// CardDetails().type("givex").number("603628672882001915092").cvc("5754"));
//        storedValueLoadRequest.setReference("loadReference");
//
//        StoredValueLoadResponse storedValueLoadResponse =
// storedValue.load(storedValueLoadRequest);
...
//        assertEquals(StoredValueLoadResponse.ResultCodeEnum.SUCCESS,
// storedValueLoadResponse.getResultCode());
...
//        StoredValue storedValue = new StoredValue(client);
//
//        StoredValueBalanceCheckRequest storedValueBalanceCheckRequest = new
// StoredValueBalanceCheckRequest();
//        storedValueBalanceCheckRequest.setMerchantAccount("merchantAccount");
//        storedValueBalanceCheckRequest.setPaymentMethod(new
// CardDetails().type("givex").number("603628672882001915092").cvc("5754"));
...
// storedValue.checkBalance(storedValueBalanceCheckRequest);
//        assertEquals("EUR", storedValueBalanceCheckResponse.getCurrentBalance().getCurrency());
//        assertEquals(new Long(999999),
// storedValueBalanceCheckResponse.getCurrentBalance().getValue());
//        assertEquals("851591688783359H", storedValueBalanceCheckResponse.getPspReference());
//        assertEquals(StoredValueBalanceCheckResponse.ResultCodeEnum.SUCCESS,
...
//        StoredValue storedValue = new StoredValue(client);
//
//        StoredValueBalanceMergeRequest storedValueBalanceMergeRequest = new
// StoredValueBalanceMergeRequest();
//        storedValueBalanceMergeRequest.setMerchantAccount("merchantAccount");
//        storedValueBalanceMergeRequest.setSourcePaymentMethod(new
// CardDetails().number("7777182708544835").cvc("2329"));
//        storedValueBalanceMergeRequest.setPaymentMethod(new
// CardDetails().type("valuelink").number("8888182708544836").cvc("2330"));
...
// storedValue.mergeBalance(storedValueBalanceMergeRequest);
//        assertEquals("EUR", storedValueBalanceMergeResponse.getCurrentBalance().getCurrency());
//        assertEquals(new Long(5600),
// storedValueBalanceMergeResponse.getCurrentBalance().getValue());
//        assertEquals("881564657480267D", storedValueBalanceMergeResponse.getPspReference());
//        assertEquals(StoredValueBalanceMergeResponse.ResultCodeEnum.SUCCESS,
// storedValueBalanceMergeResponse.getResultCode());
//    }
//
//    @Test
//    public void testVoidTransactionSuccessMocked() throws Exception {
//        Client client =
// createMockClientFromFile("mocks/storedvalue/void-transaction-success.json");
//        StoredValue storedValue = new StoredValue(client);
//
...
// storedValue.voidTransaction(storedValueVoidRequest);
...
//        assertEquals(StoredValueVoidResponse.ResultCodeEnum.SUCCESS,
// storedValueVoidResponse.getResultCode());
//    }
//
//
// }
