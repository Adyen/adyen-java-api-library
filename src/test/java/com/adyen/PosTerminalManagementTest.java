...
public class PosTerminalManagementTest extends BaseTest {
  ...
  public void testAssignTerminalsSuccess() throws Exception {
    Client client =
        createMockClientFromFile("mocks/posterminalmanagement/assign-terminals-success.json");
  ...
  public void testFindTerminalSuccess() throws Exception {
    Client client =
        createMockClientFromFile("mocks/posterminalmanagement/find-terminal-success.json");
    PosTerminalManagementApi posTerminalManagement = new PosTerminalManagementApi(client);
  ...
  public void testGetTerminalsUnderAccountSuccess() throws Exception {
    Client client =
        createMockClientFromFile(
            "mocks/posterminalmanagement/get-terminals-under-account-success.json");
    PosTerminalManagementApi posTerminalManagement = new PosTerminalManagementApi(client);

    GetTerminalsUnderAccountRequest request = new GetTerminalsUnderAccountRequest();
    request.setCompanyAccount("DemoCompany");
    GetTerminalsUnderAccountResponse result =
        posTerminalManagement.getTerminalsUnderAccount(request);
    ...
    assertEquals(
        "P400Plus-375039202",
        result.getMerchantAccounts().get(0).getStores().get(0).getInStoreTerminals().get(0));
  }
  ...
  public void testGetStoresUnderAccountSuccess() throws Exception {
    Client client =
        createMockClientFromFile(
            "mocks/posterminalmanagement/get-stores-under-account-success.json");
    PosTerminalManagementApi posTerminalManagement = new PosTerminalManagementApi(client);
  ...
  public void testGetTerminalDetailsSuccess() throws Exception {
    Client client =
        createMockClientFromFile("mocks/posterminalmanagement/get-terminal-details-success.json");
    PosTerminalManagementApi posTerminalManagement = new PosTerminalManagementApi(client);
