 ...
 * DEPRECATED
 *
 * <p>Centralised handler for de-serialising all (Banking) webhook payloads.
 *
 * @deprecated Each webhook provides its own handler, for example use AcsWebhooksHandler to process
 *     AcsWebhooks events Use the specific WebhookHandler implementation: AcsWebhooks,
 *     ReportWebhooksHandler, ConfigurationWebhooks, TransferWebhooks, TransactionWebhooks, etc..
 */
...
public class BankingWebhookHandler {
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // use NegativeBalanceWarningWebhooksHandler instead
