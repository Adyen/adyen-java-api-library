 ...
 *
 * <p>This builder allows you to configure and create various types of Terminal API requests by
 * setting the appropriate request object and associated metadata such as MessageClassType and
 * MessageCategoryType.
 *
 * <p>Each type of Terminal API request (e.g. PaymentRequest, BalanceInquiryRequest, etc.) has a
 * dedicated `withXRequest` method that sets the necessary fields and message types internally. Once
 * all necessary fields are set, call build() to generate the TerminalAPIRequest.
 *
 * <p>Example usage:
 *
 * <pre>{@code
...
public final class TerminalAPIRequestBuilder {
  ...
  public TerminalAPIRequestBuilder withBalanceInquiryRequest(
  ...
  public TerminalAPIRequestBuilder withCardAcquisitionRequest(
  ...
  public TerminalAPIRequestBuilder withEnableServiceRequest(
  ...
  public TerminalAPIRequestBuilder withCardReaderInitRequest(
  ...
  public TerminalAPIRequestBuilder withCardReaderAPDURequest(
  ...
  public TerminalAPIRequestBuilder withCardReaderPowerOffRequest(
  ...
  public TerminalAPIRequestBuilder withReconciliationRequest(
  ...
  public TerminalAPIRequestBuilder withTransactionStatusRequest(
