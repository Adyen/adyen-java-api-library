...
public class AccountHolderTransactionListRequest {
  ...
  public AccountHolderTransactionListRequest transactionListsPerAccount(
      List<TransactionListForAccount> transactionListsPerAccount) {
    this.transactionListsPerAccount = transactionListsPerAccount;
    return this;
  }

  public AccountHolderTransactionListRequest addTransactionListsPerAccountItem(
      TransactionListForAccount transactionListsPerAccountItem) {
  ...
  @JsonProperty(JSON_PROPERTY_TRANSACTION_LISTS_PER_ACCOUNT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTransactionListsPerAccount(
      List<TransactionListForAccount> transactionListsPerAccount) {
    this.transactionListsPerAccount = transactionListsPerAccount;
  }

  public AccountHolderTransactionListRequest transactionStatuses(
      List<TransactionStatusesEnum> transactionStatuses) {
    this.transactionStatuses = transactionStatuses;
    return this;
  }

  public AccountHolderTransactionListRequest addTransactionStatusesItem(
      TransactionStatusesEnum transactionStatusesItem) {
   ...
   * included. &gt;Permitted values: &gt;* &#x60;PendingCredit&#x60; - a pending balance credit.
   * &gt;* &#x60;CreditFailed&#x60; - a pending credit failure; the balance will not be credited.
   * &gt;* &#x60;Credited&#x60; - a credited balance. &gt;* &#x60;PendingDebit&#x60; - a pending
   * balance debit (e.g., a refund). &gt;* &#x60;CreditClosed&#x60; - a pending credit closed; the
   * balance will not be credited. &gt;* &#x60;CreditSuspended&#x60; - a pending credit closed; the
   * balance will not be credited. &gt;* &#x60;DebitFailed&#x60; - a pending debit failure; the
   * balance will not be debited. &gt;* &#x60;Debited&#x60; - a debited balance (e.g., a refund).
   * &gt;* &#x60;DebitReversedReceived&#x60; - a pending refund reversal. &gt;*
   * &#x60;DebitedReversed&#x60; - a reversed refund. &gt;* &#x60;ChargebackReceived&#x60; - a
   * received chargeback request. &gt;* &#x60;Chargeback&#x60; - a processed chargeback. &gt;*
   * &#x60;ChargebackReversedReceived&#x60; - a pending chargeback reversal. &gt;*
   * &#x60;ChargebackReversed&#x60; - a reversed chargeback. &gt;* &#x60;Converted&#x60; -
   * converted. &gt;* &#x60;ManualCorrected&#x60; - manual booking/adjustment by Adyen. &gt;*
   * &#x60;Payout&#x60; - a payout. &gt;* &#x60;PayoutReversed&#x60; - a reversed payout. &gt;*
  ...
  public boolean equals(Object o) {
    ...
    AccountHolderTransactionListRequest accountHolderTransactionListRequest =
        (AccountHolderTransactionListRequest) o;
    return Objects.equals(
            this.accountHolderCode, accountHolderTransactionListRequest.accountHolderCode)
        && Objects.equals(
            this.transactionListsPerAccount,
            accountHolderTransactionListRequest.transactionListsPerAccount)
        && Objects.equals(
            this.transactionStatuses, accountHolderTransactionListRequest.transactionStatuses);
  }
  ...
  public String toString() {
    ...
    sb.append("    transactionListsPerAccount: ")
        .append(toIndentedString(transactionListsPerAccount))
        .append("\n");
    sb.append("    transactionStatuses: ")
        .append(toIndentedString(transactionStatuses))
        .append("\n");
    sb.append("}");
    return sb.toString();
  }
