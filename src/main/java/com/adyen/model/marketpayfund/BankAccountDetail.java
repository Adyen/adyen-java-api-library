...
public class BankAccountDetail {
  ...
  /**
   * The bank account number (without separators). &gt;Refer to [Required
   ...
   * values are: &#x60;checking&#x60;, &#x60;savings&#x60;. &gt;Refer to [Required
   * information](https://docs.adyen.com/marketplaces-and-platforms/classic/verification-process/required-information)
   * for details on field requirements.
   *
   * @return accountType
  ...
  /**
   * The unique identifier (UUID) of the Bank Account. &gt;If, during an account holder create or
   * update request, this field is left blank (but other fields provided), a new Bank Account will
   * be created with a procedurally-generated UUID. &gt;If, during an account holder create request,
   * a UUID is provided, the creation of the Bank Account will fail while the creation of the
   * account holder will continue. &gt;If, during an account holder update request, a UUID that is
   * not correlated with an existing Bank Account is provided, the update of the account holder will
   * fail. &gt;If, during an account holder update request, a UUID that is correlated with an
   * existing Bank Account is provided, the existing Bank Account will be updated.
   *
  ...
  /**
   * The bank identifier code. &gt;Refer to [Required
   * information](https://docs.adyen.com/marketplaces-and-platforms/classic/verification-process/required-information)
   * for details on field requirements.
   *
   * @return bankBicSwift
  ...
  /**
   * The city in which the bank branch is located. &gt;Refer to [Required
   * information](https://docs.adyen.com/marketplaces-and-platforms/classic/verification-process/required-information)
   * for details on field requirements.
   *
   * @return bankCity
  ...
  /**
   * The bank code of the banking institution with which the bank account is registered. &gt;Refer
   * to [Required
   * information](https://docs.adyen.com/marketplaces-and-platforms/classic/verification-process/required-information)
   * for details on field requirements.
   *
  ...
  /**
   * The name of the banking institution with which the bank account is held. &gt;Refer to [Required
   * information](https://docs.adyen.com/marketplaces-and-platforms/classic/verification-process/required-information)
   * for details on field requirements.
   *
   * @return bankName
  ...
  /**
   * The branch code of the branch under which the bank account is registered. The value to be
   * specified in this parameter depends on the country of the bank account: * United States -
   * Routing number * United Kingdom - Sort code * Germany - Bankleitzahl &gt;Refer to [Required
   * information](https://docs.adyen.com/marketplaces-and-platforms/classic/verification-process/required-information)
   * for details on field requirements.
   *
   * @return branchCode
  ...
  /**
   * The check code of the bank account. &gt;Refer to [Required
   * information](https://docs.adyen.com/marketplaces-and-platforms/classic/verification-process/required-information)
   * for details on field requirements.
   *
   * @return checkCode
  ...
  /**
   * The two-letter country code in which the bank account is registered. &gt;The permitted country
   * codes are defined in ISO-3166-1 alpha-2 (e.g. &#39;NL&#39;). &gt;Refer to [Required
   * information](https://docs.adyen.com/marketplaces-and-platforms/classic/verification-process/required-information)
   * for details on field requirements.
   *
   * @return countryCode
  ...
  /**
   * The currency in which the bank account deals. &gt;The permitted currency codes are defined in
   * ISO-4217 (e.g. &#39;EUR&#39;).
   *
   * @return currencyCode
   */
  ...
  /**
   * The international bank account number. &gt;The IBAN standard is defined in ISO-13616. &gt;Refer
   * to [Required
   * information](https://docs.adyen.com/marketplaces-and-platforms/classic/verification-process/required-information)
   * for details on field requirements.
   *
  ...
  /**
   * The city of residence of the bank account owner. &gt;Refer to [Required
   * information](https://docs.adyen.com/marketplaces-and-platforms/classic/verification-process/required-information)
   * for details on field requirements.
   *
   * @return ownerCity
   ...
   * country codes are defined in ISO-3166-1 alpha-2 (e.g. &#39;NL&#39;). &gt;Refer to [Required
   * information](https://docs.adyen.com/marketplaces-and-platforms/classic/verification-process/required-information)
   * for details on field requirements.
   *
  ...
  /**
   * The date of birth of the bank account owner. The date should be in ISO-8601 format yyyy-mm-dd
   * (e.g. 2000-01-31).
   *
  ...
  /**
   * The house name or number of the residence of the bank account owner. &gt;Refer to [Required
   * information](https://docs.adyen.com/marketplaces-and-platforms/classic/verification-process/required-information)
   * for details on field requirements.
   *
  ...
  /**
   * The name of the bank account owner. &gt;Refer to [Required
   * information](https://docs.adyen.com/marketplaces-and-platforms/classic/verification-process/required-information)
   * for details on field requirements.
   *
   * @return ownerName
  ...
  /**
   * The postal code of the residence of the bank account owner. &gt;Refer to [Required
   * information](https://docs.adyen.com/marketplaces-and-platforms/classic/verification-process/required-information)
   * for details on field requirements.
   *
  ...
  /**
   * The state of residence of the bank account owner. &gt;Refer to [Required
   * information](https://docs.adyen.com/marketplaces-and-platforms/classic/verification-process/required-information)
   * for details on field requirements.
   *
   * @return ownerState
  ...
  /**
   * The street name of the residence of the bank account owner. &gt;Refer to [Required
   * information](https://docs.adyen.com/marketplaces-and-platforms/classic/verification-process/required-information)
   * for details on field requirements.
   *
   * @return ownerStreet
  ...
  /**
   * The tax ID number. &gt;Refer to [Required
   * information](https://docs.adyen.com/marketplaces-and-platforms/classic/verification-process/required-information)
   * for details on field requirements.
   *
   * @return taxId
  ...
  /**
   * The URL to be used for bank account verification. This may be generated on bank account
   * creation. &gt;Refer to [Required
   * information](https://docs.adyen.com/marketplaces-and-platforms/classic/verification-process/required-information)
   * for details on field requirements.
   *
  ...
  public String toString() {
    ...
    sb.append("    bankAccountReference: ")
        .append(toIndentedString(bankAccountReference))
        .append("\n");
    ...
    sb.append("    ownerHouseNumberOrName: ")
        .append(toIndentedString(ownerHouseNumberOrName))
        .append("\n");
   ...
   * @throws JacksonException if the JSON string is invalid with respect to BankAccountDetail
   */
  public static BankAccountDetail fromJson(String jsonString) throws JacksonException {
