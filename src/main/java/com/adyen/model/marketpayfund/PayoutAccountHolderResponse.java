...
public class PayoutAccountHolderResponse {
  ...
  public int hashCode() {
    return Objects.hash(
        bankAccountUUID, invalidFields, merchantReference, payoutSpeed, pspReference, resultCode);
  }
   ...
   *     PayoutAccountHolderResponse
   */
  public static PayoutAccountHolderResponse fromJson(String jsonString) throws JacksonException {
