...
public class SetupBeneficiaryResponse {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to SetupBeneficiaryResponse
   */
  public static SetupBeneficiaryResponse fromJson(String jsonString) throws JacksonException {
