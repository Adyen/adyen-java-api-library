...
public class AccountDetailBalance {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to AccountDetailBalance
   */
  public static AccountDetailBalance fromJson(String jsonString) throws JacksonException {
