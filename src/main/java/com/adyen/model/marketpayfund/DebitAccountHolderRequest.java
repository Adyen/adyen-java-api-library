...
public class DebitAccountHolderRequest {
  ...
  /**
   * The Adyen-generated unique alphanumeric identifier (UUID) of the account holder&#39;s bank
   * account.
   *
  ...
  /**
   * A description of the direct debit. Maximum length: 35 characters. Allowed characters: **a-z**,
   * **A-Z**, **0-9**, and special characters **_/?:().,&#39;+ \&quot;;**.
   *
   * @return description
   */
  @ApiModelProperty(
  ...
  /**
   * Contains instructions on how to split the funds between the accounts in your platform. The
   * request must have at least one split item.
   *
   * @return splits
   */
  @ApiModelProperty(
   ...
   *     DebitAccountHolderRequest
   */
  public static DebitAccountHolderRequest fromJson(String jsonString) throws JacksonException {
