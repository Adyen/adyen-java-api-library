...
public class RefundFundsTransferResponse {
  ...
  /**
   * The value supplied by the executing user when initiating the transfer refund; may be used to
   * link multiple transactions.
   *
  ...
  public int hashCode() {
    return Objects.hash(
        invalidFields, merchantReference, message, originalReference, pspReference, resultCode);
  }
