...
public class TransactionListForAccount {
  ...
  /**
   * The page of transactions to retrieve. Each page lists fifty (50) transactions. The most recent
   * transactions are included on page 1.
   *
   * @return page
   */
  @ApiModelProperty(
   ...
   *     TransactionListForAccount
   */
  public static TransactionListForAccount fromJson(String jsonString) throws JacksonException {
