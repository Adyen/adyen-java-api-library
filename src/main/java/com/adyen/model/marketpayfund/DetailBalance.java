...
public class DetailBalance {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to DetailBalance
   */
  public static DetailBalance fromJson(String jsonString) throws JacksonException {
