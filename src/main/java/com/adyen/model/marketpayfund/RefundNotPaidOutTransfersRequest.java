 ...
 */
@JsonPropertyOrder({
  RefundNotPaidOutTransfersRequest.JSON_PROPERTY_ACCOUNT_CODE,
  RefundNotPaidOutTransfersRequest.JSON_PROPERTY_ACCOUNT_HOLDER_CODE
})
...
public class RefundNotPaidOutTransfersRequest {
   ...
   * @return accountCode
  **/
  @ApiModelProperty(required = true, value = "The code of the account from which to perform the refund(s).")
  ...
  **/
  @ApiModelProperty(required = true, value = "The code of the Account Holder which owns the account from which to perform the refund(s).")
  ...
  /**
   * Return true if this RefundNotPaidOutTransfersRequest object is equal to o.
   */
  @Override
...
/**
   ...
   * @throws JsonProcessingException if the JSON string is invalid with respect to RefundNotPaidOutTransfersRequest
   */
  public static RefundNotPaidOutTransfersRequest fromJson(String jsonString) throws JsonProcessingException {
    return JSON.getMapper().readValue(jsonString, RefundNotPaidOutTransfersRequest.class);
  }
/**
