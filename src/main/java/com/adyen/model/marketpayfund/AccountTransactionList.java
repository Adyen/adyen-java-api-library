...
public class AccountTransactionList {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to AccountTransactionList
   */
  public static AccountTransactionList fromJson(String jsonString) throws JacksonException {
