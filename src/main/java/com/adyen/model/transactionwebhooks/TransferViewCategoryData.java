...
import com.adyen.model.transactionwebhooks.InternalCategoryData;
import com.adyen.model.transactionwebhooks.IssuedCard;
import com.adyen.model.transactionwebhooks.PlatformPayment;
import com.adyen.model.transactionwebhooks.RelayedAuthorisationData;
import com.adyen.model.transactionwebhooks.TransferNotificationValidationFact;
...
public class TransferViewCategoryData extends AbstractOpenApiSchema {
    ...
    public static class TransferViewCategoryDataSerializer extends StdSerializer<TransferViewCategoryData> {
        ...
        @Override
        public void serialize(TransferViewCategoryData value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class TransferViewCategoryDataDeserializer extends StdDeserializer<TransferViewCategoryData> {
        ...
        @Override
        public TransferViewCategoryData deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 0) {
                throw new IOException(String.format("Failed deserialization for TransferViewCategoryData: %d classes match result, expected 1", match));
            }
            // Log warning if there is more than one match
            if (match > 1) {
                log.log(Level.WARNING, String.format("Warning, indecisive deserialization for TransferViewCategoryData: %d classes match result, expected 1", match));
            }
         ...
         */
        @Override
        public TransferViewCategoryData getNullValue(DeserializationContext ctxt) throws JsonMappingException {
