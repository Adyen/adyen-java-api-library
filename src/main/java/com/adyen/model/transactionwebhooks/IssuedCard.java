...
public class IssuedCard {
  ...
  public enum PanEntryModeEnum {
    ...
    public static PanEntryModeEnum fromValue(String value) {
      ...
      LOG.warning("PanEntryModeEnum: unexpected enum value '" + value + "' - Supported values are "+ Arrays.toString(PanEntryModeEnum.values()));
      return null;
    }
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authorisationType, panEntryMode, processingType, relayedAuthorisationData, schemeTraceId, schemeUniqueTransactionId, threeDSecure, type, validationFacts);
  }
