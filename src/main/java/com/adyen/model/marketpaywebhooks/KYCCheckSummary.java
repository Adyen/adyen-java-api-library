...
public class KYCCheckSummary {
  ...
  /**
   * The code of the check. For possible values, refer to [Verification
  ...
  public String toString() {
    ...
    sb.append("    kycCheckDescription: ")
        .append(toIndentedString(kycCheckDescription))
        .append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws JacksonException if the JSON string is invalid with respect to KYCCheckSummary
   */
  public static KYCCheckSummary fromJson(String jsonString) throws JacksonException {
