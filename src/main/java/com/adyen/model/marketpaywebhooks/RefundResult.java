...
public class RefundResult {
   ...
   */
  @ApiModelProperty(
      value = "The response indicating if the refund has been received for processing.")
  ...
  public String toString() {
    ...
    sb.append("    originalTransaction: ")
        .append(toIndentedString(originalTransaction))
        .append("\n");
   ...
   */
  public static RefundResult fromJson(String jsonString) throws JacksonException {
