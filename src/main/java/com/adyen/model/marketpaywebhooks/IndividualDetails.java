...
public class IndividualDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to IndividualDetails
   */
  public static IndividualDetails fromJson(String jsonString) throws JacksonException {
