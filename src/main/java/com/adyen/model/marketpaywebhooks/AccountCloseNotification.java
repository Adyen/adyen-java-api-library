...
import com.adyen.model.marketpaywebhooks.CloseAccountResponse;
 ...
 */
@JsonPropertyOrder({
  AccountCloseNotification.JSON_PROPERTY_CONTENT,
  AccountCloseNotification.JSON_PROPERTY_ERROR,
  AccountCloseNotification.JSON_PROPERTY_EVENT_DATE,
  AccountCloseNotification.JSON_PROPERTY_EVENT_TYPE,
  AccountCloseNotification.JSON_PROPERTY_EXECUTING_USER_KEY,
  AccountCloseNotification.JSON_PROPERTY_LIVE,
  AccountCloseNotification.JSON_PROPERTY_PSP_REFERENCE
})
...
/**
   ...
   * @throws JsonProcessingException if the JSON string is invalid with respect to AccountCloseNotification
   */
  public static AccountCloseNotification fromJson(String jsonString) throws JsonProcessingException {
    return JSON.getMapper().readValue(jsonString, AccountCloseNotification.class);
  }
/**
