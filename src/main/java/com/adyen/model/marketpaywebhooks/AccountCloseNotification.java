...
public class AccountCloseNotification {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to AccountCloseNotification
   */
  public static AccountCloseNotification fromJson(String jsonString) throws JacksonException {
