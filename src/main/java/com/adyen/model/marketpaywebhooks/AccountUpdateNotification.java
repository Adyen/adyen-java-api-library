...
import com.adyen.model.marketpaywebhooks.UpdateAccountResponse;
 ...
 */
@JsonPropertyOrder({
  AccountUpdateNotification.JSON_PROPERTY_CONTENT,
  AccountUpdateNotification.JSON_PROPERTY_ERROR,
  AccountUpdateNotification.JSON_PROPERTY_EVENT_DATE,
  AccountUpdateNotification.JSON_PROPERTY_EVENT_TYPE,
  AccountUpdateNotification.JSON_PROPERTY_EXECUTING_USER_KEY,
  AccountUpdateNotification.JSON_PROPERTY_LIVE,
  AccountUpdateNotification.JSON_PROPERTY_PSP_REFERENCE
})
...
public class AccountUpdateNotification {
  ...
  **/
  ...
  /**
   * Return true if this AccountUpdateNotification object is equal to o.
   */
  @Override
...
/**
   ...
   * @throws JsonProcessingException if the JSON string is invalid with respect to AccountUpdateNotification
   */
  public static AccountUpdateNotification fromJson(String jsonString) throws JsonProcessingException {
    return JSON.getMapper().readValue(jsonString, AccountUpdateNotification.class);
  }
/**
