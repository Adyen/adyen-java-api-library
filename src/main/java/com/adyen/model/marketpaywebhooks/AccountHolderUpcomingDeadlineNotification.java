...
@JsonPropertyOrder({
  AccountHolderUpcomingDeadlineNotification.JSON_PROPERTY_CONTENT,
  AccountHolderUpcomingDeadlineNotification.JSON_PROPERTY_ERROR,
  AccountHolderUpcomingDeadlineNotification.JSON_PROPERTY_EVENT_DATE,
  AccountHolderUpcomingDeadlineNotification.JSON_PROPERTY_EVENT_TYPE,
  AccountHolderUpcomingDeadlineNotification.JSON_PROPERTY_EXECUTING_USER_KEY,
  AccountHolderUpcomingDeadlineNotification.JSON_PROPERTY_LIVE,
  AccountHolderUpcomingDeadlineNotification.JSON_PROPERTY_PSP_REFERENCE
})
public class AccountHolderUpcomingDeadlineNotification {
  public static final String JSON_PROPERTY_CONTENT = "content";
  private AccountHolderUpcomingDeadlineNotificationContent content;
  ...
  public AccountHolderUpcomingDeadlineNotification content(
      AccountHolderUpcomingDeadlineNotificationContent content) {
  ...
  public AccountHolderUpcomingDeadlineNotification eventDate(OffsetDateTime eventDate) {
  ...
  public AccountHolderUpcomingDeadlineNotification eventType(String eventType) {
  ...
  /** Return true if this AccountHolderUpcomingDeadlineNotification object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    AccountHolderUpcomingDeadlineNotification accountHolderUpcomingDeadlineNotification =
        (AccountHolderUpcomingDeadlineNotification) o;
    return Objects.equals(this.content, accountHolderUpcomingDeadlineNotification.content)
        ...
        && Objects.equals(this.eventType, accountHolderUpcomingDeadlineNotification.eventType)
        && Objects.equals(
            this.executingUserKey, accountHolderUpcomingDeadlineNotification.executingUserKey)
        && Objects.equals(this.live, accountHolderUpcomingDeadlineNotification.live)
        && Objects.equals(
            this.pspReference, accountHolderUpcomingDeadlineNotification.pspReference);
  }
  ...
  /**
   * Create an instance of AccountHolderUpcomingDeadlineNotification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccountHolderUpcomingDeadlineNotification
   * @throws JsonProcessingException if the JSON string is invalid with respect to
   *     AccountHolderUpcomingDeadlineNotification
   */
  public static AccountHolderUpcomingDeadlineNotification fromJson(String jsonString)
      throws JsonProcessingException {
    return JSON.getMapper().readValue(jsonString, AccountHolderUpcomingDeadlineNotification.class);
  }

  /**
   * Convert an instance of AccountHolderUpcomingDeadlineNotification to an JSON string
   *
   * @return JSON string
   */
