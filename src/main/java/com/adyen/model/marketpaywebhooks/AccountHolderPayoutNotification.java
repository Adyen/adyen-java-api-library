...
import com.adyen.model.marketpaywebhooks.AccountHolderPayoutNotificationContent;
 ...
 */
@JsonPropertyOrder({
  AccountHolderPayoutNotification.JSON_PROPERTY_CONTENT,
  AccountHolderPayoutNotification.JSON_PROPERTY_ERROR,
  AccountHolderPayoutNotification.JSON_PROPERTY_EVENT_DATE,
  AccountHolderPayoutNotification.JSON_PROPERTY_EVENT_TYPE,
  AccountHolderPayoutNotification.JSON_PROPERTY_EXECUTING_USER_KEY,
  AccountHolderPayoutNotification.JSON_PROPERTY_LIVE,
  AccountHolderPayoutNotification.JSON_PROPERTY_PSP_REFERENCE
})
...
public class AccountHolderPayoutNotification {
  ...
  **/
  ...
  /**
   * Return true if this AccountHolderPayoutNotification object is equal to o.
   */
  @Override
...
/**
   ...
   * @throws JsonProcessingException if the JSON string is invalid with respect to AccountHolderPayoutNotification
   */
  public static AccountHolderPayoutNotification fromJson(String jsonString) throws JsonProcessingException {
    return JSON.getMapper().readValue(jsonString, AccountHolderPayoutNotification.class);
  }
/**
