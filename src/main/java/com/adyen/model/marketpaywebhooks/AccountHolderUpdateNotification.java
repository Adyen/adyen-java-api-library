...
import com.adyen.model.marketpaywebhooks.UpdateAccountHolderResponse;
 ...
 */
@JsonPropertyOrder({
  AccountHolderUpdateNotification.JSON_PROPERTY_CONTENT,
  AccountHolderUpdateNotification.JSON_PROPERTY_ERROR,
  AccountHolderUpdateNotification.JSON_PROPERTY_EVENT_DATE,
  AccountHolderUpdateNotification.JSON_PROPERTY_EVENT_TYPE,
  AccountHolderUpdateNotification.JSON_PROPERTY_EXECUTING_USER_KEY,
  AccountHolderUpdateNotification.JSON_PROPERTY_LIVE,
  AccountHolderUpdateNotification.JSON_PROPERTY_PSP_REFERENCE
})
...
public class AccountHolderUpdateNotification {
  ...
  **/
  ...
  public AccountHolderUpdateNotification eventDate(OffsetDateTime eventDate) {
  ...
  **/
  ...
  /**
   * Return true if this AccountHolderUpdateNotification object is equal to o.
   */
  @Override
...
/**
   ...
   * @throws JsonProcessingException if the JSON string is invalid with respect to AccountHolderUpdateNotification
   */
  public static AccountHolderUpdateNotification fromJson(String jsonString) throws JsonProcessingException {
    return JSON.getMapper().readValue(jsonString, AccountHolderUpdateNotification.class);
  }
/**
