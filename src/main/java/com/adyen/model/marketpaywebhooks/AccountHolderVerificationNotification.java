...
import com.adyen.model.marketpaywebhooks.AccountHolderVerificationNotificationContent;
 ...
 */
@JsonPropertyOrder({
  AccountHolderVerificationNotification.JSON_PROPERTY_CONTENT,
  AccountHolderVerificationNotification.JSON_PROPERTY_ERROR,
  AccountHolderVerificationNotification.JSON_PROPERTY_EVENT_DATE,
  AccountHolderVerificationNotification.JSON_PROPERTY_EVENT_TYPE,
  AccountHolderVerificationNotification.JSON_PROPERTY_EXECUTING_USER_KEY,
  AccountHolderVerificationNotification.JSON_PROPERTY_LIVE,
  AccountHolderVerificationNotification.JSON_PROPERTY_PSP_REFERENCE
})
...
public class AccountHolderVerificationNotification {
  ...
  **/
  ...
  public AccountHolderVerificationNotification eventDate(OffsetDateTime eventDate) {
  ...
  **/
  ...
  /**
   * Return true if this AccountHolderVerificationNotification object is equal to o.
   */
  @Override
...
/**
   ...
   * @throws JsonProcessingException if the JSON string is invalid with respect to AccountHolderVerificationNotification
   */
  public static AccountHolderVerificationNotification fromJson(String jsonString) throws JsonProcessingException {
    return JSON.getMapper().readValue(jsonString, AccountHolderVerificationNotification.class);
  }
/**
