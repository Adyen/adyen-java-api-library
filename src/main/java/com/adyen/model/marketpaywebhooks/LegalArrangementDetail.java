...
public class LegalArrangementDetail {
   ...
   * The possible values depend on the &#x60;type&#x60;. - For &#x60;type&#x60; **Trust**:
   ...
   * **PooledSuperannuationTrust**, **PublicTradingTrust**, or **UnlistedPublicUnitTrust**. - For
   * &#x60;type&#x60; **Partnership**: **LimitedPartnership**, **FamilyPartnership**, or
   * **OtherPartnership**
   */
  ...
  /**
   * The [type of legal
   * arrangement](https://docs.adyen.com/marketplaces-and-platforms/classic/verification-process/legal-arrangements#types-of-legal-arrangements).
   * Possible values: - **Association** - **Partnership** - **SoleProprietorship** - **Trust**
   */
   ...
   * when you create a legal arrangement. Use only when updating an account holder. If you include
  ...
  public LegalArrangementDetail legalArrangementEntities(
      List<LegalArrangementEntityDetail> legalArrangementEntities) {
    this.legalArrangementEntities = legalArrangementEntities;
    return this;
  }

  public LegalArrangementDetail addLegalArrangementEntitiesItem(
      LegalArrangementEntityDetail legalArrangementEntitiesItem) {
  ...
  @JsonProperty(JSON_PROPERTY_LEGAL_ARRANGEMENT_ENTITIES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLegalArrangementEntities(
      List<LegalArrangementEntityDetail> legalArrangementEntities) {
    this.legalArrangementEntities = legalArrangementEntities;
  }
   ...
   */
  @ApiModelProperty(
      value = "Your reference for the legal arrangement. Must be between 3 to 128 characters.")
  ...
  @ApiModelProperty(
      required = true,
      value = "The legal name of the legal arrangement. Minimum length: 3 characters.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.address, legalArrangementDetail.address)
        ...
        && Objects.equals(
            this.legalArrangementEntities, legalArrangementDetail.legalArrangementEntities)
        && Objects.equals(
            this.legalArrangementReference, legalArrangementDetail.legalArrangementReference)
  ...
  public String toString() {
    ...
    sb.append("    legalArrangementCode: ")
        ...
        .append("\n");
    sb.append("    legalArrangementEntities: ")
        .append(toIndentedString(legalArrangementEntities))
        .append("\n");
    sb.append("    legalArrangementReference: ")
        .append(toIndentedString(legalArrangementReference))
        .append("\n");
