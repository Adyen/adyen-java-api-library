...
public class PersonalDocumentData {
   ...
   * **SOCIALSECURITY**, **VISA**. To delete an existing entry for a document &#x60;type&#x60;, send
   * only the &#x60;type&#x60; field in your request.
   */
  ...
  /**
   * The country where the document was issued, in the two-character [ISO 3166-1
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PersonalDocumentData
   */
  public static PersonalDocumentData fromJson(String jsonString) throws JacksonException {
