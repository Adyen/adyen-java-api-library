 ...
 */
@JsonPropertyOrder({
  DirectDebitInitiatedNotification.JSON_PROPERTY_CONTENT,
  DirectDebitInitiatedNotification.JSON_PROPERTY_ERROR,
  DirectDebitInitiatedNotification.JSON_PROPERTY_EVENT_DATE,
  DirectDebitInitiatedNotification.JSON_PROPERTY_EVENT_TYPE,
  DirectDebitInitiatedNotification.JSON_PROPERTY_EXECUTING_USER_KEY,
  DirectDebitInitiatedNotification.JSON_PROPERTY_LIVE,
  DirectDebitInitiatedNotification.JSON_PROPERTY_PSP_REFERENCE
})
...
public class DirectDebitInitiatedNotification {
  ...
  **/
  ...
  /**
   * Return true if this DirectDebitInitiatedNotification object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.content, directDebitInitiatedNotification.content) &&
        ...
        Objects.equals(this.eventType, directDebitInitiatedNotification.eventType) &&
...
/**
   * Create an instance of DirectDebitInitiatedNotification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DirectDebitInitiatedNotification
   * @throws JsonProcessingException if the JSON string is invalid with respect to DirectDebitInitiatedNotification
   */
  public static DirectDebitInitiatedNotification fromJson(String jsonString) throws JsonProcessingException {
    return JSON.getMapper().readValue(jsonString, DirectDebitInitiatedNotification.class);
  }
/**
  * Convert an instance of DirectDebitInitiatedNotification to an JSON string
  *
  * @return JSON string
  */
