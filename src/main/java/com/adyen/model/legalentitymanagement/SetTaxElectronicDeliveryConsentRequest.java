...
@JsonPropertyOrder({SetTaxElectronicDeliveryConsentRequest.JSON_PROPERTY_US1099K})
public class SetTaxElectronicDeliveryConsentRequest {
   ...
   * @return the current {@code SetTaxElectronicDeliveryConsentRequest} instance, allowing for
   *     method chaining
   */
   ...
   *     SetTaxElectronicDeliveryConsentRequest
   */
  public static SetTaxElectronicDeliveryConsentRequest fromJson(String jsonString)
