...
public class UnincorporatedPartnership {
  ...
  /**
   * Type of Partnership. Possible values: * **limitedPartnership** * **generalPartnership** *
   * **familyPartnership** * **commercialPartnership** * **publicPartnership** *
   * **otherPartnership** * **gbr** * **gmbh** * **kgaa** * **cv** * **vof** * **maatschap** *
   * **privateFundLimitedPartnership** * **businessTrustEntity** * **businessPartnership** *
   * **limitedLiabilityPartnership** * **eg** * **cooperative** * **vos** * **comunidadDeBienes** *
   * **herenciaYacente** * **comunidadDePropietarios** * **sep** * **sca** * **bt** * **kkt** *
   * **scs** * **snc**
   */
  ...
  @JsonCreator
  public UnincorporatedPartnership(@JsonProperty(JSON_PROPERTY_TYPE) TypeEnum type) {
    this();
    this.type = type;
  }
   ...
   * **scs** * **snc**
   *
   * @return type Type of Partnership. Possible values: * **limitedPartnership** *
   *     **generalPartnership** * **familyPartnership** * **commercialPartnership** *
   *     **publicPartnership** * **otherPartnership** * **gbr** * **gmbh** * **kgaa** * **cv** *
   *     **vof** * **maatschap** * **privateFundLimitedPartnership** * **businessTrustEntity** *
   *     **businessPartnership** * **limitedLiabilityPartnership** * **eg** * **cooperative** *
   *     **vos** * **comunidadDeBienes** * **herenciaYacente** * **comunidadDePropietarios** *
   *     **sep** * **sca** * **bt** * **kkt** * **scs** * **snc**
   */
   ...
   *     UnincorporatedPartnership
   */
  public static UnincorporatedPartnership fromJson(String jsonString) throws JacksonException {
