...
public class CalculatePciStatusRequest {
   ...
   */
  public CalculatePciStatusRequest additionalSalesChannels(
  ...
  public CalculatePciStatusRequest addAdditionalSalesChannelsItem(
   ...
   */
  public CalculatePciStatusRequest includeNullValues(boolean includeNullValues) {
   ...
   *     CalculatePciStatusRequest
   */
  public static CalculatePciStatusRequest fromJson(String jsonString) throws JacksonException {
