...
public class TransferInstrument {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bankAccount, isSetBankAccount, capabilities, isSetCapabilities, documentDetails, isSetDocumentDetails, id, isSetId, legalEntityId, isSetLegalEntityId, problems, isSetProblems, type, isSetType);
  }
