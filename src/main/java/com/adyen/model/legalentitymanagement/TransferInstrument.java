...
public class TransferInstrument {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to TransferInstrument
   */
  public static TransferInstrument fromJson(String jsonString) throws JacksonException {
