...
public class AcceptTermsOfServiceResponse {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(acceptedBy, isSetAcceptedBy, id, isSetId, ipAddress, isSetIpAddress, language, isSetLanguage, termsOfServiceDocumentId, isSetTermsOfServiceDocumentId, type, isSetType);
  }
