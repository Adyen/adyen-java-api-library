...
public class Document {
   ...
   * **proofOfOwnership**, **proofOfIndustry**, **proofOfSignatory**, or
   ...
   *     **proofOfSignatory**, or **proofOfFundingOrWealthSource**. * For **individual**, the
   *     &#x60;type&#x60; values can be **identityCard**, **driversLicense**, **passport**,
   ...
   *     **proofOfAddress**, or **proofOfIndustry**. * For **trust**, the &#x60;type&#x60; value is
   *     **constitutionalDocument**. * For **unincorporatedPartnership**, the &#x60;type&#x60; value
   *     is **constitutionalDocument**. * Use **bankStatement** to upload documents for a [transfer
   *     instrument](https://docs.adyen.com/api-explorer/#/legalentity/latest/post/transferInstruments__resParam_id).
   * @return the current {@code Document} instance, allowing for method chaining
   */
