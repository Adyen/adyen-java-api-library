...
public class VerificationDeadline {
  ...
  /**
   * The list of capabilities that will be disallowed if information is not reviewed by the time of
   * the deadline
   *
   * @return capabilities The list of capabilities that will be disallowed if information is not
   *     reviewed by the time of the deadline
   */
   ...
   *
   * @return entityIds The unique identifiers of the legal entity or supporting entities that the
   *     deadline applies to
   */
   ...
   * @throws JacksonException if the JSON string is invalid with respect to VerificationDeadline
   */
  public static VerificationDeadline fromJson(String jsonString) throws JacksonException {
