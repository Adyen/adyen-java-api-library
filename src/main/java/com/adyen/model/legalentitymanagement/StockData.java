...
public class StockData {
  ...
  **/
  ...
  public String toString() {
      String sb = "class StockData {\n" +
              "    marketIdentifier: " + toIndentedString(marketIdentifier) + "\n" +
              "    stockNumber: " + toIndentedString(stockNumber) + "\n" +
              "    tickerSymbol: " + toIndentedString(tickerSymbol) + "\n" +
              "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (StockData.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in StockData is not found in the empty JSON string", StockData.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!StockData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StockData` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
