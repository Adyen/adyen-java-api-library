...
public class OnboardingLinkInfo {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to OnboardingLinkInfo
   */
  public static OnboardingLinkInfo fromJson(String jsonString) throws JacksonException {
