...
public class AcceptTermsOfServiceRequest {
  ...
  **/
  ...
  public String toString() {
      String sb = "class AcceptTermsOfServiceRequest {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (AcceptTermsOfServiceRequest.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in AcceptTermsOfServiceRequest is not found in the empty JSON string", AcceptTermsOfServiceRequest.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AcceptTermsOfServiceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AcceptTermsOfServiceRequest` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
