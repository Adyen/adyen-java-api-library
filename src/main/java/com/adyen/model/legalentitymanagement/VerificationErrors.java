...
public class VerificationErrors {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to VerificationErrors
   */
  public static VerificationErrors fromJson(String jsonString) throws JacksonException {
