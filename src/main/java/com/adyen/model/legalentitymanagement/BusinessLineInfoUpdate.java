...
public class BusinessLineInfoUpdate {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(industryCode, isSetIndustryCode, salesChannels, isSetSalesChannels, sourceOfFunds, isSetSourceOfFunds, webData, isSetWebData, webDataExemption, isSetWebDataExemption);
  }
