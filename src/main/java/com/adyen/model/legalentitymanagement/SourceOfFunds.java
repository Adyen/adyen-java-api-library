...
public class SourceOfFunds {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class SourceOfFunds {\n" +
            "    acquiringBusinessLineId: " + toIndentedString(acquiringBusinessLineId) + "\n" +
            "    adyenProcessedFunds: " + toIndentedString(adyenProcessedFunds) + "\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (SourceOfFunds.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in SourceOfFunds is not found in the empty JSON string", SourceOfFunds.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SourceOfFunds.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SourceOfFunds` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
