...
public class SourceOfFunds {
   ...
   *
   * @param adyenProcessedFunds Indicates whether the funds are coming from transactions processed by Adyen. If **false**, the &#x60;type&#x60; is required.
  ...
  /**
   * Indicates whether the funds are coming from transactions processed by Adyen. If **false**, the &#x60;type&#x60; is required.
   * @return adyenProcessedFunds Indicates whether the funds are coming from transactions processed by Adyen. If **false**, the &#x60;type&#x60; is required.
   */
   ...
   *
   * @param assetMonthsHeld The number of months that the asset has been in possession of the user.  For example, if the source of funds is of type **cryptocurrencyIncome** then &#x60;assetMonthsHeld&#x60; is the number of months the user has owned the cryptocurrency.
   * @return the current {@code SourceOfFunds} instance, allowing for method chaining
   */
  ...
  /**
   * The number of months that the asset has been in possession of the user.  For example, if the source of funds is of type **cryptocurrencyIncome** then &#x60;assetMonthsHeld&#x60; is the number of months the user has owned the cryptocurrency.
   * @return assetMonthsHeld The number of months that the asset has been in possession of the user.  For example, if the source of funds is of type **cryptocurrencyIncome** then &#x60;assetMonthsHeld&#x60; is the number of months the user has owned the cryptocurrency.
   */
   ...
   *
   * @param cryptocurrencyExchange Required if &#x60;type&#x60; is **cryptocurrencyIncome**. The cryptocurrency exchange where the funds were acquired.
   * @return the current {@code SourceOfFunds} instance, allowing for method chaining
   */
  ...
  /**
   * Required if &#x60;type&#x60; is **cryptocurrencyIncome**. The cryptocurrency exchange where the funds were acquired.
   * @return cryptocurrencyExchange Required if &#x60;type&#x60; is **cryptocurrencyIncome**. The cryptocurrency exchange where the funds were acquired.
   */
   ...
   *
   * @param dateOfFundsReceived Required if &#x60;type&#x60; is **donations** or **inheritance**. The date the funds were received, in YYYY-MM-DD format.
   * @return the current {@code SourceOfFunds} instance, allowing for method chaining
   */
  ...
  /**
   * Required if &#x60;type&#x60; is **donations** or **inheritance**. The date the funds were received, in YYYY-MM-DD format.
   * @return dateOfFundsReceived Required if &#x60;type&#x60; is **donations** or **inheritance**. The date the funds were received, in YYYY-MM-DD format.
   */
   ...
   *
   * @param dateOfSourceEvent Required if &#x60;type&#x60; is **assetSale** or **gamblingWinnings**. The date the funds were received, in YYYY-MM-DD format.  For example, if the source of funds is of type **assetSale**, the dateOfSourceEvent is the date of the sale. If the source of funds is of type **gamblingWinnings**, the dateOfSourceEvent is the date of winnings.
   * @return the current {@code SourceOfFunds} instance, allowing for method chaining
   */
  ...
  /**
   * Required if &#x60;type&#x60; is **assetSale** or **gamblingWinnings**. The date the funds were received, in YYYY-MM-DD format.  For example, if the source of funds is of type **assetSale**, the dateOfSourceEvent is the date of the sale. If the source of funds is of type **gamblingWinnings**, the dateOfSourceEvent is the date of winnings.
   * @return dateOfSourceEvent Required if &#x60;type&#x60; is **assetSale** or **gamblingWinnings**. The date the funds were received, in YYYY-MM-DD format.  For example, if the source of funds is of type **assetSale**, the dateOfSourceEvent is the date of the sale. If the source of funds is of type **gamblingWinnings**, the dateOfSourceEvent is the date of winnings.
   */
   ...
   *
   * @param financiers Required if &#x60;type&#x60; is **thirdPartyFunding**. Information about the financiers.
   * @return the current {@code SourceOfFunds} instance, allowing for method chaining
   */
  ...
  /**
   * Required if &#x60;type&#x60; is **thirdPartyFunding**. Information about the financiers.
   * @return financiers Required if &#x60;type&#x60; is **thirdPartyFunding**. Information about the financiers.
   */
   ...
   *
   * @param originatorLegalEntityId Required if &#x60;type&#x60; is **donations** or **inheritance**. The legal entity ID representing the originator of the source of funds.  For example, if the source of funds is **inheritance**, then &#x60;originatorOfFundsReference&#x60; should be the legal entity reference of the benefactor.
   * @return the current {@code SourceOfFunds} instance, allowing for method chaining
   */
  ...
  /**
   * Required if &#x60;type&#x60; is **donations** or **inheritance**. The legal entity ID representing the originator of the source of funds.  For example, if the source of funds is **inheritance**, then &#x60;originatorOfFundsReference&#x60; should be the legal entity reference of the benefactor.
   * @return originatorLegalEntityId Required if &#x60;type&#x60; is **donations** or **inheritance**. The legal entity ID representing the originator of the source of funds.  For example, if the source of funds is **inheritance**, then &#x60;originatorOfFundsReference&#x60; should be the legal entity reference of the benefactor.
   */
   ...
   *
   * @param purpose Required if &#x60;type&#x60; is **donations**. The reason for receiving the funds.
   * @return the current {@code SourceOfFunds} instance, allowing for method chaining
   */
  ...
  /**
   * Required if &#x60;type&#x60; is **donations**. The reason for receiving the funds.
   * @return purpose Required if &#x60;type&#x60; is **donations**. The reason for receiving the funds.
   */
   ...
   *
   * @param relationship Required if &#x60;type&#x60; is **donations** or **inheritance**. The relationship of the originator of the funds to the recipient.
   * @return the current {@code SourceOfFunds} instance, allowing for method chaining
   */
  ...
  /**
   * Required if &#x60;type&#x60; is **donations** or **inheritance**. The relationship of the originator of the funds to the recipient.
   * @return relationship Required if &#x60;type&#x60; is **donations** or **inheritance**. The relationship of the originator of the funds to the recipient.
   */
   ...
   * The type of the source of funds.    Possible values: *  **business** *  **employment** *  **donations** *  **inheritance** *  **financialAid** *  **rentalIncome** *  **dividendIncome** *  **royaltyIncome** *  **thirdPartyFunding** *  **pensionIncome** *  **insuranceSettlement** *  **cryptocurrencyIncome** *  **assetSale** *  **loans** *  **gamblingWinnings**  
   *
   * @param type The type of the source of funds.    Possible values: *  **business** *  **employment** *  **donations** *  **inheritance** *  **financialAid** *  **rentalIncome** *  **dividendIncome** *  **royaltyIncome** *  **thirdPartyFunding** *  **pensionIncome** *  **insuranceSettlement** *  **cryptocurrencyIncome** *  **assetSale** *  **loans** *  **gamblingWinnings**  
   * @return the current {@code SourceOfFunds} instance, allowing for method chaining
   */
  ...
  /**
   * The type of the source of funds.    Possible values: *  **business** *  **employment** *  **donations** *  **inheritance** *  **financialAid** *  **rentalIncome** *  **dividendIncome** *  **royaltyIncome** *  **thirdPartyFunding** *  **pensionIncome** *  **insuranceSettlement** *  **cryptocurrencyIncome** *  **assetSale** *  **loans** *  **gamblingWinnings**  
   * @return type The type of the source of funds.    Possible values: *  **business** *  **employment** *  **donations** *  **inheritance** *  **financialAid** *  **rentalIncome** *  **dividendIncome** *  **royaltyIncome** *  **thirdPartyFunding** *  **pensionIncome** *  **insuranceSettlement** *  **cryptocurrencyIncome** *  **assetSale** *  **loans** *  **gamblingWinnings**  
   */
   ...
   *
   * @param website Required if &#x60;type&#x60; is **gamblingWinnings**. The location of the gambling site for the winnings.  For example, if the source of funds is online gambling, provide the website of the gambling company.
   * @return the current {@code SourceOfFunds} instance, allowing for method chaining
   */
  ...
  /**
   * Required if &#x60;type&#x60; is **gamblingWinnings**. The location of the gambling site for the winnings.  For example, if the source of funds is online gambling, provide the website of the gambling company.
   * @return website Required if &#x60;type&#x60; is **gamblingWinnings**. The location of the gambling site for the winnings.  For example, if the source of funds is online gambling, provide the website of the gambling company.
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.adyenProcessedFunds, sourceOfFunds.adyenProcessedFunds) &&
        ...
        Objects.equals(this.isSetCryptocurrencyExchange, sourceOfFunds.isSetCryptocurrencyExchange) &&
        ...
        Objects.equals(this.isSetOriginatorLegalEntityId, sourceOfFunds.isSetOriginatorLegalEntityId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(adyenProcessedFunds, isSetAdyenProcessedFunds, amount, isSetAmount, assetMonthsHeld, isSetAssetMonthsHeld, cryptocurrencyExchange, isSetCryptocurrencyExchange, dateOfFundsReceived, isSetDateOfFundsReceived, dateOfSourceEvent, isSetDateOfSourceEvent, description, isSetDescription, financiers, isSetFinanciers, originatorLegalEntityId, isSetOriginatorLegalEntityId, purpose, isSetPurpose, relationship, isSetRelationship, type, isSetType, website, isSetWebsite);
  }
  ...
  public String toString() {
    ...
    sb.append("    cryptocurrencyExchange: ").append(toIndentedString(cryptocurrencyExchange)).append("\n");
    sb.append("    dateOfFundsReceived: ").append(toIndentedString(dateOfFundsReceived)).append("\n");
    ...
    sb.append("    originatorLegalEntityId: ").append(toIndentedString(originatorLegalEntityId)).append("\n");
