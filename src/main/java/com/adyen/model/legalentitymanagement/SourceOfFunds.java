...
public class SourceOfFunds {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(adyenProcessedFunds, amount, assetMonthsHeld, cryptocurrencyExchange, dateOfFundsReceived, dateOfSourceEvent, description, financiers, originatorLegalEntityId, purpose, relationship, type, website);
  }
