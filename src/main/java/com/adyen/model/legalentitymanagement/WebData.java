...
public class WebData {
  ...
  /** Mark when the attribute has been explicitly set. */
  private boolean isSetWebAddressId = false;
   ...
   */
  public WebData includeNullValues(boolean includeNullValues) {
  ...
  public Map<String, Object> getExplicitNulls() {
    ...
    if (isSetWebAddressId) {
      addIfNull(nulls, JSON_PROPERTY_WEB_ADDRESS_ID, this.webAddressId);
    }
   ...
   * @throws JacksonException if the JSON string is invalid with respect to WebData
   */
  public static WebData fromJson(String jsonString) throws JacksonException {
