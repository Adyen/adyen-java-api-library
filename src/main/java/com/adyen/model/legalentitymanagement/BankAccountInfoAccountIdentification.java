...
@JsonDeserialize(
    using =
        BankAccountInfoAccountIdentification.BankAccountInfoAccountIdentificationDeserializer.class)
@JsonSerialize(
    using =
        BankAccountInfoAccountIdentification.BankAccountInfoAccountIdentificationSerializer.class)
public class BankAccountInfoAccountIdentification extends AbstractOpenApiSchema {
  private static final Logger log =
      Logger.getLogger(BankAccountInfoAccountIdentification.class.getName());

  public static class BankAccountInfoAccountIdentificationSerializer
      extends StdSerializer<BankAccountInfoAccountIdentification> {
    public BankAccountInfoAccountIdentificationSerializer(
        Class<BankAccountInfoAccountIdentification> t) {
      super(t);
    }
    ...
    public void serialize(
        BankAccountInfoAccountIdentification value, JsonGenerator jgen, SerializerProvider provider)
        throws IOException, JsonProcessingException {
      jgen.writeObject(value.getActualInstance());
    }
  }

  public static class BankAccountInfoAccountIdentificationDeserializer
      extends StdDeserializer<BankAccountInfoAccountIdentification> {
    ...
    @Override
    public BankAccountInfoAccountIdentification deserialize(
      ...
      throw new IOException(
          String.format(
              "Failed deserialization for BankAccountInfoAccountIdentification: %d classes match result, expected 1",
              match));
    }

    /** Handle deserialization of the 'null' value. */
    @Override
    public BankAccountInfoAccountIdentification getNullValue(DeserializationContext ctxt)
        throws JsonMappingException {
      throw new JsonMappingException(
          ctxt.getParser(), "BankAccountInfoAccountIdentification cannot be null");
    }
  }
  ...
  static {
    ...
    JSON.registerDescendants(
        BankAccountInfoAccountIdentification.class, Collections.unmodifiableMap(schemas));
  }
   ...
   * against the oneOf child schemas: AULocalAccountIdentification, CALocalAccountIdentification,
   * CZLocalAccountIdentification, DKLocalAccountIdentification, HKLocalAccountIdentification,
   * HULocalAccountIdentification, IbanAccountIdentification, NOLocalAccountIdentification,
   * NZLocalAccountIdentification, NumberAndBicAccountIdentification, PLLocalAccountIdentification,
   ...
   *
   * @return The actual instance (AULocalAccountIdentification, CALocalAccountIdentification,
   *     CZLocalAccountIdentification, DKLocalAccountIdentification, HKLocalAccountIdentification,
   *     HULocalAccountIdentification, IbanAccountIdentification, NOLocalAccountIdentification,
