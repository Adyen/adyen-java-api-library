...
public class SupportingEntityCapability {
  ...
  /**
   * Indicates whether the capability is allowed for the supporting entity. If a capability is
   * allowed for a supporting entity but not for the parent legal entity, this means the legal
   * entity has other supporting entities that failed verification. **You can use the allowed
   * supporting entity** regardless of the verification status of other supporting entities.
   *
   * @return allowed Indicates whether the capability is allowed for the supporting entity. If a
   *     capability is allowed for a supporting entity but not for the parent legal entity, this
   *     means the legal entity has other supporting entities that failed verification. **You can
   *     use the allowed supporting entity** regardless of the verification status of other
   *     supporting entities.
   */
  ...
  /**
   * The status of the verification checks for the capability of the supporting entity. Possible
   ...
   *
   * @return verificationStatus The status of the verification checks for the capability of the
   *     supporting entity. Possible values: * **pending**: Adyen is running the verification. *
