...
public class PciSigningRequest {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PciSigningRequest
   */
  public static PciSigningRequest fromJson(String jsonString) throws JacksonException {
