...
public class PciDocumentInfo {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PciDocumentInfo
   */
  public static PciDocumentInfo fromJson(String jsonString) throws JacksonException {
