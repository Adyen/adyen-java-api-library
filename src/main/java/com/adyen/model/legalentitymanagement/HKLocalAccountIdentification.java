...
public class HKLocalAccountIdentification {
   ...
   *
   * @param accountNumber The 9- to 17-digit bank account number, without separators or whitespace. Starts with the 3-digit branch code.
  ...
  /**
   * The 9- to 17-digit bank account number, without separators or whitespace. Starts with the 3-digit branch code.
   * @return accountNumber The 9- to 17-digit bank account number, without separators or whitespace. Starts with the 3-digit branch code.
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountNumber, isSetAccountNumber, clearingCode, isSetClearingCode, type, isSetType);
  }
