...
public class LegalEntityInfoRequiredType {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class LegalEntityInfoRequiredType {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (LegalEntityInfoRequiredType.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in LegalEntityInfoRequiredType is not found in the empty JSON string", LegalEntityInfoRequiredType.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!LegalEntityInfoRequiredType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LegalEntityInfoRequiredType` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
