...
public class Individual {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to Individual
   */
  public static Individual fromJson(String jsonString) throws JacksonException {
