...
public class Individual {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(birthData, isSetBirthData, email, isSetEmail, identificationData, isSetIdentificationData, name, isSetName, nationality, isSetNationality, phone, isSetPhone, residentialAddress, isSetResidentialAddress, support, isSetSupport, taxInformation, isSetTaxInformation, webData, isSetWebData);
  }
