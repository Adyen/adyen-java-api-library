...
public class OnboardingThemes {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to OnboardingThemes
   */
  public static OnboardingThemes fromJson(String jsonString) throws JacksonException {
