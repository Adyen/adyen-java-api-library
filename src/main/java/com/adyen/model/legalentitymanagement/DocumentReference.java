...
public class DocumentReference {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, isSetActive, description, isSetDescription, fileName, isSetFileName, id, isSetId, modificationDate, isSetModificationDate, pages, isSetPages, type, isSetType);
  }
