...
public class Financier {
   ...
   *
   * @param location The city and country/region where the financier is currently located. For example: Chicago, USA
   * @return the current {@code Financier} instance, allowing for method chaining
   */
  ...
  /**
   * The city and country/region where the financier is currently located. For example: Chicago, USA
   * @return location The city and country/region where the financier is currently located. For example: Chicago, USA
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amount, isSetAmount, firstName, isSetFirstName, lastName, isSetLastName, location, isSetLocation);
  }
