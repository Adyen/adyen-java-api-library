...
public class Financier {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to Financier
   */
  public static Financier fromJson(String jsonString) throws JacksonException {
