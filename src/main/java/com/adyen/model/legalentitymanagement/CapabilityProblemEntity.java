...
public class CapabilityProblemEntity {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class CapabilityProblemEntity {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CapabilityProblemEntity.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in CapabilityProblemEntity is not found in the empty JSON string", CapabilityProblemEntity.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CapabilityProblemEntity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CapabilityProblemEntity` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
