...
public class GetTermsOfServiceDocumentRequest {
   ...
   * @return language
  **/
  @ApiModelProperty(required = true, value = "The language to be used for the Terms of Service document, specified by the two letter [ISO 639-1](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) language code. For example, **nl** for Dutch.")
   ...
   * @return type
  **/
  @ApiModelProperty(required = true, value = "The type of Terms of Service.")
