...
public class GetTermsOfServiceDocumentRequest {
   ...
   *
   * @param language The language to be used for the Terms of Service document, specified by the two-letter [ISO 639-1](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) language code. Possible values: **en** for English or **fr** for French.
  ...
  /**
   * The language to be used for the Terms of Service document, specified by the two-letter [ISO 639-1](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) language code. Possible values: **en** for English or **fr** for French.
   * @return language The language to be used for the Terms of Service document, specified by the two-letter [ISO 639-1](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) language code. Possible values: **en** for English or **fr** for French.
   */
   ...
   *
   * @param termsOfServiceDocumentFormat The requested format for the Terms of Service document. Default value: JSON. Possible values: **JSON**, **PDF**, or **TXT**.
   * @return the current {@code GetTermsOfServiceDocumentRequest} instance, allowing for method chaining
   */
  ...
  /**
   * The requested format for the Terms of Service document. Default value: JSON. Possible values: **JSON**, **PDF**, or **TXT**.
   * @return termsOfServiceDocumentFormat The requested format for the Terms of Service document. Default value: JSON. Possible values: **JSON**, **PDF**, or **TXT**.
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.language, getTermsOfServiceDocumentRequest.language) &&
        ...
        Objects.equals(this.isSetTermsOfServiceDocumentFormat, getTermsOfServiceDocumentRequest.isSetTermsOfServiceDocumentFormat) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(language, isSetLanguage, termsOfServiceDocumentFormat, isSetTermsOfServiceDocumentFormat, type, isSetType);
  }
