...
public class TaxInformation {
  ...
  **/
  ...
  public String toString() {
      String sb = "class TaxInformation {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (TaxInformation.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in TaxInformation is not found in the empty JSON string", TaxInformation.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TaxInformation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TaxInformation` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
