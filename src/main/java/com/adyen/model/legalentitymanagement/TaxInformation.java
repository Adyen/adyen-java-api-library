...
public class TaxInformation {
   ...
   *
   * @param numberAbsent Set this to **true** if the legal entity or legal arrangement does not have a tax ID number (TIN). Only applicable in Australia.
   * @return the current {@code TaxInformation} instance, allowing for method chaining
   */
  ...
  /**
   * Set this to **true** if the legal entity or legal arrangement does not have a tax ID number (TIN). Only applicable in Australia.
   * @return numberAbsent Set this to **true** if the legal entity or legal arrangement does not have a tax ID number (TIN). Only applicable in Australia.
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(country, isSetCountry, number, isSetNumber, numberAbsent, isSetNumberAbsent, type, isSetType);
  }
