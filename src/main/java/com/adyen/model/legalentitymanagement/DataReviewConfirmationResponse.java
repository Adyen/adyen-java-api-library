...
@JsonPropertyOrder({DataReviewConfirmationResponse.JSON_PROPERTY_DATA_REVIEWED_AT})
public class DataReviewConfirmationResponse {
   ...
   * @return the current {@code DataReviewConfirmationResponse} instance, allowing for method
   *     chaining
   */
   ...
   *     DataReviewConfirmationResponse
   */
  public static DataReviewConfirmationResponse fromJson(String jsonString) throws JacksonException {
