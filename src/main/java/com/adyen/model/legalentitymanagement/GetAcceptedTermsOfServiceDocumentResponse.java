...
public class GetAcceptedTermsOfServiceDocumentResponse {
  ...
  public enum TermsOfServiceDocumentFormatEnum {
    ...
    private static final Logger LOG = Logger.getLogger(TermsOfServiceDocumentFormatEnum.class.getName());
    ...
    public static TermsOfServiceDocumentFormatEnum fromValue(String value) {
      ...
      LOG.warning("TermsOfServiceDocumentFormatEnum: unexpected enum value '" + value + "' - Supported values are "+ Arrays.toString(TermsOfServiceDocumentFormatEnum.values()));
      return null;
    }
  }
  ...
  public boolean equals(Object o) {
    ...
    return Arrays.equals(this.document, getAcceptedTermsOfServiceDocumentResponse.document) &&
        Objects.equals(this.isSetDocument, getAcceptedTermsOfServiceDocumentResponse.isSetDocument) &&
        ...
        Objects.equals(this.isSetTermsOfServiceAcceptanceReference, getAcceptedTermsOfServiceDocumentResponse.isSetTermsOfServiceAcceptanceReference) &&
        Objects.equals(this.termsOfServiceDocumentFormat, getAcceptedTermsOfServiceDocumentResponse.termsOfServiceDocumentFormat) &&
        Objects.equals(this.isSetTermsOfServiceDocumentFormat, getAcceptedTermsOfServiceDocumentResponse.isSetTermsOfServiceDocumentFormat)
    ;
  }

  @Override
  public int hashCode() {
    return Objects.hash(Arrays.hashCode(document), isSetDocument, id, isSetId, termsOfServiceAcceptanceReference, isSetTermsOfServiceAcceptanceReference, termsOfServiceDocumentFormat, isSetTermsOfServiceDocumentFormat);
  }
  ...
  public Map<String, Object> getExplicitNulls() {
    ...
    if (isSetTermsOfServiceAcceptanceReference) {
      addIfNull(nulls, JSON_PROPERTY_TERMS_OF_SERVICE_ACCEPTANCE_REFERENCE, this.termsOfServiceAcceptanceReference);
    }
