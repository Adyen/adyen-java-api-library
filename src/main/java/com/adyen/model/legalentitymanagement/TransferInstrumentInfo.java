...
public class TransferInstrumentInfo {
  ...
  **/
  ...
  @Override
  public String toString() {
      String sb = "class TransferInstrumentInfo {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (TransferInstrumentInfo.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransferInstrumentInfo is not found in the empty JSON string", TransferInstrumentInfo.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TransferInstrumentInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransferInstrumentInfo` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
