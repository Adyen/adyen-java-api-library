...
public class BusinessLineInfo {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(industryCode, isSetIndustryCode, legalEntityId, isSetLegalEntityId, salesChannels, isSetSalesChannels, service, isSetService, sourceOfFunds, isSetSourceOfFunds, webData, isSetWebData, webDataExemption, isSetWebDataExemption);
  }
