...
public class BusinessLineInfo {
   ...
   *
   * @param industryCode A code that represents the industry of the legal entity for
   *     [marketplaces](https://docs.adyen.com/marketplaces/verification-requirements/reference-additional-products/#list-industry-codes)
   *     or
   *     [platforms](https://docs.adyen.com/platforms/verification-requirements/reference-additional-products/#list-industry-codes).
   *     For example, **4431A** for computer software stores.
   ...
   * For example, **4431A** for computer software stores.
   *
   * @return industryCode A code that represents the industry of the legal entity for
   *     [marketplaces](https://docs.adyen.com/marketplaces/verification-requirements/reference-additional-products/#list-industry-codes)
   *     or
   *     [platforms](https://docs.adyen.com/platforms/verification-requirements/reference-additional-products/#list-industry-codes).
   *     For example, **4431A** for computer software stores.
   ...
   *
   * @param legalEntityId Unique identifier of the [legal
   *     entity](https://docs.adyen.com/api-explorer/#/legalentity/latest/post/legalEntities__resParam_id)
   *     that owns the business line.
   * @return the current {@code BusinessLineInfo} instance, allowing for method chaining
   */
   ...
   * that owns the business line.
   *
   * @return legalEntityId Unique identifier of the [legal
   *     entity](https://docs.adyen.com/api-explorer/#/legalentity/latest/post/legalEntities__resParam_id)
   *     that owns the business line.
   */
   ...
   * @throws JacksonException if the JSON string is invalid with respect to BusinessLineInfo
   */
  public static BusinessLineInfo fromJson(String jsonString) throws JacksonException {
