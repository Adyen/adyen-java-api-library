...
public class LegalEntity {
  ...
  public LegalEntity(
    ...
    @JsonProperty(JSON_PROPERTY_TRANSFER_INSTRUMENTS) List<TransferInstrumentReference> transferInstruments, 
  ...
  @Override
  public int hashCode() {
    return Objects.hash(capabilities, isSetCapabilities, documentDetails, isSetDocumentDetails, documents, isSetDocuments, entityAssociations, isSetEntityAssociations, id, isSetId, individual, isSetIndividual, organization, isSetOrganization, problems, isSetProblems, reference, isSetReference, soleProprietorship, isSetSoleProprietorship, transferInstruments, isSetTransferInstruments, trust, isSetTrust, type, isSetType, unincorporatedPartnership, isSetUnincorporatedPartnership, verificationDeadlines, isSetVerificationDeadlines, verificationPlan, isSetVerificationPlan);
  }
