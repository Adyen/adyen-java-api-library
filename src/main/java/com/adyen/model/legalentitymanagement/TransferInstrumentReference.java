...
public class TransferInstrumentReference {
  ...
  **/
  ...
  public String toString() {
      String sb = "class TransferInstrumentReference {\n" +
              "    accountIdentifier: " + toIndentedString(accountIdentifier) + "\n" +
              "    id: " + toIndentedString(id) + "\n" +
              "    realLastFour: " + toIndentedString(realLastFour) + "\n" +
              "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (TransferInstrumentReference.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransferInstrumentReference is not found in the empty JSON string", TransferInstrumentReference.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TransferInstrumentReference.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransferInstrumentReference` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
