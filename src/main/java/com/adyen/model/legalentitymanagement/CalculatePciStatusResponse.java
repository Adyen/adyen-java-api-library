...
public class CalculatePciStatusResponse {
  ...
  /**
   * Indicates if the user is required to sign PCI questionnaires. If **false**, they do not need to
   * sign any questionnaires.
   *
   * @param signingRequired Indicates if the user is required to sign PCI questionnaires. If
   *     **false**, they do not need to sign any questionnaires.
   ...
   * sign any questionnaires.
   *
   * @return signingRequired Indicates if the user is required to sign PCI questionnaires. If
   *     **false**, they do not need to sign any questionnaires.
   */
