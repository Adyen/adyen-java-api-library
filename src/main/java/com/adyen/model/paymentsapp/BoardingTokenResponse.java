...
public class BoardingTokenResponse {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to BoardingTokenResponse
   */
  public static BoardingTokenResponse fromJson(String jsonString) throws JacksonException {
