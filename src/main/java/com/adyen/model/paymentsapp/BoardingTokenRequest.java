...
public class BoardingTokenRequest {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to BoardingTokenRequest
   */
  public static BoardingTokenRequest fromJson(String jsonString) throws JacksonException {
