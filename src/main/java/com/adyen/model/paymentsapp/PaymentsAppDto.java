...
public class PaymentsAppDto {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PaymentsAppDto
   */
  public static PaymentsAppDto fromJson(String jsonString) throws JacksonException {
