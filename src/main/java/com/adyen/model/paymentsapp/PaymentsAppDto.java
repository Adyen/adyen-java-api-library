...
public class PaymentsAppDto {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(installationId, isSetInstallationId, merchantAccountCode, isSetMerchantAccountCode, merchantStoreCode, isSetMerchantStoreCode, status, isSetStatus);
  }
