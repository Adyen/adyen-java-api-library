...
public class DefenseReasonsResponse {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to DefenseReasonsResponse
   */
  public static DefenseReasonsResponse fromJson(String jsonString) throws JacksonException {
