...
public class AcceptDisputeRequest {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to AcceptDisputeRequest
   */
  public static AcceptDisputeRequest fromJson(String jsonString) throws JacksonException {
