...
public class DisputeServiceResult {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to DisputeServiceResult
   */
  public static DisputeServiceResult fromJson(String jsonString) throws JacksonException {
