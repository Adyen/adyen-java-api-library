...
import com.adyen.model.balancewebhooks.ReleaseBlockedBalanceNotificationData;
...
public class ReleasedBlockedBalanceNotificationRequest {
  ...
  public enum TypeEnum {
    ...
    BALANCEPLATFORM_BALANCEACCOUNT_BALANCE_BLOCK_RELEASED(String.valueOf("balancePlatform.balanceAccount.balance.block.released"));
   ...
   *
   * @param data 
   * @return the current {@code ReleasedBlockedBalanceNotificationRequest} instance, allowing for method chaining
   */
  public ReleasedBlockedBalanceNotificationRequest data(ReleaseBlockedBalanceNotificationData data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ReleasedBlockedBalanceNotificationRequest releasedBlockedBalanceNotificationRequest = (ReleasedBlockedBalanceNotificationRequest) o;
...
/**
   ...
   * @throws JsonProcessingException if the JSON string is invalid with respect to ReleasedBlockedBalanceNotificationRequest
   */
  public static ReleasedBlockedBalanceNotificationRequest fromJson(String jsonString) throws JsonProcessingException {
