...
public class Balances {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to Balances
   */
  public static Balances fromJson(String jsonString) throws JacksonException {
