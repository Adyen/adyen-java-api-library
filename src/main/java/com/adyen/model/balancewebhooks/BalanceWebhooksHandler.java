...
public class BalanceWebhooksHandler {
    ...
    public Optional<BalanceAccountBalanceNotificationRequest> getBalanceAccountBalanceNotificationRequest() {
        ...
        var optionalBalanceAccountBalanceNotificationRequest =  getOptionalField(BalanceAccountBalanceNotificationRequest.class);
     ...
     * @return an Optional containing the deserialized object, or empty if deserialization fails
     */
    public Optional<ReleasedBlockedBalanceNotificationRequest> getReleasedBlockedBalanceNotificationRequest() {

        var optionalReleasedBlockedBalanceNotificationRequest =  getOptionalField(ReleasedBlockedBalanceNotificationRequest.class);
