...
public class PartyIdentification {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(address, isSetAddress, dateOfBirth, isSetDateOfBirth, email, isSetEmail, firstName, isSetFirstName, fullName, isSetFullName, lastName, isSetLastName, reference, isSetReference, type, isSetType, url, isSetUrl);
  }
