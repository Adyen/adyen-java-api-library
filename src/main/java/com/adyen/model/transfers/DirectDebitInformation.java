...
public class DirectDebitInformation {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to DirectDebitInformation
   */
  public static DirectDebitInformation fromJson(String jsonString) throws JacksonException {
