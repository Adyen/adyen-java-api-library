...
public class TransactionRuleReference {
   ...
   *
   * @param score The transaction score determined by the rule. Returned only when &#x60;outcomeType&#x60; is **scoreBased**.
   * @return the current {@code TransactionRuleReference} instance, allowing for method chaining
   */
  ...
  /**
   * The transaction score determined by the rule. Returned only when &#x60;outcomeType&#x60; is **scoreBased**.
   * @return score The transaction score determined by the rule. Returned only when &#x60;outcomeType&#x60; is **scoreBased**.
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, isSetDescription, id, isSetId, outcomeType, isSetOutcomeType, reference, isSetReference, score, isSetScore);
  }
