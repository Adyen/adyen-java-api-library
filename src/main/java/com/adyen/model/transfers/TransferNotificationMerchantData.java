...
public class TransferNotificationMerchantData {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(acquirerId, isSetAcquirerId, city, isSetCity, country, isSetCountry, mcc, isSetMcc, merchantId, isSetMerchantId, name, isSetName, postalCode, isSetPostalCode);
  }
