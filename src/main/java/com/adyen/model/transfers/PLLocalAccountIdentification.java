...
public class PLLocalAccountIdentification {
  ...
  **/
  ...
  @Override
  public String toString() {
      String sb = "class PLLocalAccountIdentification {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (PLLocalAccountIdentification.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in PLLocalAccountIdentification is not found in the empty JSON string", PLLocalAccountIdentification.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PLLocalAccountIdentification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PLLocalAccountIdentification` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
