...
public class RoutingDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to RoutingDetails
   */
  public static RoutingDetails fromJson(String jsonString) throws JacksonException {
