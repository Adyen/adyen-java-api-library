...
public class CapitalGrantInfo {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to CapitalGrantInfo
   */
  public static CapitalGrantInfo fromJson(String jsonString) throws JacksonException {
