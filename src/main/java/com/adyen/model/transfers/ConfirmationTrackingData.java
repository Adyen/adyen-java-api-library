...
public class ConfirmationTrackingData {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to ConfirmationTrackingData
   */
  public static ConfirmationTrackingData fromJson(String jsonString) throws JacksonException {
