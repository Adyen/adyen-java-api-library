...
public class ConfirmationTrackingData {
   ...
   * The status of the transfer.  Possible values:   - **credited**: the funds are credited to your user&#39;s transfer instrument or bank account.- **accepted**: the request is accepted by the integration.
   *
   * @param status The status of the transfer.  Possible values:   - **credited**: the funds are credited to your user&#39;s transfer instrument or bank account.- **accepted**: the request is accepted by the integration.
  ...
  /**
   * The status of the transfer.  Possible values:   - **credited**: the funds are credited to your user&#39;s transfer instrument or bank account.- **accepted**: the request is accepted by the integration.
   * @return status The status of the transfer.  Possible values:   - **credited**: the funds are credited to your user&#39;s transfer instrument or bank account.- **accepted**: the request is accepted by the integration.
   */
