...
public class IssuedCard {
  ...
  /** Mark when the attribute has been explicitly set. */
  private boolean isSetNetworkVariant = false;

  /**
   * Indicates the method used for entering the PAN to initiate a transaction. Possible values:
   * **manual**, **chip**, **magstripe**, **contactless**, **cof**, **ecommerce**, **token**.
   */
   ...
   * **finalAuthorisation**
   *
   * @param authorisationType The authorisation type. For example, **defaultAuthorisation**,
   ...
   * **finalAuthorisation**
   *
   * @return authorisationType The authorisation type. For example, **defaultAuthorisation**,
   *     **preAuthorisation**, **finalAuthorisation**
   */
  ...
  public IssuedCard networkVariant(NetworkVariantEnum networkVariant) {
    ...
    isSetNetworkVariant = true; // mark as set
    return this;
  }
   ...
   * **manual**, **chip**, **magstripe**, **contactless**, **cof**, **ecommerce**, **token**.
   *
   * @param panEntryMode Indicates the method used for entering the PAN to initiate a transaction.
   ...
   * **manual**, **chip**, **magstripe**, **contactless**, **cof**, **ecommerce**, **token**.
   *
   * @return panEntryMode Indicates the method used for entering the PAN to initiate a transaction.
   *     Possible values: **manual**, **chip**, **magstripe**, **contactless**, **cof**,
   *     **ecommerce**, **token**.
   */
   ...
   * alphanumeric or numeric, depending on the scheme. The &#x60;schemeTraceID&#x60; should refer to
   * an original &#x60;schemeUniqueTransactionID&#x60; provided in an earlier payment (not
   * necessarily processed by Adyen). A &#x60;schemeTraceId&#x60; is typically available for
   * authorization adjustments or recurring payments.
   *
   * @param schemeTraceId The identifier of the original payment. This ID is provided by the scheme
   *     and can be alphanumeric or numeric, depending on the scheme. The &#x60;schemeTraceID&#x60;
   *     should refer to an original &#x60;schemeUniqueTransactionID&#x60; provided in an earlier
   *     payment (not necessarily processed by Adyen). A &#x60;schemeTraceId&#x60; is typically
   *     available for authorization adjustments or recurring payments.
   * @return the current {@code IssuedCard} instance, allowing for method chaining
   */
   ...
   * checks](https://docs.adyen.com/issuing/validation-checks) for more information.
   *
   * @param validationFacts The evaluation of the validation facts. See [validation
   *     checks](https://docs.adyen.com/issuing/validation-checks) for more information.
   * @return the current {@code IssuedCard} instance, allowing for method chaining
   */
   ...
   * checks](https://docs.adyen.com/issuing/validation-checks) for more information.
   *
   * @return validationFacts The evaluation of the validation facts. See [validation
   *     checks](https://docs.adyen.com/issuing/validation-checks) for more information.
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authorisationType, issuedCard.authorisationType)
        ...
        && Objects.equals(this.isSetNetworkVariant, issuedCard.isSetNetworkVariant)
  ...
  public String toString() {
    ...
    sb.append("    relayedAuthorisationData: ")
        .append(toIndentedString(relayedAuthorisationData))
        .append("\n");
  ...
  public Map<String, Object> getExplicitNulls() {
    ...
    if (isSetNetworkVariant) {
      addIfNull(nulls, JSON_PROPERTY_NETWORK_VARIANT, this.networkVariant);
    }
