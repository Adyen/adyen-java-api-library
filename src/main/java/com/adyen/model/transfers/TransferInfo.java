...
public class TransferInfo {
   ...
   * instrument or a bank account. The &#x60;category&#x60; must be **bank**. -
   * **internalTransfer**: for push transfers between balance accounts. The &#x60;category&#x60;
   * must be **internal**. - **internalDirectDebit**: for pull transfers (direct debits) between
   ...
   * If you want to make a transfer using a **virtual** **bankAccount** assigned to the balance
   * account, you must specify the [payment instrument
   * ID](https://docs.adyen.com/api-explorer/balanceplatform/latest/post/paymentInstruments#responses-200-id)
   * of the **virtual** **bankAccount**. If you only specify a balance account ID, Adyen uses the
   * default **physical** **bankAccount** payment instrument assigned to the balance account.
   *
   ...
   *     account, you must specify the [payment instrument
   *     ID](https://docs.adyen.com/api-explorer/balanceplatform/latest/post/paymentInstruments#responses-200-id)
   *     of the **virtual** **bankAccount**. If you only specify a balance account ID, Adyen uses
   *     the default **physical** **bankAccount** payment instrument assigned to the balance
   *     account.
   * @return the current {@code TransferInfo} instance, allowing for method chaining
   */
  ...
  /**
   * The unique identifier of the source [payment
   * instrument](https://docs.adyen.com/api-explorer/balanceplatform/latest/post/paymentInstruments#responses-200-id).
   * If you want to make a transfer using a **virtual** **bankAccount**, you must specify the
   * payment instrument ID of the **virtual** **bankAccount**. If you only specify a balance account
   * ID, Adyen uses the default **physical** **bankAccount** payment instrument assigned to the
   * balance account.
   *
   * @param paymentInstrumentId The unique identifier of the source [payment
   *     instrument](https://docs.adyen.com/api-explorer/balanceplatform/latest/post/paymentInstruments#responses-200-id).
   *     If you want to make a transfer using a **virtual** **bankAccount**, you must specify the
   *     payment instrument ID of the **virtual** **bankAccount**. If you only specify a balance
   *     account ID, Adyen uses the default **physical** **bankAccount** payment instrument assigned
   ...
   * balance account.
   *
   * @return paymentInstrumentId The unique identifier of the source [payment
   *     instrument](https://docs.adyen.com/api-explorer/balanceplatform/latest/post/paymentInstruments#responses-200-id).
   *     If you want to make a transfer using a **virtual** **bankAccount**, you must specify the
   *     payment instrument ID of the **virtual** **bankAccount**. If you only specify a balance
   *     account ID, Adyen uses the default **physical** **bankAccount** payment instrument assigned
   ...
   * movement. Supported characters: **a-z**, **A-Z**, **0-9**. The maximum length depends on the
   ...
   *     **0-9**. The maximum length depends on the &#x60;category&#x60;. - **internal**: 80
   *     characters - **bank**: 35 characters when transferring to an IBAN, 15 characters for
   *     others.
   * @return the current {@code TransferInfo} instance, allowing for method chaining
   */
   ...
   * balance accounts. The &#x60;category&#x60; must be **internal**.
   *
   * @param type The type of transfer. Possible values: - **bankTransfer**: for push transfers to a
   *     transfer instrument or a bank account. The &#x60;category&#x60; must be **bank**. -
   *     **internalTransfer**: for push transfers between balance accounts. The &#x60;category&#x60;
   *     must be **internal**. - **internalDirectDebit**: for pull transfers (direct debits) between
   *     balance accounts. The &#x60;category&#x60; must be **internal**.
   * @return the current {@code TransferInfo} instance, allowing for method chaining
   ...
   * balance accounts. The &#x60;category&#x60; must be **internal**.
   *
   * @return type The type of transfer. Possible values: - **bankTransfer**: for push transfers to a
   *     transfer instrument or a bank account. The &#x60;category&#x60; must be **bank**. -
   *     **internalTransfer**: for push transfers between balance accounts. The &#x60;category&#x60;
   *     must be **internal**. - **internalDirectDebit**: for pull transfers (direct debits) between
   *     balance accounts. The &#x60;category&#x60; must be **internal**.
   ...
   * @throws JacksonException if the JSON string is invalid with respect to TransferInfo
   */
  public static TransferInfo fromJson(String jsonString) throws JacksonException {
