...
public class NameLocation {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to NameLocation
   */
  public static NameLocation fromJson(String jsonString) throws JacksonException {
