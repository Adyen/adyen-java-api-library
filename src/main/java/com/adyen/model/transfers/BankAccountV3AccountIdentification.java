...
@JsonDeserialize(
    using = BankAccountV3AccountIdentification.BankAccountV3AccountIdentificationDeserializer.class)
@JsonSerialize(
    using = BankAccountV3AccountIdentification.BankAccountV3AccountIdentificationSerializer.class)
public class BankAccountV3AccountIdentification extends AbstractOpenApiSchema {
  private static final Logger log =
      Logger.getLogger(BankAccountV3AccountIdentification.class.getName());

  public static class BankAccountV3AccountIdentificationSerializer
      extends StdSerializer<BankAccountV3AccountIdentification> {
    public BankAccountV3AccountIdentificationSerializer(
        Class<BankAccountV3AccountIdentification> t) {
      super(t);
    }
    ...
    public void serialize(
        BankAccountV3AccountIdentification value, JsonGenerator jgen, SerializationContext context)
        throws JacksonException {
      context.writeValue(jgen, value.getActualInstance());
    }
  }

  public static class BankAccountV3AccountIdentificationDeserializer
      extends StdDeserializer<BankAccountV3AccountIdentification> {
    ...
    @Override
    public BankAccountV3AccountIdentification deserialize(
      ...
      throw DatabindException.from(
          ctxt,
          String.format(
              "Failed deserialization for BankAccountV3AccountIdentification: %d classes match result, expected 1",
              match));
    }

    /** Handle deserialization of the 'null' value. */
    @Override
    public BankAccountV3AccountIdentification getNullValue(DeserializationContext ctxt)
        throws DatabindException {
      throw DatabindException.from(ctxt, "BankAccountV3AccountIdentification cannot be null");
    }
  }
