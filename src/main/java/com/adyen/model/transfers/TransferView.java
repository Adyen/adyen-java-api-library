...
public class TransferView {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to TransferView
   */
  public static TransferView fromJson(String jsonString) throws JacksonException {
