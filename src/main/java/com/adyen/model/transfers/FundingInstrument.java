...
public class FundingInstrument {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to FundingInstrument
   */
  public static FundingInstrument fromJson(String jsonString) throws JacksonException {
