...
public class CapitalGrant {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to CapitalGrant
   */
  public static CapitalGrant fromJson(String jsonString) throws JacksonException {
