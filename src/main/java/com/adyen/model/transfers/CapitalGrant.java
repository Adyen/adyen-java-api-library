...
public class CapitalGrant {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amount, isSetAmount, balances, isSetBalances, counterparty, isSetCounterparty, fee, isSetFee, grantAccountId, isSetGrantAccountId, grantOfferId, isSetGrantOfferId, id, isSetId, repayment, isSetRepayment, status, isSetStatus);
  }
