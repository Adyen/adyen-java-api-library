...
public class DKLocalAccountIdentification {
  ...
  **/
  ...
  @Override
  public String toString() {
      String sb = "class DKLocalAccountIdentification {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (DKLocalAccountIdentification.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in DKLocalAccountIdentification is not found in the empty JSON string", DKLocalAccountIdentification.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DKLocalAccountIdentification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DKLocalAccountIdentification` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
