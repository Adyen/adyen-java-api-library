...
public class TransactionSearchResponse {
  ...
  **/
  ...
  public String toString() {
      String sb = "class TransactionSearchResponse {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (TransactionSearchResponse.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransactionSearchResponse is not found in the empty JSON string", TransactionSearchResponse.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TransactionSearchResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransactionSearchResponse` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
