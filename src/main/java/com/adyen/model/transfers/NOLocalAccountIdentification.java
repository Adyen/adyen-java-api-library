...
public class NOLocalAccountIdentification {
  ...
  **/
  ...
  @Override
  public String toString() {
      String sb = "class NOLocalAccountIdentification {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (NOLocalAccountIdentification.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in NOLocalAccountIdentification is not found in the empty JSON string", NOLocalAccountIdentification.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!NOLocalAccountIdentification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NOLocalAccountIdentification` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
