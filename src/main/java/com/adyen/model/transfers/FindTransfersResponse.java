...
public class FindTransfersResponse {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to FindTransfersResponse
   */
  public static FindTransfersResponse fromJson(String jsonString) throws JacksonException {
