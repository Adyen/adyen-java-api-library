...
public class BankAccountV3 {
   ...
   *
   * @param storedPaymentMethodId The unique token that identifies the stored bank account details of the counterparty for a payout.
   * @return the current {@code BankAccountV3} instance, allowing for method chaining
   */
  ...
  /**
   * The unique token that identifies the stored bank account details of the counterparty for a payout.
   * @return storedPaymentMethodId The unique token that identifies the stored bank account details of the counterparty for a payout.
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountHolder, bankAccountV3.accountHolder) &&
        ...
        Objects.equals(this.isSetStoredPaymentMethodId, bankAccountV3.isSetStoredPaymentMethodId)
    ;
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountHolder, isSetAccountHolder, accountIdentification, isSetAccountIdentification, storedPaymentMethodId, isSetStoredPaymentMethodId);
  }
