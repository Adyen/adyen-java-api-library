...
public class IssuingTransactionData {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to IssuingTransactionData
   */
  public static IssuingTransactionData fromJson(String jsonString) throws JacksonException {
