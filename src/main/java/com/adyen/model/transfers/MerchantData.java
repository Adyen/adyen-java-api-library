...
public class MerchantData {
  ...
  **/
  ...
  public String toString() {
      String sb = "class MerchantData {\n" +
              "    mcc: " + toIndentedString(mcc) + "\n" +
              "    merchantId: " + toIndentedString(merchantId) + "\n" +
              "    nameLocation: " + toIndentedString(nameLocation) + "\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (MerchantData.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in MerchantData is not found in the empty JSON string", MerchantData.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!MerchantData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MerchantData` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
