...
public class MerchantData {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to MerchantData
   */
  public static MerchantData fromJson(String jsonString) throws JacksonException {
