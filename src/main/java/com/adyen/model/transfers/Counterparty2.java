 ...
 */
@JsonPropertyOrder({
  Counterparty2.JSON_PROPERTY_ACCOUNT_HOLDER_ID,
  Counterparty2.JSON_PROPERTY_BALANCE_ACCOUNT_ID,
  Counterparty2.JSON_PROPERTY_TRANSFER_INSTRUMENT_ID
})
@JsonTypeName("Counterparty-2")
...
/**
   ...
   * @throws JsonProcessingException if the JSON string is invalid with respect to Counterparty2
   */
  public static Counterparty2 fromJson(String jsonString) throws JsonProcessingException {
    return JSON.getMapper().readValue(jsonString, Counterparty2.class);
  }
/**
