...
public class NegativeBalanceWarningWebhooksHandler {
    ...
    public Optional<NegativeBalanceCompensationWarningNotificationRequest> getNegativeBalanceCompensationWarningNotificationRequest() {
        ...
        var optionalNegativeBalanceCompensationWarningNotificationRequest =  getOptionalField(NegativeBalanceCompensationWarningNotificationRequest.class);
        ...
        if(optionalNegativeBalanceCompensationWarningNotificationRequest.isPresent()) {
            ...
            for (var value : NegativeBalanceCompensationWarningNotificationRequest.TypeEnum.values()) {
                if (value.equals(optionalNegativeBalanceCompensationWarningNotificationRequest.get().getType())) {
