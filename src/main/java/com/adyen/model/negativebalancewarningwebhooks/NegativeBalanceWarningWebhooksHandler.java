 ...
 *
 * <p>This class provides functionality to deserialize the payload of NegativeBalanceWarningWebhooks
 * events.
 */
public class NegativeBalanceWarningWebhooksHandler {

  private static final Logger LOG =
      Logger.getLogger(NegativeBalanceWarningWebhooksHandler.class.getName());
