...
/** CloseStoresRequest */
@JsonPropertyOrder({
  CloseStoresRequest.JSON_PROPERTY_ACCOUNT_HOLDER_CODE,
  CloseStoresRequest.JSON_PROPERTY_STORES
})
public class CloseStoresRequest {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to CloseStoresRequest
   */
  public static CloseStoresRequest fromJson(String jsonString) throws JacksonException {
    return JSON.getMapper().readValue(jsonString, CloseStoresRequest.class);
  }
