...
public class DeleteSignatoriesRequest {
  ...
  @ApiModelProperty(
      required = true,
      value = "The code of the account holder from which to delete the signatories.")
   ...
   * @throws JacksonException if the JSON string is invalid with respect to DeleteSignatoriesRequest
   */
  public static DeleteSignatoriesRequest fromJson(String jsonString) throws JacksonException {
