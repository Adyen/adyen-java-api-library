...
public class UpdateAccountHolderRequest {
  ...
  public UpdateAccountHolderRequest accountHolderDetails(
  ...
  /**
   * A description of the account holder, maximum 256 characters. You can use alphanumeric
  ...
  /**
   * The primary three-character [ISO currency
   * code](https://docs.adyen.com/development-resources/currency-codes), to which the account holder
   * should be updated.
   *
  ...
  /**
   * The processing tier to which the Account Holder should be updated. &gt;The processing tier can
   * not be lowered through this request. &gt;Required if accountHolderDetails are not provided.
   *
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountHolderCode, updateAccountHolderRequest.accountHolderCode)
        && Objects.equals(
            this.accountHolderDetails, updateAccountHolderRequest.accountHolderDetails)
   ...
   *     UpdateAccountHolderRequest
   */
  public static UpdateAccountHolderRequest fromJson(String jsonString) throws JacksonException {
