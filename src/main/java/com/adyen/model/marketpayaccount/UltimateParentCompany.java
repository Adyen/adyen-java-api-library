...
public class UltimateParentCompany {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to UltimateParentCompany
   */
  public static UltimateParentCompany fromJson(String jsonString) throws JacksonException {
