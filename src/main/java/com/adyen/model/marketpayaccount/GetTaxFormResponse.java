...
public class GetTaxFormResponse {
  ...
  public int hashCode() {
    return Objects.hash(
        Arrays.hashCode(content), contentType, invalidFields, pspReference, resultCode);
  }
   ...
   * @throws JacksonException if the JSON string is invalid with respect to GetTaxFormResponse
   */
  public static GetTaxFormResponse fromJson(String jsonString) throws JacksonException {
