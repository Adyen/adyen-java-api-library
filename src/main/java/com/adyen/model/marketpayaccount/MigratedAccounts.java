...
public class MigratedAccounts {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to MigratedAccounts
   */
  public static MigratedAccounts fromJson(String jsonString) throws JacksonException {
