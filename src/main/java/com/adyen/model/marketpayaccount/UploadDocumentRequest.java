...
public class UploadDocumentRequest {
  ...
  /**
   * The content of the document, in Base64-encoded string format. To learn about document
   * requirements, refer to [Verification
   ...
   * @throws JacksonException if the JSON string is invalid with respect to UploadDocumentRequest
   */
  public static UploadDocumentRequest fromJson(String jsonString) throws JacksonException {
