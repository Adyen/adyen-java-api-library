...
public class DeleteBankAccountRequest {
  ...
  @ApiModelProperty(
      required = true,
      value = "The code of the Account Holder from which to delete the Bank Account(s).")
   ...
   * @throws JacksonException if the JSON string is invalid with respect to DeleteBankAccountRequest
   */
  public static DeleteBankAccountRequest fromJson(String jsonString) throws JacksonException {
