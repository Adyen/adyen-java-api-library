 ...
 */
@JsonPropertyOrder({
  CloseAccountHolderResponse.JSON_PROPERTY_ACCOUNT_HOLDER_STATUS,
  CloseAccountHolderResponse.JSON_PROPERTY_INVALID_FIELDS,
  CloseAccountHolderResponse.JSON_PROPERTY_PSP_REFERENCE,
  CloseAccountHolderResponse.JSON_PROPERTY_RESULT_CODE
})
...
public class CloseAccountHolderResponse {
  ...
  **/
  ...
  /**
   * Return true if this CloseAccountHolderResponse object is equal to o.
   */
  @Override
...
/**
   ...
   * @throws JsonProcessingException if the JSON string is invalid with respect to CloseAccountHolderResponse
   */
  public static CloseAccountHolderResponse fromJson(String jsonString) throws JsonProcessingException {
    return JSON.getMapper().readValue(jsonString, CloseAccountHolderResponse.class);
  }
/**
