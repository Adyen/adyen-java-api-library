...
public class DocumentDetail {
   ...
   * checks](https://docs.adyen.com/marketplaces-and-platforms/classic/verification-checks) for
   * details on when each document type should be submitted and for the accepted file formats.
   * Permitted values: * **BANK_STATEMENT**: A file containing a bank statement or other document
   * proving ownership of a specific bank account. * **COMPANY_REGISTRATION_SCREENING** (Supported
   ...
   * arrangement. * **PASSPORT**: A file containing the identity page(s) of a passport. *
   * **ID_CARD_FRONT**: A file containing only the front of the ID card. In order for a document to
   * be usable, both the **ID_CARD_FRONT** and **ID_CARD_BACK** must be submitted. *
   ...
   * **DRIVING_LICENCE_FRONT**: A file containing only the front of the driving licence. In order
   * for a document to be usable, both the **DRIVING_LICENCE_FRONT** and **DRIVING_LICENCE_BACK**
   * must be submitted. * **DRIVING_LICENCE_BACK**: A file containing only the back of the driving
   * licence. In order for a document to be usable, both the **DRIVING_LICENCE_FRONT** and
  ...
  /**
   * The Adyen-generated
   * [&#x60;bankAccountUUID&#x60;](https://docs.adyen.com/api-explorer/#/Account/latest/post/createAccountHolder__resParam_accountHolderDetails-bankAccountDetails-bankAccountUUID)
   * to which the document must be linked. Refer to [Bank account
   * check](https://docs.adyen.com/marketplaces-and-platforms/classic/verification-checks/bank-account-check#uploading-a-bank-statement)
   * for details on when a document should be submitted. &gt;Required if the
   * &#x60;documentType&#x60; is **BANK_STATEMENT**, where a document is being submitted in order to
  ...
  /**
   * The Adyen-generated
   * [&#x60;legalArrangementCode&#x60;](https://docs.adyen.com/api-explorer/#/Account/latest/post/createAccountHolder__resParam_accountHolderDetails-legalArrangements-legalArrangementCode)
  ...
  /**
   * The Adyen-generated
   * [&#x60;legalArrangementEntityCode&#x60;](https://docs.adyen.com/api-explorer/#/Account/v6/post/createAccountHolder__resParam_accountHolderDetails-legalArrangements-legalArrangementEntities-legalArrangementEntityCode)
   * to which the document must be linked.
   *
  ...
  /**
   * The Adyen-generated
   * [&#x60;shareholderCode&#x60;](https://docs.adyen.com/api-explorer/#/Account/latest/post/createAccountHolder__resParam_accountHolderDetails-businessDetails-shareholders-shareholderCode)
   * to which the document must be linked. Refer to [Verification
   * checks](https://docs.adyen.com/marketplaces-and-platforms/classic/verification-checks) for
   * details on when a document should be submitted. &gt;Required if the account holder has a
   * &#x60;legalEntity&#x60; of type **Business** and the &#x60;documentType&#x60; is either
   * **PASSPORT**, **ID_CARD_FRONT**, **ID_CARD_BACK**, **DRIVING_LICENCE_FRONT**, or
  ...
  /**
   * The Adyen-generated
   * [&#x60;signatoryCode&#x60;](https://docs.adyen.com/api-explorer/#/Account/v6/post/createAccountHolder__resParam_accountHolderDetails-businessDetails-signatories-signatoryCode)
   * to which the document must be linked.
   *
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountHolderCode, documentDetail.accountHolderCode)
        ...
        && Objects.equals(
            this.legalArrangementEntityCode, documentDetail.legalArrangementEntityCode)
  ...
  public String toString() {
    ...
    sb.append("    legalArrangementCode: ")
        ...
        .append("\n");
    sb.append("    legalArrangementEntityCode: ")
        .append(toIndentedString(legalArrangementEntityCode))
        .append("\n");
   ...
   * @throws JacksonException if the JSON string is invalid with respect to DocumentDetail
   */
  public static DocumentDetail fromJson(String jsonString) throws JacksonException {
