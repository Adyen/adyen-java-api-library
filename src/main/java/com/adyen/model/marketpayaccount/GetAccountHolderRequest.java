...
public class GetAccountHolderRequest {
  ...
  /**
   * The code of the account of which to retrieve the details. &gt; Required if no
   * &#x60;accountHolderCode&#x60; is provided.
   *
   * @return accountCode
   */
  @ApiModelProperty(
  ...
  /**
   * The code of the account holder of which to retrieve the details. &gt; Required if no
   * &#x60;accountCode&#x60; is provided.
   *
   ...
   * @throws JacksonException if the JSON string is invalid with respect to GetAccountHolderRequest
   */
  public static GetAccountHolderRequest fromJson(String jsonString) throws JacksonException {
