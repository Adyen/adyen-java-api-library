...
public class DeleteShareholderRequest {
  ...
  @ApiModelProperty(
      required = true,
      value = "The code of the Account Holder from which to delete the Shareholders.")
   ...
   */
  public static DeleteShareholderRequest fromJson(String jsonString) throws JacksonException {
