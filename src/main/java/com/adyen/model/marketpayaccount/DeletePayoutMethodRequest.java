...
public class DeletePayoutMethodRequest {
  ...
  @ApiModelProperty(
      required = true,
      value = "The code of the account holder, from which to delete the payout methods.")
   ...
   *     DeletePayoutMethodRequest
   */
  public static DeletePayoutMethodRequest fromJson(String jsonString) throws JacksonException {
