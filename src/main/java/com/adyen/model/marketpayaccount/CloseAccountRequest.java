...
/** CloseAccountRequest */
@JsonPropertyOrder({CloseAccountRequest.JSON_PROPERTY_ACCOUNT_CODE})
public class CloseAccountRequest {
   ...
   * @return accountCode
   */
  @ApiModelProperty(required = true, value = "The code of account to be closed.")
   ...
   *     CloseAccountRequest
   */
  public static CloseAccountRequest fromJson(String jsonString) throws JsonProcessingException {
    return JSON.getMapper().readValue(jsonString, CloseAccountRequest.class);
  }
