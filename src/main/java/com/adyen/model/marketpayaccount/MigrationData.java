...
public class MigrationData {
  ...
  /**
   * Contains the mapping of virtual account codes (classic integration) to the balance account
   * codes (balance platform) associated with the migrated account holder.
   *
   ...
   */
  @ApiModelProperty(
      value = "Contains the mapping of shareholders associated with the migrated legal entities.")
  ...
  public String toString() {
    ...
    sb.append("    migratedShareholders: ")
        .append(toIndentedString(migratedShareholders))
        .append("\n");
