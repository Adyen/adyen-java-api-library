...
public class DeleteLegalArrangementRequest {
  ...
  public DeleteLegalArrangementRequest legalArrangements(
      List<LegalArrangementRequest> legalArrangements) {
    this.legalArrangements = legalArrangements;
    return this;
  }

  public DeleteLegalArrangementRequest addLegalArrangementsItem(
      LegalArrangementRequest legalArrangementsItem) {
   ...
   *     DeleteLegalArrangementRequest
   */
  public static DeleteLegalArrangementRequest fromJson(String jsonString) throws JacksonException {
