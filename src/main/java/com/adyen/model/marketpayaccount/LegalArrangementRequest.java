...
public class LegalArrangementRequest {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to LegalArrangementRequest
   */
  public static LegalArrangementRequest fromJson(String jsonString) throws JacksonException {
