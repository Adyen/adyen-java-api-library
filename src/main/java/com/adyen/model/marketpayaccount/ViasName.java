...
public class ViasName {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to ViasName
   */
  public static ViasName fromJson(String jsonString) throws JacksonException {
