...
public class MigratedShareholders {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to MigratedShareholders
   */
  public static MigratedShareholders fromJson(String jsonString) throws JacksonException {
