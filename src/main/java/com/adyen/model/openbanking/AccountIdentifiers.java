...
public class AccountIdentifiers {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to AccountIdentifiers
   */
  public static AccountIdentifiers fromJson(String jsonString) throws JacksonException {
