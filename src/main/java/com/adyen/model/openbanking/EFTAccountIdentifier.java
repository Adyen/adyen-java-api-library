...
public class EFTAccountIdentifier {
   ...
   *
   * @param branch Identifies the specific branch where the account is held within the Canadian
   *     banking system.
   * @return the current {@code EFTAccountIdentifier} instance, allowing for method chaining
   */
   ...
   * Identifies the specific branch where the account is held within the Canadian banking system.
   *
   * @return branch Identifies the specific branch where the account is held within the Canadian
   *     banking system.
   */
   ...
   * @throws JacksonException if the JSON string is invalid with respect to EFTAccountIdentifier
   */
  public static EFTAccountIdentifier fromJson(String jsonString) throws JacksonException {
