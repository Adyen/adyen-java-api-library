...
public class BACSAccountIdentifier {
   ...
   *
   * @param sortCode A number that identifies the specific bank and branch where a UK bank account is held.
   * @return the current {@code BACSAccountIdentifier} instance, allowing for method chaining
   */
  ...
  /**
   * A number that identifies the specific bank and branch where a UK bank account is held.
   * @return sortCode A number that identifies the specific bank and branch where a UK bank account is held.
   */
...
/**
   ...
   * @throws JsonProcessingException if the JSON string is invalid with respect to BACSAccountIdentifier
   */
