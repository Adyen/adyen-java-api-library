...
import com.adyen.model.openbanking.Provider;
 ...
 */
@JsonPropertyOrder({
  Route.JSON_PROPERTY_LINK,
  Route.JSON_PROPERTY_PROVIDER
})
...
public class Route {
   ...
   *
   * @param link The redirection link. You can use this link to redirect the user to the open banking flow when the user selects it.
  ...
  /**
   * The redirection link. You can use this link to redirect the user to the open banking flow when the user selects it.
   * @return link The redirection link. You can use this link to redirect the user to the open banking flow when the user selects it.
   */
  ...
  public boolean equals(Object o) {
    ...
    Route route = (Route) o;
    return Objects.equals(this.link, route.link) &&
        Objects.equals(this.provider, route.provider);
  }
