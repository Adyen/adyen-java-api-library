 ...
 */
@JsonPropertyOrder({
  Provider.JSON_PROPERTY_LOGO_U_R_L,
...
public class Provider {
   ...
   *
   * @param logoURL The URL of the organization&#39;s or brand&#39;s logo. This URL typically points to an image file (e.g., .png, .jpg, .svg) that can be displayed to visually represent the entity.
  ...
  /**
   * The URL of the organization&#39;s or brand&#39;s logo. This URL typically points to an image file (e.g., .png, .jpg, .svg) that can be displayed to visually represent the entity.
   * @return logoURL The URL of the organization&#39;s or brand&#39;s logo. This URL typically points to an image file (e.g., .png, .jpg, .svg) that can be displayed to visually represent the entity.
   */
