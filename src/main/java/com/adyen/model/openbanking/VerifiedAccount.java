...
public class VerifiedAccount {
  ...
  /**
   * The name of the bank account. This name is assigned by the banking institution, and it
   * describes the type of bank account.
   *
   * @param accountName The name of the bank account. This name is assigned by the banking
   *     institution, and it describes the type of bank account.
   * @return the current {@code VerifiedAccount} instance, allowing for method chaining
   */
   ...
   * describes the type of bank account.
   *
   * @return accountName The name of the bank account. This name is assigned by the banking
   *     institution, and it describes the type of bank account.
   */
