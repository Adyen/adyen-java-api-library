...
@JsonPropertyOrder({
  GetOnboardingUrlResponse.JSON_PROPERTY_INVALID_FIELDS,
  GetOnboardingUrlResponse.JSON_PROPERTY_PSP_REFERENCE,
  GetOnboardingUrlResponse.JSON_PROPERTY_REDIRECT_URL,
  GetOnboardingUrlResponse.JSON_PROPERTY_RESULT_CODE
})
public class GetOnboardingUrlResponse {
  ...
  /**
   * The URL to the Hosted Onboarding Page where you should redirect your sub-merchant. This URL
