...
public class GetPciUrlRequest {
  ...
  /**
   * The URL where the account holder will be redirected back to after they fill out the
   * questionnaire, or if their session times out. Maximum length of 500 characters.
   *
   * @return returnUrl
   */
  @ApiModelProperty(
