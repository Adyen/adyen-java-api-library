...
public class GetOnboardingUrlRequest {
  ...
  @ApiModelProperty(
      required = true,
      value = "The account holder code you provided when you created the account holder.")
   ...
   */
  @ApiModelProperty(
      value = "Indicates if editing checks is allowed even if all the checks have passed.")
  ...
  /**
   * The URL to which the account holder is redirected after completing an OAuth authentication with
   * a bank through Trustly/PayMyBank.
   *
  ...
  /**
   * The URL where the account holder will be redirected back to after they complete the onboarding,
   * or if their session times out. Maximum length of 500 characters. If you don&#39;t provide this,
   * the account holder will be redirected back to the default return URL configured in your
   * platform account.
   *
   * @return returnUrl
   */
   ...
   * For example, **pt-BR**. If not specified in the request or if the language is not supported,
   * the page uses the browser language. If the browser language is not supported, the page uses
   * **en-US** by default. For a list of supported languages, refer to [Change the page
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountHolderCode, getOnboardingUrlRequest.accountHolderCode)
        ...
        && Objects.equals(
            this.mobileOAuthCallbackUrl, getOnboardingUrlRequest.mobileOAuthCallbackUrl)
  ...
  public String toString() {
    ...
    sb.append("    mobileOAuthCallbackUrl: ")
        .append(toIndentedString(mobileOAuthCallbackUrl))
        .append("\n");
   ...
   * @throws JacksonException if the JSON string is invalid with respect to GetOnboardingUrlRequest
   */
  public static GetOnboardingUrlRequest fromJson(String jsonString) throws JacksonException {
