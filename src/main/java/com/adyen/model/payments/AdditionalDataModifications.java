...
public class AdditionalDataModifications {
  ...
  **/
  ...
  public String toString() {
      String sb = "class AdditionalDataModifications {\n" +
              "    installmentPaymentDataSelectedInstallmentOption: " + toIndentedString(installmentPaymentDataSelectedInstallmentOption) + "\n" +
              "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (AdditionalDataModifications.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdditionalDataModifications is not found in the empty JSON string", AdditionalDataModifications.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AdditionalDataModifications.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdditionalDataModifications` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
