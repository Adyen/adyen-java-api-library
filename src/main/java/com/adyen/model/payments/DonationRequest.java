...
public class DonationRequest {
  ...
  **/
  ...
  public String toString() {
      String sb = "class DonationRequest {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (DonationRequest.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in DonationRequest is not found in the empty JSON string", DonationRequest.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DonationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DonationRequest` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
