...
public class ShopperInteractionDevice {
  ...
  **/
  ...
  public String toString() {
      String sb = "class ShopperInteractionDevice {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ShopperInteractionDevice.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShopperInteractionDevice is not found in the empty JSON string", ShopperInteractionDevice.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ShopperInteractionDevice.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ShopperInteractionDevice` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
