...
public class AdditionalDataOpi {
  ...
  **/
  ...
  public String toString() {
      String sb = "class AdditionalDataOpi {\n" +
              "    opiIncludeTransToken: " + toIndentedString(opiIncludeTransToken) + "\n" +
              "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (AdditionalDataOpi.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdditionalDataOpi is not found in the empty JSON string", AdditionalDataOpi.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AdditionalDataOpi.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdditionalDataOpi` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
