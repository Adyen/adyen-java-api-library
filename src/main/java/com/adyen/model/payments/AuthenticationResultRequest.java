...
public class AuthenticationResultRequest {
  ...
  **/
  ...
  public String toString() {
      String sb = "class AuthenticationResultRequest {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (AuthenticationResultRequest.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in AuthenticationResultRequest is not found in the empty JSON string", AuthenticationResultRequest.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AuthenticationResultRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AuthenticationResultRequest` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
