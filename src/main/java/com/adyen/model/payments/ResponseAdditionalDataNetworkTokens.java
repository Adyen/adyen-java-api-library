...
public class ResponseAdditionalDataNetworkTokens {
  ...
  **/
  ...
  public String toString() {
      String sb = "class ResponseAdditionalDataNetworkTokens {\n" +
              "    networkTokenAvailable: " + toIndentedString(networkTokenAvailable) + "\n" +
              "    networkTokenBin: " + toIndentedString(networkTokenBin) + "\n" +
              "    networkTokenTokenSummary: " + toIndentedString(networkTokenTokenSummary) + "\n" +
              "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ResponseAdditionalDataNetworkTokens.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResponseAdditionalDataNetworkTokens is not found in the empty JSON string", ResponseAdditionalDataNetworkTokens.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResponseAdditionalDataNetworkTokens.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponseAdditionalDataNetworkTokens` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
