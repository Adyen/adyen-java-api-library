...
public class PaymentRequest3d {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class PaymentRequest3d {\n" +
            ...
            "    paResponse: " + toIndentedString(paResponse) + "\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (PaymentRequest3d.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentRequest3d is not found in the empty JSON string", PaymentRequest3d.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PaymentRequest3d.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentRequest3d` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
