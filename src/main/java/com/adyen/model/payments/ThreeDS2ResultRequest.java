...
public class ThreeDS2ResultRequest {
  ...
  **/
  ...
  public String toString() {
      String sb = "class ThreeDS2ResultRequest {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ThreeDS2ResultRequest.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in ThreeDS2ResultRequest is not found in the empty JSON string", ThreeDS2ResultRequest.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ThreeDS2ResultRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ThreeDS2ResultRequest` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
