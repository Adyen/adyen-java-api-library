...
public class ResponseAdditionalDataBillingAddress {
  ...
  **/
  ...
  public String toString() {
      String sb = "class ResponseAdditionalDataBillingAddress {\n" +
              "    billingAddressCity: " + toIndentedString(billingAddressCity) + "\n" +
              "    billingAddressCountry: " + toIndentedString(billingAddressCountry) + "\n" +
              "    billingAddressHouseNumberOrName: " + toIndentedString(billingAddressHouseNumberOrName) + "\n" +
              "    billingAddressPostalCode: " + toIndentedString(billingAddressPostalCode) + "\n" +
              "    billingAddressStateOrProvince: " + toIndentedString(billingAddressStateOrProvince) + "\n" +
              "    billingAddressStreet: " + toIndentedString(billingAddressStreet) + "\n" +
              "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ResponseAdditionalDataBillingAddress.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResponseAdditionalDataBillingAddress is not found in the empty JSON string", ResponseAdditionalDataBillingAddress.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResponseAdditionalDataBillingAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponseAdditionalDataBillingAddress` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
