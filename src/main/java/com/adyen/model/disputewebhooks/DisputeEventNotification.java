...
public class DisputeEventNotification {
   ...
   *
   * @param arn The unique Acquirer Reference Number (arn) generated by the card scheme for each capture. You can use the arn to trace the transaction through its lifecycle.
  ...
  /**
   * The unique Acquirer Reference Number (arn) generated by the card scheme for each capture. You can use the arn to trace the transaction through its lifecycle.
   * @return arn The unique Acquirer Reference Number (arn) generated by the card scheme for each capture. You can use the arn to trace the transaction through its lifecycle.
   */
   ...
   *
   * @param transactionId The unique reference of the transaction for which the dispute is requested.
   * @return the current {@code DisputeEventNotification} instance, allowing for method chaining
   */
  ...
  /**
   * The unique reference of the transaction for which the dispute is requested.
   * @return transactionId The unique reference of the transaction for which the dispute is requested.
   */
