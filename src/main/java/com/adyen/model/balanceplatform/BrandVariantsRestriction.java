...
public class BrandVariantsRestriction {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to BrandVariantsRestriction
   */
  public static BrandVariantsRestriction fromJson(String jsonString) throws JacksonException {
