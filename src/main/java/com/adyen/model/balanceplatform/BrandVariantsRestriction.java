...
public class BrandVariantsRestriction {
  ...
  **/
  ...
  public String toString() {
      String sb = "class BrandVariantsRestriction {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (BrandVariantsRestriction.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in BrandVariantsRestriction is not found in the empty JSON string", BrandVariantsRestriction.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!BrandVariantsRestriction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BrandVariantsRestriction` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
