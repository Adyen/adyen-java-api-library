...
@JsonPropertyOrder({
  InternationalTransactionRestriction.JSON_PROPERTY_OPERATION,
  InternationalTransactionRestriction.JSON_PROPERTY_VALUE
})
public class InternationalTransactionRestriction {
   ...
   * @return the current {@code InternationalTransactionRestriction} instance, allowing for method
   *     chaining
   */
  ...
  /**
   * Boolean indicating whether transaction is an international transaction. Possible values: -
   * **true**: The transaction is an international transaction. - **false**: The transaction is a
   * domestic transaction.
   *
   * @param value Boolean indicating whether transaction is an international transaction. Possible
   *     values: - **true**: The transaction is an international transaction. - **false**: The
   ...
   * domestic transaction.
   *
   * @return value Boolean indicating whether transaction is an international transaction. Possible
   *     values: - **true**: The transaction is an international transaction. - **false**: The
   *     transaction is a domestic transaction.
   */
   ...
   */
  public InternationalTransactionRestriction includeNullValues(boolean includeNullValues) {
  ...
  /** Return true if this InternationalTransactionRestriction object is equal to o. */
  @Override
