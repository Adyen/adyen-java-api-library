...
public class PhoneNumber {
  ...
  public enum PhoneTypeEnum {
    ...
    public static PhoneTypeEnum fromValue(String value) {
      ...
      LOG.warning("PhoneTypeEnum: unexpected enum value '" + value + "' - Supported values are "+ Arrays.toString(PhoneTypeEnum.values()));
      return null;
    }
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(phoneCountryCode, isSetPhoneCountryCode, phoneNumber, isSetPhoneNumber, phoneType, isSetPhoneType);
  }
