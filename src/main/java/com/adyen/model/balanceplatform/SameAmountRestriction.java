...
public class SameAmountRestriction {
   ...
   */
  public SameAmountRestriction includeNullValues(boolean includeNullValues) {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to SameAmountRestriction
   */
  public static SameAmountRestriction fromJson(String jsonString) throws JacksonException {
