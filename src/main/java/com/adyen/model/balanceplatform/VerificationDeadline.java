...
public class VerificationDeadline {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class VerificationDeadline {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (VerificationDeadline.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in VerificationDeadline is not found in the empty JSON string", VerificationDeadline.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!VerificationDeadline.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VerificationDeadline` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
