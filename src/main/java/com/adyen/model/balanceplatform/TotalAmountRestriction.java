...
public class TotalAmountRestriction {
   ...
   */
  public TotalAmountRestriction includeNullValues(boolean includeNullValues) {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to TotalAmountRestriction
   */
  public static TotalAmountRestriction fromJson(String jsonString) throws JacksonException {
