...
public class BeginScaDeviceRegistrationResponse {
   ...
   *
   * @param scaDevice
   * @return the current {@code BeginScaDeviceRegistrationResponse} instance, allowing for method
   *     chaining
   */
   ...
   *     BeginScaDeviceRegistrationResponse
   */
  public static BeginScaDeviceRegistrationResponse fromJson(String jsonString)
