...
public class BalancePlatform {
  ...
  /**
   * The status of the balance platform. Possible values: **Active**, **Inactive**, **Closed**,
   * **Suspended**.
   *
   * @param status The status of the balance platform. Possible values: **Active**, **Inactive**,
   *     **Closed**, **Suspended**.
   * @return the current {@code BalancePlatform} instance, allowing for method chaining
   */
   ...
   * **Suspended**.
   *
   * @return status The status of the balance platform. Possible values: **Active**, **Inactive**,
   *     **Closed**, **Suspended**.
   */
   ...
   * @throws JacksonException if the JSON string is invalid with respect to BalancePlatform
   */
  public static BalancePlatform fromJson(String jsonString) throws JacksonException {
