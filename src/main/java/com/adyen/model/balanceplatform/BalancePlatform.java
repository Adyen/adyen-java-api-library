...
public class BalancePlatform {
  ...
  **/
  ...
  public String toString() {
      String sb = "class BalancePlatform {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (BalancePlatform.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in BalancePlatform is not found in the empty JSON string", BalancePlatform.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!BalancePlatform.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BalancePlatform` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
