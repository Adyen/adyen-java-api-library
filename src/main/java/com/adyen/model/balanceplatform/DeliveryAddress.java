...
public class DeliveryAddress {
   ...
   *
   * @param stateOrProvince The state or province code, maximum 3 characters. For example, **CA** for California in the US or **ON** for Ontario in Canada. &gt; Required for the US and Canada.
   * @return the current {@code DeliveryAddress} instance, allowing for method chaining
   */
  ...
  /**
   * The state or province code, maximum 3 characters. For example, **CA** for California in the US or **ON** for Ontario in Canada. &gt; Required for the US and Canada.
   * @return stateOrProvince The state or province code, maximum 3 characters. For example, **CA** for California in the US or **ON** for Ontario in Canada. &gt; Required for the US and Canada.
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(city, isSetCity, country, isSetCountry, line1, isSetLine1, line2, isSetLine2, line3, isSetLine3, postalCode, isSetPostalCode, stateOrProvince, isSetStateOrProvince);
  }
