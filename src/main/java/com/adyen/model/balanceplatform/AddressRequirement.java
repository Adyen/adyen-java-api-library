...
public class AddressRequirement {
  ...
  public enum RequiredAddressFieldsEnum {
    ...
    public static RequiredAddressFieldsEnum fromValue(String value) {
      ...
      LOG.warning("RequiredAddressFieldsEnum: unexpected enum value '" + value + "' - Supported values are "+ Arrays.toString(RequiredAddressFieldsEnum.values()));
      return null;
    }
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, addressRequirement.description) &&
        ...
        Objects.equals(this.isSetRequiredAddressFields, addressRequirement.isSetRequiredAddressFields) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, isSetDescription, requiredAddressFields, isSetRequiredAddressFields, type, isSetType);
  }
