...
public class NetworkTokenActivationDataResponse {
   ...
   * &#x60;sdkInput&#x60; is required to create provisioning data for the network token. For more
   ...
   *
   * @param sdkInput A block of data automatically generated by Adyen&#39;s SDK for network token
   *     provisioning. This &#x60;sdkInput&#x60; is required to create provisioning data for the
   ...
   * [Adyen Google Wallet Provisioning SDK](https://github.com/Adyen/adyen-issuing-android)
   *
   * @return sdkInput A block of data automatically generated by Adyen&#39;s SDK for network token
   *     provisioning. This &#x60;sdkInput&#x60; is required to create provisioning data for the
   *     network token. For more information, see the repositories for Adyen&#39;s SDKs for network
   *     token provisioning: * [Adyen Apple Pay Provisioning
   *     SDK](https://github.com/Adyen/adyen-apple-pay-provisioning-ios). * [Adyen Google Wallet
