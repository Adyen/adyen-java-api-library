...
public class NetworkToken {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to NetworkToken
   */
  public static NetworkToken fromJson(String jsonString) throws JacksonException {
