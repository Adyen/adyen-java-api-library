...
public class DifferentCurrenciesRestriction {
   ...
   * @return the current {@code DifferentCurrenciesRestriction} instance, allowing for method
   *     chaining
   */
  ...
  /**
   * Checks the currency of the payment against the currency of the payment instrument. Possible
   * values: - **true**: The currency of the payment is different from the currency of the payment
   * instrument. - **false**: The currencies are the same.
   *
   * @param value Checks the currency of the payment against the currency of the payment instrument.
   *     Possible values: - **true**: The currency of the payment is different from the currency of
   *     the payment instrument. - **false**: The currencies are the same.
   * @return the current {@code DifferentCurrenciesRestriction} instance, allowing for method
   *     chaining
   */
   ...
   * instrument. - **false**: The currencies are the same.
   *
   * @return value Checks the currency of the payment against the currency of the payment
   *     instrument. Possible values: - **true**: The currency of the payment is different from the
   *     currency of the payment instrument. - **false**: The currencies are the same.
   */
   ...
   */
  public DifferentCurrenciesRestriction includeNullValues(boolean includeNullValues) {
