...
public class ScaInformation {
   ...
   */
  public ScaInformation includeNullValues(boolean includeNullValues) {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to ScaInformation
   */
  public static ScaInformation fromJson(String jsonString) throws JacksonException {
