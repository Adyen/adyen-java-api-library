        ...
        public BankAccountIdentificationValidationRequestAccountIdentification deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(AULocalAccountIdentification.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(BRLocalAccountIdentification.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(CALocalAccountIdentification.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(CZLocalAccountIdentification.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(DKLocalAccountIdentification.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(HKLocalAccountIdentification.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(HULocalAccountIdentification.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(IbanAccountIdentification.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(NOLocalAccountIdentification.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(NZLocalAccountIdentification.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(NumberAndBicAccountIdentification.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(PLLocalAccountIdentification.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(SELocalAccountIdentification.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(SGLocalAccountIdentification.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(UKLocalAccountIdentification.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(USLocalAccountIdentification.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
