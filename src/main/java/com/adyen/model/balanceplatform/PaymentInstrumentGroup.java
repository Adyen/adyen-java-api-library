...
public class PaymentInstrumentGroup {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(balancePlatform, isSetBalancePlatform, description, isSetDescription, id, isSetId, properties, isSetProperties, reference, isSetReference, txVariant, isSetTxVariant);
  }
