...
public class BankAccountModel {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to BankAccountModel
   */
  public static BankAccountModel fromJson(String jsonString) throws JacksonException {
