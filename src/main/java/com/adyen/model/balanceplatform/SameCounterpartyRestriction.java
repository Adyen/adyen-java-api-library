...
/**
   ...
   * @throws JsonProcessingException if the JSON string is invalid with respect to SameCounterpartyRestriction
   */
  public static SameCounterpartyRestriction fromJson(String jsonString) throws JsonProcessingException {
