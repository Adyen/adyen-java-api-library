...
public class PublicKeyResponse {
  ...
  public String toString() {
    ...
    sb.append("    publicKeyExpiryDate: ")
        .append(toIndentedString(publicKeyExpiryDate))
        .append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PublicKeyResponse
   */
  public static PublicKeyResponse fromJson(String jsonString) throws JacksonException {
