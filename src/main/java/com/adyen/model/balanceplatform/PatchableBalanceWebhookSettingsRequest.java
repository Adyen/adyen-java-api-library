...
public class PatchableBalanceWebhookSettingsRequest {
   ...
   * @return currency
   */
  @ApiModelProperty(value = "The three-character [ISO currency code](https://docs.adyen.com/development-resources/currency-codes) of the balance.")
   ...
   * @return status
   */
  @ApiModelProperty(value = "The status of the webhook setting. Possible values:  * **active**: You receive a balance webhook if any of the conditions in this setting are met. * **inactive**: You do not receive a balance webhook even if the conditions in this settings are met.")
   ...
   * @return type
   */
  @ApiModelProperty(value = "The type of the webhook you are configuring. Set to **balance**.")
