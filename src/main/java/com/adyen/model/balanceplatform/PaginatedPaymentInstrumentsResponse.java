...
public class PaginatedPaymentInstrumentsResponse {
  ...
  **/
  ...
  public String toString() {
      String sb = "class PaginatedPaymentInstrumentsResponse {\n" +
              "    hasNext: " + toIndentedString(hasNext) + "\n" +
              "    hasPrevious: " + toIndentedString(hasPrevious) + "\n" +
              "    paymentInstruments: " + toIndentedString(paymentInstruments) + "\n" +
              "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (PaginatedPaymentInstrumentsResponse.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaginatedPaymentInstrumentsResponse is not found in the empty JSON string", PaginatedPaymentInstrumentsResponse.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PaginatedPaymentInstrumentsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaginatedPaymentInstrumentsResponse` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
