...
public class DeliveryContact {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(address, isSetAddress, company, isSetCompany, email, isSetEmail, fullPhoneNumber, isSetFullPhoneNumber, name, isSetName, phoneNumber, isSetPhoneNumber, webAddress, isSetWebAddress);
  }
