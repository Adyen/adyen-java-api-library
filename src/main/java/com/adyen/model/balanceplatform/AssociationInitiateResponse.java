 ...
 */
@JsonPropertyOrder({
  AssociationInitiateResponse.JSON_PROPERTY_SDK_INPUT
})
...
/**
   ...
   * @throws JsonProcessingException if the JSON string is invalid with respect to AssociationInitiateResponse
   */
  public static AssociationInitiateResponse fromJson(String jsonString) throws JsonProcessingException {
