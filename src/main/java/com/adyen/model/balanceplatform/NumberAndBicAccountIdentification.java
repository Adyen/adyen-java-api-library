...
public class NumberAndBicAccountIdentification {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class NumberAndBicAccountIdentification {\n" +
            "    accountNumber: " + toIndentedString(accountNumber) + "\n" +
            "    additionalBankIdentification: " + toIndentedString(additionalBankIdentification) + "\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (NumberAndBicAccountIdentification.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in NumberAndBicAccountIdentification is not found in the empty JSON string", NumberAndBicAccountIdentification.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!NumberAndBicAccountIdentification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NumberAndBicAccountIdentification` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
