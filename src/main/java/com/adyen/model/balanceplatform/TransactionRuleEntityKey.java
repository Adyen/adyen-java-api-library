...
public class TransactionRuleEntityKey {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to TransactionRuleEntityKey
   */
  public static TransactionRuleEntityKey fromJson(String jsonString) throws JacksonException {
