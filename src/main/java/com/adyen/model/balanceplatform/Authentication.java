...
public class Authentication {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to Authentication
   */
  public static Authentication fromJson(String jsonString) throws JacksonException {
