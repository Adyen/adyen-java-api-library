...
public class TransferRouteRequest {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to TransferRouteRequest
   */
  public static TransferRouteRequest fromJson(String jsonString) throws JacksonException {
