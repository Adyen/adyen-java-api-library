...
public class MatchingTransactionsRestriction {
   ...
   * @return the current {@code MatchingTransactionsRestriction} instance, allowing for method
   *     chaining
   */
   ...
   *     MatchingTransactionsRestriction
   */
  public static MatchingTransactionsRestriction fromJson(String jsonString)
