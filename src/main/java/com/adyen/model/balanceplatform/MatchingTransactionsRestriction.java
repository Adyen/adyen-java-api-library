...
public class MatchingTransactionsRestriction {
  ...
  **/
  ...
  public String toString() {
      String sb = "class MatchingTransactionsRestriction {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (MatchingTransactionsRestriction.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in MatchingTransactionsRestriction is not found in the empty JSON string", MatchingTransactionsRestriction.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!MatchingTransactionsRestriction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MatchingTransactionsRestriction` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
