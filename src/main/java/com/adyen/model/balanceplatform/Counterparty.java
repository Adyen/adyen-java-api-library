...
public class Counterparty {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to Counterparty
   */
  public static Counterparty fromJson(String jsonString) throws JacksonException {
