...
public class RevealPinResponse {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to RevealPinResponse
   */
  public static RevealPinResponse fromJson(String jsonString) throws JacksonException {
