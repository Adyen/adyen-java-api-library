...
public class GrantOffer {
   ...
   * The contract type of the grant offer. Possible value: **cashAdvance**, **loan**.
   *
   * @param contractType The contract type of the grant offer. Possible value: **cashAdvance**,
   *     **loan**.
   * @return the current {@code GrantOffer} instance, allowing for method chaining
   */
   ...
   * The contract type of the grant offer. Possible value: **cashAdvance**, **loan**.
   *
   * @return contractType The contract type of the grant offer. Possible value: **cashAdvance**,
   *     **loan**.
   */
