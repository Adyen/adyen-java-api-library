...
public class DayOfWeekRestriction {
  ...
  **/
  ...
  @Override
  public String toString() {
      String sb = "class DayOfWeekRestriction {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (DayOfWeekRestriction.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in DayOfWeekRestriction is not found in the empty JSON string", DayOfWeekRestriction.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DayOfWeekRestriction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DayOfWeekRestriction` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
