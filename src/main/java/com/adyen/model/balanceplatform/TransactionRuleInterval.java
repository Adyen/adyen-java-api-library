...
public class TransactionRuleInterval {
   ...
   * default, this is set to **monday**. Possible values: **sunday**, **monday**, **tuesday**,
  ...
  public enum DayOfWeekEnum {
    ...
    public static DayOfWeekEnum fromValue(String value) {
      ...
      LOG.warning(
          "DayOfWeekEnum: unexpected enum value '"
              + value
              + "' - Supported values are "
              + Arrays.toString(DayOfWeekEnum.values()));
      return null;
    }
  }
   ...
   * which the rule conditions and limits apply, and how often counters are reset. Possible values:
   * * **perTransaction**: conditions are evaluated and the counters are reset for every
   * transaction. * **daily**: the counters are reset daily at 00:00:00 CET. * **weekly**: the
   * counters are reset every Monday at 00:00:00 CET. * **monthly**: the counters reset every first
   * day of the month at 00:00:00 CET. * **lifetime**: conditions are applied to the lifetime of the
   * payment instrument. * **rolling**: conditions are applied and the counters are reset based on a
   * &#x60;duration&#x60;. If the reset date and time are not provided, Adyen applies the default
   * reset time similar to fixed intervals. For example, if the duration is every two weeks, the
   * counter resets every third Monday at 00:00:00 CET. * **sliding**: conditions are applied and
   * the counters are reset based on the current time and a &#x60;duration&#x60; that you specify.
   */
  ...
  /**
   * The day of month, used when the &#x60;duration.unit&#x60; is **months**. If not provided, by
   * default, this is set to **1**, the first day of the month.
   *
   * @param dayOfMonth The day of month, used when the &#x60;duration.unit&#x60; is **months**. If
   *     not provided, by default, this is set to **1**, the first day of the month.
   ...
   * default, this is set to **1**, the first day of the month.
   *
   * @return dayOfMonth The day of month, used when the &#x60;duration.unit&#x60; is **months**. If
   *     not provided, by default, this is set to **1**, the first day of the month.
   */
   ...
   * **wednesday**, **thursday**, **friday**.
   *
   * @param dayOfWeek The day of week, used when the &#x60;duration.unit&#x60; is **weeks**. If not
   *     provided, by default, this is set to **monday**. Possible values: **sunday**, **monday**,
   ...
   * **wednesday**, **thursday**, **friday**.
   *
   * @return dayOfWeek The day of week, used when the &#x60;duration.unit&#x60; is **weeks**. If not
   *     provided, by default, this is set to **monday**. Possible values: **sunday**, **monday**,
   *     **tuesday**, **wednesday**, **thursday**, **friday**.
   */
   ...
   * If not provided, by default, this is set to **00:00:00**.
   *
   * @param timeOfDay The time of day, in **hh:mm:ss** format, used when the
   ...
   * If not provided, by default, this is set to **00:00:00**.
   *
   * @return timeOfDay The time of day, in **hh:mm:ss** format, used when the
   *     &#x60;duration.unit&#x60; is **hours**. If not provided, by default, this is set to
   *     **00:00:00**.
   */
   ...
   *
   * @param timeZone The [time zone](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones).
   ...
   * **Europe/Amsterdam**. By default, this is set to **UTC**.
   *
   * @return timeZone The [time zone](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones).
   *     For example, **Europe/Amsterdam**. By default, this is set to **UTC**.
   */
   ...
   *     interval](https://docs.adyen.com/issuing/transaction-rules#time-intervals) during which the
   *     rule conditions and limits apply, and how often counters are reset. Possible values: *
   *     **perTransaction**: conditions are evaluated and the counters are reset for every
   *     transaction. * **daily**: the counters are reset daily at 00:00:00 CET. * **weekly**: the
   *     counters are reset every Monday at 00:00:00 CET. * **monthly**: the counters reset every
   *     first day of the month at 00:00:00 CET. * **lifetime**: conditions are applied to the
   *     lifetime of the payment instrument. * **rolling**: conditions are applied and the counters
   *     are reset based on a &#x60;duration&#x60;. If the reset date and time are not provided,
   *     Adyen applies the default reset time similar to fixed intervals. For example, if the
   *     duration is every two weeks, the counter resets every third Monday at 00:00:00 CET. *
   *     **sliding**: conditions are applied and the counters are reset based on the current time
   *     and a &#x60;duration&#x60; that you specify.
   * @return the current {@code TransactionRuleInterval} instance, allowing for method chaining
   */
