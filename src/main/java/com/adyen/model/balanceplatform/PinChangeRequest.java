...
public class PinChangeRequest {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PinChangeRequest
   */
  public static PinChangeRequest fromJson(String jsonString) throws JacksonException {
