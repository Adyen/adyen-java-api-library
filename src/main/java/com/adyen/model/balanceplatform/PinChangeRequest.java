...
public class PinChangeRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(encryptedKey, isSetEncryptedKey, encryptedPinBlock, isSetEncryptedPinBlock, paymentInstrumentId, isSetPaymentInstrumentId, token, isSetToken);
  }
