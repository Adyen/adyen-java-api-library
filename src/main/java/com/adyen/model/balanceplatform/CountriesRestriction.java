...
public class CountriesRestriction {
  ...
  **/
  ...
  public String toString() {
      String sb = "class CountriesRestriction {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CountriesRestriction.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in CountriesRestriction is not found in the empty JSON string", CountriesRestriction.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CountriesRestriction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CountriesRestriction` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
