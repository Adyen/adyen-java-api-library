...
public class CountriesRestriction {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to CountriesRestriction
   */
  public static CountriesRestriction fromJson(String jsonString) throws JacksonException {
