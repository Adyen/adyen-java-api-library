...
public class CardOrderItem {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(balancePlatform, isSetBalancePlatform, card, isSetCard, cardOrderItemId, isSetCardOrderItemId, creationDate, isSetCreationDate, id, isSetId, paymentInstrumentId, isSetPaymentInstrumentId, pin, isSetPin, shippingMethod, isSetShippingMethod);
  }
