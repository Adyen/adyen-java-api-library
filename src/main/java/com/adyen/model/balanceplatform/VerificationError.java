...
public class VerificationError {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(capabilities, isSetCapabilities, code, isSetCode, message, isSetMessage, remediatingActions, isSetRemediatingActions, subErrors, isSetSubErrors, type, isSetType);
  }
