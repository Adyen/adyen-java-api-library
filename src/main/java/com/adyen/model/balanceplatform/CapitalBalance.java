...
public class CapitalBalance {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to CapitalBalance
   */
  public static CapitalBalance fromJson(String jsonString) throws JacksonException {
