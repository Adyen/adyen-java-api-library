...
public class BankIdentification {
  ...
  public enum IdentificationTypeEnum {
    ...
    public static IdentificationTypeEnum fromValue(String value) {
      ...
      LOG.warning("IdentificationTypeEnum: unexpected enum value '" + value + "' - Supported values are "+ Arrays.toString(IdentificationTypeEnum.values()));
      return null;
    }
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(country, isSetCountry, identification, isSetIdentification, identificationType, isSetIdentificationType);
  }
