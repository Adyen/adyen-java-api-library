...
public class BalanceWebhookSettingInfoUpdate {
   ...
   *     webhook.
   * @return the current {@code BalanceWebhookSettingInfoUpdate} instance, allowing for method
   *     chaining
   */
   ...
   *     BalanceWebhookSettingInfoUpdate
   */
  public static BalanceWebhookSettingInfoUpdate fromJson(String jsonString)
