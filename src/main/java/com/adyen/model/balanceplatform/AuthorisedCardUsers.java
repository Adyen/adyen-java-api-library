 ...
 */
@JsonPropertyOrder({
  AuthorisedCardUsers.JSON_PROPERTY_LEGAL_ENTITY_IDS
})
...
public class AuthorisedCardUsers {
   ...
   *
   * @param legalEntityIds The legal entity IDs of the authorized card users linked to the specified payment instrument.
  ...
  /**
   * The legal entity IDs of the authorized card users linked to the specified payment instrument.
   * @return legalEntityIds The legal entity IDs of the authorized card users linked to the specified payment instrument.
   */
...
/**
   ...
   * @throws JsonProcessingException if the JSON string is invalid with respect to AuthorisedCardUsers
   */
