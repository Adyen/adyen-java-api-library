...
@JsonSubTypes({
  @JsonSubTypes.Type(value = BalanceWebhookSettingsResponse.class, name = "BalanceWebhookSettingsResponse"),
...
public class WebhookSettingResponse {
   ...
   * @return id
   */
  @ApiModelProperty(required = true, value = "The unique identifier of the webhook setting.")
