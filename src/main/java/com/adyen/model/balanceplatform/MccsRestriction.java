...
public class MccsRestriction {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to MccsRestriction
   */
  public static MccsRestriction fromJson(String jsonString) throws JacksonException {
