...
public class TransferRoute {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to TransferRoute
   */
  public static TransferRoute fromJson(String jsonString) throws JacksonException {
