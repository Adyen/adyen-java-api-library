...
public class AccountHolderCapability {
  ...
  public AccountHolderCapability(
    ...
    @JsonProperty(JSON_PROPERTY_TRANSFER_INSTRUMENTS) List<AccountSupportingEntityCapability> transferInstruments, 
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowed, isSetAllowed, allowedLevel, isSetAllowedLevel, allowedSettings, isSetAllowedSettings, enabled, isSetEnabled, problems, isSetProblems, requested, isSetRequested, requestedLevel, isSetRequestedLevel, requestedSettings, isSetRequestedSettings, transferInstruments, isSetTransferInstruments, verificationStatus, isSetVerificationStatus);
  }
