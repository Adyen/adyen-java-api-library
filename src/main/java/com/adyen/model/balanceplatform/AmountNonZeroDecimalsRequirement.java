...
public class AmountNonZeroDecimalsRequirement {
   ...
   *
   * @param description Specifies for which routes the amount in a transfer request must have no
   *     non-zero decimal places, so the transfer can only be processed if the amount consists of
   *     round numbers.
   * @return the current {@code AmountNonZeroDecimalsRequirement} instance, allowing for method
   *     chaining
   */
   ...
   * places, so the transfer can only be processed if the amount consists of round numbers.
   *
   * @return description Specifies for which routes the amount in a transfer request must have no
   *     non-zero decimal places, so the transfer can only be processed if the amount consists of
   *     round numbers.
   */
   ...
   */
  public AmountNonZeroDecimalsRequirement includeNullValues(boolean includeNullValues) {
