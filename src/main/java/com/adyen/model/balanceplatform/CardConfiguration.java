...
public class CardConfiguration {
   ...
   * of the card. For example, **en**.
   *
   * @param language The two-letter
   *     [ISO-639-1](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) language code of the
   *     card. For example, **en**.
   * @return the current {@code CardConfiguration} instance, allowing for method chaining
   */
   ...
   * of the card. For example, **en**.
   *
   * @return language The two-letter
   *     [ISO-639-1](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) language code of the
   *     card. For example, **en**.
   */
