...
public class ActiveNetworkTokensRestriction {
  ...
  **/
  ...
  public String toString() {
      String sb = "class ActiveNetworkTokensRestriction {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ActiveNetworkTokensRestriction.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActiveNetworkTokensRestriction is not found in the empty JSON string", ActiveNetworkTokensRestriction.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ActiveNetworkTokensRestriction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActiveNetworkTokensRestriction` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
