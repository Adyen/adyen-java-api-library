...
public class MerchantAcquirerPair {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to MerchantAcquirerPair
   */
  public static MerchantAcquirerPair fromJson(String jsonString) throws JacksonException {
