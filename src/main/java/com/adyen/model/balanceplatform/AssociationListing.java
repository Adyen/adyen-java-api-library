...
public class AssociationListing {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt, isSetCreatedAt, entityId, isSetEntityId, entityType, isSetEntityType, scaDeviceId, isSetScaDeviceId, scaDeviceName, isSetScaDeviceName, scaDeviceType, isSetScaDeviceType, status, isSetStatus);
  }
