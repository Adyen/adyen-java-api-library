...
public class UpdatePaymentInstrument {
  ...
  public UpdatePaymentInstrument addAdditionalBankAccountIdentificationsItem(
  ...
  /**
   * Comment for the status of the payment instrument. Required if &#x60;statusReason&#x60; is
   * **other**.
   *
   * @param statusComment Comment for the status of the payment instrument. Required if
   *     &#x60;statusReason&#x60; is **other**.
   * @return the current {@code UpdatePaymentInstrument} instance, allowing for method chaining
   */
   ...
   * **other**.
   *
   * @return statusComment Comment for the status of the payment instrument. Required if
   *     &#x60;statusReason&#x60; is **other**.
   */
   ...
   * @throws JacksonException if the JSON string is invalid with respect to UpdatePaymentInstrument
   */
  public static UpdatePaymentInstrument fromJson(String jsonString) throws JacksonException {
