...
public class DelegatedAuthenticationData {
   ...
   *
   * @param sdkOutput A base64-encoded block with the data required to register the SCA device. You obtain this information by using our authentication SDK.
  ...
  /**
   * A base64-encoded block with the data required to register the SCA device. You obtain this information by using our authentication SDK.
   * @return sdkOutput A base64-encoded block with the data required to register the SCA device. You obtain this information by using our authentication SDK.
   */
  ...
  public DelegatedAuthenticationData includeNullValues(boolean includeNullValues) {
