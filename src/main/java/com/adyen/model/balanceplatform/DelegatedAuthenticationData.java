...
@JsonPropertyOrder({DelegatedAuthenticationData.JSON_PROPERTY_SDK_OUTPUT})
public class DelegatedAuthenticationData {
   ...
   *     DelegatedAuthenticationData
   */
  public static DelegatedAuthenticationData fromJson(String jsonString) throws JacksonException {
