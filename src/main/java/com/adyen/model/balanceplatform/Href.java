...
/** Href */
@JsonPropertyOrder({Href.JSON_PROPERTY_HREF})
public class Href {
   ...
   */
  public Href includeNullValues(boolean includeNullValues) {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to Href
   */
  public static Href fromJson(String jsonString) throws JacksonException {
