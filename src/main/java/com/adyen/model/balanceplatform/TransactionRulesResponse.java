...
public class TransactionRulesResponse {
  ...
  private boolean isSetTransactionRules = false;
   ...
   *
   * @param transactionRules List of transaction rules.
  ...
  public TransactionRulesResponse transactionRules(List<TransactionRule> transactionRules) {
    ...
    isSetTransactionRules = true; // mark as set
    return this;
  }
   ...
   * List of transaction rules.
   *
   * @return transactionRules List of transaction rules.
   */
  ...
  public Map<String, Object> getExplicitNulls() {
    ...
    if (isSetTransactionRules) {
      addIfNull(nulls, JSON_PROPERTY_TRANSACTION_RULES, this.transactionRules);
    }
   ...
   * @throws JacksonException if the JSON string is invalid with respect to TransactionRulesResponse
   */
  public static TransactionRulesResponse fromJson(String jsonString) throws JacksonException {
