...
public class MerchantsRestriction {
  ...
  **/
  ...
  public String toString() {
      String sb = "class MerchantsRestriction {\n" +
  ...
  * @throws IOException if the JSON Object is invalid with respect to MerchantsRestriction
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (MerchantsRestriction.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in MerchantsRestriction is not found in the empty JSON string", MerchantsRestriction.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!MerchantsRestriction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MerchantsRestriction` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
