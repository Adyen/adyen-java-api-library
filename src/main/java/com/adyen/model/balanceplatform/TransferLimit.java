...
public class TransferLimit {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to TransferLimit
   */
  public static TransferLimit fromJson(String jsonString) throws JacksonException {
