...
public class TransactionRule {
  ...
  public enum OutcomeTypeEnum {
    ...
    public static OutcomeTypeEnum fromValue(String value) {
      ...
      LOG.warning("OutcomeTypeEnum: unexpected enum value '" + value + "' - Supported values are "+ Arrays.toString(OutcomeTypeEnum.values()));
      return null;
    }
  }
  ...
  public enum RequestTypeEnum {
    ...
    public static RequestTypeEnum fromValue(String value) {
      ...
      // handling unexpected value
      LOG.warning("RequestTypeEnum: unexpected enum value '" + value + "' - Supported values are "+ Arrays.toString(RequestTypeEnum.values()));
      return null;
    }
  }
   ...
   *
   * @param endDate The date when the rule will stop being evaluated, in ISO 8601 extended offset date-time format. For example, **2025-03-19T10:15:30+01:00**.  If not provided, the rule will be evaluated until the rule status is set to **inactive**.
   * @return the current {@code TransactionRule} instance, allowing for method chaining
   */
  ...
  /**
   * The date when the rule will stop being evaluated, in ISO 8601 extended offset date-time format. For example, **2025-03-19T10:15:30+01:00**.  If not provided, the rule will be evaluated until the rule status is set to **inactive**.
   * @return endDate The date when the rule will stop being evaluated, in ISO 8601 extended offset date-time format. For example, **2025-03-19T10:15:30+01:00**.  If not provided, the rule will be evaluated until the rule status is set to **inactive**.
   */
   ...
   *
   * @param startDate The date when the rule will start to be evaluated, in ISO 8601 extended offset date-time format. For example, **2025-03-19T10:15:30+01:00**.  If not provided when creating a transaction rule, the &#x60;startDate&#x60; is set to the date when the rule status is set to **active**.   
   * @return the current {@code TransactionRule} instance, allowing for method chaining
   */
  ...
  /**
   * The date when the rule will start to be evaluated, in ISO 8601 extended offset date-time format. For example, **2025-03-19T10:15:30+01:00**.  If not provided when creating a transaction rule, the &#x60;startDate&#x60; is set to the date when the rule status is set to **active**.   
   * @return startDate The date when the rule will start to be evaluated, in ISO 8601 extended offset date-time format. For example, **2025-03-19T10:15:30+01:00**.  If not provided when creating a transaction rule, the &#x60;startDate&#x60; is set to the date when the rule status is set to **active**.   
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(aggregationLevel, isSetAggregationLevel, description, isSetDescription, endDate, isSetEndDate, entityKey, isSetEntityKey, id, isSetId, interval, isSetInterval, outcomeType, isSetOutcomeType, reference, isSetReference, requestType, isSetRequestType, ruleRestrictions, isSetRuleRestrictions, score, isSetScore, startDate, isSetStartDate, status, isSetStatus, type, isSetType);
  }
