...
public class RiskScores {
  ...
  /**
   * Transaction risk score provided by Mastercard. Values provided by Mastercard range between 0
   * (lowest risk) to 998 (highest risk).
   *
   * @param mastercard Transaction risk score provided by Mastercard. Values provided by Mastercard
   *     range between 0 (lowest risk) to 998 (highest risk).
   ...
   * (lowest risk) to 998 (highest risk).
   *
   * @return mastercard Transaction risk score provided by Mastercard. Values provided by Mastercard
   *     range between 0 (lowest risk) to 998 (highest risk).
   */
  ...
  /**
   * Transaction risk score provided by Visa. Values provided by Visa range between 01 (lowest risk)
   * to 99 (highest risk).
   *
   * @param visa Transaction risk score provided by Visa. Values provided by Visa range between 01
   *     (lowest risk) to 99 (highest risk).
   * @return the current {@code RiskScores} instance, allowing for method chaining
   */
   ...
   * to 99 (highest risk).
   *
   * @return visa Transaction risk score provided by Visa. Values provided by Visa range between 01
   *     (lowest risk) to 99 (highest risk).
   */
