...
public class BalanceAccountBase {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class BalanceAccountBase {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (BalanceAccountBase.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in BalanceAccountBase is not found in the empty JSON string", BalanceAccountBase.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!BalanceAccountBase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BalanceAccountBase` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
