...
public class BalanceAccountBase {
   ...
   * @return the current {@code BalanceAccountBase} instance, allowing for method chaining
   */
  public BalanceAccountBase platformPaymentConfiguration(
   ...
   * @throws JacksonException if the JSON string is invalid with respect to BalanceAccountBase
   */
  public static BalanceAccountBase fromJson(String jsonString) throws JacksonException {
