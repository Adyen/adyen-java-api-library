...
public class BankAccountIdentificationTypeRequirement {
  ...
  public enum BankAccountIdentificationTypesEnum {
    ...
    private static final Logger LOG = Logger.getLogger(BankAccountIdentificationTypesEnum.class.getName());
    ...
    public static BankAccountIdentificationTypesEnum fromValue(String value) {
      ...
      LOG.warning("BankAccountIdentificationTypesEnum: unexpected enum value '" + value + "' - Supported values are "+ Arrays.toString(BankAccountIdentificationTypesEnum.values()));
      return null;
    }
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bankAccountIdentificationTypes, isSetBankAccountIdentificationTypes, description, isSetDescription, type, isSetType);
  }
  ...
  public Map<String, Object> getExplicitNulls() {
    ...
    if (isSetBankAccountIdentificationTypes) {
      addIfNull(nulls, JSON_PROPERTY_BANK_ACCOUNT_IDENTIFICATION_TYPES, this.bankAccountIdentificationTypes);
    }
    if (isSetDescription) {
