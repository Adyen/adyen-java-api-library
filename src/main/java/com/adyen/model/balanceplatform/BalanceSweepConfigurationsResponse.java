...
public class BalanceSweepConfigurationsResponse {
  ...
  **/
  ...
  public String toString() {
      String sb = "class BalanceSweepConfigurationsResponse {\n" +
              "    hasNext: " + toIndentedString(hasNext) + "\n" +
              "    hasPrevious: " + toIndentedString(hasPrevious) + "\n" +
              "    sweeps: " + toIndentedString(sweeps) + "\n" +
              "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (BalanceSweepConfigurationsResponse.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in BalanceSweepConfigurationsResponse is not found in the empty JSON string", BalanceSweepConfigurationsResponse.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!BalanceSweepConfigurationsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BalanceSweepConfigurationsResponse` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
