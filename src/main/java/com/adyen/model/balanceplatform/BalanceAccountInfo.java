...
public class BalanceAccountInfo {
  ...
  **/
  ...
  public String toString() {
      String sb = "class BalanceAccountInfo {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (BalanceAccountInfo.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in BalanceAccountInfo is not found in the empty JSON string", BalanceAccountInfo.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!BalanceAccountInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BalanceAccountInfo` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
