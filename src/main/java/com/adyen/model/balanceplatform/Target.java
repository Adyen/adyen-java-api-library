 ...
 */
@JsonPropertyOrder({
  Target.JSON_PROPERTY_ID,
  Target.JSON_PROPERTY_TYPE
})
...
public class Target {
   ...
   * @return id
   */
  @ApiModelProperty(required = true, value = "The unique identifier of the `target.type`. This can be the ID of your:  * balance platform * account holder * account holder's balance account")
   ...
   * @return type
   */
  @ApiModelProperty(required = true, value = "The resource for which you want to receive notifications. Possible values:  * **balancePlatform**: receive notifications about balance changes in your entire balance platform.  * **accountHolder**: receive notifications about balance changes of a specific user.  * **balanceAccount**: receive notifications about balance changes in a specific balance account.")
