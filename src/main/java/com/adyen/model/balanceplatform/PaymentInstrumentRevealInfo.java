...
public class PaymentInstrumentRevealInfo {
  ...
  **/
  ...
  public String toString() {
      String sb = "class PaymentInstrumentRevealInfo {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (PaymentInstrumentRevealInfo.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentInstrumentRevealInfo is not found in the empty JSON string", PaymentInstrumentRevealInfo.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PaymentInstrumentRevealInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentInstrumentRevealInfo` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
