...
public class BankAccountIdentificationValidationRequest {
   ...
   * @return the current {@code BankAccountIdentificationValidationRequest} instance, allowing for
   *     method chaining
   */
  public BankAccountIdentificationValidationRequest accountIdentification(
      BankAccountIdentificationValidationRequestAccountIdentification accountIdentification) {
   ...
   */
  public BankAccountIdentificationValidationRequest includeNullValues(boolean includeNullValues) {
   ...
   *     BankAccountIdentificationValidationRequest
   */
  public static BankAccountIdentificationValidationRequest fromJson(String jsonString)
