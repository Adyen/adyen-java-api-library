...
public class ScaEntity {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to ScaEntity
   */
  public static ScaEntity fromJson(String jsonString) throws JacksonException {
