...
public class WebhookSetting {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to WebhookSetting
   */
  public static WebhookSetting fromJson(String jsonString) throws JacksonException {
