...
public class CapitalGrantAccount {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to CapitalGrantAccount
   */
  public static CapitalGrantAccount fromJson(String jsonString) throws JacksonException {
