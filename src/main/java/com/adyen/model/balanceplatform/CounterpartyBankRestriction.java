...
public class CounterpartyBankRestriction {
   ...
   */
  public CounterpartyBankRestriction includeNullValues(boolean includeNullValues) {
   ...
   *     CounterpartyBankRestriction
   */
  public static CounterpartyBankRestriction fromJson(String jsonString) throws JacksonException {
