...
public class EntryModesRestriction {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class EntryModesRestriction {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (EntryModesRestriction.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in EntryModesRestriction is not found in the empty JSON string", EntryModesRestriction.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!EntryModesRestriction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EntryModesRestriction` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
