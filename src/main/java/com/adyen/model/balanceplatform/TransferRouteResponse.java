...
public class TransferRouteResponse {
   ...
   * initiate a transfer.
   *
   * @param transferRoutes List of available priorities for a transfer, along with requirements. Use
   *     this information to initiate a transfer.
   ...
   * initiate a transfer.
   *
   * @return transferRoutes List of available priorities for a transfer, along with requirements.
