...
public class TimeOfDayRestriction {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to TimeOfDayRestriction
   */
  public static TimeOfDayRestriction fromJson(String jsonString) throws JacksonException {
