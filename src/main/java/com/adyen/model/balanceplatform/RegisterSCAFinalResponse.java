...
@JsonPropertyOrder({RegisterSCAFinalResponse.JSON_PROPERTY_SUCCESS})
public class RegisterSCAFinalResponse {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to RegisterSCAFinalResponse
   */
  public static RegisterSCAFinalResponse fromJson(String jsonString) throws JacksonException {
