...
public class CALocalAccountIdentification {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class CALocalAccountIdentification {\n" +
            "    accountNumber: " + toIndentedString(accountNumber) + "\n" +
            "    accountType: " + toIndentedString(accountType) + "\n" +
            "    institutionNumber: " + toIndentedString(institutionNumber) + "\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CALocalAccountIdentification.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in CALocalAccountIdentification is not found in the empty JSON string", CALocalAccountIdentification.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CALocalAccountIdentification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CALocalAccountIdentification` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
