...
public class ApproveAssociationRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(entityId, isSetEntityId, entityType, isSetEntityType, scaDeviceIds, isSetScaDeviceIds, status, isSetStatus);
  }
...
/**
   ...
   * @throws JsonProcessingException if the JSON string is invalid with respect to ApproveAssociationRequest
   */
