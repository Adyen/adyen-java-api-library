...
public class AdditionalBankIdentificationRequirement {
  ...
  public enum AdditionalBankIdentificationTypeEnum {
    ...
    private static final Logger LOG = Logger.getLogger(AdditionalBankIdentificationTypeEnum.class.getName());
    ...
    public static AdditionalBankIdentificationTypeEnum fromValue(String value) {
      ...
      LOG.warning("AdditionalBankIdentificationTypeEnum: unexpected enum value '" + value + "' - Supported values are "+ Arrays.toString(AdditionalBankIdentificationTypeEnum.values()));
      return null;
    }
  }

  public static final String JSON_PROPERTY_ADDITIONAL_BANK_IDENTIFICATION_TYPE = "additionalBankIdentificationType";
  private AdditionalBankIdentificationTypeEnum additionalBankIdentificationType;
  /** Mark when the attribute has been explicitly set. */
  private boolean isSetAdditionalBankIdentificationType = false;
  ...
  public enum TypeEnum {
    ...
    ADDITIONALBANKIDENTIFICATIONREQUIREMENT(String.valueOf("additionalBankIdentificationRequirement"));
   ...
   * The type of additional bank identification, depending on the country.  Possible values:   * **auBsbCode**: The 6-digit [Australian Bank State Branch (BSB) code](https://en.wikipedia.org/wiki/Bank_state_branch), without separators or spaces.  * **caRoutingNumber**: The 9-digit [Canadian routing number](https://en.wikipedia.org/wiki/Routing_number_(Canada)), in EFT format, without separators or spaces.  * **gbSortCode**: The 6-digit [UK sort code](https://en.wikipedia.org/wiki/Sort_code), without separators or spaces  * **usRoutingNumber**: The 9-digit [routing number](https://en.wikipedia.org/wiki/ABA_routing_transit_number), without separators or spaces.
   *
   * @param additionalBankIdentificationType The type of additional bank identification, depending on the country.  Possible values:   * **auBsbCode**: The 6-digit [Australian Bank State Branch (BSB) code](https://en.wikipedia.org/wiki/Bank_state_branch), without separators or spaces.  * **caRoutingNumber**: The 9-digit [Canadian routing number](https://en.wikipedia.org/wiki/Routing_number_(Canada)), in EFT format, without separators or spaces.  * **gbSortCode**: The 6-digit [UK sort code](https://en.wikipedia.org/wiki/Sort_code), without separators or spaces  * **usRoutingNumber**: The 9-digit [routing number](https://en.wikipedia.org/wiki/ABA_routing_transit_number), without separators or spaces.
   * @return the current {@code AdditionalBankIdentificationRequirement} instance, allowing for method chaining
   */
  public AdditionalBankIdentificationRequirement additionalBankIdentificationType(AdditionalBankIdentificationTypeEnum additionalBankIdentificationType) {
    this.additionalBankIdentificationType = additionalBankIdentificationType;
    isSetAdditionalBankIdentificationType = true; // mark as set
    return this;
  }

  /**
   * The type of additional bank identification, depending on the country.  Possible values:   * **auBsbCode**: The 6-digit [Australian Bank State Branch (BSB) code](https://en.wikipedia.org/wiki/Bank_state_branch), without separators or spaces.  * **caRoutingNumber**: The 9-digit [Canadian routing number](https://en.wikipedia.org/wiki/Routing_number_(Canada)), in EFT format, without separators or spaces.  * **gbSortCode**: The 6-digit [UK sort code](https://en.wikipedia.org/wiki/Sort_code), without separators or spaces  * **usRoutingNumber**: The 9-digit [routing number](https://en.wikipedia.org/wiki/ABA_routing_transit_number), without separators or spaces.
   * @return additionalBankIdentificationType The type of additional bank identification, depending on the country.  Possible values:   * **auBsbCode**: The 6-digit [Australian Bank State Branch (BSB) code](https://en.wikipedia.org/wiki/Bank_state_branch), without separators or spaces.  * **caRoutingNumber**: The 9-digit [Canadian routing number](https://en.wikipedia.org/wiki/Routing_number_(Canada)), in EFT format, without separators or spaces.  * **gbSortCode**: The 6-digit [UK sort code](https://en.wikipedia.org/wiki/Sort_code), without separators or spaces  * **usRoutingNumber**: The 9-digit [routing number](https://en.wikipedia.org/wiki/ABA_routing_transit_number), without separators or spaces.
   */
  ...
  @JsonProperty(JSON_PROPERTY_ADDITIONAL_BANK_IDENTIFICATION_TYPE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAdditionalBankIdentificationType(AdditionalBankIdentificationTypeEnum additionalBankIdentificationType) {
    this.additionalBankIdentificationType = additionalBankIdentificationType;
    isSetAdditionalBankIdentificationType = true; // mark as set
  }
  ...
  public boolean equals(Object o) {
    ...
    AdditionalBankIdentificationRequirement additionalBankIdentificationRequirement = (AdditionalBankIdentificationRequirement) o;
    return Objects.equals(this.additionalBankIdentificationType, additionalBankIdentificationRequirement.additionalBankIdentificationType) &&
        Objects.equals(this.isSetAdditionalBankIdentificationType, additionalBankIdentificationRequirement.isSetAdditionalBankIdentificationType) &&
        Objects.equals(this.description, additionalBankIdentificationRequirement.description) &&
        Objects.equals(this.isSetDescription, additionalBankIdentificationRequirement.isSetDescription) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additionalBankIdentificationType, isSetAdditionalBankIdentificationType, description, isSetDescription, type, isSetType);
  }
  ...
  public Map<String, Object> getExplicitNulls() {
    ...
    if (isSetAdditionalBankIdentificationType) {
      addIfNull(nulls, JSON_PROPERTY_ADDITIONAL_BANK_IDENTIFICATION_TYPE, this.additionalBankIdentificationType);
    }
    if (isSetDescription) {
...
/**
   ...
   */
  public static AdditionalBankIdentificationRequirement fromJson(String jsonString) throws JsonProcessingException {
