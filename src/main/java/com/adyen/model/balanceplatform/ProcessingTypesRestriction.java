...
public class ProcessingTypesRestriction {
  ...
  /**
   * List of processing types. Possible values: **atmWithdraw**, **balanceInquiry**, **ecommerce**,
   * **moto**, **pos**, **recurring**, **token**.
   *
   * @param value List of processing types. Possible values: **atmWithdraw**, **balanceInquiry**,
   *     **ecommerce**, **moto**, **pos**, **recurring**, **token**.
   * @return the current {@code ProcessingTypesRestriction} instance, allowing for method chaining
   */
   ...
   * **moto**, **pos**, **recurring**, **token**.
   *
   * @return value List of processing types. Possible values: **atmWithdraw**, **balanceInquiry**,
   *     **ecommerce**, **moto**, **pos**, **recurring**, **token**.
   */
   ...
   *     ProcessingTypesRestriction
   */
  public static ProcessingTypesRestriction fromJson(String jsonString) throws JacksonException {
