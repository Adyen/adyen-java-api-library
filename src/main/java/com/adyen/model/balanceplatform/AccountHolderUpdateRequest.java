...
public class AccountHolderUpdateRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(balancePlatform, isSetBalancePlatform, capabilities, isSetCapabilities, contactDetails, isSetContactDetails, description, isSetDescription, metadata, isSetMetadata, migratedAccountHolderCode, isSetMigratedAccountHolderCode, primaryBalanceAccount, isSetPrimaryBalanceAccount, reference, isSetReference, status, isSetStatus, timeZone, isSetTimeZone, verificationDeadlines, isSetVerificationDeadlines);
  }
