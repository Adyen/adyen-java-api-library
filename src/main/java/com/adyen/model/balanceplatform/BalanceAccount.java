...
public class BalanceAccount {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountHolderId, isSetAccountHolderId, balances, isSetBalances, defaultCurrencyCode, isSetDefaultCurrencyCode, description, isSetDescription, id, isSetId, metadata, isSetMetadata, migratedAccountCode, isSetMigratedAccountCode, platformPaymentConfiguration, isSetPlatformPaymentConfiguration, reference, isSetReference, status, isSetStatus, timeZone, isSetTimeZone);
  }
