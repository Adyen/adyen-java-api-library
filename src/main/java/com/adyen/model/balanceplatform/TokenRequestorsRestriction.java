...
public class TokenRequestorsRestriction {
   ...
   */
  public TokenRequestorsRestriction includeNullValues(boolean includeNullValues) {
   ...
   *     TokenRequestorsRestriction
   */
  public static TokenRequestorsRestriction fromJson(String jsonString) throws JacksonException {
