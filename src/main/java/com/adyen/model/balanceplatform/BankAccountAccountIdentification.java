...
@JsonSerialize(
    using = BankAccountAccountIdentification.BankAccountAccountIdentificationSerializer.class)
public class BankAccountAccountIdentification extends AbstractOpenApiSchema {
  private static final Logger log =
      Logger.getLogger(BankAccountAccountIdentification.class.getName());

  public static class BankAccountAccountIdentificationSerializer
      extends StdSerializer<BankAccountAccountIdentification> {
  ...
  public static class BankAccountAccountIdentificationDeserializer
      extends StdDeserializer<BankAccountAccountIdentification> {
  ...
  static {
    ...
    JSON.registerDescendants(
        BankAccountAccountIdentification.class, Collections.unmodifiableMap(schemas));
    ...
    mappings.put("BankAccount_accountIdentification", BankAccountAccountIdentification.class);
    JSON.registerDiscriminator(BankAccountAccountIdentification.class, "type", mappings);
  }
