...
public class CreateTransferLimitRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amount, isSetAmount, endsAt, isSetEndsAt, reference, isSetReference, scaInformation, isSetScaInformation, scope, isSetScope, startsAt, isSetStartsAt, transferType, isSetTransferType);
  }
