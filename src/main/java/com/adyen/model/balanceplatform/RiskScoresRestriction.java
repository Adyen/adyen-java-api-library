...
public class RiskScoresRestriction {
   ...
   */
  public RiskScoresRestriction includeNullValues(boolean includeNullValues) {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to RiskScoresRestriction
   */
  public static RiskScoresRestriction fromJson(String jsonString) throws JacksonException {
