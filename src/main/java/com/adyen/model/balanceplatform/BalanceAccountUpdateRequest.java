...
public class BalanceAccountUpdateRequest {
  ...
  /**
   * The status of the balance account. Payment instruments linked to the balance account can only
   * be used if the balance account status is **active**. Possible values: **active**, **closed**,
   * **suspended**.
   */
   ...
   *
   * @param description A human-readable description of the balance account. You can use this
   ...
   * between multiple balance accounts under an account holder.
   *
   * @return description A human-readable description of the balance account. You can use this
   *     parameter to distinguish between multiple balance accounts under an account holder.
   */
   ...
   * @return the current {@code BalanceAccountUpdateRequest} instance, allowing for method chaining
   */
  public BalanceAccountUpdateRequest platformPaymentConfiguration(
   ...
   * **suspended**.
   *
   * @param status The status of the balance account. Payment instruments linked to the balance
   *     account can only be used if the balance account status is **active**. Possible values:
   ...
   * **suspended**.
   *
   * @return status The status of the balance account. Payment instruments linked to the balance
   *     account can only be used if the balance account status is **active**. Possible values:
   *     **active**, **closed**, **suspended**.
   */
   ...
   *     BalanceAccountUpdateRequest
   */
  public static BalanceAccountUpdateRequest fromJson(String jsonString) throws JacksonException {
