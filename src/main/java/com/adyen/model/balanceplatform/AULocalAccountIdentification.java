...
public class AULocalAccountIdentification {
  ...
  **/
  ...
  @Override
  public String toString() {
      String sb = "class AULocalAccountIdentification {\n" +
              "    accountNumber: " + toIndentedString(accountNumber) + "\n" +
              "    bsbCode: " + toIndentedString(bsbCode) + "\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (AULocalAccountIdentification.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in AULocalAccountIdentification is not found in the empty JSON string", AULocalAccountIdentification.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AULocalAccountIdentification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AULocalAccountIdentification` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
