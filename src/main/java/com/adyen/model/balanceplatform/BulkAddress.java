...
public class BulkAddress {
   ...
   *
   * @param line1 The name of the street and the number of the building.  For example: **Simon Carmiggeltstraat 6-50**.
   * @return the current {@code BulkAddress} instance, allowing for method chaining
   */
  ...
  /**
   * The name of the street and the number of the building.  For example: **Simon Carmiggeltstraat 6-50**.
   * @return line1 The name of the street and the number of the building.  For example: **Simon Carmiggeltstraat 6-50**.
   */
   ...
   *
   * @param line2 Additional information about the delivery address. For example, an apartment number.
   * @return the current {@code BulkAddress} instance, allowing for method chaining
   */
  ...
  /**
   * Additional information about the delivery address. For example, an apartment number.
   * @return line2 Additional information about the delivery address. For example, an apartment number.
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(city, isSetCity, company, isSetCompany, country, isSetCountry, email, isSetEmail, houseNumberOrName, isSetHouseNumberOrName, line1, isSetLine1, line2, isSetLine2, line3, isSetLine3, mobile, isSetMobile, name, isSetName, postalCode, isSetPostalCode, stateOrProvince, isSetStateOrProvince, street, isSetStreet);
  }
