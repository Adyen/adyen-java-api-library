...
/**
   ...
   * @throws JsonProcessingException if the JSON string is invalid with respect to NetworkTokenRiskRuleData
   */
  public static NetworkTokenRiskRuleData fromJson(String jsonString) throws JsonProcessingException {
