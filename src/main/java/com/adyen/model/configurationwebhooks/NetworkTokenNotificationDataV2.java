...
public class NetworkTokenNotificationDataV2 {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authentication, authenticationApplied, balancePlatform, decision, id, paymentInstrumentId, status, tokenLastFour, tokenRequestor, transactionRulesResult, type, validationFacts, wallet);
  }
