...
public class AccountHolder {
   ...
   *
   * @param migratedAccountHolderCode The unique identifier of the migrated account holder in the
   *     classic integration.
   * @return the current {@code AccountHolder} instance, allowing for method chaining
   */
   ...
   *
   * @param verificationDeadlines List of verification deadlines and the capabilities that will be
   ...
   * @throws JacksonException if the JSON string is invalid with respect to AccountHolder
   */
  public static AccountHolder fromJson(String jsonString) throws JacksonException {
