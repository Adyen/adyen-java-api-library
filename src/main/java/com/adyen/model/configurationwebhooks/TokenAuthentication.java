...
public class TokenAuthentication {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to TokenAuthentication
   */
  public static TokenAuthentication fromJson(String jsonString) throws JacksonException {
