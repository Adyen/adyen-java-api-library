...
public class CapabilitySettings {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to CapabilitySettings
   */
  public static CapabilitySettings fromJson(String jsonString) throws JacksonException {
