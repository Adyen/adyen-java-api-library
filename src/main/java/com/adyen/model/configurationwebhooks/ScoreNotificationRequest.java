...
public class ScoreNotificationRequest {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to ScoreNotificationRequest
   */
  public static ScoreNotificationRequest fromJson(String jsonString) throws JacksonException {
