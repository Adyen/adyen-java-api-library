...
public class ValidationFacts {
   ...
   *
   * @param reasons The reason for the &#x60;result&#x60; of the validations. For example: **walletValidation**, **paymentInstrument**.  Sent only when &#x60;result&#x60; is **invalid**.
  ...
  /**
   * The reason for the &#x60;result&#x60; of the validations. For example: **walletValidation**, **paymentInstrument**.  Sent only when &#x60;result&#x60; is **invalid**.
   * @return reasons The reason for the &#x60;result&#x60; of the validations. For example: **walletValidation**, **paymentInstrument**.  Sent only when &#x60;result&#x60; is **invalid**.
   */
