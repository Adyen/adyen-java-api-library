...
public class ValidationFacts {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to ValidationFacts
   */
  public static ValidationFacts fromJson(String jsonString) throws JacksonException {
