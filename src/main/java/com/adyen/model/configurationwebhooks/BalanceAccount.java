...
public class BalanceAccount {
   ...
   *
   * @param migratedAccountCode The unique identifier of the account of the migrated account holder
   ...
   * @throws JacksonException if the JSON string is invalid with respect to BalanceAccount
   */
  public static BalanceAccount fromJson(String jsonString) throws JacksonException {
