...
public class Wallet {
  ...
  public enum RecommendationReasonsEnum {
    ...
    public static RecommendationReasonsEnum fromValue(String value) {
      ...
      LOG.warning("RecommendationReasonsEnum: unexpected enum value '" + value + "' - Supported values are "+ Arrays.toString(RecommendationReasonsEnum.values()));
      return null;
    }
  }
  ...
  @Deprecated // deprecated since Configuration webhooks v2: Use name of the `tokenRequestor` instead.
  private String type;
   ...
   *
   * @param provisioningMethod The method used for provisioning the network token.  Possible values: **push**, **manual**, **cof**, **unknown**.
   * @return the current {@code Wallet} instance, allowing for method chaining
   */
  ...
  /**
   * The method used for provisioning the network token.  Possible values: **push**, **manual**, **cof**, **unknown**.
   * @return provisioningMethod The method used for provisioning the network token.  Possible values: **push**, **manual**, **cof**, **unknown**.
   */
   ...
   *
   * @param recommendationReasons A list of risk indicators triggered at the time of provisioning the network token.  Some example values of risk indicators are:  * **accountTooNewSinceLaunch** * **tooManyRecentAttempts** * **lowDeviceScore** * **lowAccountScore** 
   * @return the current {@code Wallet} instance, allowing for method chaining
   */
  ...
  /**
   * A list of risk indicators triggered at the time of provisioning the network token.  Some example values of risk indicators are:  * **accountTooNewSinceLaunch** * **tooManyRecentAttempts** * **lowDeviceScore** * **lowAccountScore** 
   * @return recommendationReasons A list of risk indicators triggered at the time of provisioning the network token.  Some example values of risk indicators are:  * **accountTooNewSinceLaunch** * **tooManyRecentAttempts** * **lowDeviceScore** * **lowAccountScore** 
   */
