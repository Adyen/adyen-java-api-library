...
public class Wallet {
   ...
   *
   * @param recommendationReasons A list of risk indicators triggered at the time of provisioning the network token.  Possible values:  * **accountTooNewSinceLaunch** * **accountTooNew** * **accountCardTooNew** * **accountRecentlyChanged** * **suspiciousActivity** * **inactiveAccount** * **hasSuspendedTokens** * **deviceRecentlyLost** * **tooManyRecentAttempts** * **tooManyRecentTokens** * **tooManyDifferentCardholders** * **lowDeviceScore** * **lowAccountScore** * **outSideHomeTerritory** * **unableToAssess** * **accountHighRisk** * **lowPhoneNumberScore** * **unknown**
   * @return the current {@code Wallet} instance, allowing for method chaining
   */
  ...
  /**
   * A list of risk indicators triggered at the time of provisioning the network token.  Possible values:  * **accountTooNewSinceLaunch** * **accountTooNew** * **accountCardTooNew** * **accountRecentlyChanged** * **suspiciousActivity** * **inactiveAccount** * **hasSuspendedTokens** * **deviceRecentlyLost** * **tooManyRecentAttempts** * **tooManyRecentTokens** * **tooManyDifferentCardholders** * **lowDeviceScore** * **lowAccountScore** * **outSideHomeTerritory** * **unableToAssess** * **accountHighRisk** * **lowPhoneNumberScore** * **unknown**
   * @return recommendationReasons A list of risk indicators triggered at the time of provisioning the network token.  Possible values:  * **accountTooNewSinceLaunch** * **accountTooNew** * **accountCardTooNew** * **accountRecentlyChanged** * **suspiciousActivity** * **inactiveAccount** * **hasSuspendedTokens** * **deviceRecentlyLost** * **tooManyRecentAttempts** * **tooManyRecentTokens** * **tooManyDifferentCardholders** * **lowDeviceScore** * **lowAccountScore** * **outSideHomeTerritory** * **unableToAssess** * **accountHighRisk** * **lowPhoneNumberScore** * **unknown**
   */
