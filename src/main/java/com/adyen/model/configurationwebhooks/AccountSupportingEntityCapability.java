...
public class AccountSupportingEntityCapability {
   ...
   *
   * @param allowed Indicates whether the supporting entity capability is allowed. Adyen sets this
   ...
   * **notApplicable**, **low**, **medium**, **high**.
   *
   * @param allowedLevel The capability level that is allowed for the account holder. Possible
   ...
   * reasons to not allow the capability.
   *
   * @param verificationStatus The status of the verification checks for the supporting entity
   ...
   *     chaining
   */
  public AccountSupportingEntityCapability verificationStatus(
