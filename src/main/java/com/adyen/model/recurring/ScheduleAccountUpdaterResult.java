...
public class ScheduleAccountUpdaterResult {
  ...
  **/
  ...
  public String toString() {
      String sb = "class ScheduleAccountUpdaterResult {\n" +
  ...
  * @throws IOException if the JSON Object is invalid with respect to ScheduleAccountUpdaterResult
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ScheduleAccountUpdaterResult.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScheduleAccountUpdaterResult is not found in the empty JSON string", ScheduleAccountUpdaterResult.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ScheduleAccountUpdaterResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScheduleAccountUpdaterResult` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
