...
public class TokenDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to TokenDetails
   */
  public static TokenDetails fromJson(String jsonString) throws JacksonException {
