...
public class RecurringDetailsRequest {
  ...
  **/
  ...
  public String toString() {
      String sb = "class RecurringDetailsRequest {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (RecurringDetailsRequest.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecurringDetailsRequest is not found in the empty JSON string", RecurringDetailsRequest.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!RecurringDetailsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RecurringDetailsRequest` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
