...
public class RecurringDetailsRequest {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to RecurringDetailsRequest
   */
  public static RecurringDetailsRequest fromJson(String jsonString) throws JacksonException {
