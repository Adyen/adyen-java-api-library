...
public class RecurringDetailWrapper {
  ...
  private boolean isSetRecurringDetail = false;
  ...
  public RecurringDetailWrapper recurringDetail(RecurringDetail recurringDetail) {
    ...
    isSetRecurringDetail = true; // mark as set
    return this;
  }
  ...
  public RecurringDetailWrapper includeNullValues(boolean includeNullValues) {
  ...
  public Map<String, Object> getExplicitNulls() {
    ...
    if (isSetRecurringDetail) {
      addIfNull(nulls, JSON_PROPERTY_RECURRING_DETAIL, this.recurringDetail);
    }
