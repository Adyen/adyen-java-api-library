...
public class PermitRestriction {
  ...
  /**
   * Only a single payment can be made using this permit if set to true, otherwise multiple payments
   * are allowed.
   *
   * @param singleUse Only a single payment can be made using this permit if set to true, otherwise
   ...
   * are allowed.
   *
   * @return singleUse Only a single payment can be made using this permit if set to true, otherwise
   *     multiple payments are allowed.
   */
  ...
  public String toString() {
    ...
    sb.append("    singleTransactionLimit: ")
        .append(toIndentedString(singleTransactionLimit))
        .append("\n");
   ...
   */
  public static PermitRestriction fromJson(String jsonString) throws JacksonException {
