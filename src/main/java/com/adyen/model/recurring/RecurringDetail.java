...
public class RecurringDetail {
  ...
  /**
   * This field contains additional data, which may be returned in a particular response. The
   ...
   *     particular response. The additionalData object consists of entries, each of which includes
   *     the key and value.
   ...
   *
   * @param firstPspReference The &#x60;pspReference&#x60; of the first recurring payment that
   *     created the recurring detail.
   * @return the current {@code RecurringDetail} instance, allowing for method chaining
   */
   ...
   * The &#x60;pspReference&#x60; of the first recurring payment that created the recurring detail.
   *
   * @return firstPspReference The &#x60;pspReference&#x60; of the first recurring payment that
   *     created the recurring detail.
   */
   ...
   *
   * @param paymentMethodVariant The type or sub-brand of a payment method used, e.g. Visa Debit,
   ...
   * [PaymentMethodVariant](https://docs.adyen.com/development-resources/paymentmethodvariant).
   *
   * @return paymentMethodVariant The type or sub-brand of a payment method used, e.g. Visa Debit,
   *     Visa Corporate, etc. For more information, refer to
   *     [PaymentMethodVariant](https://docs.adyen.com/development-resources/paymentmethodvariant).
   */
   ...
   *
   * @param socialSecurityNumber A shopper&#39;s social security number (only in countries where it
   *     is legal to collect).
   * @return the current {@code RecurringDetail} instance, allowing for method chaining
   */
   ...
   * A shopper&#39;s social security number (only in countries where it is legal to collect).
   *
   * @return socialSecurityNumber A shopper&#39;s social security number (only in countries where it
   *     is legal to collect).
   */
   ...
   * \&quot;paypal\&quot;.
   *
   * @param variant The payment method, such as “mc\&quot;, \&quot;visa\&quot;, \&quot;ideal\&quot;,
   *     \&quot;paypal\&quot;.
   * @return the current {@code RecurringDetail} instance, allowing for method chaining
   */
   ...
   * \&quot;paypal\&quot;.
   *
   * @return variant The payment method, such as “mc\&quot;, \&quot;visa\&quot;,
   *     \&quot;ideal\&quot;, \&quot;paypal\&quot;.
   */
