...
public class Permit {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(partnerId, isSetPartnerId, profileReference, isSetProfileReference, restriction, isSetRestriction, resultKey, isSetResultKey, validTillDate, isSetValidTillDate);
  }
