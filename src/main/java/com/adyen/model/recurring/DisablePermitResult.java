...
public class DisablePermitResult {
  ...
  **/
  ...
  public String toString() {
      String sb = "class DisablePermitResult {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (DisablePermitResult.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisablePermitResult is not found in the empty JSON string", DisablePermitResult.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DisablePermitResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisablePermitResult` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
