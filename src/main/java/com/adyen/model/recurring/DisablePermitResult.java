...
public class DisablePermitResult {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to DisablePermitResult
   */
  public static DisablePermitResult fromJson(String jsonString) throws JacksonException {
