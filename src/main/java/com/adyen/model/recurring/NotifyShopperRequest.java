...
public class NotifyShopperRequest {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to NotifyShopperRequest
   */
  public static NotifyShopperRequest fromJson(String jsonString) throws JacksonException {
