...
public class NotifyShopperRequest {
  ...
  **/
  ...
  public String toString() {
      String sb = "class NotifyShopperRequest {\n" +
              "    amount: " + toIndentedString(amount) + "\n" +
              "    billingDate: " + toIndentedString(billingDate) + "\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (NotifyShopperRequest.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in NotifyShopperRequest is not found in the empty JSON string", NotifyShopperRequest.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!NotifyShopperRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NotifyShopperRequest` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
