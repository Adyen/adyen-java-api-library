...
public class CreatePermitResult {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to CreatePermitResult
   */
  public static CreatePermitResult fromJson(String jsonString) throws JacksonException {
