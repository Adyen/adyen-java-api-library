...
public class DisablePermitRequest {
  ...
  **/
  ...
  public String toString() {
      String sb = "class DisablePermitRequest {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (DisablePermitRequest.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisablePermitRequest is not found in the empty JSON string", DisablePermitRequest.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DisablePermitRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisablePermitRequest` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
