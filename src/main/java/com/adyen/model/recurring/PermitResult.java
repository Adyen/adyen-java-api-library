...
public class PermitResult {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PermitResult
   */
  public static PermitResult fromJson(String jsonString) throws JacksonException {
