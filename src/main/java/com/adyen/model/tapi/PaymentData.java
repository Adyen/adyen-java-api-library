...
public class PaymentData {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PaymentData
   */
  public static PaymentData fromJson(String jsonString) throws JacksonException {
