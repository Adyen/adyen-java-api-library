...
public class SaleData {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to SaleData
   */
  public static SaleData fromJson(String jsonString) throws JacksonException {
