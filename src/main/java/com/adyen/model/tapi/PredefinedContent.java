...
public class PredefinedContent {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PredefinedContent
   */
  public static PredefinedContent fromJson(String jsonString) throws JacksonException {
