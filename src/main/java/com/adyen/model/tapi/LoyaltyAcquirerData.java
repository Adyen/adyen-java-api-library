...
public class LoyaltyAcquirerData {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to LoyaltyAcquirerData
   */
  public static LoyaltyAcquirerData fromJson(String jsonString) throws JacksonException {
