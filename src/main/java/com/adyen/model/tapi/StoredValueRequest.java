...
public class StoredValueRequest {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to StoredValueRequest
   */
  public static StoredValueRequest fromJson(String jsonString) throws JacksonException {
