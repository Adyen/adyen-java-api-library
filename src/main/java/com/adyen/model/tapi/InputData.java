...
public class InputData {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to InputData
   */
  public static InputData fromJson(String jsonString) throws JacksonException {
