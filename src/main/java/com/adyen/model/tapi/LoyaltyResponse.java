...
public class LoyaltyResponse {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to LoyaltyResponse
   */
  public static LoyaltyResponse fromJson(String jsonString) throws JacksonException {
