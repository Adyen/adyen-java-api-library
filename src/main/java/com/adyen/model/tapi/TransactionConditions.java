...
public class TransactionConditions {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to TransactionConditions
   */
  public static TransactionConditions fromJson(String jsonString) throws JacksonException {
