...
public class PaymentAcquirerData {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PaymentAcquirerData
   */
  public static PaymentAcquirerData fromJson(String jsonString) throws JacksonException {
