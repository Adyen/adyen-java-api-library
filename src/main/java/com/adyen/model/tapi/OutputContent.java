...
public class OutputContent {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to OutputContent
   */
  public static OutputContent fromJson(String jsonString) throws JacksonException {
