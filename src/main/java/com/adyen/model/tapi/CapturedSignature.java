...
public class CapturedSignature {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to CapturedSignature
   */
  public static CapturedSignature fromJson(String jsonString) throws JacksonException {
