...
public class InputResult {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to InputResult
   */
  public static InputResult fromJson(String jsonString) throws JacksonException {
