...
public class InputResponse {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to InputResponse
   */
  public static InputResponse fromJson(String jsonString) throws JacksonException {
