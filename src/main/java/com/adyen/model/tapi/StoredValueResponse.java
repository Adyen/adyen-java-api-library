...
public class StoredValueResponse {
  ...
  /** Mark when the attribute has been explicitly set. */
  private boolean isSetStoredValueResult = false;
  ...
  /**
   * Result of loading/reloading a stored value card. If StoredValueResponse.Result is Success or
   * Partial, one entry per StoredValueRequest.StoredValueData loaded or activated.
   *
   * @param storedValueResult Result of loading/reloading a stored value card. If
   *     StoredValueResponse.Result is Success or Partial, one entry per
   *     StoredValueRequest.StoredValueData loaded or activated.
   * @return the current {@code StoredValueResponse} instance, allowing for method chaining
   */
  public StoredValueResponse storedValueResult(List<StoredValueResult> storedValueResult) {
    ...
    isSetStoredValueResult = true; // mark as set
    return this;
  }
   ...
   * Partial, one entry per StoredValueRequest.StoredValueData loaded or activated.
   *
   * @return storedValueResult Result of loading/reloading a stored value card. If
   *     StoredValueResponse.Result is Success or Partial, one entry per
   *     StoredValueRequest.StoredValueData loaded or activated.
   */
   ...
   */
  public StoredValueResponse includeNullValues(boolean includeNullValues) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.response, storedValueResponse.response)
        ...
        && Objects.equals(this.isSetPaymentReceipt, storedValueResponse.isSetPaymentReceipt);
  }
