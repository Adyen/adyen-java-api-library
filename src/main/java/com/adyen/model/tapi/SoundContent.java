...
public class SoundContent {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to SoundContent
   */
  public static SoundContent fromJson(String jsonString) throws JacksonException {
