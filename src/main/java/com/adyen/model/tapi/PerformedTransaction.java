...
public class PerformedTransaction {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PerformedTransaction
   */
  public static PerformedTransaction fromJson(String jsonString) throws JacksonException {
