...
public class PaymentResult {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PaymentResult
   */
  public static PaymentResult fromJson(String jsonString) throws JacksonException {
