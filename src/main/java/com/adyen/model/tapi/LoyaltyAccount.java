...
public class LoyaltyAccount {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to LoyaltyAccount
   */
  public static LoyaltyAccount fromJson(String jsonString) throws JacksonException {
