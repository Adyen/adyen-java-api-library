...
public class CardHolderPIN {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to CardHolderPIN
   */
  public static CardHolderPIN fromJson(String jsonString) throws JacksonException {
