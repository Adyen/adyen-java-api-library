...
public class CardData {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to CardData
   */
  public static CardData fromJson(String jsonString) throws JacksonException {
