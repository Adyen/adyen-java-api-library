...
public class Response {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to Response
   */
  public static Response fromJson(String jsonString) throws JacksonException {
