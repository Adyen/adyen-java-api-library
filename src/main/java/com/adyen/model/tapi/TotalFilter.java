...
public class TotalFilter {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to TotalFilter
   */
  public static TotalFilter fromJson(String jsonString) throws JacksonException {
