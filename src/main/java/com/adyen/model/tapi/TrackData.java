...
public class TrackData {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to TrackData
   */
  public static TrackData fromJson(String jsonString) throws JacksonException {
