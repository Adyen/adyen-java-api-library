...
public class PaymentTransaction {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PaymentTransaction
   */
  public static PaymentTransaction fromJson(String jsonString) throws JacksonException {
