...
public class Geolocation {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to Geolocation
   */
  public static Geolocation fromJson(String jsonString) throws JacksonException {
