...
public class AmountsResp {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to AmountsResp
   */
  public static AmountsResp fromJson(String jsonString) throws JacksonException {
