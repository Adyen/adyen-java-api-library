 ...
 * of the Balance Inquiry Request message.
 */
@JsonPropertyOrder({
...
public class BalanceInquiryRequest {
  ...
  private boolean isSetPaymentAccountReq = false;
  ...
  /** Mark when the attribute has been explicitly set. */
  private boolean isSetLoyaltyAccountReq = false;
  ...
  public BalanceInquiryRequest paymentAccountReq(PaymentAccountReq paymentAccountReq) {
    ...
    isSetPaymentAccountReq = true; // mark as set
    return this;
  }
  ...
  public BalanceInquiryRequest loyaltyAccountReq(LoyaltyAccountReq loyaltyAccountReq) {
    ...
    isSetLoyaltyAccountReq = true; // mark as set
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.paymentAccountReq, balanceInquiryRequest.paymentAccountReq)
        ...
        && Objects.equals(
            this.isSetLoyaltyAccountReq, balanceInquiryRequest.isSetLoyaltyAccountReq);
  }

  @Override
  public int hashCode() {
    return Objects.hash(
        paymentAccountReq, isSetPaymentAccountReq, loyaltyAccountReq, isSetLoyaltyAccountReq);
  }
  ...
  public Map<String, Object> getExplicitNulls() {
    ...
    if (isSetPaymentAccountReq) {
      addIfNull(nulls, JSON_PROPERTY_PAYMENT_ACCOUNT_REQ, this.paymentAccountReq);
    }
    if (isSetLoyaltyAccountReq) {
      addIfNull(nulls, JSON_PROPERTY_LOYALTY_ACCOUNT_REQ, this.loyaltyAccountReq);
    }
