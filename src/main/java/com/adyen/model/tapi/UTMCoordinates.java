...
public class UTMCoordinates {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to UTMCoordinates
   */
  public static UTMCoordinates fromJson(String jsonString) throws JacksonException {
