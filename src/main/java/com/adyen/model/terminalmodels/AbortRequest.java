...
public class AbortRequest {
   ...
   *
   * @param displayOutput Information to display and the way to process the display. To display an abort message to the Customer.
   * @return the current {@code AbortRequest} instance, allowing for method chaining
   */
  ...
  /**
   * Information to display and the way to process the display. To display an abort message to the Customer.
   * @return displayOutput Information to display and the way to process the display. To display an abort message to the Customer.
   */
