...
import com.adyen.model.terminalmodels.InputResult;
...
public class InputResponse {
   ...
   *
   * @param outputResult Information related to the result the output (display, print, input). If DisplayOutput present in the request.
  ...
  /**
   * Information related to the result the output (display, print, input). If DisplayOutput present in the request.
   * @return outputResult Information related to the result the output (display, print, input). If DisplayOutput present in the request.
   */
