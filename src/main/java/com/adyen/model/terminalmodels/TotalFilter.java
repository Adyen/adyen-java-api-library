...
public class TotalFilter {
   ...
   *
   * @param totalsGroupID Sent if totals in the response have to be computed only for this particular value of TotalsGroupID.
   * @return the current {@code TotalFilter} instance, allowing for method chaining
   */
  ...
  /**
   * Sent if totals in the response have to be computed only for this particular value of TotalsGroupID.
   * @return totalsGroupID Sent if totals in the response have to be computed only for this particular value of TotalsGroupID.
   */
