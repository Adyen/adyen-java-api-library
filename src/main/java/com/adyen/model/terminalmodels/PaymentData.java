...
public class PaymentData {
   ...
   *
   * @param splitPaymentFlag Indicates if the payment of the Sale transaction is split. Allows the POI to decline payment means that cannot accept split payment.
   * @return the current {@code PaymentData} instance, allowing for method chaining
   */
  ...
  /**
   * Indicates if the payment of the Sale transaction is split. Allows the POI to decline payment means that cannot accept split payment.
   * @return splitPaymentFlag Indicates if the payment of the Sale transaction is split. Allows the POI to decline payment means that cannot accept split payment.
   */
   ...
   *
   * @param requestedValidityDate Requested validity date for the reservation. Allows a specific period for the reservation according to the need of the Merchant for the first reservation and the reservation updates as well.
   * @return the current {@code PaymentData} instance, allowing for method chaining
   */
  ...
  /**
   * Requested validity date for the reservation. Allows a specific period for the reservation according to the need of the Merchant for the first reservation and the reservation updates as well.
   * @return requestedValidityDate Requested validity date for the reservation. Allows a specific period for the reservation according to the need of the Merchant for the first reservation and the reservation updates as well.
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(paymentType, splitPaymentFlag, requestedValidityDate, cardAcquisitionReference, instalment, paymentInstrumentData);
  }
