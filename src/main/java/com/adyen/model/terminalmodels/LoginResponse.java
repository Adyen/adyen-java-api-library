...
import com.adyen.model.terminalmodels.POISystemData;
...
public class LoginResponse {
   ...
   *
   * @param poISystemData Information related to the POI System. Returned if the response result is Success.
   * @return the current {@code LoginResponse} instance, allowing for method chaining
   */
  ...
  /**
   * Information related to the POI System. Returned if the response result is Success.
   * @return poISystemData Information related to the POI System. Returned if the response result is Success.
   */
