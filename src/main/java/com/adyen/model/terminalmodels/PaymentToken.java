...
public class PaymentToken {
  ...
  /**
   * @deprecated Use instead setExpiryDateTime(OffsetDateTime expiryDateTime)
   */
  @Deprecated
  public void setExpiryDateTime(XMLGregorianCalendar expiryDateTime) {
    ...
    this.expiryDateTime = expiryDateTime.toGregorianCalendar().toZonedDateTime().toOffsetDateTime();
  }
