...
public class PaymentResponse {
   ...
   *
   * @param paymentResult Data related to the result of a processed payment transaction. If one data element is present.
   * @return the current {@code PaymentResponse} instance, allowing for method chaining
   */
  ...
  /**
   * Data related to the result of a processed payment transaction. If one data element is present.
   * @return paymentResult Data related to the result of a processed payment transaction. If one data element is present.
   */
