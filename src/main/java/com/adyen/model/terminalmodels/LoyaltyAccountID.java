...
import com.adyen.model.terminalmodels.IdentificationSupport;
...
public class LoyaltyAccountID {
   ...
   *
   * @param identificationSupport Support of the loyalty account identification. Allows knowing where and how you have found the loyalty account identification. Possible values: * **HybridCard** * **LinkedCard** * **LoyaltyCard** * **NoCard**
   * @return the current {@code LoyaltyAccountID} instance, allowing for method chaining
   */
  ...
  /**
   * Support of the loyalty account identification. Allows knowing where and how you have found the loyalty account identification. Possible values: * **HybridCard** * **LinkedCard** * **LoyaltyCard** * **NoCard**
   * @return identificationSupport Support of the loyalty account identification. Allows knowing where and how you have found the loyalty account identification. Possible values: * **HybridCard** * **LinkedCard** * **LoyaltyCard** * **NoCard**
   */
