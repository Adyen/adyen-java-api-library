...
import com.adyen.model.terminalmodels.LoyaltyAcquirerData;
...
public class LoyaltyResult {
   ...
   *
   * @param loyaltyAcquirerData Data related to the loyalty Acquirer during a loyalty transaction. If content not empty.
   * @return the current {@code LoyaltyResult} instance, allowing for method chaining
   */
  ...
  /**
   * Data related to the loyalty Acquirer during a loyalty transaction. If content not empty.
   * @return loyaltyAcquirerData Data related to the loyalty Acquirer during a loyalty transaction. If content not empty.
   */
