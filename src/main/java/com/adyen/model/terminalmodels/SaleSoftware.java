...
public class SaleSoftware {
   ...
   *
   * @param certificationCode Certification code of the software which manages the Sale to POI protocol.
   * @return the current {@code SaleSoftware} instance, allowing for method chaining
   */
  ...
  /**
   * Certification code of the software which manages the Sale to POI protocol.
   * @return certificationCode Certification code of the software which manages the Sale to POI protocol.
   */
