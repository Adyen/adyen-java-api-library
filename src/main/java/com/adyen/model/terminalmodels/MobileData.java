...
import com.adyen.model.terminalmodels.Geolocation;
import com.adyen.model.terminalmodels.SensitiveMobileData;
...
public class MobileData {
   ...
   * minimum: 2
   * maximum: 3
   * @return mobileNetworkCode Identifies the mobile phone operator inside a country. If data available.
   */
   ...
   *
   * @param geolocation Geographic location specified by geographic or UTM coordinates. If data available.
   * @return the current {@code MobileData} instance, allowing for method chaining
   */
  ...
  /**
   * Geographic location specified by geographic or UTM coordinates. If data available.
   * @return geolocation Geographic location specified by geographic or UTM coordinates. If data available.
   */
   ...
   *
   * @param protectedMobileData Sensitive information related to the mobile phone, protected by CMS. SensitiveMobileData.
   * @return the current {@code MobileData} instance, allowing for method chaining
   */
  ...
  /**
   * Sensitive information related to the mobile phone, protected by CMS. SensitiveMobileData.
   * @return protectedMobileData Sensitive information related to the mobile phone, protected by CMS. SensitiveMobileData.
   */
   ...
   *
   * @param sensitiveMobileData Sensitive information related to the mobile phone. If unprotected mobile data.
   * @return the current {@code MobileData} instance, allowing for method chaining
   */
  ...
  /**
   * Sensitive information related to the mobile phone. If unprotected mobile data.
   * @return sensitiveMobileData Sensitive information related to the mobile phone. If unprotected mobile data.
   */
