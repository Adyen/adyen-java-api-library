...
public class LoyaltyData {
   ...
   *
   * @param cardAcquisitionReference Reference to the last CardAcquisition, to use the same card. If the loyalty account ID comes from a previous CardAcquisition.
  ...
  /**
   * Reference to the last CardAcquisition, to use the same card. If the loyalty account ID comes from a previous CardAcquisition.
   * @return cardAcquisitionReference Reference to the last CardAcquisition, to use the same card. If the loyalty account ID comes from a previous CardAcquisition.
   */
   ...
   *
   * @param loyaltyAccountID Identification of a Loyalty account. If loyalty identification of the loyalty account is realised by the Sale System.
   * @return the current {@code LoyaltyData} instance, allowing for method chaining
   */
  ...
  /**
   * Identification of a Loyalty account. If loyalty identification of the loyalty account is realised by the Sale System.
   * @return loyaltyAccountID Identification of a Loyalty account. If loyalty identification of the loyalty account is realised by the Sale System.
   */
