...
import com.adyen.model.terminalmodels.OutputResult;
...
public class DisplayResponse {
   ...
   *
   * @param outputResult Information related to the result the output (display, print, input). One per DisplayOutput item of the request, and in the same order.
  ...
  /**
   * Information related to the result the output (display, print, input). One per DisplayOutput item of the request, and in the same order.
   * @return outputResult Information related to the result the output (display, print, input). One per DisplayOutput item of the request, and in the same order.
   */
