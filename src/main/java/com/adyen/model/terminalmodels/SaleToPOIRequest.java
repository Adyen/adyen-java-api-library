...
import com.adyen.model.terminalmodels.AbortRequest;
import com.adyen.model.terminalmodels.AdminRequest;
import com.adyen.model.terminalmodels.BalanceInquiryRequest;
import com.adyen.model.terminalmodels.CardAcquisitionRequest;
import com.adyen.model.terminalmodels.CardReaderAPDURequest;
import com.adyen.model.terminalmodels.DiagnosisRequest;
import com.adyen.model.terminalmodels.DisplayRequest;
import com.adyen.model.terminalmodels.EnableServiceRequest;
import com.adyen.model.terminalmodels.EventNotification;
import com.adyen.model.terminalmodels.GetTotalsRequest;
import com.adyen.model.terminalmodels.InputRequest;
import com.adyen.model.terminalmodels.InputUpdate;
import com.adyen.model.terminalmodels.LoginRequest;
import com.adyen.model.terminalmodels.LogoutRequest;
import com.adyen.model.terminalmodels.MessageHeader;
import com.adyen.model.terminalmodels.PaymentRequest;
import com.adyen.model.terminalmodels.PrintRequest;
import com.adyen.model.terminalmodels.ReconciliationRequest;
import com.adyen.model.terminalmodels.ReversalRequest;
import com.adyen.model.terminalmodels.StoredValueRequest;
import com.adyen.model.terminalmodels.TransactionStatusRequest;
...
/**
 * The SaleToPOIRequest message pair is a container for the request message content. It contains a MessageHeader and a message body. The message body is one of the following: AbortRequest, BalanceInquiryRequest, BatchRequest, CardAcquisitionRequest, AdminRequest, DiagnosisRequest, DisplayRequest, EnableServiceRequest, EventNotification, GetTotalsRequest, InputRequest, InputUpdate, LoginRequest, LogoutRequest, LoyaltyRequest, PaymentRequest, PINRequest, PrintRequest, CardReaderInitRequest, CardReaderAPDURequest, CardReaderPowerOffRequest, ReconciliationRequest, ReversalRequest, SoundRequest, StoredValueRequest, TransactionStatusRequest, or TransmitRequest.
 */
@JsonPropertyOrder({
...
public class SaleToPOIRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(messageHeader, abortRequest, balanceInquiryRequest, cardAcquisitionRequest, adminRequest, diagnosisRequest, displayRequest, enableServiceRequest, eventNotification, getTotalsRequest, inputRequest, inputUpdate, loginRequest, logoutRequest, paymentRequest, printRequest, cardReaderAPDURequest, reconciliationRequest, reversalRequest, storedValueRequest, transactionStatusRequest);
  }
