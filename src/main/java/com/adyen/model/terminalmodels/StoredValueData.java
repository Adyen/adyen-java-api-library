...
public class StoredValueData {
   ...
   *
   * @param storedValueTransactionType Identification of operation to proceed on the stored value account or the stored value card. Possible values: * **Activate** * **Duplicate** * **Load** * **Reserve** * **Reverse** * **Unload**
   * @return the current {@code StoredValueData} instance, allowing for method chaining
   */
  ...
  /**
   * Identification of operation to proceed on the stored value account or the stored value card. Possible values: * **Activate** * **Duplicate** * **Load** * **Reserve** * **Reverse** * **Unload**
   * @return storedValueTransactionType Identification of operation to proceed on the stored value account or the stored value card. Possible values: * **Activate** * **Duplicate** * **Load** * **Reserve** * **Reverse** * **Unload**
   */
   ...
   *
   * @param storedValueAccountID Identification of the stored value account or the stored value card. If the identification of the Stored Value account or card has been made by the Sale System before the request.
   * @return the current {@code StoredValueData} instance, allowing for method chaining
   */
  ...
  /**
   * Identification of the stored value account or the stored value card. If the identification of the Stored Value account or card has been made by the Sale System before the request.
   * @return storedValueAccountID Identification of the stored value account or the stored value card. If the identification of the Stored Value account or card has been made by the Sale System before the request.
   */
   ...
   *
   * @param originalPOITransaction Identification of a previous POI transaction. If StoredValueTransactionType is Reverse or Duplicate.
   * @return the current {@code StoredValueData} instance, allowing for method chaining
   */
  ...
  /**
   * Identification of a previous POI transaction. If StoredValueTransactionType is Reverse or Duplicate.
   * @return originalPOITransaction Identification of a previous POI transaction. If StoredValueTransactionType is Reverse or Duplicate.
   */
