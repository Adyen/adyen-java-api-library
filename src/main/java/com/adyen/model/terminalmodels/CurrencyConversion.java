...
import com.adyen.model.terminalmodels.ConvertedAmount;
...
public class CurrencyConversion {
   ...
   *
   * @param customerApprovedFlag Notify if the customer has approved something. Indicates if the customer has accepted a currency conversion.
  ...
  /**
   * Notify if the customer has approved something. Indicates if the customer has accepted a currency conversion.
   * @return customerApprovedFlag Notify if the customer has approved something. Indicates if the customer has accepted a currency conversion.
   */
   ...
   *
   * @param declaration Declaration to present to the customer or the cashier for validation. If a declaration has to be presented to the customer.
   * @return the current {@code CurrencyConversion} instance, allowing for method chaining
   */
  ...
  /**
   * Declaration to present to the customer or the cashier for validation. If a declaration has to be presented to the customer.
   * @return declaration Declaration to present to the customer or the cashier for validation. If a declaration has to be presented to the customer.
   */
