...
import com.adyen.model.terminalmodels.GlobalStatus;
import com.adyen.model.terminalmodels.PrinterStatus;
...
public class POIStatus {
   ...
   *
   * @param globalStatus Global status of a POI Server or POI Terminal. Possible values: * **Busy** * **Maintenance** * **OK** * **Unreachable**
  ...
  /**
   * Global status of a POI Server or POI Terminal. Possible values: * **Busy** * **Maintenance** * **OK** * **Unreachable**
   * @return globalStatus Global status of a POI Server or POI Terminal. Possible values: * **Busy** * **Maintenance** * **OK** * **Unreachable**
   */
   ...
   *
   * @param printerStatus Possible values: * **NoPaper** * **OK** * **OutOfOrder** * **PaperJam** * **PaperLow**
   * @return the current {@code POIStatus} instance, allowing for method chaining
   */
  ...
  /**
   * Possible values: * **NoPaper** * **OK** * **OutOfOrder** * **PaperJam** * **PaperLow**
   * @return printerStatus Possible values: * **NoPaper** * **OK** * **OutOfOrder** * **PaperJam** * **PaperLow**
   */
