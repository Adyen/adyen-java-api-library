...
import com.adyen.model.terminalmodels.SaleToIssuerData;
...
public class SaleData {
   ...
   *
   * @param saleTerminalData Information related to the software and hardware features of the Sale Terminal. If content is not empty.
   * @return the current {@code SaleData} instance, allowing for method chaining
   */
  ...
  /**
   * Information related to the software and hardware features of the Sale Terminal. If content is not empty.
   * @return saleTerminalData Information related to the software and hardware features of the Sale Terminal. If content is not empty.
   */
   ...
   *
   * @param saleToIssuerData Sale information intended for the Issuer. Send to the Acquirer if present.
   * @return the current {@code SaleData} instance, allowing for method chaining
   */
  ...
  /**
   * Sale information intended for the Issuer. Send to the Acquirer if present.
   * @return saleToIssuerData Sale information intended for the Issuer. Send to the Acquirer if present.
   */
