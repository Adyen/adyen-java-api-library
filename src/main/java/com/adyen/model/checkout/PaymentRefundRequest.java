...
public class PaymentRefundRequest {
   ...
   *
   * @param capturePspReference This is only available for PayPal refunds. The [&#x60;pspReference&#x60;](https://docs.adyen.com/api-explorer/#/CheckoutService/latest/post/payments__resParam_pspReference) of the specific capture to refund.
   * @return the current {@code PaymentRefundRequest} instance, allowing for method chaining
   */
  ...
  /**
   * This is only available for PayPal refunds. The [&#x60;pspReference&#x60;](https://docs.adyen.com/api-explorer/#/CheckoutService/latest/post/payments__resParam_pspReference) of the specific capture to refund.
   * @return capturePspReference This is only available for PayPal refunds. The [&#x60;pspReference&#x60;](https://docs.adyen.com/api-explorer/#/CheckoutService/latest/post/payments__resParam_pspReference) of the specific capture to refund.
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amount, applicationInfo, capturePspReference, enhancedSchemeData, lineItems, merchantAccount, merchantRefundReason, reference, splits, store);
  }
