...
public class PayPayDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PayPayDetails
   */
  public static PayPayDetails fromJson(String jsonString) throws JacksonException {
