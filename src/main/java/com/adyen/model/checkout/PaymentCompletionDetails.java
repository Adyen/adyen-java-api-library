...
public class PaymentCompletionDetails {
   ...
   *
   * @param oneTimePasscode A random number sent to the mobile phone number of the shopper to verify
   *     the payment.
   * @return the current {@code PaymentCompletionDetails} instance, allowing for method chaining
   */
   ...
   * A random number sent to the mobile phone number of the shopper to verify the payment.
   *
   * @return oneTimePasscode A random number sent to the mobile phone number of the shopper to
   *     verify the payment.
   */
   ...
   * Possible values: any value starting with &#x60;requestPayment:&#x60;.
   *
   * @param paymentStatus Value passed from the WeChat MiniProgram &#x60;wx.requestPayment&#x60;
   *     **complete** callback. Possible values: any value starting with
   *     &#x60;requestPayment:&#x60;.
   * @return the current {@code PaymentCompletionDetails} instance, allowing for method chaining
   */
   ...
   * Possible values: any value starting with &#x60;requestPayment:&#x60;.
   *
   * @return paymentStatus Value passed from the WeChat MiniProgram &#x60;wx.requestPayment&#x60;
   *     **complete** callback. Possible values: any value starting with
   *     &#x60;requestPayment:&#x60;.
   */
   ...
   *
   * @param returnUrlQueryString The query string as appended to the &#x60;returnURL&#x60; when
   *     using direct issuer links .
   * @return the current {@code PaymentCompletionDetails} instance, allowing for method chaining
   */
   ...
   * The query string as appended to the &#x60;returnURL&#x60; when using direct issuer links .
   *
   * @return returnUrlQueryString The query string as appended to the &#x60;returnURL&#x60; when
   *     using direct issuer links .
   */
  ...
  /**
   * Base64-encoded string returned by the Component after the challenge flow. It contains the
   * following parameters: &#x60;transStatus&#x60;, &#x60;authorisationToken&#x60;.
   *
   * @param threeDSResult Base64-encoded string returned by the Component after the challenge flow.
   *     It contains the following parameters: &#x60;transStatus&#x60;,
   *     &#x60;authorisationToken&#x60;.
   * @return the current {@code PaymentCompletionDetails} instance, allowing for method chaining
   */
   ...
   * following parameters: &#x60;transStatus&#x60;, &#x60;authorisationToken&#x60;.
   *
   * @return threeDSResult Base64-encoded string returned by the Component after the challenge flow.
   *     It contains the following parameters: &#x60;transStatus&#x60;,
   *     &#x60;authorisationToken&#x60;.
   */
  ...
  /**
   * Base64-encoded string returned by the Component after the challenge flow. It contains the
   * following parameter: &#x60;transStatus&#x60;.
   *
   * @param threeds2ChallengeResult Base64-encoded string returned by the Component after the
   ...
   * following parameter: &#x60;transStatus&#x60;.
   *
   * @return threeds2ChallengeResult Base64-encoded string returned by the Component after the
   *     challenge flow. It contains the following parameter: &#x60;transStatus&#x60;.
   */
  ...
  /**
   * Base64-encoded string returned by the Component after the challenge flow. It contains the
   * following parameter: &#x60;threeDSCompInd&#x60;.
   *
   * @param threeds2Fingerprint Base64-encoded string returned by the Component after the challenge
   *     flow. It contains the following parameter: &#x60;threeDSCompInd&#x60;.
   * @return the current {@code PaymentCompletionDetails} instance, allowing for method chaining
   */
   ...
   * following parameter: &#x60;threeDSCompInd&#x60;.
   *
   * @return threeds2Fingerprint Base64-encoded string returned by the Component after the challenge
   *     flow. It contains the following parameter: &#x60;threeDSCompInd&#x60;.
   */
  ...
  public String toString() {
    ...
    sb.append("    cupsecureplusSmscode: ")
        ...
        .append("\n");
    sb.append("    facilitatorAccessToken: ")
        .append(toIndentedString(facilitatorAccessToken))
        .append("\n");
    ...
    sb.append("    returnUrlQueryString: ")
        .append(toIndentedString(returnUrlQueryString))
        .append("\n");
    sb.append("    threeDSResult: ").append(toIndentedString(threeDSResult)).append("\n");
    sb.append("    threeds2ChallengeResult: ")
        .append(toIndentedString(threeds2ChallengeResult))
        .append("\n");
    sb.append("    threeds2Fingerprint: ")
        .append(toIndentedString(threeds2Fingerprint))
        .append("\n");
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PaymentCompletionDetails
   */
  public static PaymentCompletionDetails fromJson(String jsonString) throws JacksonException {
