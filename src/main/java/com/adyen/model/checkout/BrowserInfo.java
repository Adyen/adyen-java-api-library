...
public class BrowserInfo {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to BrowserInfo
   */
  public static BrowserInfo fromJson(String jsonString) throws JacksonException {
