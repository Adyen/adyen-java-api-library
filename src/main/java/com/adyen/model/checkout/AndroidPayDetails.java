...
public class AndroidPayDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to AndroidPayDetails
   */
  public static AndroidPayDetails fromJson(String jsonString) throws JacksonException {
