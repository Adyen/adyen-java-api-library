...
public class PaymentLinkResponse {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PaymentLinkResponse
   */
  public static PaymentLinkResponse fromJson(String jsonString) throws JacksonException {
