...
public class PaymentCaptureResponse {
   ...
   *
   * @param paymentPspReference The [&#x60;pspReference&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments#responses-200-pspReference) of the payment to capture. 
   * @return the current {@code PaymentCaptureResponse} instance, allowing for method chaining
   */
  ...
  /**
   * The [&#x60;pspReference&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments#responses-200-pspReference) of the payment to capture. 
   * @return paymentPspReference The [&#x60;pspReference&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments#responses-200-pspReference) of the payment to capture. 
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, paymentCaptureResponse.amount) &&
        ...
        Objects.equals(this.isSetPaymentPspReference, paymentCaptureResponse.isSetPaymentPspReference) &&
        Objects.equals(this.platformChargebackLogic, paymentCaptureResponse.platformChargebackLogic) &&
        Objects.equals(this.isSetPlatformChargebackLogic, paymentCaptureResponse.isSetPlatformChargebackLogic) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amount, isSetAmount, lineItems, isSetLineItems, merchantAccount, isSetMerchantAccount, paymentPspReference, isSetPaymentPspReference, platformChargebackLogic, isSetPlatformChargebackLogic, pspReference, isSetPspReference, reference, isSetReference, splits, isSetSplits, status, isSetStatus, subMerchants, isSetSubMerchants);
  }
