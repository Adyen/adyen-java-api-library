...
public class TwintDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to TwintDetails
   */
  public static TwintDetails fromJson(String jsonString) throws JacksonException {
