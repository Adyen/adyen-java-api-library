            ...
            return (TypeAdapter<T>) new TypeAdapter<PaymentResponseAction>() {
                ...
                public PaymentResponseAction read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        CheckoutAwaitAction.validateJsonObject(jsonObject, true);
                    ...
                    try {
                        // validate the JSON object to see if any exception is thrown
                        CheckoutNativeRedirectAction.validateJsonObject(jsonObject, true);
                    ...
                    try {
                        // validate the JSON object to see if any exception is thrown
                        CheckoutQrCodeAction.validateJsonObject(jsonObject, true);
                    ...
                    try {
                        // validate the JSON object to see if any exception is thrown
                        CheckoutRedirectAction.validateJsonObject(jsonObject, true);
                    ...
                    try {
                        // validate the JSON object to see if any exception is thrown
                        CheckoutSDKAction.validateJsonObject(jsonObject, true);
                    ...
                    try {
                        // validate the JSON object to see if any exception is thrown
                        CheckoutThreeDS2Action.validateJsonObject(jsonObject, true);
                    ...
                    try {
                        // validate the JSON object to see if any exception is thrown
                        CheckoutVoucherAction.validateJsonObject(jsonObject, true);
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    try {
      ...
      CheckoutAwaitAction.validateJsonObject(jsonObj, true);
      validCount++;
    } catch (Exception e) {
      errorMessages.add(String.format("Deserialization for CheckoutAwaitAction failed with `%s`.", e.getMessage()));
    ...
    try {
      ...
      CheckoutNativeRedirectAction.validateJsonObject(jsonObj, true);
      validCount++;
    } catch (Exception e) {
      errorMessages.add(String.format("Deserialization for CheckoutNativeRedirectAction failed with `%s`.", e.getMessage()));
      // continue to the next one
    ...
    try {
      ...
      CheckoutQrCodeAction.validateJsonObject(jsonObj, true);
      validCount++;
    } catch (Exception e) {
      errorMessages.add(String.format("Deserialization for CheckoutQrCodeAction failed with `%s`.", e.getMessage()));
      // continue to the next one
    ...
    try {
      ...
      CheckoutRedirectAction.validateJsonObject(jsonObj, true);
      validCount++;
    } catch (Exception e) {
      errorMessages.add(String.format("Deserialization for CheckoutRedirectAction failed with `%s`.", e.getMessage()));
      // continue to the next one
    ...
    try {
      ...
      CheckoutSDKAction.validateJsonObject(jsonObj, true);
      validCount++;
    } catch (Exception e) {
      errorMessages.add(String.format("Deserialization for CheckoutSDKAction failed with `%s`.", e.getMessage()));
      // continue to the next one
    ...
    try {
      ...
      CheckoutThreeDS2Action.validateJsonObject(jsonObj, true);
      validCount++;
    } catch (Exception e) {
      errorMessages.add(String.format("Deserialization for CheckoutThreeDS2Action failed with `%s`.", e.getMessage()));
      // continue to the next one
    ...
    try {
      ...
      CheckoutVoucherAction.validateJsonObject(jsonObj, true);
      validCount++;
    } catch (Exception e) {
      errorMessages.add(String.format("Deserialization for CheckoutVoucherAction failed with `%s`.", e.getMessage()));
      // continue to the next one
