...
public class AlmaDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to AlmaDetails
   */
  public static AlmaDetails fromJson(String jsonString) throws JacksonException {
