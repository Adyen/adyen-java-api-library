...
public class CheckoutOrderResponse {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to CheckoutOrderResponse
   */
  public static CheckoutOrderResponse fromJson(String jsonString) throws JacksonException {
