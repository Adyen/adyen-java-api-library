...
public class CheckoutForwardResponse {
   ...
   *
   * @param response The details of the response Adyen received from the third party.
   * @return the current {@code CheckoutForwardResponse} instance, allowing for method chaining
   */
   ...
   * The details of the response Adyen received from the third party.
   *
   * @return response The details of the response Adyen received from the third party.
   */
