...
public class CheckoutForwardResponse {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to CheckoutForwardResponse
   */
  public static CheckoutForwardResponse fromJson(String jsonString) throws JacksonException {
