...
public class CreatePaymentCancelRequest {
  ...
  **/
  ...
  public String toString() {
      String sb = "class CreatePaymentCancelRequest {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CreatePaymentCancelRequest.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePaymentCancelRequest is not found in the empty JSON string", CreatePaymentCancelRequest.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreatePaymentCancelRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePaymentCancelRequest` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
