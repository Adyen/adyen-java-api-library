...
/** AuPayDetails */
@JsonPropertyOrder({
  AuPayDetails.JSON_PROPERTY_CHECKOUT_ATTEMPT_ID,
  AuPayDetails.JSON_PROPERTY_RECURRING_DETAIL_REFERENCE,
  AuPayDetails.JSON_PROPERTY_SDK_DATA,
  AuPayDetails.JSON_PROPERTY_STORED_PAYMENT_METHOD_ID,
  AuPayDetails.JSON_PROPERTY_TYPE
})
public class AuPayDetails {
   ...
   * @return the current {@code AuPayDetails} instance, allowing for method chaining
   */
  public AuPayDetails checkoutAttemptId(String checkoutAttemptId) {
   ...
   */
  @Deprecated
  public AuPayDetails recurringDetailReference(String recurringDetailReference) {
   ...
   * @return the current {@code AuPayDetails} instance, allowing for method chaining
   */
  public AuPayDetails sdkData(String sdkData) {
   ...
   * @return the current {@code AuPayDetails} instance, allowing for method chaining
   */
  public AuPayDetails storedPaymentMethodId(String storedPaymentMethodId) {
   ...
   * @return the current {@code AuPayDetails} instance, allowing for method chaining
   */
  public AuPayDetails type(TypeEnum type) {
    this.type = type;
   ...
   */
  public AuPayDetails includeNullValues(boolean includeNullValues) {
  ...
  /** Return true if this AuPayDetails object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    AuPayDetails auPayDetails = (AuPayDetails) o;
    return Objects.equals(this.checkoutAttemptId, auPayDetails.checkoutAttemptId)
        && Objects.equals(this.isSetCheckoutAttemptId, auPayDetails.isSetCheckoutAttemptId)
        && Objects.equals(this.recurringDetailReference, auPayDetails.recurringDetailReference)
        && Objects.equals(
            this.isSetRecurringDetailReference, auPayDetails.isSetRecurringDetailReference)
        && Objects.equals(this.sdkData, auPayDetails.sdkData)
        && Objects.equals(this.isSetSdkData, auPayDetails.isSetSdkData)
        && Objects.equals(this.storedPaymentMethodId, auPayDetails.storedPaymentMethodId)
        && Objects.equals(this.isSetStoredPaymentMethodId, auPayDetails.isSetStoredPaymentMethodId)
        && Objects.equals(this.type, auPayDetails.type)
        && Objects.equals(this.isSetType, auPayDetails.isSetType);
  }
  ...
  /**
   * Create an instance of AuPayDetails given an JSON string
   *
  ...
  /**
   * Convert an instance of AuPayDetails to an JSON string
   *
   * @return JSON string
   */
