...
public class CheckoutQrCodeAction {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to CheckoutQrCodeAction
   */
  public static CheckoutQrCodeAction fromJson(String jsonString) throws JacksonException {
