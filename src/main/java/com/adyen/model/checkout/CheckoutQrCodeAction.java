...
public class CheckoutQrCodeAction {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class CheckoutQrCodeAction {\n" +
            ...
            "    qrCodeData: " + toIndentedString(qrCodeData) + "\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CheckoutQrCodeAction.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in CheckoutQrCodeAction is not found in the empty JSON string", CheckoutQrCodeAction.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CheckoutQrCodeAction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CheckoutQrCodeAction` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
