...
public class PaymentMethodIssuer {
  ...
  **/
  ...
  public String toString() {
      String sb = "class PaymentMethodIssuer {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (PaymentMethodIssuer.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentMethodIssuer is not found in the empty JSON string", PaymentMethodIssuer.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PaymentMethodIssuer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentMethodIssuer` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
