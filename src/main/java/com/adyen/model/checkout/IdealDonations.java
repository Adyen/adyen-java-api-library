...
public class IdealDonations {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to IdealDonations
   */
  public static IdealDonations fromJson(String jsonString) throws JacksonException {
