...
public class CheckoutBankAccount {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountType, isSetAccountType, bankAccountNumber, isSetBankAccountNumber, bankCity, isSetBankCity, bankLocationId, isSetBankLocationId, bankName, isSetBankName, bic, isSetBic, countryCode, isSetCountryCode, iban, isSetIban, ownerName, isSetOwnerName, taxId, isSetTaxId);
  }
