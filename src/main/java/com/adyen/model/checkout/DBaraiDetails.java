...
/** DBaraiDetails */
@JsonPropertyOrder({
  DBaraiDetails.JSON_PROPERTY_CHECKOUT_ATTEMPT_ID,
  DBaraiDetails.JSON_PROPERTY_RECURRING_DETAIL_REFERENCE,
  DBaraiDetails.JSON_PROPERTY_SDK_DATA,
  DBaraiDetails.JSON_PROPERTY_STORED_PAYMENT_METHOD_ID,
  DBaraiDetails.JSON_PROPERTY_TYPE
})
public class DBaraiDetails {
   ...
   * @return the current {@code DBaraiDetails} instance, allowing for method chaining
   */
  public DBaraiDetails checkoutAttemptId(String checkoutAttemptId) {
   ...
   */
  @Deprecated
  public DBaraiDetails recurringDetailReference(String recurringDetailReference) {
   ...
   * @return the current {@code DBaraiDetails} instance, allowing for method chaining
   */
  public DBaraiDetails sdkData(String sdkData) {
   ...
   * @return the current {@code DBaraiDetails} instance, allowing for method chaining
   */
  public DBaraiDetails storedPaymentMethodId(String storedPaymentMethodId) {
   ...
   * @return the current {@code DBaraiDetails} instance, allowing for method chaining
   */
  public DBaraiDetails type(TypeEnum type) {
    this.type = type;
   ...
   */
  public DBaraiDetails includeNullValues(boolean includeNullValues) {
  ...
  /** Return true if this DBaraiDetails object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    DBaraiDetails dbaraiDetails = (DBaraiDetails) o;
    return Objects.equals(this.checkoutAttemptId, dbaraiDetails.checkoutAttemptId)
        && Objects.equals(this.isSetCheckoutAttemptId, dbaraiDetails.isSetCheckoutAttemptId)
        && Objects.equals(this.recurringDetailReference, dbaraiDetails.recurringDetailReference)
        && Objects.equals(
            this.isSetRecurringDetailReference, dbaraiDetails.isSetRecurringDetailReference)
        && Objects.equals(this.sdkData, dbaraiDetails.sdkData)
        && Objects.equals(this.isSetSdkData, dbaraiDetails.isSetSdkData)
        && Objects.equals(this.storedPaymentMethodId, dbaraiDetails.storedPaymentMethodId)
        && Objects.equals(this.isSetStoredPaymentMethodId, dbaraiDetails.isSetStoredPaymentMethodId)
        && Objects.equals(this.type, dbaraiDetails.type)
        && Objects.equals(this.isSetType, dbaraiDetails.isSetType);
  }
  ...
  /**
   * Create an instance of DBaraiDetails given an JSON string
   *
  ...
  /**
   * Convert an instance of DBaraiDetails to an JSON string
   *
   * @return JSON string
   */
