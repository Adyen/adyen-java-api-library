...
public class CheckoutVoucherAction {
   ...
   *
   * @param collectionInstitutionNumber A collection institution number (store number) for Econtext
   *     Pay-Easy ATM.
   * @return the current {@code CheckoutVoucherAction} instance, allowing for method chaining
   */
   ...
   * A collection institution number (store number) for Econtext Pay-Easy ATM.
   *
   * @return collectionInstitutionNumber A collection institution number (store number) for Econtext
   *     Pay-Easy ATM.
   */
   ...
   * The initial amount.
   *
   * @return initialAmount The initial amount.
   */
  ...
  /**
   * A Base64-encoded token containing all properties of the voucher. For iOS, you can use this to
   * pass a voucher to Apple Wallet.
   *
   * @param passCreationToken A Base64-encoded token containing all properties of the voucher. For
   *     iOS, you can use this to pass a voucher to Apple Wallet.
   * @return the current {@code CheckoutVoucherAction} instance, allowing for method chaining
   */
   ...
   * pass a voucher to Apple Wallet.
   *
   * @return passCreationToken A Base64-encoded token containing all properties of the voucher. For
   *     iOS, you can use this to pass a voucher to Apple Wallet.
   */
   ...
   * The surcharge amount.
   *
   * @return surcharge The surcharge amount.
   */
   ...
   *
   * @param totalAmount The total amount (initial plus surcharge amount).
   * @return the current {@code CheckoutVoucherAction} instance, allowing for method chaining
   */
   ...
   * The total amount (initial plus surcharge amount).
   *
   * @return totalAmount The total amount (initial plus surcharge amount).
   */
  ...
  public String toString() {
    ...
    sb.append("    alternativeReference: ")
        .append(toIndentedString(alternativeReference))
        .append("\n");
    sb.append("    collectionInstitutionNumber: ")
        .append(toIndentedString(collectionInstitutionNumber))
        .append("\n");
    ...
    sb.append("    maskedTelephoneNumber: ")
        .append(toIndentedString(maskedTelephoneNumber))
        .append("\n");
