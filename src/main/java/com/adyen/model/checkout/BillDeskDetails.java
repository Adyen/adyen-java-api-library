...
public class BillDeskDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to BillDeskDetails
   */
  public static BillDeskDetails fromJson(String jsonString) throws JacksonException {
