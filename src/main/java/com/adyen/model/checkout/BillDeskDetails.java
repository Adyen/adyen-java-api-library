...
public class BillDeskDetails {
  ...
  **/
  ...
  @Override
  public String toString() {
      String sb = "class BillDeskDetails {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (BillDeskDetails.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in BillDeskDetails is not found in the empty JSON string", BillDeskDetails.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!BillDeskDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BillDeskDetails` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
