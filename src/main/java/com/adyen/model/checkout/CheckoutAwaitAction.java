...
public class CheckoutAwaitAction {
  ...
  **/
  ...
  @Override
  public String toString() {
      String sb = "class CheckoutAwaitAction {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CheckoutAwaitAction.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in CheckoutAwaitAction is not found in the empty JSON string", CheckoutAwaitAction.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CheckoutAwaitAction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CheckoutAwaitAction` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
