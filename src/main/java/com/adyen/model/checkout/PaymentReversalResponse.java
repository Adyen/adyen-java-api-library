...
public class PaymentReversalResponse {
   ...
   *
   * @param paymentPspReference The [&#x60;pspReference&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments#responses-200-pspReference) of the payment to reverse. 
   * @return the current {@code PaymentReversalResponse} instance, allowing for method chaining
   */
  ...
  /**
   * The [&#x60;pspReference&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments#responses-200-pspReference) of the payment to reverse. 
   * @return paymentPspReference The [&#x60;pspReference&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments#responses-200-pspReference) of the payment to reverse. 
   */
   ...
   *
   * @param pspReference Adyen&#39;s 16-character reference associated with the reversal request.
   * @return the current {@code PaymentReversalResponse} instance, allowing for method chaining
   */
  ...
  /**
   * Adyen&#39;s 16-character reference associated with the reversal request.
   * @return pspReference Adyen&#39;s 16-character reference associated with the reversal request.
   */
   ...
   *
   * @param reference Your reference for the reversal request.
   * @return the current {@code PaymentReversalResponse} instance, allowing for method chaining
   */
  ...
  /**
   * Your reference for the reversal request.
   * @return reference Your reference for the reversal request.
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.merchantAccount, paymentReversalResponse.merchantAccount) &&
        Objects.equals(this.isSetMerchantAccount, paymentReversalResponse.isSetMerchantAccount) &&
        Objects.equals(this.paymentPspReference, paymentReversalResponse.paymentPspReference) &&
        Objects.equals(this.isSetPaymentPspReference, paymentReversalResponse.isSetPaymentPspReference) &&
        Objects.equals(this.pspReference, paymentReversalResponse.pspReference) &&
        Objects.equals(this.isSetPspReference, paymentReversalResponse.isSetPspReference) &&
        Objects.equals(this.reference, paymentReversalResponse.reference) &&
        Objects.equals(this.isSetReference, paymentReversalResponse.isSetReference) &&
        Objects.equals(this.status, paymentReversalResponse.status) &&
        Objects.equals(this.isSetStatus, paymentReversalResponse.isSetStatus)
    ;
  }

  @Override
  public int hashCode() {
    return Objects.hash(merchantAccount, isSetMerchantAccount, paymentPspReference, isSetPaymentPspReference, pspReference, isSetPspReference, reference, isSetReference, status, isSetStatus);
  }
