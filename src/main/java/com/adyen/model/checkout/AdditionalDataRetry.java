...
public class AdditionalDataRetry {
  ...
  **/
  ...
  public String toString() {
      String sb = "class AdditionalDataRetry {\n" +
              "    retryChainAttemptNumber: " + toIndentedString(retryChainAttemptNumber) + "\n" +
              "    retryOrderAttemptNumber: " + toIndentedString(retryOrderAttemptNumber) + "\n" +
              "    retrySkipRetry: " + toIndentedString(retrySkipRetry) + "\n" +
              "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (AdditionalDataRetry.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdditionalDataRetry is not found in the empty JSON string", AdditionalDataRetry.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AdditionalDataRetry.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdditionalDataRetry` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
