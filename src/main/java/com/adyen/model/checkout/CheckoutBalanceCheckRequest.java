...
public class CheckoutBalanceCheckRequest {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class CheckoutBalanceCheckRequest {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CheckoutBalanceCheckRequest.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in CheckoutBalanceCheckRequest is not found in the empty JSON string", CheckoutBalanceCheckRequest.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CheckoutBalanceCheckRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CheckoutBalanceCheckRequest` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
