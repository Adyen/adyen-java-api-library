...
public class FundOrigin {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to FundOrigin
   */
  public static FundOrigin fromJson(String jsonString) throws JacksonException {
