...
public class EnhancedSchemeData {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to EnhancedSchemeData
   */
  public static EnhancedSchemeData fromJson(String jsonString) throws JacksonException {
