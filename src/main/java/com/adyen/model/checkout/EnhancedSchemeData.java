...
public class EnhancedSchemeData {
   ...
   * data](https://docs.adyen.com/payment-methods/cards/enhanced-scheme-data/airline/) that may be
   * required for processing the transaction and/or for interchange savings.
   *
   * @param airline [Airline enhanced scheme
   *     data](https://docs.adyen.com/payment-methods/cards/enhanced-scheme-data/airline/) that may
   *     be required for processing the transaction and/or for interchange savings.
   ...
   * required for processing the transaction and/or for interchange savings.
   *
   * @return airline [Airline enhanced scheme
   *     data](https://docs.adyen.com/payment-methods/cards/enhanced-scheme-data/airline/) that may
   *     be required for processing the transaction and/or for interchange savings.
   */
   ...
   * data](https://docs.adyen.com/payment-methods/cards/enhanced-scheme-data/l2-l3/) that may be
   * required for processing the transaction and/or for interchange savings.
   *
   * @param levelTwoThree [Level 2 and Level 3 enhanced scheme
   *     data](https://docs.adyen.com/payment-methods/cards/enhanced-scheme-data/l2-l3/) that may be
   *     required for processing the transaction and/or for interchange savings.
   * @return the current {@code EnhancedSchemeData} instance, allowing for method chaining
   */
   ...
   * required for processing the transaction and/or for interchange savings.
   *
   * @return levelTwoThree [Level 2 and Level 3 enhanced scheme
   *     data](https://docs.adyen.com/payment-methods/cards/enhanced-scheme-data/l2-l3/) that may be
   *     required for processing the transaction and/or for interchange savings.
   */
