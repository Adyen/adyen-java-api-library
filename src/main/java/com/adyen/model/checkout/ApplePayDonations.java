...
public class ApplePayDonations {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to ApplePayDonations
   */
  public static ApplePayDonations fromJson(String jsonString) throws JacksonException {
