...
public class FastlaneDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to FastlaneDetails
   */
  public static FastlaneDetails fromJson(String jsonString) throws JacksonException {
