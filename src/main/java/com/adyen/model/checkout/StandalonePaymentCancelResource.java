...
public class StandalonePaymentCancelResource {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class StandalonePaymentCancelResource {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (StandalonePaymentCancelResource.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in StandalonePaymentCancelResource is not found in the empty JSON string", StandalonePaymentCancelResource.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!StandalonePaymentCancelResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StandalonePaymentCancelResource` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
