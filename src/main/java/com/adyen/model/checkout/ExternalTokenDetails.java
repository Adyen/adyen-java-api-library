...
public class ExternalTokenDetails {
  ...
  /**
   * The external service from which to fetch the token. Supported only for specific companies.
   * Contact Adyen if you want to use this feature.
   */
   ...
   * Contact Adyen if you want to use this feature.
   *
   * @param subtype The external service from which to fetch the token. Supported only for specific
   ...
   * Contact Adyen if you want to use this feature.
   *
   * @return subtype The external service from which to fetch the token. Supported only for specific
   *     companies. Contact Adyen if you want to use this feature.
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.checkoutAttemptId, externalTokenDetails.checkoutAttemptId)
        ...
        && Objects.equals(
            this.isSetStoredPaymentMethodId, externalTokenDetails.isSetStoredPaymentMethodId)
   ...
   * @throws JacksonException if the JSON string is invalid with respect to ExternalTokenDetails
   */
  public static ExternalTokenDetails fromJson(String jsonString) throws JacksonException {
