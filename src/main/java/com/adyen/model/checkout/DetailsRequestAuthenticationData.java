...
public class DetailsRequestAuthenticationData {
  ...
  **/
  ...
  public String toString() {
      String sb = "class DetailsRequestAuthenticationData {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (DetailsRequestAuthenticationData.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetailsRequestAuthenticationData is not found in the empty JSON string", DetailsRequestAuthenticationData.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DetailsRequestAuthenticationData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetailsRequestAuthenticationData` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
  }
