...
public class DirectDebitAuDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to DirectDebitAuDetails
   */
  public static DirectDebitAuDetails fromJson(String jsonString) throws JacksonException {
