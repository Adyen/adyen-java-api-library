...
public class ShopperName {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to ShopperName
   */
  public static ShopperName fromJson(String jsonString) throws JacksonException {
