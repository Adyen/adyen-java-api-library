...
public class DonationCampaignsRequest {
   ...
   * @return the current {@code DonationCampaignsRequest} instance, allowing for method chaining
   */
  public DonationCampaignsRequest store(String store) {
    this.store = store;
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.currency, donationCampaignsRequest.currency)
        ...
        && Objects.equals(this.store, donationCampaignsRequest.store)
        && Objects.equals(this.isSetStore, donationCampaignsRequest.isSetStore);
  }
   ...
   * @throws JacksonException if the JSON string is invalid with respect to DonationCampaignsRequest
   */
  public static DonationCampaignsRequest fromJson(String jsonString) throws JacksonException {
