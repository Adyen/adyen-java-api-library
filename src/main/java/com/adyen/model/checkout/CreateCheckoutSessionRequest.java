...
public class CreateCheckoutSessionRequest {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class CreateCheckoutSessionRequest {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CreateCheckoutSessionRequest.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateCheckoutSessionRequest is not found in the empty JSON string", CreateCheckoutSessionRequest.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateCheckoutSessionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateCheckoutSessionRequest` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
