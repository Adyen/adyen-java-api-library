...
public class Leg {
   ...
   *
   * @param fareBasisCode The [fare basis code](https://en.wikipedia.org/wiki/Fare_basis_code), alphanumeric. * minLength: 1 character * maxLength: 15 characters * Must not start with a space or be all spaces. * Must not be all zeros.
   * @return the current {@code Leg} instance, allowing for method chaining
   */
  ...
  /**
   * The [fare basis code](https://en.wikipedia.org/wiki/Fare_basis_code), alphanumeric. * minLength: 1 character * maxLength: 15 characters * Must not start with a space or be all spaces. * Must not be all zeros.
   * @return fareBasisCode The [fare basis code](https://en.wikipedia.org/wiki/Fare_basis_code), alphanumeric. * minLength: 1 character * maxLength: 15 characters * Must not start with a space or be all spaces. * Must not be all zeros.
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(carrierCode, isSetCarrierCode, classOfTravel, isSetClassOfTravel, dateOfTravel, isSetDateOfTravel, departureAirportCode, isSetDepartureAirportCode, departureTax, isSetDepartureTax, destinationAirportCode, isSetDestinationAirportCode, fareBasisCode, isSetFareBasisCode, flightNumber, isSetFlightNumber, stopOverCode, isSetStopOverCode);
  }
