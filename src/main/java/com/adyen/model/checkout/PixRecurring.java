...
public class PixRecurring {
  ...
  /**
   * Flag used to define whether liquidation can happen only on business days
   * @return businessDayOnly Flag used to define whether liquidation can happen only on business days
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(billingDate, businessDayOnly, endsAt, frequency, minAmount, originalPspReference, recurringAmount, recurringStatement, retryPolicy, startsAt);
  }
