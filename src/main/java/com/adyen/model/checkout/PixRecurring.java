...
public class PixRecurring {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PixRecurring
   */
  public static PixRecurring fromJson(String jsonString) throws JacksonException {
