...
public class CardDonations {
   ...
   *
   * @param encryptedPassword This field contains an encrypted, one-time password or an authentication code provided by the cardholder.
   * @return the current {@code CardDonations} instance, allowing for method chaining
   */
  ...
  /**
   * This field contains an encrypted, one-time password or an authentication code provided by the cardholder.
   * @return encryptedPassword This field contains an encrypted, one-time password or an authentication code provided by the cardholder.
   */
   ...
   *
   * @param networkPaymentReference The transaction identifier from card schemes. This is the [&#x60;networkTxReference&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments#responses-200-additionalData-ResponseAdditionalDataCommon-networkTxReference) from the response to the first payment.
   * @return the current {@code CardDonations} instance, allowing for method chaining
   */
  ...
  /**
   * The transaction identifier from card schemes. This is the [&#x60;networkTxReference&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments#responses-200-additionalData-ResponseAdditionalDataCommon-networkTxReference) from the response to the first payment.
   * @return networkPaymentReference The transaction identifier from card schemes. This is the [&#x60;networkTxReference&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments#responses-200-additionalData-ResponseAdditionalDataCommon-networkTxReference) from the response to the first payment.
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.billingSequenceNumber, cardDonations.billingSequenceNumber) &&
        ...
        Objects.equals(this.isSetNetworkPaymentReference, cardDonations.isSetNetworkPaymentReference) &&
        ...
        Objects.equals(this.isSetRecurringDetailReference, cardDonations.isSetRecurringDetailReference) &&
        ...
        Objects.equals(this.isSetShopperNotificationReference, cardDonations.isSetShopperNotificationReference) &&
