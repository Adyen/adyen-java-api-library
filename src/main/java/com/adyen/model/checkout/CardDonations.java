...
public class CardDonations {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to CardDonations
   */
  public static CardDonations fromJson(String jsonString) throws JacksonException {
