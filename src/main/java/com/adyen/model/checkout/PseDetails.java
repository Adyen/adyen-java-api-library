...
public class PseDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PseDetails
   */
  public static PseDetails fromJson(String jsonString) throws JacksonException {
