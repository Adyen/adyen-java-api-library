...
public class CheckoutCreateOrderRequest {
  ...
  **/
  ...
  public String toString() {
      String sb = "class CheckoutCreateOrderRequest {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CheckoutCreateOrderRequest.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in CheckoutCreateOrderRequest is not found in the empty JSON string", CheckoutCreateOrderRequest.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CheckoutCreateOrderRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CheckoutCreateOrderRequest` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
