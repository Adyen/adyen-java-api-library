...
public class ApplePaySessionResponse {
  ...
  **/
  ...
  public String toString() {
      String sb = "class ApplePaySessionResponse {\n" +
  ...
  * @throws IOException if the JSON Object is invalid with respect to ApplePaySessionResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ApplePaySessionResponse.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApplePaySessionResponse is not found in the empty JSON string", ApplePaySessionResponse.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ApplePaySessionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApplePaySessionResponse` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
