...
public class OpenInvoiceDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to OpenInvoiceDetails
   */
  public static OpenInvoiceDetails fromJson(String jsonString) throws JacksonException {
