...
public class PaymentRefundResponse {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PaymentRefundResponse
   */
  public static PaymentRefundResponse fromJson(String jsonString) throws JacksonException {
