...
public class SubInputDetail {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to SubInputDetail
   */
  public static SubInputDetail fromJson(String jsonString) throws JacksonException {
