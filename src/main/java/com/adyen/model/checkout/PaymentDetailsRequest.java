...
public class PaymentDetailsRequest {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PaymentDetailsRequest
   */
  public static PaymentDetailsRequest fromJson(String jsonString) throws JacksonException {
