...
public class PaymentMethodsRequest {
   ...
   * payment methods that are only available on specific platforms. Possible values: * iOS * Android
   * * Web
   */
   ...
   * * Web
   *
   * @param channel The platform where a payment transaction takes place. This field can be used for
   *     filtering out payment methods that are only available on specific platforms. Possible
   ...
   * * Web
   *
   * @return channel The platform where a payment transaction takes place. This field can be used
   *     for filtering out payment methods that are only available on specific platforms. Possible
   *     values: * iOS * Android * Web
   */
