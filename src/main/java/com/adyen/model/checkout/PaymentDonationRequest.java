...
public class PaymentDonationRequest {
  ...
  **/
  ...
  public PaymentDonationRequest putLocalizedShopperStatementItem(String key, String localizedShopperStatementItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountInfo, paymentDonationRequest.accountInfo) &&
        ...
        Objects.equals(this.industryUsage, paymentDonationRequest.industryUsage) &&
        ...
        Objects.equals(this.localizedShopperStatement, paymentDonationRequest.localizedShopperStatement) &&
  ...
  @Override
  public String toString() {
    String sb = "class PaymentDonationRequest {\n" +
            ...
            "    donationOriginalPspReference: " + toIndentedString(donationOriginalPspReference) + "\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (PaymentDonationRequest.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentDonationRequest is not found in the empty JSON string", PaymentDonationRequest.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PaymentDonationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentDonationRequest` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
