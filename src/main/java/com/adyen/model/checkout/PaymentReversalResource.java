...
public class PaymentReversalResource {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class PaymentReversalResource {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (PaymentReversalResource.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentReversalResource is not found in the empty JSON string", PaymentReversalResource.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PaymentReversalResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentReversalResource` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
