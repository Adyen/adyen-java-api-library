...
public class AmazonPayDetails {
   ...
   * Session](https://amazon-pay-acquirer-guide.s3-eu-west-1.amazonaws.com/v1/amazon-pay-api-v2/checkout-session.html#get-checkout-session)
   * response. This token is used for API only integration specifically.
   *
   * @param amazonPayToken This is the &#x60;amazonPayToken&#x60; that you obtained from the [Get
   *     Checkout
   *     Session](https://amazon-pay-acquirer-guide.s3-eu-west-1.amazonaws.com/v1/amazon-pay-api-v2/checkout-session.html#get-checkout-session)
   *     response. This token is used for API only integration specifically.
   ...
   * response. This token is used for API only integration specifically.
   *
   * @return amazonPayToken This is the &#x60;amazonPayToken&#x60; that you obtained from the [Get
   *     Checkout
   *     Session](https://amazon-pay-acquirer-guide.s3-eu-west-1.amazonaws.com/v1/amazon-pay-api-v2/checkout-session.html#get-checkout-session)
   *     response. This token is used for API only integration specifically.
   */
  ...
  /**
   * The &#x60;checkoutSessionId&#x60; is used to identify the checkout session at the Amazon Pay
   * side. This field is required only for drop-in and components integration, where it replaces the
   * amazonPayToken.
   *
   * @param checkoutSessionId The &#x60;checkoutSessionId&#x60; is used to identify the checkout
   *     session at the Amazon Pay side. This field is required only for drop-in and components
   ...
   * amazonPayToken.
   *
   * @return checkoutSessionId The &#x60;checkoutSessionId&#x60; is used to identify the checkout
   *     session at the Amazon Pay side. This field is required only for drop-in and components
   *     integration, where it replaces the amazonPayToken.
   */
   ...
   * @throws JacksonException if the JSON string is invalid with respect to AmazonPayDetails
   */
  public static AmazonPayDetails fromJson(String jsonString) throws JacksonException {
