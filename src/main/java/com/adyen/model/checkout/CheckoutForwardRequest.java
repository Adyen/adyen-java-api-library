...
public class CheckoutForwardRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(baseUrl, isSetBaseUrl, merchantAccount, isSetMerchantAccount, options, isSetOptions, paymentMethod, isSetPaymentMethod, request, isSetRequest, shopperReference, isSetShopperReference, storedPaymentMethodId, isSetStoredPaymentMethodId);
  }
