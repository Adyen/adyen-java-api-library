...
public class CheckoutForwardRequest {
   ...
   *
   * @param amount The amount of the forwarded payment.
   ...
   * The amount of the forwarded payment.
   *
   * @return amount The amount of the forwarded payment.
   */
   ...
   *
   * @param options The customizations that can be applied when making a forward request.
   * @return the current {@code CheckoutForwardRequest} instance, allowing for method chaining
   */
   ...
   * The customizations that can be applied when making a forward request.
   *
   * @return options The customizations that can be applied when making a forward request.
   */
   ...
   * The card details.
   *
   * @param paymentMethod The card details.
   * @return the current {@code CheckoutForwardRequest} instance, allowing for method chaining
   */
   ...
   * The card details.
   *
   * @return paymentMethod The card details.
   */
  ...
  /**
   * The [details of the
   * request](https://docs.adyen.com/online-payments/tokenization/forward-payment-details#request-to-adyen-card)
   * that you want to forward to the third-party.
   *
   * @param request The [details of the
   *     request](https://docs.adyen.com/online-payments/tokenization/forward-payment-details#request-to-adyen-card)
   *     that you want to forward to the third-party.
   * @return the current {@code CheckoutForwardRequest} instance, allowing for method chaining
   */
   ...
   * that you want to forward to the third-party.
   *
   * @return request The [details of the
   *     request](https://docs.adyen.com/online-payments/tokenization/forward-payment-details#request-to-adyen-card)
   *     that you want to forward to the third-party.
   */
