...
import com.adyen.model.checkout.CheckoutForwardRequestCard;
import com.adyen.model.checkout.CheckoutForwardRequestOptions;
import com.adyen.model.checkout.CheckoutOutgoingForwardRequest;
...
public class CheckoutForwardRequest {
   ...
   *
   * @param baseUrl The base URL of the third party API, where Adyen will send the request to forward the payment details.
  ...
  /**
   * The base URL of the third party API, where Adyen will send the request to forward the payment details.
   * @return baseUrl The base URL of the third party API, where Adyen will send the request to forward the payment details.
   */
   ...
   *
   * @param storedPaymentMethodId The unique identifier of the token that you want to forward to the third party. This is the &#x60;storedPaymentMethodId&#x60; you received in the webhook after you created the token.
   * @return the current {@code CheckoutForwardRequest} instance, allowing for method chaining
   */
  ...
  /**
   * The unique identifier of the token that you want to forward to the third party. This is the &#x60;storedPaymentMethodId&#x60; you received in the webhook after you created the token.
   * @return storedPaymentMethodId The unique identifier of the token that you want to forward to the third party. This is the &#x60;storedPaymentMethodId&#x60; you received in the webhook after you created the token.
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.baseUrl, checkoutForwardRequest.baseUrl) &&
        ...
        Objects.equals(this.isSetMerchantReference, checkoutForwardRequest.isSetMerchantReference) &&
        ...
        Objects.equals(this.isSetStoredPaymentMethodId, checkoutForwardRequest.isSetStoredPaymentMethodId)
    ;
  }

  @Override
  public int hashCode() {
    return Objects.hash(baseUrl, isSetBaseUrl, merchantAccount, isSetMerchantAccount, merchantReference, isSetMerchantReference, options, isSetOptions, paymentMethod, isSetPaymentMethod, request, isSetRequest, shopperReference, isSetShopperReference, storedPaymentMethodId, isSetStoredPaymentMethodId);
  }
...
/**
   ...
   * @throws JsonProcessingException if the JSON string is invalid with respect to CheckoutForwardRequest
   */
