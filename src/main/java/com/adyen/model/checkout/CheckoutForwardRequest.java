...
public class CheckoutForwardRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(baseUrl, isSetBaseUrl, merchantAccount, isSetMerchantAccount, options, isSetOptions, request, isSetRequest, shopperReference, isSetShopperReference, storedPaymentMethodId, isSetStoredPaymentMethodId);
  }
