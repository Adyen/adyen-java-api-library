...
@JsonPropertyOrder({
  PaymentAmountUpdateResponse.JSON_PROPERTY_ADJUST_AUTHORISATION_DATA,
...
public class PaymentAmountUpdateResponse {
  ...
  /**
   * The status of your request. If you included &#x60;adjustAuthorisationData&#x60; in your
   * request, possible values are the following: * **authorised** * **refused** Otherwise, the value
   * is **received**.
   */
  ...
  /**
   * The data blob for subsequent synchronous adjust authorisation calls. Returned when the
   * synchronous flow is used.
   *
   * @param adjustAuthorisationData The data blob for subsequent synchronous adjust authorisation
   *     calls. Returned when the synchronous flow is used.
   * @return the current {@code PaymentAmountUpdateResponse} instance, allowing for method chaining
   */
  public PaymentAmountUpdateResponse adjustAuthorisationData(String adjustAuthorisationData) {
   ...
   * synchronous flow is used.
   *
   * @return adjustAuthorisationData The data blob for subsequent synchronous adjust authorisation
   *     calls. Returned when the synchronous flow is used.
   */
   ...
   * is **received**.
   *
   * @param status The status of your request. If you included &#x60;adjustAuthorisationData&#x60;
   *     in your request, possible values are the following: * **authorised** * **refused**
   ...
   * is **received**.
   *
   * @return status The status of your request. If you included &#x60;adjustAuthorisationData&#x60;
   *     in your request, possible values are the following: * **authorised** * **refused**
   *     Otherwise, the value is **received**.
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(
            this.adjustAuthorisationData, paymentAmountUpdateResponse.adjustAuthorisationData)
        && Objects.equals(
            this.isSetAdjustAuthorisationData,
            paymentAmountUpdateResponse.isSetAdjustAuthorisationData)
        && Objects.equals(this.amount, paymentAmountUpdateResponse.amount)
   ...
   *     PaymentAmountUpdateResponse
   */
  public static PaymentAmountUpdateResponse fromJson(String jsonString) throws JacksonException {
