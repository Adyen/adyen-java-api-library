...
public class PaymentAmountUpdateResponse {
   ...
   *
   * @param paymentPspReference The [&#x60;pspReference&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments#responses-200-pspReference) of the payment to update. 
   * @return the current {@code PaymentAmountUpdateResponse} instance, allowing for method chaining
   */
  ...
  /**
   * The [&#x60;pspReference&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments#responses-200-pspReference) of the payment to update. 
   * @return paymentPspReference The [&#x60;pspReference&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments#responses-200-pspReference) of the payment to update. 
   */
   ...
   *
   * @param pspReference Adyen&#39;s 16-character reference associated with the amount update request.
   * @return the current {@code PaymentAmountUpdateResponse} instance, allowing for method chaining
   */
  ...
  /**
   * Adyen&#39;s 16-character reference associated with the amount update request.
   * @return pspReference Adyen&#39;s 16-character reference associated with the amount update request.
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, paymentAmountUpdateResponse.amount) &&
        ...
        Objects.equals(this.isSetMerchantAccount, paymentAmountUpdateResponse.isSetMerchantAccount) &&
        Objects.equals(this.paymentPspReference, paymentAmountUpdateResponse.paymentPspReference) &&
        Objects.equals(this.isSetPaymentPspReference, paymentAmountUpdateResponse.isSetPaymentPspReference) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amount, isSetAmount, industryUsage, isSetIndustryUsage, lineItems, isSetLineItems, merchantAccount, isSetMerchantAccount, paymentPspReference, isSetPaymentPspReference, pspReference, isSetPspReference, reference, isSetReference, splits, isSetSplits, status, isSetStatus);
  }
