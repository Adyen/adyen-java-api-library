...
public class CheckoutForwardRequestCard {
   ...
   * (1-20 characters). Depending on the card brand, it is also known as: * CVV2/CVC2 – length: 3
   * digits * CID – length: 4 digits
   *
   * @param cvc The [card verification
   *     code](https://docs.adyen.com/payments-fundamentals/payment-glossary#card-security-code-cvc-cvv-cid)
   *     (1-20 characters). Depending on the card brand, it is also known as: * CVV2/CVC2 – length:
   *     3 digits * CID – length: 4 digits
   ...
   * compliant](https://docs.adyen.com/development-resources/pci-dss-compliance-guide). Format: Do
   * not use separators.
   *
   * @param number The card number. Only collect raw card data if you are fully [PCI
   *     compliant](https://docs.adyen.com/development-resources/pci-dss-compliance-guide). Format:
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cvc, checkoutForwardRequestCard.cvc)
        ...
        && Objects.equals(
            this.isSetEncryptedCardNumber, checkoutForwardRequestCard.isSetEncryptedCardNumber)
        && Objects.equals(
            this.encryptedExpiryMonth, checkoutForwardRequestCard.encryptedExpiryMonth)
        && Objects.equals(
            this.isSetEncryptedExpiryMonth, checkoutForwardRequestCard.isSetEncryptedExpiryMonth)
        && Objects.equals(this.encryptedExpiryYear, checkoutForwardRequestCard.encryptedExpiryYear)
        && Objects.equals(
            this.isSetEncryptedExpiryYear, checkoutForwardRequestCard.isSetEncryptedExpiryYear)
        && Objects.equals(
            this.encryptedSecurityCode, checkoutForwardRequestCard.encryptedSecurityCode)
        && Objects.equals(
            this.isSetEncryptedSecurityCode, checkoutForwardRequestCard.isSetEncryptedSecurityCode)
   ...
   *     CheckoutForwardRequestCard
   */
  public static CheckoutForwardRequestCard fromJson(String jsonString) throws JacksonException {
