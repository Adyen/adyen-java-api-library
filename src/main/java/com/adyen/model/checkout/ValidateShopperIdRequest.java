...
public class ValidateShopperIdRequest {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to ValidateShopperIdRequest
   */
  public static ValidateShopperIdRequest fromJson(String jsonString) throws JacksonException {
