...
public class Recurring {
  /**
   * The type of recurring contract to be used. Possible values: * &#x60;ONECLICK&#x60; – Payment
   * details can be used to initiate a one-click payment, where the shopper enters the [card
   * security code
  ...
  public String toString() {
    ...
    sb.append("    recurringDetailName: ")
        .append(toIndentedString(recurringDetailName))
        .append("\n");
   ...
   * @throws JacksonException if the JSON string is invalid with respect to Recurring
   */
  public static Recurring fromJson(String jsonString) throws JacksonException {
