...
public class RatepayDetails {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class RatepayDetails {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (RatepayDetails.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in RatepayDetails is not found in the empty JSON string", RatepayDetails.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!RatepayDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RatepayDetails` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
