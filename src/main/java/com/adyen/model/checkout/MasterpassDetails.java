...
public class MasterpassDetails {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class MasterpassDetails {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (MasterpassDetails.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in MasterpassDetails is not found in the empty JSON string", MasterpassDetails.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!MasterpassDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MasterpassDetails` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
