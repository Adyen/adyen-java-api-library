...
import com.adyen.model.checkout.UpiQrDetails;
...
public class CheckoutPaymentMethod extends AbstractOpenApiSchema {
        ...
        public CheckoutPaymentMethod deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(AchDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(AffirmDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(AfterpayDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(AmazonPayDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(AncvDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(AndroidPayDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(ApplePayDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(BacsDirectDebitDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(BillDeskDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(BlikDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(CardDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(CashAppDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(CellulantDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(DokuDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(DragonpayDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(EBankingFinlandDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(EcontextVoucherDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(EftDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(FastlaneDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(GenericIssuerPaymentMethodDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(GooglePayDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(IdealDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(KlarnaDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(MasterpassDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(MbwayDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(MobilePayDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(MolPayDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(OpenInvoiceDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(PayByBankAISDirectDebitDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(PayByBankDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(PayPalDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(PayPayDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(PayToDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(PayUUpiDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(PayWithGoogleDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(PaymentDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(PixDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(PseDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(RakutenPayDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(RatepayDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(RivertyDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(SamsungPayDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(SepaDirectDebitDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(StoredPaymentMethodDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(TwintDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(UpiCollectDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(UpiIntentDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(UpiQrDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(VippsDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(VisaCheckoutDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(WeChatPayDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(WeChatPayMiniProgramDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(ZipDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
     ...
     * AchDetails, AffirmDetails, AfterpayDetails, AmazonPayDetails, AncvDetails, AndroidPayDetails, ApplePayDetails, BacsDirectDebitDetails, BillDeskDetails, BlikDetails, CardDetails, CashAppDetails, CellulantDetails, DokuDetails, DragonpayDetails, EBankingFinlandDetails, EcontextVoucherDetails, EftDetails, FastlaneDetails, GenericIssuerPaymentMethodDetails, GooglePayDetails, IdealDetails, KlarnaDetails, MasterpassDetails, MbwayDetails, MobilePayDetails, MolPayDetails, OpenInvoiceDetails, PayByBankAISDirectDebitDetails, PayByBankDetails, PayPalDetails, PayPayDetails, PayToDetails, PayUUpiDetails, PayWithGoogleDetails, PaymentDetails, PixDetails, PseDetails, RakutenPayDetails, RatepayDetails, RivertyDetails, SamsungPayDetails, SepaDirectDebitDetails, StoredPaymentMethodDetails, TwintDetails, UpiCollectDetails, UpiIntentDetails, UpiQrDetails, VippsDetails, VisaCheckoutDetails, WeChatPayDetails, WeChatPayMiniProgramDetails, ZipDetails
     *
     * @return The actual instance (AchDetails, AffirmDetails, AfterpayDetails, AmazonPayDetails, AncvDetails, AndroidPayDetails, ApplePayDetails, BacsDirectDebitDetails, BillDeskDetails, BlikDetails, CardDetails, CashAppDetails, CellulantDetails, DokuDetails, DragonpayDetails, EBankingFinlandDetails, EcontextVoucherDetails, EftDetails, FastlaneDetails, GenericIssuerPaymentMethodDetails, GooglePayDetails, IdealDetails, KlarnaDetails, MasterpassDetails, MbwayDetails, MobilePayDetails, MolPayDetails, OpenInvoiceDetails, PayByBankAISDirectDebitDetails, PayByBankDetails, PayPalDetails, PayPayDetails, PayToDetails, PayUUpiDetails, PayWithGoogleDetails, PaymentDetails, PixDetails, PseDetails, RakutenPayDetails, RatepayDetails, RivertyDetails, SamsungPayDetails, SepaDirectDebitDetails, StoredPaymentMethodDetails, TwintDetails, UpiCollectDetails, UpiIntentDetails, UpiQrDetails, VippsDetails, VisaCheckoutDetails, WeChatPayDetails, WeChatPayMiniProgramDetails, ZipDetails)
     */
    @Override
