...
public class PaypalUpdateOrderRequest {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PaypalUpdateOrderRequest
   */
  public static PaypalUpdateOrderRequest fromJson(String jsonString) throws JacksonException {
