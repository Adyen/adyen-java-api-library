...
public class PaypalUpdateOrderRequest {
   ...
   *
   * @param amount The updated final payment amount. This amount is the item total plus the shipping
   *     costs of the selected &#x60;deliveryMethod&#x60;.
   ...
   * selected &#x60;deliveryMethod&#x60;.
   *
   * @return amount The updated final payment amount. This amount is the item total plus the
   ...
   *
   * @param paymentData The &#x60;paymentData&#x60; from the client side. This value changes every
   *     time you make a &#x60;/paypal/updateOrder&#x60; request.
   * @return the current {@code PaypalUpdateOrderRequest} instance, allowing for method chaining
   */
   ...
   * &#x60;/paypal/updateOrder&#x60; request.
   *
   * @return paymentData The &#x60;paymentData&#x60; from the client side. This value changes every
   *     time you make a &#x60;/paypal/updateOrder&#x60; request.
   */
   ...
   *
   * @param pspReference The original &#x60;pspReference&#x60; from the &#x60;/payments&#x60;
   *     response.
   * @return the current {@code PaypalUpdateOrderRequest} instance, allowing for method chaining
   */
   ...
   * The original &#x60;pspReference&#x60; from the &#x60;/payments&#x60; response.
   *
   * @return pspReference The original &#x60;pspReference&#x60; from the &#x60;/payments&#x60;
   *     response.
   */
   ...
   *
   * @param taxTotal Total tax amount from the order.
   * @return the current {@code PaypalUpdateOrderRequest} instance, allowing for method chaining
   */
   ...
   * Total tax amount from the order.
   *
   * @return taxTotal Total tax amount from the order.
   */
