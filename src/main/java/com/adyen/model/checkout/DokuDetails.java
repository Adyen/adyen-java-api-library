...
public class DokuDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to DokuDetails
   */
  public static DokuDetails fromJson(String jsonString) throws JacksonException {
