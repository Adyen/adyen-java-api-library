  ...
  **/
  ...
  public String toString() {
    String sb = "class AchDetails {\n" +
            ...
            "    encryptedBankAccountNumber: " + toIndentedString(encryptedBankAccountNumber) + "\n" +
            "    encryptedBankLocationId: " + toIndentedString(encryptedBankLocationId) + "\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (AchDetails.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in AchDetails is not found in the empty JSON string", AchDetails.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AchDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AchDetails` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
