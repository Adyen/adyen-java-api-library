...
public class PaymentSessionRequest {
    ...
    public String toString() {
        ...
        sb.append("class PaymentSessionRequest {").append(TextConstants.LINE_BREAK);
        ...
        sb.append("    configId: ").append(toIndentedString(configId)).append(TextConstants.LINE_BREAK);
        ...
        sb.append("    enableOneClick: ").append(toIndentedString(enableOneClick)).append(TextConstants.LINE_BREAK);
        sb.append("    enablePayOut: ").append(toIndentedString(enablePayOut)).append(TextConstants.LINE_BREAK);
        sb.append("    enableRealTimeUpdate: ").append(toIndentedString(enableRealTimeUpdate)).append(TextConstants.LINE_BREAK);
        sb.append("    enableRecurring: ").append(toIndentedString(enableRecurring)).append(TextConstants.LINE_BREAK);
