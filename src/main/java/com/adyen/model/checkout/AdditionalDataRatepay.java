...
public class AdditionalDataRatepay {
  ...
  /**
   * Invoice date, defined by the merchant. If not included, the invoice date is set to the delivery
   * date.
   *
   * @param ratepaydataInvoiceDate Invoice date, defined by the merchant. If not included, the
   ...
   * date.
   *
   * @return ratepaydataInvoiceDate Invoice date, defined by the merchant. If not included, the
   *     invoice date is set to the delivery date.
   */
   ...
   *
   * @param ratepaydataInvoiceId Identification name or number for the invoice, defined by the
   *     merchant.
   * @return the current {@code AdditionalDataRatepay} instance, allowing for method chaining
   */
   ...
   * Identification name or number for the invoice, defined by the merchant.
   *
   * @return ratepaydataInvoiceId Identification name or number for the invoice, defined by the
   *     merchant.
   */
  ...
  public String toString() {
    ...
    sb.append("    ratepayInstallmentAmount: ")
        .append(toIndentedString(ratepayInstallmentAmount))
        .append("\n");
    sb.append("    ratepayInterestRate: ")
        .append(toIndentedString(ratepayInterestRate))
        .append("\n");
    sb.append("    ratepayLastInstallmentAmount: ")
        .append(toIndentedString(ratepayLastInstallmentAmount))
        .append("\n");
    sb.append("    ratepayPaymentFirstday: ")
        .append(toIndentedString(ratepayPaymentFirstday))
        .append("\n");
    sb.append("    ratepaydataDeliveryDate: ")
        .append(toIndentedString(ratepaydataDeliveryDate))
        .append("\n");
    sb.append("    ratepaydataDueDate: ").append(toIndentedString(ratepaydataDueDate)).append("\n");
    sb.append("    ratepaydataInvoiceDate: ")
        .append(toIndentedString(ratepaydataInvoiceDate))
        .append("\n");
    sb.append("    ratepaydataInvoiceId: ")
        .append(toIndentedString(ratepaydataInvoiceId))
        .append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws JacksonException if the JSON string is invalid with respect to AdditionalDataRatepay
   */
  public static AdditionalDataRatepay fromJson(String jsonString) throws JacksonException {
