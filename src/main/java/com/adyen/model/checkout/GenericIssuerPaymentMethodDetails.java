...
public class GenericIssuerPaymentMethodDetails {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class GenericIssuerPaymentMethodDetails {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (GenericIssuerPaymentMethodDetails.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenericIssuerPaymentMethodDetails is not found in the empty JSON string", GenericIssuerPaymentMethodDetails.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GenericIssuerPaymentMethodDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenericIssuerPaymentMethodDetails` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
