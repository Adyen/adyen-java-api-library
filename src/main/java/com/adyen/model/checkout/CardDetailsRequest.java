...
public class CardDetailsRequest {
   ...
   *
   * @param cardNumber A minimum of the first six digits of the card number. The full card number gives the best result.   You must be [fully PCI compliant](https://docs.adyen.com/development-resources/pci-dss-compliance-guide) to collect raw card data. Alternatively, you can use the &#x60;encryptedCardNumber&#x60; field.
  ...
  /**
   * A minimum of the first six digits of the card number. The full card number gives the best result.   You must be [fully PCI compliant](https://docs.adyen.com/development-resources/pci-dss-compliance-guide) to collect raw card data. Alternatively, you can use the &#x60;encryptedCardNumber&#x60; field.
   * @return cardNumber A minimum of the first six digits of the card number. The full card number gives the best result.   You must be [fully PCI compliant](https://docs.adyen.com/development-resources/pci-dss-compliance-guide) to collect raw card data. Alternatively, you can use the &#x60;encryptedCardNumber&#x60; field.
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cardNumber, cardDetailsRequest.cardNumber) &&
        ...
        Objects.equals(this.isSetEncryptedCardNumber, cardDetailsRequest.isSetEncryptedCardNumber) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cardNumber, isSetCardNumber, countryCode, isSetCountryCode, encryptedCardNumber, isSetEncryptedCardNumber, merchantAccount, isSetMerchantAccount, supportedBrands, isSetSupportedBrands);
  }
