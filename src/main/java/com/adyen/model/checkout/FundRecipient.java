...
public class FundRecipient {
  ...
  public enum WalletPurposeEnum {
    ...
    public static WalletPurposeEnum fromValue(String value) {
      ...
      LOG.warning("WalletPurposeEnum: unexpected enum value '" + value + "' - Supported values are "+ Arrays.toString(WalletPurposeEnum.values()));
      return null;
    }
  }
