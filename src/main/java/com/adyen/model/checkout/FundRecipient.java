...
public class FundRecipient {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to FundRecipient
   */
  public static FundRecipient fromJson(String jsonString) throws JacksonException {
