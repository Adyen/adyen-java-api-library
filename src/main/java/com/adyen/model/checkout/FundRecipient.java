...
public class FundRecipient {
   ...
   *
   * @param paymentMethod The payment method used by the shopper.
   * @return the current {@code FundRecipient} instance, allowing for method chaining
   */
   ...
   * The payment method used by the shopper.
   *
   * @return paymentMethod The payment method used by the shopper.
   */
   ...
   * The name of the shopper.
   *
   * @return shopperName The name of the shopper.
   */
   ...
   * shopper&#39;s stored card when the wallet balance is insufficient. The final merchant who will
   * receive the money, also known as a
   * [sub-merchant](https://docs.adyen.com/get-started-with-adyen/payment-glossary/#submerchant).
   *
   * @param subMerchant Required for back-to-back/purchase-driven-load transactions, where the funds
   *     are taken from the shopper&#39;s stored card when the wallet balance is insufficient. The
   *     final merchant who will receive the money, also known as a
   *     [sub-merchant](https://docs.adyen.com/get-started-with-adyen/payment-glossary/#submerchant).
   * @return the current {@code FundRecipient} instance, allowing for method chaining
   */
   ...
   * [sub-merchant](https://docs.adyen.com/get-started-with-adyen/payment-glossary/#submerchant).
   *
   * @return subMerchant Required for back-to-back/purchase-driven-load transactions, where the
   *     funds are taken from the shopper&#39;s stored card when the wallet balance is insufficient.
