...
public class BacsDirectDebitDetails {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class BacsDirectDebitDetails {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (BacsDirectDebitDetails.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in BacsDirectDebitDetails is not found in the empty JSON string", BacsDirectDebitDetails.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!BacsDirectDebitDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BacsDirectDebitDetails` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
