...
public class BacsDirectDebitDetails {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bankAccountNumber, bankLocationId, checkoutAttemptId, holderName, recurringDetailReference, sdkData, storedPaymentMethodId, transferInstrumentId, type);
  }
