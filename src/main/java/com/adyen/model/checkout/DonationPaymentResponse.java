...
public class DonationPaymentResponse {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to DonationPaymentResponse
   */
  public static DonationPaymentResponse fromJson(String jsonString) throws JacksonException {
