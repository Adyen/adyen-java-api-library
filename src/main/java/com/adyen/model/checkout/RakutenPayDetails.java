...
public class RakutenPayDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to RakutenPayDetails
   */
  public static RakutenPayDetails fromJson(String jsonString) throws JacksonException {
