...
public class ResponsePaymentMethod {
  ...
  **/
  ...
  public String toString() {
      String sb = "class ResponsePaymentMethod {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ResponsePaymentMethod.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResponsePaymentMethod is not found in the empty JSON string", ResponsePaymentMethod.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResponsePaymentMethod.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponsePaymentMethod` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
