...
public class ResponsePaymentMethod {
  ...
  /**
   * The card brand that the shopper used to pay. Only returned if &#x60;paymentMethod.type&#x60; is
   * **scheme**.
   *
   * @param brand The card brand that the shopper used to pay. Only returned if
   ...
   * **scheme**.
   *
   * @return brand The card brand that the shopper used to pay. Only returned if
   *     &#x60;paymentMethod.type&#x60; is **scheme**.
   */
   ...
   * @throws JacksonException if the JSON string is invalid with respect to ResponsePaymentMethod
   */
  public static ResponsePaymentMethod fromJson(String jsonString) throws JacksonException {
