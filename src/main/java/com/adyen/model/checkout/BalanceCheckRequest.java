...
public class BalanceCheckRequest {
  ...
  /**
   * Shopper account information for 3D Secure 2. &gt; For 3D Secure 2 transactions, we recommend
   * that you include this object to increase the chances of achieving a frictionless flow.
   *
   * @param accountInfo Shopper account information for 3D Secure 2. &gt; For 3D Secure 2
   *     transactions, we recommend that you include this object to increase the chances of
   ...
   * that you include this object to increase the chances of achieving a frictionless flow.
   *
   * @return accountInfo Shopper account information for 3D Secure 2. &gt; For 3D Secure 2
   *     transactions, we recommend that you include this object to increase the chances of
   *     achieving a frictionless flow.
   */
   ...
   * request to use a non-zero value, assign this value to &#x60;additionalAmount&#x60; (while the
   * amount must be still set to 0 to trigger BIN or card verification). Required to be in the same
   * currency as the &#x60;amount&#x60;.
   *
   * @param additionalAmount If you want a [BIN or card
   *     verification](https://docs.adyen.com/payment-methods/cards/bin-data-and-card-verification)
   *     request to use a non-zero value, assign this value to &#x60;additionalAmount&#x60; (while
   *     the amount must be still set to 0 to trigger BIN or card verification). Required to be in
   *     the same currency as the &#x60;amount&#x60;.
   * @return the current {@code BalanceCheckRequest} instance, allowing for method chaining
   */
   ...
   * currency as the &#x60;amount&#x60;.
   *
   * @return additionalAmount If you want a [BIN or card
   *     verification](https://docs.adyen.com/payment-methods/cards/bin-data-and-card-verification)
   *     request to use a non-zero value, assign this value to &#x60;additionalAmount&#x60; (while
   *     the amount must be still set to 0 to trigger BIN or card verification). Required to be in
   *     the same currency as the &#x60;amount&#x60;.
   ...
   * units](https://docs.adyen.com/development-resources/currency-codes)). For [BIN or card
   * verification](https://docs.adyen.com/payment-methods/cards/bin-data-and-card-verification)
   * requests, set amount to 0 (zero).
   *
   * @param amount The amount information for the transaction (in [minor
   *     units](https://docs.adyen.com/development-resources/currency-codes)). For [BIN or card
   *     verification](https://docs.adyen.com/payment-methods/cards/bin-data-and-card-verification)
   *     requests, set amount to 0 (zero).
   * @return the current {@code BalanceCheckRequest} instance, allowing for method chaining
   ...
   * requests, set amount to 0 (zero).
   *
   * @return amount The amount information for the transaction (in [minor
   *     units](https://docs.adyen.com/development-resources/currency-codes)). For [BIN or card
   *     verification](https://docs.adyen.com/payment-methods/cards/bin-data-and-card-verification)
   *     requests, set amount to 0 (zero).
   */
   ...
   *
   * @param applicationInfo Information about your application. For more details, see [Building
   ...
   * solutions](https://docs.adyen.com/development-resources/building-adyen-solutions).
   *
   * @return applicationInfo Information about your application. For more details, see [Building
   *     Adyen solutions](https://docs.adyen.com/development-resources/building-adyen-solutions).
   */
  ...
  /**
   * The address where to send the invoice. &gt; The &#x60;billingAddress&#x60; object is required
   * in the following scenarios. Include all of the fields within this object. &gt;* For 3D Secure 2
   * transactions in all browser-based and mobile implementations. &gt;* For cross-border payouts to
   * and from Canada.
   *
   * @param billingAddress The address where to send the invoice. &gt; The
   *     &#x60;billingAddress&#x60; object is required in the following scenarios. Include all of
   *     the fields within this object. &gt;* For 3D Secure 2 transactions in all browser-based and
   *     mobile implementations. &gt;* For cross-border payouts to and from Canada.
   * @return the current {@code BalanceCheckRequest} instance, allowing for method chaining
   */
   ...
   * and from Canada.
   *
   * @return billingAddress The address where to send the invoice. &gt; The
   *     &#x60;billingAddress&#x60; object is required in the following scenarios. Include all of
   *     the fields within this object. &gt;* For 3D Secure 2 transactions in all browser-based and
   *     mobile implementations. &gt;* For cross-border payouts to and from Canada.
   */
  ...
  /**
   * The shopper&#39;s browser information. &gt; For 3D Secure, the full object is required for web
   * integrations. For mobile app integrations, include the &#x60;userAgent&#x60; and
   * &#x60;acceptHeader&#x60; fields to indicate that your integration can support a redirect in
   * case a payment is routed to 3D Secure 2 redirect.
   *
   * @param browserInfo The shopper&#39;s browser information. &gt; For 3D Secure, the full object
   *     is required for web integrations. For mobile app integrations, include the
   *     &#x60;userAgent&#x60; and &#x60;acceptHeader&#x60; fields to indicate that your integration
   *     can support a redirect in case a payment is routed to 3D Secure 2 redirect.
   * @return the current {@code BalanceCheckRequest} instance, allowing for method chaining
   */
   ...
   * case a payment is routed to 3D Secure 2 redirect.
   *
   * @return browserInfo The shopper&#39;s browser information. &gt; For 3D Secure, the full object
   *     is required for web integrations. For mobile app integrations, include the
   *     &#x60;userAgent&#x60; and &#x60;acceptHeader&#x60; fields to indicate that your integration
   *     can support a redirect in case a payment is routed to 3D Secure 2 redirect.
   */
   ...
   *
   * @param dccQuote The forex quote as returned in the response of the forex service.
   * @return the current {@code BalanceCheckRequest} instance, allowing for method chaining
   */
   ...
   * The forex quote as returned in the response of the forex service.
   *
   * @return dccQuote The forex quote as returned in the response of the forex service.
   */
   ...
   *
   * @param deliveryAddress The address where the purchased goods should be delivered.
   * @return the current {@code BalanceCheckRequest} instance, allowing for method chaining
   */
   ...
   * The address where the purchased goods should be delivered.
   *
   * @return deliveryAddress The address where the purchased goods should be delivered.
   */
   ...
   * [Installments](https://docs.adyen.com/payment-methods/cards/credit-card-installments).
   *
   * @param installments Contains installment settings. For more information, refer to
   *     [Installments](https://docs.adyen.com/payment-methods/cards/credit-card-installments).
   * @return the current {@code BalanceCheckRequest} instance, allowing for method chaining
   */
   ...
   * [Installments](https://docs.adyen.com/payment-methods/cards/credit-card-installments).
   *
   * @return installments Contains installment settings. For more information, refer to
   *     [Installments](https://docs.adyen.com/payment-methods/cards/credit-card-installments).
   */
  ...
  public BalanceCheckRequest localizedShopperStatement(
      Map<String, String> localizedShopperStatement) {
  ...
  /**
   * Additional risk fields for 3D Secure 2. &gt; For 3D Secure 2 transactions, we recommend that
   * you include this object to increase the chances of achieving a frictionless flow.
   *
   * @param merchantRiskIndicator Additional risk fields for 3D Secure 2. &gt; For 3D Secure 2
   *     transactions, we recommend that you include this object to increase the chances of
   *     achieving a frictionless flow.
   * @return the current {@code BalanceCheckRequest} instance, allowing for method chaining
   */
   ...
   * you include this object to increase the chances of achieving a frictionless flow.
   *
   * @return merchantRiskIndicator Additional risk fields for 3D Secure 2. &gt; For 3D Secure 2
   *     transactions, we recommend that you include this object to increase the chances of
   *     achieving a frictionless flow.
   */
   ...
   *
   * @param recurring The recurring settings for the payment. Use this property when you want to
   *     enable [recurring payments](https://docs.adyen.com/classic-integration/recurring-payments).
   * @return the current {@code BalanceCheckRequest} instance, allowing for method chaining
   */
   ...
   * payments](https://docs.adyen.com/classic-integration/recurring-payments).
   *
   * @return recurring The recurring settings for the payment. Use this property when you want to
   *     enable [recurring payments](https://docs.adyen.com/classic-integration/recurring-payments).
   */
   ...
   * @return the current {@code BalanceCheckRequest} instance, allowing for method chaining
   */
  public BalanceCheckRequest recurringProcessingModel(
   ...
   * @return the current {@code BalanceCheckRequest} instance, allowing for method chaining
   */
  public BalanceCheckRequest selectedRecurringDetailReference(
   ...
   *
   * @param shopperName The shopper&#39;s full name.
   * @return the current {@code BalanceCheckRequest} instance, allowing for method chaining
   */
   ...
   * The shopper&#39;s full name.
   *
   * @return shopperName The shopper&#39;s full name.
   */
   ...
   *
   * @param threeDS2RequestData Request fields for 3D Secure 2. To check if any of the following
   *     fields are required for your integration, refer to [Online
   ...
   * integration](https://docs.adyen.com/classic-integration) documentation.
   *
   * @return threeDS2RequestData Request fields for 3D Secure 2. To check if any of the following
   *     fields are required for your integration, refer to [Online
   *     payments](https://docs.adyen.com/online-payments) or [Classic
   *     integration](https://docs.adyen.com/classic-integration) documentation.
   */
   ...
   */
  public BalanceCheckRequest includeNullValues(boolean includeNullValues) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountInfo, balanceCheckRequest.accountInfo)
        && Objects.equals(this.isSetAccountInfo, balanceCheckRequest.isSetAccountInfo)
        && Objects.equals(this.additionalAmount, balanceCheckRequest.additionalAmount)
        && Objects.equals(this.isSetAdditionalAmount, balanceCheckRequest.isSetAdditionalAmount)
        && Objects.equals(this.additionalData, balanceCheckRequest.additionalData)
        && Objects.equals(this.isSetAdditionalData, balanceCheckRequest.isSetAdditionalData)
        && Objects.equals(this.amount, balanceCheckRequest.amount)
        && Objects.equals(this.isSetAmount, balanceCheckRequest.isSetAmount)
        && Objects.equals(this.applicationInfo, balanceCheckRequest.applicationInfo)
        && Objects.equals(this.isSetApplicationInfo, balanceCheckRequest.isSetApplicationInfo)
        && Objects.equals(this.billingAddress, balanceCheckRequest.billingAddress)
        && Objects.equals(this.isSetBillingAddress, balanceCheckRequest.isSetBillingAddress)
        && Objects.equals(this.browserInfo, balanceCheckRequest.browserInfo)
        && Objects.equals(this.isSetBrowserInfo, balanceCheckRequest.isSetBrowserInfo)
        && Objects.equals(this.captureDelayHours, balanceCheckRequest.captureDelayHours)
        && Objects.equals(this.isSetCaptureDelayHours, balanceCheckRequest.isSetCaptureDelayHours)
        && Objects.equals(this.dateOfBirth, balanceCheckRequest.dateOfBirth)
        && Objects.equals(this.isSetDateOfBirth, balanceCheckRequest.isSetDateOfBirth)
        && Objects.equals(this.dccQuote, balanceCheckRequest.dccQuote)
        && Objects.equals(this.isSetDccQuote, balanceCheckRequest.isSetDccQuote)
        && Objects.equals(this.deliveryAddress, balanceCheckRequest.deliveryAddress)
        && Objects.equals(this.isSetDeliveryAddress, balanceCheckRequest.isSetDeliveryAddress)
        && Objects.equals(this.deliveryDate, balanceCheckRequest.deliveryDate)
        && Objects.equals(this.isSetDeliveryDate, balanceCheckRequest.isSetDeliveryDate)
        && Objects.equals(this.deviceFingerprint, balanceCheckRequest.deviceFingerprint)
        && Objects.equals(this.isSetDeviceFingerprint, balanceCheckRequest.isSetDeviceFingerprint)
        && Objects.equals(this.fraudOffset, balanceCheckRequest.fraudOffset)
        && Objects.equals(this.isSetFraudOffset, balanceCheckRequest.isSetFraudOffset)
        && Objects.equals(this.installments, balanceCheckRequest.installments)
        && Objects.equals(this.isSetInstallments, balanceCheckRequest.isSetInstallments)
        && Objects.equals(
            this.localizedShopperStatement, balanceCheckRequest.localizedShopperStatement)
        && Objects.equals(
            this.isSetLocalizedShopperStatement, balanceCheckRequest.isSetLocalizedShopperStatement)
        && Objects.equals(this.mcc, balanceCheckRequest.mcc)
        && Objects.equals(this.isSetMcc, balanceCheckRequest.isSetMcc)
        && Objects.equals(this.merchantAccount, balanceCheckRequest.merchantAccount)
        && Objects.equals(this.isSetMerchantAccount, balanceCheckRequest.isSetMerchantAccount)
        && Objects.equals(this.merchantOrderReference, balanceCheckRequest.merchantOrderReference)
        && Objects.equals(
            this.isSetMerchantOrderReference, balanceCheckRequest.isSetMerchantOrderReference)
        && Objects.equals(this.merchantRiskIndicator, balanceCheckRequest.merchantRiskIndicator)
        && Objects.equals(
            this.isSetMerchantRiskIndicator, balanceCheckRequest.isSetMerchantRiskIndicator)
        && Objects.equals(this.metadata, balanceCheckRequest.metadata)
        && Objects.equals(this.isSetMetadata, balanceCheckRequest.isSetMetadata)
        && Objects.equals(this.orderReference, balanceCheckRequest.orderReference)
        && Objects.equals(this.isSetOrderReference, balanceCheckRequest.isSetOrderReference)
        && Objects.equals(this.paymentMethod, balanceCheckRequest.paymentMethod)
        && Objects.equals(this.isSetPaymentMethod, balanceCheckRequest.isSetPaymentMethod)
        && Objects.equals(this.recurring, balanceCheckRequest.recurring)
        && Objects.equals(this.isSetRecurring, balanceCheckRequest.isSetRecurring)
        && Objects.equals(
            this.recurringProcessingModel, balanceCheckRequest.recurringProcessingModel)
        && Objects.equals(
            this.isSetRecurringProcessingModel, balanceCheckRequest.isSetRecurringProcessingModel)
        && Objects.equals(this.reference, balanceCheckRequest.reference)
        && Objects.equals(this.isSetReference, balanceCheckRequest.isSetReference)
        && Objects.equals(this.selectedBrand, balanceCheckRequest.selectedBrand)
        && Objects.equals(this.isSetSelectedBrand, balanceCheckRequest.isSetSelectedBrand)
        && Objects.equals(
            this.selectedRecurringDetailReference,
            balanceCheckRequest.selectedRecurringDetailReference)
        && Objects.equals(
            this.isSetSelectedRecurringDetailReference,
            balanceCheckRequest.isSetSelectedRecurringDetailReference)
        && Objects.equals(this.sessionId, balanceCheckRequest.sessionId)
        && Objects.equals(this.isSetSessionId, balanceCheckRequest.isSetSessionId)
        && Objects.equals(this.shopperEmail, balanceCheckRequest.shopperEmail)
        && Objects.equals(this.isSetShopperEmail, balanceCheckRequest.isSetShopperEmail)
        && Objects.equals(this.shopperIP, balanceCheckRequest.shopperIP)
        && Objects.equals(this.isSetShopperIP, balanceCheckRequest.isSetShopperIP)
        && Objects.equals(this.shopperInteraction, balanceCheckRequest.shopperInteraction)
        && Objects.equals(this.isSetShopperInteraction, balanceCheckRequest.isSetShopperInteraction)
        && Objects.equals(this.shopperLocale, balanceCheckRequest.shopperLocale)
        && Objects.equals(this.isSetShopperLocale, balanceCheckRequest.isSetShopperLocale)
        && Objects.equals(this.shopperName, balanceCheckRequest.shopperName)
        && Objects.equals(this.isSetShopperName, balanceCheckRequest.isSetShopperName)
        && Objects.equals(this.shopperReference, balanceCheckRequest.shopperReference)
        && Objects.equals(this.isSetShopperReference, balanceCheckRequest.isSetShopperReference)
        && Objects.equals(this.shopperStatement, balanceCheckRequest.shopperStatement)
        && Objects.equals(this.isSetShopperStatement, balanceCheckRequest.isSetShopperStatement)
        && Objects.equals(this.socialSecurityNumber, balanceCheckRequest.socialSecurityNumber)
        && Objects.equals(
            this.isSetSocialSecurityNumber, balanceCheckRequest.isSetSocialSecurityNumber)
        && Objects.equals(this.splits, balanceCheckRequest.splits)
        && Objects.equals(this.isSetSplits, balanceCheckRequest.isSetSplits)
        && Objects.equals(this.store, balanceCheckRequest.store)
        && Objects.equals(this.isSetStore, balanceCheckRequest.isSetStore)
        && Objects.equals(this.telephoneNumber, balanceCheckRequest.telephoneNumber)
        && Objects.equals(this.isSetTelephoneNumber, balanceCheckRequest.isSetTelephoneNumber)
        && Objects.equals(this.threeDS2RequestData, balanceCheckRequest.threeDS2RequestData)
        && Objects.equals(
            this.isSetThreeDS2RequestData, balanceCheckRequest.isSetThreeDS2RequestData)
        && Objects.equals(
            this.threeDSAuthenticationOnly, balanceCheckRequest.threeDSAuthenticationOnly)
        && Objects.equals(
            this.isSetThreeDSAuthenticationOnly, balanceCheckRequest.isSetThreeDSAuthenticationOnly)
        && Objects.equals(this.totalsGroup, balanceCheckRequest.totalsGroup)
        && Objects.equals(this.isSetTotalsGroup, balanceCheckRequest.isSetTotalsGroup)
        && Objects.equals(this.trustedShopper, balanceCheckRequest.trustedShopper)
        && Objects.equals(this.isSetTrustedShopper, balanceCheckRequest.isSetTrustedShopper);
  }
