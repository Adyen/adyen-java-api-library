...
public class CardBrandDetails {
  ...
  **/
  ...
  public String toString() {
      String sb = "class CardBrandDetails {\n" +
              "    supported: " + toIndentedString(supported) + "\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CardBrandDetails.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in CardBrandDetails is not found in the empty JSON string", CardBrandDetails.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CardBrandDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CardBrandDetails` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
