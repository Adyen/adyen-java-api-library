...
public class CardBrandDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to CardBrandDetails
   */
  public static CardBrandDetails fromJson(String jsonString) throws JacksonException {
