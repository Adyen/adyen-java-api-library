...
public class ThreeDSRequestData {
   ...
   * The version of 3D Secure to use. Possible values: * **2.1.0** * **2.2.0**
   *
   * @return threeDSVersion The version of 3D Secure to use. Possible values: * **2.1.0** *
   *     **2.2.0**
   */
   ...
   * @throws JacksonException if the JSON string is invalid with respect to ThreeDSRequestData
   */
  public static ThreeDSRequestData fromJson(String jsonString) throws JacksonException {
