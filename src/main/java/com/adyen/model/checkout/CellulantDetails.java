...
public class CellulantDetails {
  ...
  **/
  ...
  @Override
  public String toString() {
      String sb = "class CellulantDetails {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CellulantDetails.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in CellulantDetails is not found in the empty JSON string", CellulantDetails.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CellulantDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CellulantDetails` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
