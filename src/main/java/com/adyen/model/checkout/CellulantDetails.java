...
public class CellulantDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to CellulantDetails
   */
  public static CellulantDetails fromJson(String jsonString) throws JacksonException {
