...
public class GiropayDetails {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class GiropayDetails {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (GiropayDetails.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in GiropayDetails is not found in the empty JSON string", GiropayDetails.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GiropayDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GiropayDetails` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
