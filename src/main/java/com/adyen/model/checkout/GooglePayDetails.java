...
public class GooglePayDetails {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class GooglePayDetails {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (GooglePayDetails.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in GooglePayDetails is not found in the empty JSON string", GooglePayDetails.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GooglePayDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GooglePayDetails` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
