...
public class GooglePayDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to GooglePayDetails
   */
  public static GooglePayDetails fromJson(String jsonString) throws JacksonException {
