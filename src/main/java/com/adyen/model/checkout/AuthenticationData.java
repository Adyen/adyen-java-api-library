...
public class AuthenticationData {
  ...
  public enum AttemptAuthenticationEnum {
    ...
    public static AttemptAuthenticationEnum fromValue(String value) {
      ...
      LOG.warning("AttemptAuthenticationEnum: unexpected enum value '" + value + "' - Supported values are "+ Arrays.toString(AttemptAuthenticationEnum.values()));
      return null;
    }
  }
   ...
   *
   * @param authenticationOnly Required to trigger the [authentication-only flow](https://docs.adyen.com/online-payments/3d-secure/authentication-only/). If set to **true**, you will only perform the 3D Secure 2 authentication, and will not proceed to the payment authorization. Default: **false**.
   * @return the current {@code AuthenticationData} instance, allowing for method chaining
   */
  ...
  /**
   * Required to trigger the [authentication-only flow](https://docs.adyen.com/online-payments/3d-secure/authentication-only/). If set to **true**, you will only perform the 3D Secure 2 authentication, and will not proceed to the payment authorization. Default: **false**.
   * @return authenticationOnly Required to trigger the [authentication-only flow](https://docs.adyen.com/online-payments/3d-secure/authentication-only/). If set to **true**, you will only perform the 3D Secure 2 authentication, and will not proceed to the payment authorization. Default: **false**.
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attemptAuthentication, authenticationData.attemptAuthentication) &&
        Objects.equals(this.isSetAttemptAuthentication, authenticationData.isSetAttemptAuthentication) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(attemptAuthentication, isSetAttemptAuthentication, authenticationOnly, isSetAuthenticationOnly, threeDSRequestData, isSetThreeDSRequestData);
  }
