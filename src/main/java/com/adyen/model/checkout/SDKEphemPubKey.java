...
public class SDKEphemPubKey {
  ...
  **/
  ...
  public String toString() {
      String sb = "class SDKEphemPubKey {\n" +
              "    crv: " + toIndentedString(crv) + "\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (SDKEphemPubKey.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in SDKEphemPubKey is not found in the empty JSON string", SDKEphemPubKey.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SDKEphemPubKey.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SDKEphemPubKey` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
