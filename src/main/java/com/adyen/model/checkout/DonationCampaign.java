...
public class DonationCampaign {
   ...
   *
   * @param amounts The object that contains the fixed donation amounts that the shopper can select
   *     from.
   ...
   * The object that contains the fixed donation amounts that the shopper can select from.
   *
   * @return amounts The object that contains the fixed donation amounts that the shopper can select
   *     from.
   */
   ...
   *
   * @param donation The object that contains the details of the donation.
   * @return the current {@code DonationCampaign} instance, allowing for method chaining
   */
   ...
   * The object that contains the details of the donation.
   *
   * @return donation The object that contains the details of the donation.
   */
   ...
   *
   * @param termsAndConditionsUrl The URL of the terms and conditions page of the nonprofit and the
   *     campaign.
   * @return the current {@code DonationCampaign} instance, allowing for method chaining
   */
   ...
   * The URL of the terms and conditions page of the nonprofit and the campaign.
   *
   * @return termsAndConditionsUrl The URL of the terms and conditions page of the nonprofit and the
   *     campaign.
   */
  ...
  public String toString() {
    ...
    sb.append("    nonprofitDescription: ")
        .append(toIndentedString(nonprofitDescription))
        .append("\n");
