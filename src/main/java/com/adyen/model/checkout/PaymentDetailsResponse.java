...
public class PaymentDetailsResponse {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PaymentDetailsResponse
   */
  public static PaymentDetailsResponse fromJson(String jsonString) throws JacksonException {
