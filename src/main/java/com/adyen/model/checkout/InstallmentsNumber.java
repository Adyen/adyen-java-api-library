...
public class InstallmentsNumber {
  ...
  **/
  ...
  public String toString() {
      String sb = "class InstallmentsNumber {\n" +
              "    maxNumberOfInstallments: " + toIndentedString(maxNumberOfInstallments) + "\n" +
              "}";
    return sb;
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to InstallmentsNumber
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (InstallmentsNumber.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in InstallmentsNumber is not found in the empty JSON string", InstallmentsNumber.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!InstallmentsNumber.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InstallmentsNumber` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
