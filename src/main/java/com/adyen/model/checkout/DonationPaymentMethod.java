        ...
        public DonationPaymentMethod deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(ApplePayDonations.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(CardDonations.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(GooglePayDonations.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(IdealDonations.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(PayWithGoogleDonations.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
