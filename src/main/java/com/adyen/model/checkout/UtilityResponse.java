...
public class UtilityResponse {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to UtilityResponse
   */
  public static UtilityResponse fromJson(String jsonString) throws JacksonException {
