...
public class PaymentMethodToStore {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PaymentMethodToStore
   */
  public static PaymentMethodToStore fromJson(String jsonString) throws JacksonException {
