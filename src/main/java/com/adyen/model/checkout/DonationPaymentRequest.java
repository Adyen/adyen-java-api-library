...
public class DonationPaymentRequest {
  ...
  /**
   * The URL to return to in case of a redirection. The format depends on the channel. This URL can
   * have a maximum of 1024 characters. * For web, include the protocol &#x60;http://&#x60; or
   * &#x60;https://&#x60;. You can also include your own additional query parameters, for example,
   * shopper ID or order reference number. Example:
   ...
   *     channel. This URL can have a maximum of 1024 characters. * For web, include the protocol
   *     &#x60;http://&#x60; or &#x60;https://&#x60;. You can also include your own additional query
   *     parameters, for example, shopper ID or order reference number. Example:
