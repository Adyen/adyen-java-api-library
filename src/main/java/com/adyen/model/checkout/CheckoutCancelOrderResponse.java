...
public class CheckoutCancelOrderResponse {
  ...
  **/
  ...
  @Override
  public String toString() {
      String sb = "class CheckoutCancelOrderResponse {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CheckoutCancelOrderResponse.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in CheckoutCancelOrderResponse is not found in the empty JSON string", CheckoutCancelOrderResponse.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CheckoutCancelOrderResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CheckoutCancelOrderResponse` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
