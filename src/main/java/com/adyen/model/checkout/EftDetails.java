...
public class EftDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to EftDetails
   */
  public static EftDetails fromJson(String jsonString) throws JacksonException {
