...
public class ResponseAdditionalDataSepa {
   ...
   */
  public ResponseAdditionalDataSepa sepadirectdebitDateOfSignature(
      String sepadirectdebitDateOfSignature) {
   ...
   *
   * @param sepadirectdebitMandateId Its value corresponds to the pspReference value of the
   *     transaction.
   * @return the current {@code ResponseAdditionalDataSepa} instance, allowing for method chaining
   */
   ...
   * Its value corresponds to the pspReference value of the transaction.
   *
   * @return sepadirectdebitMandateId Its value corresponds to the pspReference value of the
   *     transaction.
   */
  ...
  /**
   * This field can take one of the following values: * OneOff: (OOFF) Direct debit instruction to
   * initiate exactly one direct debit transaction. * First: (FRST) Initial/first collection in a
   * series of direct debit instructions. * Recurring: (RCUR) Direct debit instruction to carry out
   * regular direct debit transactions initiated by the creditor. * Final: (FNAL) Last/final
   * collection in a series of direct debit instructions. Example: OOFF
   *
   * @param sepadirectdebitSequenceType This field can take one of the following values: * OneOff:
   *     (OOFF) Direct debit instruction to initiate exactly one direct debit transaction. * First:
   *     (FRST) Initial/first collection in a series of direct debit instructions. * Recurring:
   *     (RCUR) Direct debit instruction to carry out regular direct debit transactions initiated by
   *     the creditor. * Final: (FNAL) Last/final collection in a series of direct debit
   *     instructions. Example: OOFF
   * @return the current {@code ResponseAdditionalDataSepa} instance, allowing for method chaining
   */
  public ResponseAdditionalDataSepa sepadirectdebitSequenceType(
      String sepadirectdebitSequenceType) {
   ...
   * collection in a series of direct debit instructions. Example: OOFF
   *
   * @return sepadirectdebitSequenceType This field can take one of the following values: * OneOff:
   *     (OOFF) Direct debit instruction to initiate exactly one direct debit transaction. * First:
   *     (FRST) Initial/first collection in a series of direct debit instructions. * Recurring:
   *     (RCUR) Direct debit instruction to carry out regular direct debit transactions initiated by
   *     the creditor. * Final: (FNAL) Last/final collection in a series of direct debit
   ...
   */
  @JsonAnySetter
  public ResponseAdditionalDataSepa putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(
            this.sepadirectdebitDateOfSignature,
            responseAdditionalDataSepa.sepadirectdebitDateOfSignature)
        && Objects.equals(
            this.isSetSepadirectdebitDateOfSignature,
            responseAdditionalDataSepa.isSetSepadirectdebitDateOfSignature)
        && Objects.equals(
            this.sepadirectdebitMandateId, responseAdditionalDataSepa.sepadirectdebitMandateId)
        && Objects.equals(
            this.isSetSepadirectdebitMandateId,
            responseAdditionalDataSepa.isSetSepadirectdebitMandateId)
        && Objects.equals(
            this.sepadirectdebitSepadirectdebitDueDate,
            responseAdditionalDataSepa.sepadirectdebitSepadirectdebitDueDate)
        && Objects.equals(
            this.isSetSepadirectdebitSepadirectdebitDueDate,
            responseAdditionalDataSepa.isSetSepadirectdebitSepadirectdebitDueDate)
        && Objects.equals(
            this.sepadirectdebitSequenceType,
            responseAdditionalDataSepa.sepadirectdebitSequenceType)
        && Objects.equals(
            this.isSetSepadirectdebitSequenceType,
            responseAdditionalDataSepa.isSetSepadirectdebitSequenceType)
        && Objects.equals(
            this.additionalProperties, responseAdditionalDataSepa.additionalProperties);
  }
  ...
  public int hashCode() {
    return Objects.hash(
        ...
        isSetSepadirectdebitMandateId,
        sepadirectdebitSepadirectdebitDueDate,
        isSetSepadirectdebitSepadirectdebitDueDate,
        sepadirectdebitSequenceType,
        isSetSepadirectdebitSequenceType,
  ...
  public String toString() {
    ...
    sb.append("    sepadirectdebitDateOfSignature: ")
        .append(toIndentedString(sepadirectdebitDateOfSignature))
        .append("\n");
  ...
  public Map<String, Object> getExplicitNulls() {
    ...
    if (isSetSepadirectdebitSequenceType) {
      addIfNull(
          nulls, JSON_PROPERTY_SEPADIRECTDEBIT_SEQUENCE_TYPE, this.sepadirectdebitSequenceType);
    }
