...
public class RivertyDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to RivertyDetails
   */
  public static RivertyDetails fromJson(String jsonString) throws JacksonException {
