...
public class RivertyDetails {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(billingAddress, checkoutAttemptId, deliveryAddress, deviceFingerprint, iban, personalDetails, recurringDetailReference, sdkData, storedPaymentMethodId, subtype, type);
  }
