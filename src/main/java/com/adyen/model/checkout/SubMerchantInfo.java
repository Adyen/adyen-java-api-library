...
public class SubMerchantInfo {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to SubMerchantInfo
   */
  public static SubMerchantInfo fromJson(String jsonString) throws JacksonException {
