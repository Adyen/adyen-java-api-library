...
public class ThreeDS2RequestData {
   ...
   *
   * @param acctInfo Additional information about the cardholder’s account provided by the 3DS
   *     Requestor.
   ...
   * Additional information about the cardholder’s account provided by the 3DS Requestor.
   *
   * @return acctInfo Additional information about the cardholder’s account provided by the 3DS
   *     Requestor.
   */
  ...
  /**
   * Display options for the 3D Secure 2 SDK. Optional and only for &#x60;deviceChannel&#x60;
   * **app**.
   *
   * @param deviceRenderOptions Display options for the 3D Secure 2 SDK. Optional and only for
   *     &#x60;deviceChannel&#x60; **app**.
   * @return the current {@code ThreeDS2RequestData} instance, allowing for method chaining
   */
   ...
   * **app**.
   *
   * @return deviceRenderOptions Display options for the 3D Secure 2 SDK. Optional and only for
   *     &#x60;deviceChannel&#x60; **app**.
   */
  ...
  /**
   * The home phone number provided by the cardholder. The phone number must consist of a country
   * code, followed by the number. If the value you provide does not follow the guidelines, we do
   * not submit it for authentication. &gt; Required for Visa and JCB transactions that require 3D
   * Secure 2 authentication, if you did not include the &#x60;shopperEmail&#x60;, and did not send
   * the shopper&#39;s phone number in &#x60;telephoneNumber&#x60;.
   *
   * @param homePhone The home phone number provided by the cardholder. The phone number must
   *     consist of a country code, followed by the number. If the value you provide does not follow
   *     the guidelines, we do not submit it for authentication. &gt; Required for Visa and JCB
   ...
   * the shopper&#39;s phone number in &#x60;telephoneNumber&#x60;.
   *
   * @return homePhone The home phone number provided by the cardholder. The phone number must
   *     consist of a country code, followed by the number. If the value you provide does not follow
   *     the guidelines, we do not submit it for authentication. &gt; Required for Visa and JCB
   *     transactions that require 3D Secure 2 authentication, if you did not include the
   *     &#x60;shopperEmail&#x60;, and did not send the shopper&#39;s phone number in
  ...
  /**
   * The mobile phone number provided by the cardholder. The phone number must consist of a country
   * code, followed by the number. If the value you provide does not follow the guidelines, we do
   * not submit it for authentication. &gt; Required for Visa and JCB transactions that require 3D
   * Secure 2 authentication, if you did not include the &#x60;shopperEmail&#x60;, and did not send
   * the shopper&#39;s phone number in &#x60;telephoneNumber&#x60;.
   *
   * @param mobilePhone The mobile phone number provided by the cardholder. The phone number must
   *     consist of a country code, followed by the number. If the value you provide does not follow
   *     the guidelines, we do not submit it for authentication. &gt; Required for Visa and JCB
   *     transactions that require 3D Secure 2 authentication, if you did not include the
   *     &#x60;shopperEmail&#x60;, and did not send the shopper&#39;s phone number in
   ...
   * the shopper&#39;s phone number in &#x60;telephoneNumber&#x60;.
   *
   * @return mobilePhone The mobile phone number provided by the cardholder. The phone number must
   *     consist of a country code, followed by the number. If the value you provide does not follow
   *     the guidelines, we do not submit it for authentication. &gt; Required for Visa and JCB
   *     transactions that require 3D Secure 2 authentication, if you did not include the
   *     &#x60;shopperEmail&#x60;, and did not send the shopper&#39;s phone number in
  ...
  /**
   * The &#x60;sdkEphemPubKey&#x60; value as received from the 3D Secure 2 SDK. Required for
   * &#x60;deviceChannel&#x60; set to **app**.
   *
   * @param sdkEphemPubKey The &#x60;sdkEphemPubKey&#x60; value as received from the 3D Secure 2
   ...
   * &#x60;deviceChannel&#x60; set to **app**.
   *
   * @return sdkEphemPubKey The &#x60;sdkEphemPubKey&#x60; value as received from the 3D Secure 2
   *     SDK. Required for &#x60;deviceChannel&#x60; set to **app**.
   */
   ...
   * transaction
   *
   * @param threeDSRequestorAuthenticationInfo Information about how the 3DS Requestor authenticated
   *     the cardholder before or during the transaction
   * @return the current {@code ThreeDS2RequestData} instance, allowing for method chaining
   */
   ...
   * transaction
   *
   * @return threeDSRequestorAuthenticationInfo Information about how the 3DS Requestor
   ...
   * transaction.
   *
   * @param threeDSRequestorPriorAuthenticationInfo Information about how the 3DS Requestor
   *     authenticated the cardholder as part of a previous 3DS transaction.
   * @return the current {@code ThreeDS2RequestData} instance, allowing for method chaining
   */
   ...
   * transaction.
   *
   * @return threeDSRequestorPriorAuthenticationInfo Information about how the 3DS Requestor
   *     authenticated the cardholder as part of a previous 3DS transaction.
   */
  ...
  /**
   * The work phone number provided by the cardholder. The phone number must consist of a country
   * code, followed by the number. If the value you provide does not follow the guidelines, we do
   * not submit it for authentication. &gt; Required for Visa and JCB transactions that require 3D
   * Secure 2 authentication, if you did not include the &#x60;shopperEmail&#x60;, and did not send
   * the shopper&#39;s phone number in &#x60;telephoneNumber&#x60;.
   *
   * @param workPhone The work phone number provided by the cardholder. The phone number must
   *     consist of a country code, followed by the number. If the value you provide does not follow
   *     the guidelines, we do not submit it for authentication. &gt; Required for Visa and JCB
   *     transactions that require 3D Secure 2 authentication, if you did not include the
   *     &#x60;shopperEmail&#x60;, and did not send the shopper&#39;s phone number in
   ...
   * the shopper&#39;s phone number in &#x60;telephoneNumber&#x60;.
   *
   * @return workPhone The work phone number provided by the cardholder. The phone number must
   *     consist of a country code, followed by the number. If the value you provide does not follow
   *     the guidelines, we do not submit it for authentication. &gt; Required for Visa and JCB
   *     transactions that require 3D Secure 2 authentication, if you did not include the
   *     &#x60;shopperEmail&#x60;, and did not send the shopper&#39;s phone number in
