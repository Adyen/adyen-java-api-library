...
public class PaymentResponse {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(action, additionalData, amount, donationToken, fraudResult, merchantReference, order, paymentMethod, paymentValidations, pspReference, refusalReason, refusalReasonCode, resultCode, threeDS2ResponseData, threeDS2Result, threeDSPaymentData);
  }
