...
public class CreatePaymentCaptureRequest {
  ...
  **/
  ...
  public String toString() {
      String sb = "class CreatePaymentCaptureRequest {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CreatePaymentCaptureRequest.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePaymentCaptureRequest is not found in the empty JSON string", CreatePaymentCaptureRequest.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreatePaymentCaptureRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePaymentCaptureRequest` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
