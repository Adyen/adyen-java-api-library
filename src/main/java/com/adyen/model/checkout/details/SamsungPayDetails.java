...
public class SamsungPayDetails implements PaymentMethodDetails {
    ...
    public String toString() {
        ...
        sb.append("class SamsungPayDetails {").append(TextConstants.LINE_BREAK);

        sb.append("    fundingSource: ").append(Util.toIndentedString(fundingSource)).append(TextConstants.LINE_BREAK);
        sb.append("    samsungPayToken: ").append(Util.toIndentedString(samsungPayToken)).append(TextConstants.LINE_BREAK);
