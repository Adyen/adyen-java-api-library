...
public class UpdatePaymentLinkRequest {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to UpdatePaymentLinkRequest
   */
  public static UpdatePaymentLinkRequest fromJson(String jsonString) throws JacksonException {
