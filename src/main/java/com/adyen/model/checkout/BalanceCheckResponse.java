...
public class BalanceCheckResponse {
   ...
   * balance check was successful. * **NotEnoughBalance** – Commonly indicates that the card did not
   * have enough balance to pay the amount in the request, or that the currency of the balance on
   * the card did not match the currency of the requested amount. * **Failed** – Indicates that the
   ...
   *
   * @param balance The balance for the payment method.
   * @return the current {@code BalanceCheckResponse} instance, allowing for method chaining
   */
   ...
   * The balance for the payment method.
   *
   * @return balance The balance for the payment method.
   */
   ...
   * balance check failed.
   *
   * @param resultCode The result of the cancellation request. Possible values: * **Success** –
   *     Indicates that the balance check was successful. * **NotEnoughBalance** – Commonly
   *     indicates that the card did not have enough balance to pay the amount in the request, or
   *     that the currency of the balance on the card did not match the currency of the requested
   *     amount. * **Failed** – Indicates that the balance check failed.
   * @return the current {@code BalanceCheckResponse} instance, allowing for method chaining
   */
   ...
   * balance check failed.
   *
   * @return resultCode The result of the cancellation request. Possible values: * **Success** –
   *     Indicates that the balance check was successful. * **NotEnoughBalance** – Commonly
   *     indicates that the card did not have enough balance to pay the amount in the request, or
   *     that the currency of the balance on the card did not match the currency of the requested
   *     amount. * **Failed** – Indicates that the balance check failed.
   ...
   *
   * @param transactionLimit The maximum spendable balance for a single transaction. Applicable to
   *     some gift cards.
   * @return the current {@code BalanceCheckResponse} instance, allowing for method chaining
   */
   ...
   * The maximum spendable balance for a single transaction. Applicable to some gift cards.
   *
   * @return transactionLimit The maximum spendable balance for a single transaction. Applicable to
   *     some gift cards.
   */
