...
public class MolPayDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to MolPayDetails
   */
  public static MolPayDetails fromJson(String jsonString) throws JacksonException {
