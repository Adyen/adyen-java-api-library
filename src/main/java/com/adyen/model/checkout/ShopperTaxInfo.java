...
public class ShopperTaxInfo {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to ShopperTaxInfo
   */
  public static ShopperTaxInfo fromJson(String jsonString) throws JacksonException {
