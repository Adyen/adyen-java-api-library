...
public class StoredPaymentMethodDetails {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class StoredPaymentMethodDetails {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (StoredPaymentMethodDetails.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in StoredPaymentMethodDetails is not found in the empty JSON string", StoredPaymentMethodDetails.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!StoredPaymentMethodDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StoredPaymentMethodDetails` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
