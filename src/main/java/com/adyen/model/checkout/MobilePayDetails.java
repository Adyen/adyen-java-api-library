...
public class MobilePayDetails {
  ...
  **/
  ...
  @Override
  public String toString() {
      String sb = "class MobilePayDetails {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (MobilePayDetails.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in MobilePayDetails is not found in the empty JSON string", MobilePayDetails.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!MobilePayDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MobilePayDetails` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
