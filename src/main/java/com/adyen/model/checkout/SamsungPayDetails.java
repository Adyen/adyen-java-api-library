...
public class SamsungPayDetails {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class SamsungPayDetails {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (SamsungPayDetails.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in SamsungPayDetails is not found in the empty JSON string", SamsungPayDetails.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SamsungPayDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SamsungPayDetails` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
