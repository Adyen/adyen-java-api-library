...
/** TaxTotal */
@JsonPropertyOrder({TaxTotal.JSON_PROPERTY_AMOUNT})
public class TaxTotal {
   ...
   */
  public TaxTotal includeNullValues(boolean includeNullValues) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, taxTotal.amount)
        && Objects.equals(this.isSetAmount, taxTotal.isSetAmount);
  }
   ...
   * @throws JacksonException if the JSON string is invalid with respect to TaxTotal
   */
  public static TaxTotal fromJson(String jsonString) throws JacksonException {
