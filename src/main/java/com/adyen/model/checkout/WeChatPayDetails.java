...
public class WeChatPayDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to WeChatPayDetails
   */
  public static WeChatPayDetails fromJson(String jsonString) throws JacksonException {
