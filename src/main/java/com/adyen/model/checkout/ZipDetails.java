...
public class ZipDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to ZipDetails
   */
  public static ZipDetails fromJson(String jsonString) throws JacksonException {
