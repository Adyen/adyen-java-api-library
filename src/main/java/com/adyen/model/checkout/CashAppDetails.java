...
public class CashAppDetails {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cashtag, checkoutAttemptId, customerId, grantId, onFileGrantId, recurringDetailReference, requestId, sdkData, storedPaymentMethodId, subtype, type);
  }
