...
public class CashAppDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to CashAppDetails
   */
  public static CashAppDetails fromJson(String jsonString) throws JacksonException {
