...
public class PaymentValidationsNameResponse {
   ...
   *
   * @param rawResponse Contains the raw response(s) returned by the scheme for the name validation.
   ...
   * Contains the raw response(s) returned by the scheme for the name validation.
   *
   * @return rawResponse Contains the raw response(s) returned by the scheme for the name
   *     validation.
   */
   ...
   *
   * @param result Contains the scheme-agnostic match values returned by Adyen.
   * @return the current {@code PaymentValidationsNameResponse} instance, allowing for method
   *     chaining
   */
   ...
   * Contains the scheme-agnostic match values returned by Adyen.
   *
   * @return result Contains the scheme-agnostic match values returned by Adyen.
   */
