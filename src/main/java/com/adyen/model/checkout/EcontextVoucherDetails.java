...
public class EcontextVoucherDetails {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class EcontextVoucherDetails {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (EcontextVoucherDetails.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in EcontextVoucherDetails is not found in the empty JSON string", EcontextVoucherDetails.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!EcontextVoucherDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EcontextVoucherDetails` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
