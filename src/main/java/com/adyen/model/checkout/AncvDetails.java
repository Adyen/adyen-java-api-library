...
public class AncvDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to AncvDetails
   */
  public static AncvDetails fromJson(String jsonString) throws JacksonException {
