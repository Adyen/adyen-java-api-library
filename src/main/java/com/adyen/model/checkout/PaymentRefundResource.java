...
public class PaymentRefundResource {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class PaymentRefundResource {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (PaymentRefundResource.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentRefundResource is not found in the empty JSON string", PaymentRefundResource.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PaymentRefundResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentRefundResource` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
