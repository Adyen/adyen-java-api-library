...
public class PaymentVerificationRequest {
  ...
  **/
  ...
  public String toString() {
      String sb = "class PaymentVerificationRequest {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (PaymentVerificationRequest.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentVerificationRequest is not found in the empty JSON string", PaymentVerificationRequest.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PaymentVerificationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentVerificationRequest` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
