...
import com.adyen.model.checkout.PaymentValidations;
...
import com.adyen.model.checkout.Surcharge;
...
public class PaymentRequest {
   ...
   *
   * @param origin &gt; Required for browser-based (&#x60;channel&#x60; **Web**) 3D Secure 2 transactions.Set this to the origin URL of the page where you are rendering the Drop-in/Component. Do not include subdirectories and a trailing slash.
   * @return the current {@code PaymentRequest} instance, allowing for method chaining
   */
  ...
  /**
   * &gt; Required for browser-based (&#x60;channel&#x60; **Web**) 3D Secure 2 transactions.Set this to the origin URL of the page where you are rendering the Drop-in/Component. Do not include subdirectories and a trailing slash.
   * @return origin &gt; Required for browser-based (&#x60;channel&#x60; **Web**) 3D Secure 2 transactions.Set this to the origin URL of the page where you are rendering the Drop-in/Component. Do not include subdirectories and a trailing slash.
   */
   ...
   *
   * @param subMerchants This field contains additional information on the submerchant, who is onboarded to an acquirer through a payment facilitator or aggregator
   * @return the current {@code PaymentRequest} instance, allowing for method chaining
   */
  ...
  /**
   * This field contains additional information on the submerchant, who is onboarded to an acquirer through a payment facilitator or aggregator
   * @return subMerchants This field contains additional information on the submerchant, who is onboarded to an acquirer through a payment facilitator or aggregator
   */
   ...
   *
   * @param threeDSAuthenticationOnly Required to trigger the [authentication-only flow](https://docs.adyen.com/online-payments/3d-secure/authentication-only/). If set to **true**, you will only perform the 3D Secure 2 authentication, and will not proceed to the payment authorisation.Default: **false**.
   * @return the current {@code PaymentRequest} instance, allowing for method chaining
   *
  ...
  /**
   * Required to trigger the [authentication-only flow](https://docs.adyen.com/online-payments/3d-secure/authentication-only/). If set to **true**, you will only perform the 3D Secure 2 authentication, and will not proceed to the payment authorisation.Default: **false**.
   * @return threeDSAuthenticationOnly Required to trigger the [authentication-only flow](https://docs.adyen.com/online-payments/3d-secure/authentication-only/). If set to **true**, you will only perform the 3D Secure 2 authentication, and will not proceed to the payment authorisation.Default: **false**.
   * @deprecated // deprecated since Adyen Checkout API v69: Use `authenticationData.authenticationOnly` instead.
   */
  @Deprecated // deprecated since Adyen Checkout API v69: Use `authenticationData.authenticationOnly` instead.
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountInfo, paymentRequest.accountInfo) &&
        ...
        Objects.equals(this.isSetLocalizedShopperStatement, paymentRequest.isSetLocalizedShopperStatement) &&
        ...
        Objects.equals(this.isSetMerchantOrderReference, paymentRequest.isSetMerchantOrderReference) &&
        Objects.equals(this.merchantRiskIndicator, paymentRequest.merchantRiskIndicator) &&
        Objects.equals(this.isSetMerchantRiskIndicator, paymentRequest.isSetMerchantRiskIndicator) &&
        ...
        Objects.equals(this.isSetPlatformChargebackLogic, paymentRequest.isSetPlatformChargebackLogic) &&
        ...
        Objects.equals(this.isSetRecurringProcessingModel, paymentRequest.isSetRecurringProcessingModel) &&
        Objects.equals(this.redirectFromIssuerMethod, paymentRequest.redirectFromIssuerMethod) &&
        Objects.equals(this.isSetRedirectFromIssuerMethod, paymentRequest.isSetRedirectFromIssuerMethod) &&
        Objects.equals(this.redirectToIssuerMethod, paymentRequest.redirectToIssuerMethod) &&
        Objects.equals(this.isSetRedirectToIssuerMethod, paymentRequest.isSetRedirectToIssuerMethod) &&
        ...
        Objects.equals(this.isSetThreeDSAuthenticationOnly, paymentRequest.isSetThreeDSAuthenticationOnly) &&
