...
@JsonPropertyOrder({
  ...
  PaymentRequest.JSON_PROPERTY_ENHANCED_SCHEME_DATA,
...
public class PaymentRequest {
   ...
   *
   * @param authenticationData Data for 3DS authentication.
   * @return the current {@code PaymentRequest} instance, allowing for method chaining
   */
   ...
   * Data for 3DS authentication.
   *
   * @return authenticationData Data for 3DS authentication.
   */
  ...
  /**
   * The details of the bank account, from which the payment should be made. &gt; Either
   * &#x60;bankAccount&#x60; or &#x60;card&#x60; field must be provided in a payment request.
   *
   * @param bankAccount The details of the bank account, from which the payment should be made. &gt;
   ...
   * &#x60;bankAccount&#x60; or &#x60;card&#x60; field must be provided in a payment request.
   *
   * @return bankAccount The details of the bank account, from which the payment should be made.
   *     &gt; Either &#x60;bankAccount&#x60; or &#x60;card&#x60; field must be provided in a payment
   *     request.
   */
  ...
  /**
   * The [delay between the authorization and automatic
   * capture](https://docs.adyen.com/online-payments/capture?tab&#x3D;delayed-individual_2#delayed-automatic-capture)
   * of the payment, specified in hours. Maximum value: **672** (28 days).
   *
   * @param captureDelayHours The [delay between the authorization and automatic
   *     capture](https://docs.adyen.com/online-payments/capture?tab&#x3D;delayed-individual_2#delayed-automatic-capture)
   *     of the payment, specified in hours. Maximum value: **672** (28 days).
   * @return the current {@code PaymentRequest} instance, allowing for method chaining
   */
   ...
   * of the payment, specified in hours. Maximum value: **672** (28 days).
   *
   * @return captureDelayHours The [delay between the authorization and automatic
   *     capture](https://docs.adyen.com/online-payments/capture?tab&#x3D;delayed-individual_2#delayed-automatic-capture)
   *     of the payment, specified in hours. Maximum value: **672** (28 days).
   */
   ...
   *
   * @param company Information regarding the company.
   * @return the current {@code PaymentRequest} instance, allowing for method chaining
   */
   ...
   * Information regarding the company.
   *
   * @return company Information regarding the company.
   */
  ...
  /**
   * The shopper country code. Format: [ISO 3166-1
   * alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) Example: NL or DE
   *
   * @param countryCode The shopper country code. Format: [ISO 3166-1
   *     alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) Example: NL or DE
   * @return the current {@code PaymentRequest} instance, allowing for method chaining
   */
   ...
   * alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) Example: NL or DE
   *
   * @return countryCode The shopper country code. Format: [ISO 3166-1
   *     alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) Example: NL or DE
   */
  ...
  /**
   * [Enhanced scheme data](https://docs.adyen.com/payment-methods/cards/enhanced-scheme-data/) that
   * may be required for processing the payment and/or interchange savings can apply.
   *
   * @param enhancedSchemeData [Enhanced scheme
   *     data](https://docs.adyen.com/payment-methods/cards/enhanced-scheme-data/) that may be
   *     required for processing the payment and/or interchange savings can apply.
   * @return the current {@code PaymentRequest} instance, allowing for method chaining
   */
   ...
   * may be required for processing the payment and/or interchange savings can apply.
   *
   * @return enhancedSchemeData [Enhanced scheme
   *     data](https://docs.adyen.com/payment-methods/cards/enhanced-scheme-data/) that may be
   *     required for processing the payment and/or interchange savings can apply.
   */
   ...
   *
   * @param mandate The mandate details to initiate recurring transaction.
   * @return the current {@code PaymentRequest} instance, allowing for method chaining
   */
   ...
   * The mandate details to initiate recurring transaction.
   *
   * @return mandate The mandate details to initiate recurring transaction.
   */
   ...
   * another, in case of authorization retries. * Additionally include the following parameters in
   * the &#x60;additionalData&#x60; object:
   * [&#x60;retry.orderAttemptNumber&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/sessions#request-additionalData-AdditionalDataRetry-retry-orderAttemptNumber),
   * [&#x60;retry.chainAttemptNumber&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/sessions#request-additionalData-AdditionalDataRetry-retry-chainAttemptNumber),
   * and
   ...
   *     benefit from linking payment requests to one another, in case of authorization retries. *
   *     Additionally include the following parameters in the &#x60;additionalData&#x60; object:
   *     [&#x60;retry.orderAttemptNumber&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/sessions#request-additionalData-AdditionalDataRetry-retry-orderAttemptNumber),
   *     [&#x60;retry.chainAttemptNumber&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/sessions#request-additionalData-AdditionalDataRetry-retry-chainAttemptNumber),
   *     and
   *     [&#x60;retry.skipRetry&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/sessions#request-additionalData-AdditionalDataRetry-retry-skipRetry)
  ...
  /**
   * Authentication data produced by an MPI (Mastercard SecureCode, Visa Secure, or Cartes
   * Bancaires).
   *
   * @param mpiData Authentication data produced by an MPI (Mastercard SecureCode, Visa Secure, or
   *     Cartes Bancaires).
   * @return the current {@code PaymentRequest} instance, allowing for method chaining
   */
   ...
   * Bancaires).
   *
   * @return mpiData Authentication data produced by an MPI (Mastercard SecureCode, Visa Secure, or
   *     Cartes Bancaires).
   */
   ...
   * The order information required for partial payments.
   *
   * @return order The order information required for partial payments.
   */
   ...
   *
   * @param paymentValidations The object that you can use to enable payment validations for a
   *     transaction.
   * @return the current {@code PaymentRequest} instance, allowing for method chaining
   */
   ...
   * The object that you can use to enable payment validations for a transaction.
   *
   * @return paymentValidations The object that you can use to enable payment validations for a
   *     transaction.
   */
   ...
   *
   * @param platformChargebackLogic Defines how to book chargebacks when using [Adyen for
   *     Platforms](https://docs.adyen.com/adyen-for-platforms-model).
   * @return the current {@code PaymentRequest} instance, allowing for method chaining
   */
   ...
   * Platforms](https://docs.adyen.com/adyen-for-platforms-model).
   *
   * @return platformChargebackLogic Defines how to book chargebacks when using [Adyen for
   *     Platforms](https://docs.adyen.com/adyen-for-platforms-model).
   */
   ...
   *
   * @param riskData Contains risk data, such as client-side data, used to identify risk for a
   *     transaction.
   * @return the current {@code PaymentRequest} instance, allowing for method chaining
   */
   ...
   * Contains risk data, such as client-side data, used to identify risk for a transaction.
   *
   * @return riskData Contains risk data, such as client-side data, used to identify risk for a
   *     transaction.
   */
  ...
  /**
   * The shopper&#39;s email address, in valid [RFC-5322](https://www.rfc-editor.org/rfc/rfc5322)
   * format. We recommend that you provide this data, because it is used in velocity fraud checks.
   * &gt; Required for Visa and JCB transactions that require 3D Secure 2 authentication if you did
   * not include the &#x60;telephoneNumber&#x60;.
   *
   * @param shopperEmail The shopper&#39;s email address, in valid
   *     [RFC-5322](https://www.rfc-editor.org/rfc/rfc5322) format. We recommend that you provide
   *     this data, because it is used in velocity fraud checks. &gt; Required for Visa and JCB
   ...
   * not include the &#x60;telephoneNumber&#x60;.
   *
   * @return shopperEmail The shopper&#39;s email address, in valid
   *     [RFC-5322](https://www.rfc-editor.org/rfc/rfc5322) format. We recommend that you provide
   *     this data, because it is used in velocity fraud checks. &gt; Required for Visa and JCB
   *     transactions that require 3D Secure 2 authentication if you did not include the
   *     &#x60;telephoneNumber&#x60;.
   ...
   *
   * @param shopperTaxInfo The tax info of the shopper
   * @return the current {@code PaymentRequest} instance, allowing for method chaining
   */
   ...
   * The tax info of the shopper
   *
   * @return shopperTaxInfo The tax info of the shopper
   */
   ...
   *
   * @param subMerchants This field contains additional information on the submerchant, who is
   ...
   * through a payment facilitator or aggregator
   *
   * @return subMerchants This field contains additional information on the submerchant, who is
   *     onboarded to an acquirer through a payment facilitator or aggregator
   */
   ...
   *
   * @param surcharge The [surcharge](https://docs.adyen.com/online-payments/surcharge/) amount to
   ...
   * to comply with regulatory requirements when applying surcharge.
   *
   * @return surcharge The [surcharge](https://docs.adyen.com/online-payments/surcharge/) amount to
   *     apply to the transaction, in [minor
   *     units](https://docs.adyen.com/development-resources/currency-codes). When you apply
   *     surcharge, include the surcharge in the &#x60;amount.value&#x60; field. Review our
   *     [Surcharge compliance
