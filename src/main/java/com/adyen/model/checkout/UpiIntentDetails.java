...
public class UpiIntentDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to UpiIntentDetails
   */
  public static UpiIntentDetails fromJson(String jsonString) throws JacksonException {
