...
public class UpiIntentDetails {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class UpiIntentDetails {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (UpiIntentDetails.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpiIntentDetails is not found in the empty JSON string", UpiIntentDetails.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpiIntentDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpiIntentDetails` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
