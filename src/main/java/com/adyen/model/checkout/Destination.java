...
public class Destination {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to Destination
   */
  public static Destination fromJson(String jsonString) throws JacksonException {
