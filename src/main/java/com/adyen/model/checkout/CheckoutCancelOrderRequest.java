...
public class CheckoutCancelOrderRequest {
  ...
  **/
  ...
  public String toString() {
      String sb = "class CheckoutCancelOrderRequest {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CheckoutCancelOrderRequest.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in CheckoutCancelOrderRequest is not found in the empty JSON string", CheckoutCancelOrderRequest.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CheckoutCancelOrderRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CheckoutCancelOrderRequest` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
