...
public class Donation {
  ...
  @Deprecated private String donationType;
   ...
   * @throws JacksonException if the JSON string is invalid with respect to Donation
   */
  public static Donation fromJson(String jsonString) throws JacksonException {
