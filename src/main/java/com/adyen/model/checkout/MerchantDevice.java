...
public class MerchantDevice {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to MerchantDevice
   */
  public static MerchantDevice fromJson(String jsonString) throws JacksonException {
