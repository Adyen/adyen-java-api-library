...
public class CheckoutNativeRedirectAction {
  ...
  /**
   * Native SDK&#39;s redirect data containing the direct issuer link and state data that must be
   * submitted to the /v1/nativeRedirect/redirectResult.
   *
   * @param nativeRedirectData Native SDK&#39;s redirect data containing the direct issuer link and
   *     state data that must be submitted to the /v1/nativeRedirect/redirectResult.
   * @return the current {@code CheckoutNativeRedirectAction} instance, allowing for method chaining
   */
   ...
   * submitted to the /v1/nativeRedirect/redirectResult.
   *
   * @return nativeRedirectData Native SDK&#39;s redirect data containing the direct issuer link and
   *     state data that must be submitted to the /v1/nativeRedirect/redirectResult.
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, checkoutNativeRedirectAction.data)
        ...
        && Objects.equals(
            this.isSetNativeRedirectData, checkoutNativeRedirectAction.isSetNativeRedirectData)
        && Objects.equals(this.paymentMethodType, checkoutNativeRedirectAction.paymentMethodType)
        && Objects.equals(
            this.isSetPaymentMethodType, checkoutNativeRedirectAction.isSetPaymentMethodType)
