...
public class PaymentAmountUpdateResource {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class PaymentAmountUpdateResource {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (PaymentAmountUpdateResource.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentAmountUpdateResource is not found in the empty JSON string", PaymentAmountUpdateResource.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PaymentAmountUpdateResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentAmountUpdateResource` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
