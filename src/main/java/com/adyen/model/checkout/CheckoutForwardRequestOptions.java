...
public class CheckoutForwardRequestOptions {
   ...
   *
   * @param networkToken The object that contains the details for forwarding a network token.
   * @return the current {@code CheckoutForwardRequestOptions} instance, allowing for method
   *     chaining
   */
   ...
   * The object that contains the details for forwarding a network token.
   *
   * @return networkToken The object that contains the details for forwarding a network token.
   */
