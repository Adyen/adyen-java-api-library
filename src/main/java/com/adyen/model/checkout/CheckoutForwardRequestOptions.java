...
import com.adyen.model.checkout.CheckoutNetworkTokenOption;
...
public class CheckoutForwardRequestOptions {
   ...
   * @return the current {@code CheckoutForwardRequestOptions} instance, allowing for method chaining
   */
   ...
   *
   * @param dryRun Set to **true** to receive a copy of the request Adyen is making to the third party in the response. Any sensitive information will be masked in the response you receive. This functionality is only available in the test environment.
   * @return the current {@code CheckoutForwardRequestOptions} instance, allowing for method chaining
   */
  ...
  /**
   * Set to **true** to receive a copy of the request Adyen is making to the third party in the response. Any sensitive information will be masked in the response you receive. This functionality is only available in the test environment.
   * @return dryRun Set to **true** to receive a copy of the request Adyen is making to the third party in the response. Any sensitive information will be masked in the response you receive. This functionality is only available in the test environment.
   */
   ...
   *
   * @param networkTxReferencePaths Set in tokenize:true case when forwarding PAN. Addresses to the possible location(s) of networkTxReference in the incoming 3rd party response
   * @return the current {@code CheckoutForwardRequestOptions} instance, allowing for method chaining
   */
  ...
  /**
   * Set in tokenize:true case when forwarding PAN. Addresses to the possible location(s) of networkTxReference in the incoming 3rd party response
   * @return networkTxReferencePaths Set in tokenize:true case when forwarding PAN. Addresses to the possible location(s) of networkTxReference in the incoming 3rd party response
   */
   ...
   *
   * @param tokenize Set to **true**, the payment details are [tokenized](https://docs.adyen.com/online-payments/tokenization).
   * @return the current {@code CheckoutForwardRequestOptions} instance, allowing for method chaining
   */
  ...
  /**
   * Set to **true**, the payment details are [tokenized](https://docs.adyen.com/online-payments/tokenization).
   * @return tokenize Set to **true**, the payment details are [tokenized](https://docs.adyen.com/online-payments/tokenization).
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountUpdate, checkoutForwardRequestOptions.accountUpdate) &&
        ...
        Objects.equals(this.networkTxReferencePaths, checkoutForwardRequestOptions.networkTxReferencePaths) &&
        Objects.equals(this.isSetNetworkTxReferencePaths, checkoutForwardRequestOptions.isSetNetworkTxReferencePaths) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountUpdate, isSetAccountUpdate, dryRun, isSetDryRun, networkToken, isSetNetworkToken, networkTxReferencePaths, isSetNetworkTxReferencePaths, tokenize, isSetTokenize);
  }
...
/**
   ...
   * @throws JsonProcessingException if the JSON string is invalid with respect to CheckoutForwardRequestOptions
   */
  public static CheckoutForwardRequestOptions fromJson(String jsonString) throws JsonProcessingException {
