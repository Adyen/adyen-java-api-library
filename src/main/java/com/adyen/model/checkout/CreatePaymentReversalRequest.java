...
public class CreatePaymentReversalRequest {
  ...
  **/
  ...
  public String toString() {
      String sb = "class CreatePaymentReversalRequest {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CreatePaymentReversalRequest.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePaymentReversalRequest is not found in the empty JSON string", CreatePaymentReversalRequest.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreatePaymentReversalRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePaymentReversalRequest` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
