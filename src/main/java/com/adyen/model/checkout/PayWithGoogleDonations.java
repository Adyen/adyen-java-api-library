...
public class PayWithGoogleDonations {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PayWithGoogleDonations
   */
  public static PayWithGoogleDonations fromJson(String jsonString) throws JacksonException {
