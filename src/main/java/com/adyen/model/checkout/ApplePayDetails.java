...
public class ApplePayDetails {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class ApplePayDetails {\n" +
            "    applePayToken: " + toIndentedString(applePayToken) + "\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ApplePayDetails.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApplePayDetails is not found in the empty JSON string", ApplePayDetails.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ApplePayDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApplePayDetails` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
