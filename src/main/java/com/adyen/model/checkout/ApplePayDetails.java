...
public class ApplePayDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to ApplePayDetails
   */
  public static ApplePayDetails fromJson(String jsonString) throws JacksonException {
