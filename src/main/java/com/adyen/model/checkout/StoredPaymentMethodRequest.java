...
public class StoredPaymentMethodRequest {
   ...
   *
   * @param paymentMethod Contains the information required to store a payment method.
   * @return the current {@code StoredPaymentMethodRequest} instance, allowing for method chaining
   */
   ...
   * Contains the information required to store a payment method.
   *
   * @return paymentMethod Contains the information required to store a payment method.
   */
   ...
   *     as it is used in velocity fraud checks.
   * @return the current {@code StoredPaymentMethodRequest} instance, allowing for method chaining
   */
   ...
   *
   * @param shopperReference A unique identifier for the shopper (for example, user ID or account
   *     ID).
   * @return the current {@code StoredPaymentMethodRequest} instance, allowing for method chaining
   */
   ...
   * A unique identifier for the shopper (for example, user ID or account ID).
   *
   * @return shopperReference A unique identifier for the shopper (for example, user ID or account
   *     ID).
   */
