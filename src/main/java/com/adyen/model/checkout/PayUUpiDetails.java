...
public class PayUUpiDetails {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class PayUUpiDetails {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (PayUUpiDetails.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayUUpiDetails is not found in the empty JSON string", PayUUpiDetails.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PayUUpiDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PayUUpiDetails` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
