...
public class PayUUpiDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PayUUpiDetails
   */
  public static PayUUpiDetails fromJson(String jsonString) throws JacksonException {
