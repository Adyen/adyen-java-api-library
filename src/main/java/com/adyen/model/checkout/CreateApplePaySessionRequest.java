...
public class CreateApplePaySessionRequest {
  ...
  **/
  ...
  public String toString() {
      String sb = "class CreateApplePaySessionRequest {\n" +
              "    displayName: " + toIndentedString(displayName) + "\n" +
              "    domainName: " + toIndentedString(domainName) + "\n" +
              "    merchantIdentifier: " + toIndentedString(merchantIdentifier) + "\n" +
              "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CreateApplePaySessionRequest.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateApplePaySessionRequest is not found in the empty JSON string", CreateApplePaySessionRequest.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateApplePaySessionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateApplePaySessionRequest` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
