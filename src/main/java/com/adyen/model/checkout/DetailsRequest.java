...
public class DetailsRequest {
  ...
  **/
  ...
  public String toString() {
      String sb = "class DetailsRequest {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (DetailsRequest.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetailsRequest is not found in the empty JSON string", DetailsRequest.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DetailsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetailsRequest` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
      ...
      if (jsonObj.getAsJsonObject("authenticationData") != null) {
        DetailsRequestAuthenticationData.validateJsonObject(jsonObj.getAsJsonObject("authenticationData"));
      }
