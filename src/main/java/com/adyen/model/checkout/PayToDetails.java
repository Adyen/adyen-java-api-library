...
public class PayToDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PayToDetails
   */
  public static PayToDetails fromJson(String jsonString) throws JacksonException {
