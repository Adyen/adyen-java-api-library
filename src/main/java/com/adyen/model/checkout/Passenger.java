...
public class Passenger {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dateOfBirth, isSetDateOfBirth, firstName, isSetFirstName, lastName, isSetLastName, phoneNumber, isSetPhoneNumber, travellerType, isSetTravellerType);
  }
