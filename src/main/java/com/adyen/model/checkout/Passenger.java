...
public class Passenger {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to Passenger
   */
  public static Passenger fromJson(String jsonString) throws JacksonException {
