...
public class ForexQuote {
   ...
   *
   * @param interbank The interbank amount.
   * @return the current {@code ForexQuote} instance, allowing for method chaining
   */
   ...
   * The interbank amount.
   *
   * @return interbank The interbank amount.
   */
