...
public class EncryptedOrderData {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to EncryptedOrderData
   */
  public static EncryptedOrderData fromJson(String jsonString) throws JacksonException {
