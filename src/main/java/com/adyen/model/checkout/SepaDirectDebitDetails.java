...
public class SepaDirectDebitDetails {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class SepaDirectDebitDetails {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (SepaDirectDebitDetails.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in SepaDirectDebitDetails is not found in the empty JSON string", SepaDirectDebitDetails.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SepaDirectDebitDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SepaDirectDebitDetails` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
