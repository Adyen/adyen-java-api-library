...
public class SepaDirectDebitDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to SepaDirectDebitDetails
   */
  public static SepaDirectDebitDetails fromJson(String jsonString) throws JacksonException {
