...
public class PaymentReversalRequest {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PaymentReversalRequest
   */
  public static PaymentReversalRequest fromJson(String jsonString) throws JacksonException {
