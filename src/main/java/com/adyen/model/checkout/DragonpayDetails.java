...
public class DragonpayDetails {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class DragonpayDetails {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (DragonpayDetails.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in DragonpayDetails is not found in the empty JSON string", DragonpayDetails.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DragonpayDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DragonpayDetails` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
