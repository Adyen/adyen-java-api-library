...
public class UpiCollectDetails {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class UpiCollectDetails {\n" +
            "    billingSequenceNumber: " + toIndentedString(billingSequenceNumber) + "\n" +
            ...
            "    virtualPaymentAddress: " + toIndentedString(virtualPaymentAddress) + "\n" +
            "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (UpiCollectDetails.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpiCollectDetails is not found in the empty JSON string", UpiCollectDetails.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpiCollectDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpiCollectDetails` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
