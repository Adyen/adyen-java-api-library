...
public class FraudCheckResult {
  ...
  **/
  ...
  public String toString() {
      String sb = "class FraudCheckResult {\n" +
              "    accountScore: " + toIndentedString(accountScore) + "\n" +
              "    checkId: " + toIndentedString(checkId) + "\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (FraudCheckResult.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in FraudCheckResult is not found in the empty JSON string", FraudCheckResult.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!FraudCheckResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FraudCheckResult` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
