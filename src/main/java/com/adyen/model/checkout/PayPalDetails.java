...
public class PayPalDetails {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(checkoutAttemptId, orderID, payeePreferred, payerID, payerSelected, recurringDetailReference, sdkData, storedPaymentMethodId, subtype, type);
  }
