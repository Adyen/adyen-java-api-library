...
public class CheckoutUtilityRequest {
  ...
  **/
  ...
  public String toString() {
      String sb = "class CheckoutUtilityRequest {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CheckoutUtilityRequest.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in CheckoutUtilityRequest is not found in the empty JSON string", CheckoutUtilityRequest.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CheckoutUtilityRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CheckoutUtilityRequest` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
