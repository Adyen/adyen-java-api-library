...
public class AfterpayDetails {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class AfterpayDetails {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (AfterpayDetails.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in AfterpayDetails is not found in the empty JSON string", AfterpayDetails.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AfterpayDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AfterpayDetails` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
