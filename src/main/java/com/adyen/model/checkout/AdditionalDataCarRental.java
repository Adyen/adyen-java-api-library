...
public class AdditionalDataCarRental {
   ...
   * maxLength: 17 * For US and CA numbers must be 10 characters in length * Must not start with a
   * space * Must not contain any special characters such as + or - *Must not be all zeros.
   *
   * @param carRentalCustomerServiceTollFreeNumber The customer service phone number of the car
   *     rental company. * Format: Alphanumeric * maxLength: 17 * For US and CA numbers must be 10
   *     characters in length * Must not start with a space * Must not contain any special
   *     characters such as + or - *Must not be all zeros.
   * @return the current {@code AdditionalDataCarRental} instance, allowing for method chaining
   */
   ...
   * space * Must not contain any special characters such as + or - *Must not be all zeros.
   *
   * @return carRentalCustomerServiceTollFreeNumber The customer service phone number of the car
   *     rental company. * Format: Alphanumeric * maxLength: 17 * For US and CA numbers must be 10
   *     characters in length * Must not start with a space * Must not contain any special
   *     characters such as + or - *Must not be all zeros.
   */
  ...
  /**
   * Number of days for which the car is being rented. * Format: Numeric * maxLength: 4 * Must not
   * be all spaces
   *
   * @param carRentalDaysRented Number of days for which the car is being rented. * Format: Numeric
   *     * maxLength: 4 * Must not be all spaces
   * @return the current {@code AdditionalDataCarRental} instance, allowing for method chaining
   */
   ...
   * be all spaces
   *
   * @return carRentalDaysRented Number of days for which the car is being rented. * Format: Numeric
   *     * maxLength: 4 * Must not be all spaces
   */
   ...
   * maxLength: 12
   *
   * @param carRentalFuelCharges Any fuel charges associated with the rental, in [minor
   *     units](https://docs.adyen.com/development-resources/currency-codes). * Format: Numeric *
   *     maxLength: 12
   * @return the current {@code AdditionalDataCarRental} instance, allowing for method chaining
   */
   ...
   * maxLength: 12
   *
   * @return carRentalFuelCharges Any fuel charges associated with the rental, in [minor
   *     units](https://docs.adyen.com/development-resources/currency-codes). * Format: Numeric *
   *     maxLength: 12
   */
   ...
   * units](https://docs.adyen.com/development-resources/currency-codes). * Format: Numeric *
   * maxLength: 12 * Must not be all spaces *Must not be all zeros.
   *
   * @param carRentalInsuranceCharges Any insurance charges associated with the rental, in [minor
   *     units](https://docs.adyen.com/development-resources/currency-codes). * Format: Numeric *
   *     maxLength: 12 * Must not be all spaces *Must not be all zeros.
   * @return the current {@code AdditionalDataCarRental} instance, allowing for method chaining
   */
   ...
   * maxLength: 12 * Must not be all spaces *Must not be all zeros.
   *
   * @return carRentalInsuranceCharges Any insurance charges associated with the rental, in [minor
   *     units](https://docs.adyen.com/development-resources/currency-codes). * Format: Numeric *
   *     maxLength: 12 * Must not be all spaces *Must not be all zeros.
   */
  ...
  /**
   * The city where the car is rented. * Format: Alphanumeric * maxLength: 18 * Must not start with
   * a space or be all spaces *Must not be all zeros.
   *
   * @param carRentalLocationCity The city where the car is rented. * Format: Alphanumeric *
   *     maxLength: 18 * Must not start with a space or be all spaces *Must not be all zeros.
   * @return the current {@code AdditionalDataCarRental} instance, allowing for method chaining
   */
   ...
   * a space or be all spaces *Must not be all zeros.
   *
   * @return carRentalLocationCity The city where the car is rented. * Format: Alphanumeric *
   *     maxLength: 18 * Must not start with a space or be all spaces *Must not be all zeros.
   */
   ...
   * alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) format. * Format: Alphanumeric *
   * maxLength: 2
   *
   * @param carRentalLocationCountry The country where the car is rented, in [ISO 3166-1
   *     alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) format. * Format: Alphanumeric *
   *     maxLength: 2
   * @return the current {@code AdditionalDataCarRental} instance, allowing for method chaining
   */
   ...
   * maxLength: 2
   *
   * @return carRentalLocationCountry The country where the car is rented, in [ISO 3166-1
   *     alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) format. * Format: Alphanumeric *
   *     maxLength: 2
   */
  ...
  /**
   * The state or province where the car is rented. * Format: Alphanumeric * maxLength: 2 * Must not
   * start with a space or be all spaces *Must not be all zeros.
   *
   * @param carRentalLocationStateProvince The state or province where the car is rented. * Format:
   *     Alphanumeric * maxLength: 2 * Must not start with a space or be all spaces *Must not be all
   *     zeros.
   * @return the current {@code AdditionalDataCarRental} instance, allowing for method chaining
   */
   ...
   * start with a space or be all spaces *Must not be all zeros.
   *
   * @return carRentalLocationStateProvince The state or province where the car is rented. * Format:
   *     Alphanumeric * maxLength: 2 * Must not start with a space or be all spaces *Must not be all
   *     zeros.
   */
  ...
  /**
   * Indicates if the customer didn&#39;t pick up their rental car. * Y - Customer did not pick up
   * their car * N - Not applicable
   *
   * @param carRentalNoShowIndicator Indicates if the customer didn&#39;t pick up their rental car.
   *     * Y - Customer did not pick up their car * N - Not applicable
   * @return the current {@code AdditionalDataCarRental} instance, allowing for method chaining
   */
   ...
   * their car * N - Not applicable
   *
   * @return carRentalNoShowIndicator Indicates if the customer didn&#39;t pick up their rental car.
   *     * Y - Customer did not pick up their car * N - Not applicable
   */
   ...
   * units](https://docs.adyen.com/development-resources/currency-codes). * maxLength: 12
   *
   * @param carRentalOneWayDropOffCharges The charge for not returning a car to the original rental
   ...
   * units](https://docs.adyen.com/development-resources/currency-codes). * maxLength: 12
   *
   * @return carRentalOneWayDropOffCharges The charge for not returning a car to the original rental
   *     location, in [minor units](https://docs.adyen.com/development-resources/currency-codes). *
   *     maxLength: 12
   */
   ...
   * units](https://docs.adyen.com/development-resources/currency-codes). * Format: Alphanumeric *
   * maxLength: 12
   *
   * @param carRentalRate The daily rental rate, in [minor
   *     units](https://docs.adyen.com/development-resources/currency-codes). * Format: Alphanumeric
   *     * maxLength: 12
   * @return the current {@code AdditionalDataCarRental} instance, allowing for method chaining
   */
   ...
   * maxLength: 12
   *
   * @return carRentalRate The daily rental rate, in [minor
   *     units](https://docs.adyen.com/development-resources/currency-codes). * Format: Alphanumeric
   *     * maxLength: 12
   */
   ...
   *
   * @param carRentalRateIndicator Specifies whether the given rate is applied daily or weekly. * D
   *     - Daily rate * W - Weekly rate
   * @return the current {@code AdditionalDataCarRental} instance, allowing for method chaining
   */
   ...
   * Specifies whether the given rate is applied daily or weekly. * D - Daily rate * W - Weekly rate
   *
   * @return carRentalRateIndicator Specifies whether the given rate is applied daily or weekly. * D
   *     - Daily rate * W - Weekly rate
   */
  ...
  /**
   * The rental agreement number for the car rental. * Format: Alphanumeric * maxLength: 9 * Must
   * not start with a space or be all spaces *Must not be all zeros.
   *
   * @param carRentalRentalAgreementNumber The rental agreement number for the car rental. * Format:
   *     Alphanumeric * maxLength: 9 * Must not start with a space or be all spaces *Must not be all
   *     zeros.
   * @return the current {@code AdditionalDataCarRental} instance, allowing for method chaining
   */
   ...
   * not start with a space or be all spaces *Must not be all zeros.
   *
   * @return carRentalRentalAgreementNumber The rental agreement number for the car rental. *
   *     Format: Alphanumeric * maxLength: 9 * Must not start with a space or be all spaces *Must
   *     not be all zeros.
   */
  ...
  /**
   * The classification of the rental car. * Format: Alphanumeric * maxLength: 4 * Must not start
   * with a space or be all spaces *Must not be all zeros.
   *
   * @param carRentalRentalClassId The classification of the rental car. * Format: Alphanumeric *
   *     maxLength: 4 * Must not start with a space or be all spaces *Must not be all zeros.
   * @return the current {@code AdditionalDataCarRental} instance, allowing for method chaining
   */
   ...
   * with a space or be all spaces *Must not be all zeros.
   *
   * @return carRentalRentalClassId The classification of the rental car. * Format: Alphanumeric *
   *     maxLength: 4 * Must not start with a space or be all spaces *Must not be all zeros.
   */
  ...
  /**
   * The name of the person renting the car. * Format: Alphanumeric * maxLength: 26 * If you send
   * more than 26 characters, the name is truncated * Must not start with a space or be all spaces
   * *Must not be all zeros.
   *
   * @param carRentalRenterName The name of the person renting the car. * Format: Alphanumeric *
   *     maxLength: 26 * If you send more than 26 characters, the name is truncated * Must not start
   *     with a space or be all spaces *Must not be all zeros.
   * @return the current {@code AdditionalDataCarRental} instance, allowing for method chaining
   */
   ...
   * *Must not be all zeros.
   *
   * @return carRentalRenterName The name of the person renting the car. * Format: Alphanumeric *
   *     maxLength: 26 * If you send more than 26 characters, the name is truncated * Must not start
   *     with a space or be all spaces *Must not be all zeros.
   */
  ...
  /**
   * The city where the car must be returned. * Format: Alphanumeric * maxLength: 18 * Must not
   * start with a space or be all spaces *Must not be all zeros.
   *
   * @param carRentalReturnCity The city where the car must be returned. * Format: Alphanumeric *
   *     maxLength: 18 * Must not start with a space or be all spaces *Must not be all zeros.
   * @return the current {@code AdditionalDataCarRental} instance, allowing for method chaining
   */
   ...
   * start with a space or be all spaces *Must not be all zeros.
   *
   * @return carRentalReturnCity The city where the car must be returned. * Format: Alphanumeric *
   *     maxLength: 18 * Must not start with a space or be all spaces *Must not be all zeros.
   */
   ...
   * maxLength: 2
   *
   * @param carRentalReturnCountry The country where the car must be returned, in [ISO 3166-1
   *     alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) format. * Format: Alphanumeric *
   *     maxLength: 2
   * @return the current {@code AdditionalDataCarRental} instance, allowing for method chaining
   */
   ...
   * maxLength: 2
   *
   * @return carRentalReturnCountry The country where the car must be returned, in [ISO 3166-1
   *     alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) format. * Format: Alphanumeric *
   *     maxLength: 2
   */
   ...
   *
   * @param carRentalReturnDate The last date to return the car by. * Date format:
   *     &#x60;yyyyMMdd&#x60; * maxLength: 8
   * @return the current {@code AdditionalDataCarRental} instance, allowing for method chaining
   */
   ...
   * The last date to return the car by. * Date format: &#x60;yyyyMMdd&#x60; * maxLength: 8
   *
   * @return carRentalReturnDate The last date to return the car by. * Date format:
   *     &#x60;yyyyMMdd&#x60; * maxLength: 8
   */
   ...
   *
   * @param carRentalReturnLocationId The agency code, phone number, or address abbreviation *
   *     Format: Alphanumeric * maxLength: 10 * Must not start with a space or be all spaces *Must
   *     not be all zeros.
   * @return the current {@code AdditionalDataCarRental} instance, allowing for method chaining
   */
   ...
   * Must not start with a space or be all spaces *Must not be all zeros.
   *
   * @return carRentalReturnLocationId The agency code, phone number, or address abbreviation *
   *     Format: Alphanumeric * maxLength: 10 * Must not start with a space or be all spaces *Must
   *     not be all zeros.
   */
   ...
   * Must not start with a space or be all spaces *Must not be all zeros.
   *
   * @param carRentalReturnStateProvince The state or province where the car must be returned. *
   *     Format: Alphanumeric * maxLength: 3 * Must not start with a space or be all spaces *Must
   *     not be all zeros.
   * @return the current {@code AdditionalDataCarRental} instance, allowing for method chaining
   */
   ...
   * Must not start with a space or be all spaces *Must not be all zeros.
   *
   * @return carRentalReturnStateProvince The state or province where the car must be returned. *
   *     Format: Alphanumeric * maxLength: 3 * Must not start with a space or be all spaces *Must
   *     not be all zeros.
   */
  ...
  /**
   * Indicates if the goods or services were tax-exempt, or if tax was not paid on them. Values: * Y
   * - Goods or services were tax exempt * N - Tax was not collected
   *
   * @param carRentalTaxExemptIndicator Indicates if the goods or services were tax-exempt, or if
   *     tax was not paid on them. Values: * Y - Goods or services were tax exempt * N - Tax was not
   *     collected
   * @return the current {@code AdditionalDataCarRental} instance, allowing for method chaining
   */
   ...
   * - Goods or services were tax exempt * N - Tax was not collected
   *
   * @return carRentalTaxExemptIndicator Indicates if the goods or services were tax-exempt, or if
   *     tax was not paid on them. Values: * Y - Goods or services were tax exempt * N - Tax was not
   *     collected
   */
  ...
  /**
   * Number of days the car is rented for. This should be included in the auth message. * Format:
   * Numeric * maxLength: 4
   *
   * @param travelEntertainmentAuthDataDuration Number of days the car is rented for. This should be
   *     included in the auth message. * Format: Numeric * maxLength: 4
   * @return the current {@code AdditionalDataCarRental} instance, allowing for method chaining
   */
   ...
   * Numeric * maxLength: 4
   *
   * @return travelEntertainmentAuthDataDuration Number of days the car is rented for. This should
   *     be included in the auth message. * Format: Numeric * maxLength: 4
   */
  ...
  /**
   * Indicates what market-specific dataset will be submitted or is being submitted. Value should be
   * &#39;A&#39; for car rental. This should be included in the auth message. * Format: Alphanumeric
   * * maxLength: 1
   *
   * @param travelEntertainmentAuthDataMarket Indicates what market-specific dataset will be
   *     submitted or is being submitted. Value should be &#39;A&#39; for car rental. This should be
   *     included in the auth message. * Format: Alphanumeric * maxLength: 1
   * @return the current {@code AdditionalDataCarRental} instance, allowing for method chaining
   */
   ...
   */
  @JsonAnySetter
  public AdditionalDataCarRental putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.carRentalCheckOutDate, additionalDataCarRental.carRentalCheckOutDate)
        ...
        && Objects.equals(this.additionalProperties, additionalDataCarRental.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    carRentalCheckOutDate: ")
        .append(toIndentedString(carRentalCheckOutDate))
        .append("\n");
    sb.append("    carRentalCustomerServiceTollFreeNumber: ")
        .append(toIndentedString(carRentalCustomerServiceTollFreeNumber))
        .append("\n");
    sb.append("    carRentalDaysRented: ")
        .append(toIndentedString(carRentalDaysRented))
        .append("\n");
    sb.append("    carRentalFuelCharges: ")
        .append(toIndentedString(carRentalFuelCharges))
        .append("\n");
    sb.append("    carRentalInsuranceCharges: ")
        .append(toIndentedString(carRentalInsuranceCharges))
        .append("\n");
    sb.append("    carRentalLocationCity: ")
        .append(toIndentedString(carRentalLocationCity))
        .append("\n");
    sb.append("    carRentalLocationCountry: ")
        .append(toIndentedString(carRentalLocationCountry))
        .append("\n");
    sb.append("    carRentalLocationStateProvince: ")
        .append(toIndentedString(carRentalLocationStateProvince))
        .append("\n");
    sb.append("    carRentalNoShowIndicator: ")
        .append(toIndentedString(carRentalNoShowIndicator))
        .append("\n");
    sb.append("    carRentalOneWayDropOffCharges: ")
        .append(toIndentedString(carRentalOneWayDropOffCharges))
        .append("\n");
    sb.append("    carRentalRate: ").append(toIndentedString(carRentalRate)).append("\n");
    sb.append("    carRentalRateIndicator: ")
        .append(toIndentedString(carRentalRateIndicator))
        .append("\n");
    sb.append("    carRentalRentalAgreementNumber: ")
        .append(toIndentedString(carRentalRentalAgreementNumber))
        .append("\n");
    sb.append("    carRentalRentalClassId: ")
        .append(toIndentedString(carRentalRentalClassId))
        .append("\n");
    sb.append("    carRentalRenterName: ")
        .append(toIndentedString(carRentalRenterName))
        .append("\n");
    sb.append("    carRentalReturnCity: ")
        .append(toIndentedString(carRentalReturnCity))
        .append("\n");
    sb.append("    carRentalReturnCountry: ")
        .append(toIndentedString(carRentalReturnCountry))
        .append("\n");
    sb.append("    carRentalReturnDate: ")
        .append(toIndentedString(carRentalReturnDate))
        .append("\n");
    sb.append("    carRentalReturnLocationId: ")
        .append(toIndentedString(carRentalReturnLocationId))
        .append("\n");
    sb.append("    carRentalReturnStateProvince: ")
        .append(toIndentedString(carRentalReturnStateProvince))
        .append("\n");
    sb.append("    carRentalTaxExemptIndicator: ")
        .append(toIndentedString(carRentalTaxExemptIndicator))
        .append("\n");
