...
public class PaymentCancelResource {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class PaymentCancelResource {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (PaymentCancelResource.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentCancelResource is not found in the empty JSON string", PaymentCancelResource.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PaymentCancelResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentCancelResource` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
