...
public class BankAccountDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to BankAccountDetails
   */
  public static BankAccountDetails fromJson(String jsonString) throws JacksonException {
