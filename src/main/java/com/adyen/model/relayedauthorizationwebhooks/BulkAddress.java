...
public class BulkAddress {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to BulkAddress
   */
  public static BulkAddress fromJson(String jsonString) throws JacksonException {
