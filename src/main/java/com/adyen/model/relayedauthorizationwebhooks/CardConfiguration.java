...
public class CardConfiguration {
  ...
  /**
   * Your app&#39;s URL, if you want to activate cards through your app. For example,
   * **my-app://ref1236a7d**. A QR code is created based on this URL, and is included in the
   * carrier. Before you use this field, reach out to your Adyen contact to set up the QR code
   * process. Maximum length: 255 characters.
   *
   * @param activationUrl Your app&#39;s URL, if you want to activate cards through your app. For
   *     example, **my-app://ref1236a7d**. A QR code is created based on this URL, and is included
   *     in the carrier. Before you use this field, reach out to your Adyen contact to set up the QR
   *     code process. Maximum length: 255 characters.
   * @return the current {@code CardConfiguration} instance, allowing for method chaining
   */
   ...
   * process. Maximum length: 255 characters.
   *
   * @return activationUrl Your app&#39;s URL, if you want to activate cards through your app. For
   *     example, **my-app://ref1236a7d**. A QR code is created based on this URL, and is included
   *     in the carrier. Before you use this field, reach out to your Adyen contact to set up the QR
   *     code process. Maximum length: 255 characters.
   */
   ...
   * language codes of the card. For example, **[en,es]**.
   *
   * @param languages A list of two-letter
   *     [ISO-639-1](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) language codes of the
   *     card. For example, **[en,es]**.
   * @return the current {@code CardConfiguration} instance, allowing for method chaining
   */
  public CardConfiguration languages(List<String> languages) {
    this.languages = languages;
    return this;
  }

  public CardConfiguration addLanguagesItem(String languagesItem) {
   ...
   * language codes of the card. For example, **[en,es]**.
   *
   * @return languages A list of two-letter
   *     [ISO-639-1](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) language codes of the
   *     card. For example, **[en,es]**.
   */
  ...
  public String toString() {
    ...
    sb.append("    configurationProfileId: ")
        .append(toIndentedString(configurationProfileId))
        .append("\n");
   ...
   * @throws JacksonException if the JSON string is invalid with respect to CardConfiguration
   */
  public static CardConfiguration fromJson(String jsonString) throws JacksonException {
