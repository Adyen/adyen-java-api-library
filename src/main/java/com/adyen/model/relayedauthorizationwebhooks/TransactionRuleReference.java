...
public class TransactionRuleReference {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to TransactionRuleReference
   */
  public static TransactionRuleReference fromJson(String jsonString) throws JacksonException {
