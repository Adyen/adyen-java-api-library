...
public class Installments {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to Installments
   */
  public static Installments fromJson(String jsonString) throws JacksonException {
