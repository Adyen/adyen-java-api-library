...
public class AdjustAuthorisationRequest {
   ...
   * @return the current {@code AdjustAuthorisationRequest} instance, allowing for method chaining
   */
   ...
   *     AdjustAuthorisationRequest
   */
  public static AdjustAuthorisationRequest fromJson(String jsonString) throws JacksonException {
