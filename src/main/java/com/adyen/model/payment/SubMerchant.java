...
public class SubMerchant {
  ...
  /**
   * The city of the sub-merchant&#39;s address. * Format: Alphanumeric * Maximum length: 13
   * characters
   *
   * @param city The city of the sub-merchant&#39;s address. * Format: Alphanumeric * Maximum
   ...
   * characters
   *
   * @return city The city of the sub-merchant&#39;s address. * Format: Alphanumeric * Maximum
   *     length: 13 characters
   */
  ...
  /**
   * The three-letter country code of the sub-merchant&#39;s address. For example, **BRA** for
   * Brazil. * Format: [ISO 3166-1 alpha-3](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-3) *
   * Fixed length: 3 characters
   *
   * @param country The three-letter country code of the sub-merchant&#39;s address. For example,
   ...
   * Fixed length: 3 characters
   *
   * @return country The three-letter country code of the sub-merchant&#39;s address. For example,
   *     **BRA** for Brazil. * Format: [ISO 3166-1
   *     alpha-3](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-3) * Fixed length: 3 characters
   */
  ...
  /**
   * The tax ID of the sub-merchant. * Format: Numeric * Fixed length: 11 digits for the CPF or 14
   * digits for the CNPJ
   *
   * @param taxId The tax ID of the sub-merchant. * Format: Numeric * Fixed length: 11 digits for
   *     the CPF or 14 digits for the CNPJ
   * @return the current {@code SubMerchant} instance, allowing for method chaining
   */
   ...
   * digits for the CNPJ
   *
   * @return taxId The tax ID of the sub-merchant. * Format: Numeric * Fixed length: 11 digits for
   *     the CPF or 14 digits for the CNPJ
   */
