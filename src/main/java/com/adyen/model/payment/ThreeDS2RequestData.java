...
public class ThreeDS2RequestData {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to ThreeDS2RequestData
   */
  public static ThreeDS2RequestData fromJson(String jsonString) throws JacksonException {
