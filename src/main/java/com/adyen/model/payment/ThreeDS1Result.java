...
public class ThreeDS1Result {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to ThreeDS1Result
   */
  public static ThreeDS1Result fromJson(String jsonString) throws JacksonException {
