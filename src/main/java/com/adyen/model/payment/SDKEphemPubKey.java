...
public class SDKEphemPubKey {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to SDKEphemPubKey
   */
  public static SDKEphemPubKey fromJson(String jsonString) throws JacksonException {
