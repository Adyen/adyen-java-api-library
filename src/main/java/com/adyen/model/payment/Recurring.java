...
public class Recurring {
  ...
  public enum ContractEnum {
    ...
    public static ContractEnum fromValue(String value) {
      ...
      LOG.warning("ContractEnum: unexpected enum value '" + value + "' - Supported values are "+ Arrays.toString(ContractEnum.values()));
      return null;
    }
  }
  ...
  public enum TokenServiceEnum {
    ...
    public static TokenServiceEnum fromValue(String value) {
      ...
      // handling unexpected value
      LOG.warning("TokenServiceEnum: unexpected enum value '" + value + "' - Supported values are "+ Arrays.toString(TokenServiceEnum.values()));
      return null;
    }
  }
  ...
  /**
   * A descriptive name for this detail.
   * @return recurringDetailName A descriptive name for this detail.
   */
  ...
  /**
   * The name of the token service.
   * @return tokenService The name of the token service.
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(contract, isSetContract, recurringDetailName, isSetRecurringDetailName, recurringExpiry, isSetRecurringExpiry, recurringFrequency, isSetRecurringFrequency, tokenService, isSetTokenService);
  }
