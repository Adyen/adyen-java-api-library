...
public class Card {
  ...
  /**
   * The card number (4-19 characters). Do not use any separators. When this value is returned in a response, only the last 4 digits of the card number are returned.
   * @return number The card number (4-19 characters). Do not use any separators. When this value is returned in a response, only the last 4 digits of the card number are returned.
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cvc, isSetCvc, expiryMonth, isSetExpiryMonth, expiryYear, isSetExpiryYear, holderName, isSetHolderName, issueNumber, isSetIssueNumber, number, isSetNumber, startMonth, isSetStartMonth, startYear, isSetStartYear);
  }
