...
/** RefundRequest */
@JsonPropertyOrder({
  RefundRequest.JSON_PROPERTY_ADDITIONAL_DATA,
  RefundRequest.JSON_PROPERTY_MERCHANT_ACCOUNT,
  RefundRequest.JSON_PROPERTY_MODIFICATION_AMOUNT,
  RefundRequest.JSON_PROPERTY_MPI_DATA,
  RefundRequest.JSON_PROPERTY_ORIGINAL_MERCHANT_REFERENCE,
  RefundRequest.JSON_PROPERTY_ORIGINAL_REFERENCE,
  RefundRequest.JSON_PROPERTY_PLATFORM_CHARGEBACK_LOGIC,
  RefundRequest.JSON_PROPERTY_REFERENCE,
  RefundRequest.JSON_PROPERTY_SPLITS,
  RefundRequest.JSON_PROPERTY_TENDER_REFERENCE,
  RefundRequest.JSON_PROPERTY_UNIQUE_TERMINAL_ID
})
public class RefundRequest {
  ...
  /**
   * This field contains additional data, which may be required for a particular modification
   * request. The additionalData object consists of entries, each of which includes the key and
   * value.
   *
   * @param additionalData This field contains additional data, which may be required for a
   *     particular modification request. The additionalData object consists of entries, each of
   *     which includes the key and value.
   * @return the current {@code RefundRequest} instance, allowing for method chaining
   */
   ...
   * authorisation response * authorisation notification
   *
   * @param originalReference The original pspReference of the payment to modify. This reference is
   *     returned in: * authorisation response * authorisation notification
   * @return the current {@code RefundRequest} instance, allowing for method chaining
   */
   ...
   * authorisation response * authorisation notification
   *
   * @return originalReference The original pspReference of the payment to modify. This reference is
   *     returned in: * authorisation response * authorisation notification
   */
   ...
   * @return the current {@code RefundRequest} instance, allowing for method chaining
   */
  public RefundRequest platformChargebackLogic(PlatformChargebackLogic platformChargebackLogic) {
   ...
   * reports. Maximum length: 80 characters.
   *
   * @param reference Your reference for the payment modification. This reference is visible in
   *     Customer Area and in reports. Maximum length: 80 characters.
   * @return the current {@code RefundRequest} instance, allowing for method chaining
   */
   ...
   * reports. Maximum length: 80 characters.
   *
   * @return reference Your reference for the payment modification. This reference is visible in
   *     Customer Area and in reports. Maximum length: 80 characters.
   */
   ...
   * for Platforms. For more information, see how to split payments for
   ...
   *     when using Adyen for Platforms. For more information, see how to split payments for
   *     [platforms](https://docs.adyen.com/platforms/automatic-split-configuration/).
   * @return the current {@code RefundRequest} instance, allowing for method chaining
   */
   ...
   *
   * @param tenderReference The transaction reference provided by the PED. For point-of-sale
   *     integrations only.
   * @return the current {@code RefundRequest} instance, allowing for method chaining
   */
   ...
   * The transaction reference provided by the PED. For point-of-sale integrations only.
   *
   * @return tenderReference The transaction reference provided by the PED. For point-of-sale
   *     integrations only.
   */
  ...
  /**
   * Unique terminal ID for the PED that originally processed the request. For point-of-sale
   * integrations only.
   *
   * @param uniqueTerminalId Unique terminal ID for the PED that originally processed the request.
   *     For point-of-sale integrations only.
   * @return the current {@code RefundRequest} instance, allowing for method chaining
   */
   ...
   * integrations only.
   *
   * @return uniqueTerminalId Unique terminal ID for the PED that originally processed the request.
   *     For point-of-sale integrations only.
   */
   ...
   */
  public RefundRequest includeNullValues(boolean includeNullValues) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.additionalData, refundRequest.additionalData)
        && Objects.equals(this.isSetAdditionalData, refundRequest.isSetAdditionalData)
        && Objects.equals(this.merchantAccount, refundRequest.merchantAccount)
        && Objects.equals(this.isSetMerchantAccount, refundRequest.isSetMerchantAccount)
        && Objects.equals(this.modificationAmount, refundRequest.modificationAmount)
        && Objects.equals(this.isSetModificationAmount, refundRequest.isSetModificationAmount)
        && Objects.equals(this.mpiData, refundRequest.mpiData)
        && Objects.equals(this.isSetMpiData, refundRequest.isSetMpiData)
        && Objects.equals(this.originalMerchantReference, refundRequest.originalMerchantReference)
        && Objects.equals(
            this.isSetOriginalMerchantReference, refundRequest.isSetOriginalMerchantReference)
        && Objects.equals(this.originalReference, refundRequest.originalReference)
        && Objects.equals(this.isSetOriginalReference, refundRequest.isSetOriginalReference)
        && Objects.equals(this.platformChargebackLogic, refundRequest.platformChargebackLogic)
        && Objects.equals(
            this.isSetPlatformChargebackLogic, refundRequest.isSetPlatformChargebackLogic)
        && Objects.equals(this.reference, refundRequest.reference)
        && Objects.equals(this.isSetReference, refundRequest.isSetReference)
        && Objects.equals(this.splits, refundRequest.splits)
        && Objects.equals(this.isSetSplits, refundRequest.isSetSplits)
        && Objects.equals(this.tenderReference, refundRequest.tenderReference)
        && Objects.equals(this.isSetTenderReference, refundRequest.isSetTenderReference)
        && Objects.equals(this.uniqueTerminalId, refundRequest.uniqueTerminalId)
        && Objects.equals(this.isSetUniqueTerminalId, refundRequest.isSetUniqueTerminalId);
  }
  ...
  public String toString() {
    ...
    sb.append("    originalMerchantReference: ")
        .append(toIndentedString(originalMerchantReference))
        .append("\n");
   ...
   * @throws JsonProcessingException if the JSON string is invalid with respect to RefundRequest
   */
  public static RefundRequest fromJson(String jsonString) throws JsonProcessingException {
    return JSON.getMapper().readValue(jsonString, RefundRequest.class);
  }
