...
public class VoidPendingRefundRequest {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to VoidPendingRefundRequest
   */
  public static VoidPendingRefundRequest fromJson(String jsonString) throws JacksonException {
