...
/** PaymentRequest3d */
@JsonPropertyOrder({
  PaymentRequest3d.JSON_PROPERTY_ACCOUNT_INFO,
  PaymentRequest3d.JSON_PROPERTY_ADDITIONAL_AMOUNT,
  PaymentRequest3d.JSON_PROPERTY_ADDITIONAL_DATA,
  PaymentRequest3d.JSON_PROPERTY_AMOUNT,
  PaymentRequest3d.JSON_PROPERTY_APPLICATION_INFO,
  PaymentRequest3d.JSON_PROPERTY_BILLING_ADDRESS,
  PaymentRequest3d.JSON_PROPERTY_BROWSER_INFO,
  PaymentRequest3d.JSON_PROPERTY_CAPTURE_DELAY_HOURS,
  PaymentRequest3d.JSON_PROPERTY_DATE_OF_BIRTH,
  PaymentRequest3d.JSON_PROPERTY_DCC_QUOTE,
  PaymentRequest3d.JSON_PROPERTY_DELIVERY_ADDRESS,
  PaymentRequest3d.JSON_PROPERTY_DELIVERY_DATE,
  PaymentRequest3d.JSON_PROPERTY_DEVICE_FINGERPRINT,
  PaymentRequest3d.JSON_PROPERTY_FRAUD_OFFSET,
  PaymentRequest3d.JSON_PROPERTY_INSTALLMENTS,
  PaymentRequest3d.JSON_PROPERTY_LOCALIZED_SHOPPER_STATEMENT,
  PaymentRequest3d.JSON_PROPERTY_MCC,
  PaymentRequest3d.JSON_PROPERTY_MD,
  PaymentRequest3d.JSON_PROPERTY_MERCHANT_ACCOUNT,
  PaymentRequest3d.JSON_PROPERTY_MERCHANT_ORDER_REFERENCE,
  PaymentRequest3d.JSON_PROPERTY_MERCHANT_RISK_INDICATOR,
  PaymentRequest3d.JSON_PROPERTY_METADATA,
  PaymentRequest3d.JSON_PROPERTY_ORDER_REFERENCE,
  PaymentRequest3d.JSON_PROPERTY_PA_RESPONSE,
  PaymentRequest3d.JSON_PROPERTY_RECURRING,
  PaymentRequest3d.JSON_PROPERTY_RECURRING_PROCESSING_MODEL,
  PaymentRequest3d.JSON_PROPERTY_REFERENCE,
  PaymentRequest3d.JSON_PROPERTY_SELECTED_BRAND,
  PaymentRequest3d.JSON_PROPERTY_SELECTED_RECURRING_DETAIL_REFERENCE,
  PaymentRequest3d.JSON_PROPERTY_SESSION_ID,
  PaymentRequest3d.JSON_PROPERTY_SHOPPER_EMAIL,
  PaymentRequest3d.JSON_PROPERTY_SHOPPER_I_P,
  PaymentRequest3d.JSON_PROPERTY_SHOPPER_INTERACTION,
  PaymentRequest3d.JSON_PROPERTY_SHOPPER_LOCALE,
  PaymentRequest3d.JSON_PROPERTY_SHOPPER_NAME,
  PaymentRequest3d.JSON_PROPERTY_SHOPPER_REFERENCE,
  PaymentRequest3d.JSON_PROPERTY_SHOPPER_STATEMENT,
  PaymentRequest3d.JSON_PROPERTY_SOCIAL_SECURITY_NUMBER,
  PaymentRequest3d.JSON_PROPERTY_SPLITS,
  PaymentRequest3d.JSON_PROPERTY_STORE,
  PaymentRequest3d.JSON_PROPERTY_TELEPHONE_NUMBER,
  PaymentRequest3d.JSON_PROPERTY_THREE_D_S2_REQUEST_DATA,
  PaymentRequest3d.JSON_PROPERTY_THREE_D_S_AUTHENTICATION_ONLY,
  PaymentRequest3d.JSON_PROPERTY_TOTALS_GROUP,
  PaymentRequest3d.JSON_PROPERTY_TRUSTED_SHOPPER
})
public class PaymentRequest3d {
  ...
  public static final String JSON_PROPERTY_PA_RESPONSE = "paResponse";
  private String paResponse;

  /** Mark when the attribute has been explicitly set. */
  private boolean isSetPaResponse = false;
  ...
  public PaymentRequest3d putLocalizedShopperStatementItem(
   ...
   * The payment session identifier returned by the card issuer.
   *
   * @return md The payment session identifier returned by the card issuer.
   */
  ...
  /**
   * Payment authorisation response returned by the card issuer. The &#x60;paResponse&#x60; field
   * holds the PaRes value received from the card issuer.
   *
   * @param paResponse Payment authorisation response returned by the card issuer. The
   *     &#x60;paResponse&#x60; field holds the PaRes value received from the card issuer.
   * @return the current {@code PaymentRequest3d} instance, allowing for method chaining
   */
  public PaymentRequest3d paResponse(String paResponse) {
    this.paResponse = paResponse;
    isSetPaResponse = true; // mark as set
    return this;
  }
   ...
   * holds the PaRes value received from the card issuer.
   *
   * @return paResponse Payment authorisation response returned by the card issuer. The
   *     &#x60;paResponse&#x60; field holds the PaRes value received from the card issuer.
   */
   ...
   * @return the current {@code PaymentRequest3d} instance, allowing for method chaining
   */
  public PaymentRequest3d recurringProcessingModel(
   ...
   * @return the current {@code PaymentRequest3d} instance, allowing for method chaining
   */
  public PaymentRequest3d selectedRecurringDetailReference(
   ...
   */
  public PaymentRequest3d includeNullValues(boolean includeNullValues) {
  ...
  /** Return true if this PaymentRequest3d object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountInfo, paymentRequest3d.accountInfo)
        && Objects.equals(this.isSetAccountInfo, paymentRequest3d.isSetAccountInfo)
        && Objects.equals(this.additionalAmount, paymentRequest3d.additionalAmount)
        && Objects.equals(this.isSetAdditionalAmount, paymentRequest3d.isSetAdditionalAmount)
        && Objects.equals(this.additionalData, paymentRequest3d.additionalData)
        && Objects.equals(this.isSetAdditionalData, paymentRequest3d.isSetAdditionalData)
        && Objects.equals(this.amount, paymentRequest3d.amount)
        && Objects.equals(this.isSetAmount, paymentRequest3d.isSetAmount)
        && Objects.equals(this.applicationInfo, paymentRequest3d.applicationInfo)
        && Objects.equals(this.isSetApplicationInfo, paymentRequest3d.isSetApplicationInfo)
        && Objects.equals(this.billingAddress, paymentRequest3d.billingAddress)
        && Objects.equals(this.isSetBillingAddress, paymentRequest3d.isSetBillingAddress)
        && Objects.equals(this.browserInfo, paymentRequest3d.browserInfo)
        && Objects.equals(this.isSetBrowserInfo, paymentRequest3d.isSetBrowserInfo)
        && Objects.equals(this.captureDelayHours, paymentRequest3d.captureDelayHours)
        && Objects.equals(this.isSetCaptureDelayHours, paymentRequest3d.isSetCaptureDelayHours)
        && Objects.equals(this.dateOfBirth, paymentRequest3d.dateOfBirth)
        && Objects.equals(this.isSetDateOfBirth, paymentRequest3d.isSetDateOfBirth)
        && Objects.equals(this.dccQuote, paymentRequest3d.dccQuote)
        && Objects.equals(this.isSetDccQuote, paymentRequest3d.isSetDccQuote)
        && Objects.equals(this.deliveryAddress, paymentRequest3d.deliveryAddress)
        && Objects.equals(this.isSetDeliveryAddress, paymentRequest3d.isSetDeliveryAddress)
        && Objects.equals(this.deliveryDate, paymentRequest3d.deliveryDate)
        && Objects.equals(this.isSetDeliveryDate, paymentRequest3d.isSetDeliveryDate)
        && Objects.equals(this.deviceFingerprint, paymentRequest3d.deviceFingerprint)
        && Objects.equals(this.isSetDeviceFingerprint, paymentRequest3d.isSetDeviceFingerprint)
        && Objects.equals(this.fraudOffset, paymentRequest3d.fraudOffset)
        && Objects.equals(this.isSetFraudOffset, paymentRequest3d.isSetFraudOffset)
        && Objects.equals(this.installments, paymentRequest3d.installments)
        && Objects.equals(this.isSetInstallments, paymentRequest3d.isSetInstallments)
        && Objects.equals(
            this.localizedShopperStatement, paymentRequest3d.localizedShopperStatement)
        && Objects.equals(
            this.isSetLocalizedShopperStatement, paymentRequest3d.isSetLocalizedShopperStatement)
        && Objects.equals(this.mcc, paymentRequest3d.mcc)
        && Objects.equals(this.isSetMcc, paymentRequest3d.isSetMcc)
        && Objects.equals(this.md, paymentRequest3d.md)
        && Objects.equals(this.isSetMd, paymentRequest3d.isSetMd)
        && Objects.equals(this.merchantAccount, paymentRequest3d.merchantAccount)
        && Objects.equals(this.isSetMerchantAccount, paymentRequest3d.isSetMerchantAccount)
        && Objects.equals(this.merchantOrderReference, paymentRequest3d.merchantOrderReference)
        && Objects.equals(
            this.isSetMerchantOrderReference, paymentRequest3d.isSetMerchantOrderReference)
        && Objects.equals(this.merchantRiskIndicator, paymentRequest3d.merchantRiskIndicator)
        && Objects.equals(
            this.isSetMerchantRiskIndicator, paymentRequest3d.isSetMerchantRiskIndicator)
        && Objects.equals(this.metadata, paymentRequest3d.metadata)
        && Objects.equals(this.isSetMetadata, paymentRequest3d.isSetMetadata)
        && Objects.equals(this.orderReference, paymentRequest3d.orderReference)
        && Objects.equals(this.isSetOrderReference, paymentRequest3d.isSetOrderReference)
        && Objects.equals(this.paResponse, paymentRequest3d.paResponse)
        && Objects.equals(this.isSetPaResponse, paymentRequest3d.isSetPaResponse)
        && Objects.equals(this.recurring, paymentRequest3d.recurring)
        && Objects.equals(this.isSetRecurring, paymentRequest3d.isSetRecurring)
        && Objects.equals(this.recurringProcessingModel, paymentRequest3d.recurringProcessingModel)
        && Objects.equals(
            this.isSetRecurringProcessingModel, paymentRequest3d.isSetRecurringProcessingModel)
        && Objects.equals(this.reference, paymentRequest3d.reference)
        && Objects.equals(this.isSetReference, paymentRequest3d.isSetReference)
        && Objects.equals(this.selectedBrand, paymentRequest3d.selectedBrand)
        && Objects.equals(this.isSetSelectedBrand, paymentRequest3d.isSetSelectedBrand)
        && Objects.equals(
        ...
        && Objects.equals(
            ...
            paymentRequest3d.isSetSelectedRecurringDetailReference)
        && Objects.equals(this.sessionId, paymentRequest3d.sessionId)
        && Objects.equals(this.isSetSessionId, paymentRequest3d.isSetSessionId)
        && Objects.equals(this.shopperEmail, paymentRequest3d.shopperEmail)
        && Objects.equals(this.isSetShopperEmail, paymentRequest3d.isSetShopperEmail)
        && Objects.equals(this.shopperIP, paymentRequest3d.shopperIP)
        && Objects.equals(this.isSetShopperIP, paymentRequest3d.isSetShopperIP)
        && Objects.equals(this.shopperInteraction, paymentRequest3d.shopperInteraction)
        && Objects.equals(this.isSetShopperInteraction, paymentRequest3d.isSetShopperInteraction)
        && Objects.equals(this.shopperLocale, paymentRequest3d.shopperLocale)
        && Objects.equals(this.isSetShopperLocale, paymentRequest3d.isSetShopperLocale)
        && Objects.equals(this.shopperName, paymentRequest3d.shopperName)
        && Objects.equals(this.isSetShopperName, paymentRequest3d.isSetShopperName)
        && Objects.equals(this.shopperReference, paymentRequest3d.shopperReference)
        && Objects.equals(this.isSetShopperReference, paymentRequest3d.isSetShopperReference)
        && Objects.equals(this.shopperStatement, paymentRequest3d.shopperStatement)
        && Objects.equals(this.isSetShopperStatement, paymentRequest3d.isSetShopperStatement)
        && Objects.equals(this.socialSecurityNumber, paymentRequest3d.socialSecurityNumber)
        && Objects.equals(
            this.isSetSocialSecurityNumber, paymentRequest3d.isSetSocialSecurityNumber)
        && Objects.equals(this.splits, paymentRequest3d.splits)
        && Objects.equals(this.isSetSplits, paymentRequest3d.isSetSplits)
        && Objects.equals(this.store, paymentRequest3d.store)
        && Objects.equals(this.isSetStore, paymentRequest3d.isSetStore)
        && Objects.equals(this.telephoneNumber, paymentRequest3d.telephoneNumber)
        && Objects.equals(this.isSetTelephoneNumber, paymentRequest3d.isSetTelephoneNumber)
        && Objects.equals(this.threeDS2RequestData, paymentRequest3d.threeDS2RequestData)
        && Objects.equals(this.isSetThreeDS2RequestData, paymentRequest3d.isSetThreeDS2RequestData)
        && Objects.equals(
            this.threeDSAuthenticationOnly, paymentRequest3d.threeDSAuthenticationOnly)
        && Objects.equals(
            this.isSetThreeDSAuthenticationOnly, paymentRequest3d.isSetThreeDSAuthenticationOnly)
        && Objects.equals(this.totalsGroup, paymentRequest3d.totalsGroup)
        && Objects.equals(this.isSetTotalsGroup, paymentRequest3d.isSetTotalsGroup)
        && Objects.equals(this.trustedShopper, paymentRequest3d.trustedShopper)
        && Objects.equals(this.isSetTrustedShopper, paymentRequest3d.isSetTrustedShopper);
  }
  ...
  public Map<String, Object> getExplicitNulls() {
    ...
    if (isSetPaResponse) {
      addIfNull(nulls, JSON_PROPERTY_PA_RESPONSE, this.paResponse);
    }
    if (isSetRecurring) {
   ...
   * @throws JsonProcessingException if the JSON string is invalid with respect to PaymentRequest3d
   */
  public static PaymentRequest3d fromJson(String jsonString) throws JsonProcessingException {
    return JSON.getMapper().readValue(jsonString, PaymentRequest3d.class);
  }
