...
public class ThreeDS2ResultRequest {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to ThreeDS2ResultRequest
   */
  public static ThreeDS2ResultRequest fromJson(String jsonString) throws JacksonException {
