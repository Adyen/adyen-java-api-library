...
public class ForexQuote {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(account, isSetAccount, accountType, isSetAccountType, baseAmount, isSetBaseAmount, basePoints, isSetBasePoints, buy, isSetBuy, interbank, isSetInterbank, reference, isSetReference, sell, isSetSell, signature, isSetSignature, source, isSetSource, type, isSetType, validTill, isSetValidTill);
  }
