...
public class NotificationConfigurationDetails {
  ...
  /**
   * The SSL protocol employed by the endpoint. &gt;Permitted values: &#x60;TLSv12&#x60;,
   * &#x60;TLSv13&#x60;.
   */
  ...
  /**
   * The version of the notification to which you are subscribing. To make sure that your
   * integration can properly process the notification, subscribe to the same version as the API
   * that you&#39;re using.
   *
   * @return apiVersion
   */
  ...
  public NotificationConfigurationDetails eventConfigs(
      List<NotificationEventConfiguration> eventConfigs) {
    this.eventConfigs = eventConfigs;
    return this;
  }

  public NotificationConfigurationDetails addEventConfigsItem(
      NotificationEventConfiguration eventConfigsItem) {
   ...
   */
  @ApiModelProperty(
      value = "Contains objects that define event types and their subscription settings.")
  ...
  /**
   * A string with which to salt the notification(s) before hashing. If this field is provided, a
   * hash value will be included under the notification header &#x60;HmacSignature&#x60; and the
   * hash protocol will be included under the notification header &#x60;Protocol&#x60;. A
   * notification body along with its &#x60;hmacSignatureKey&#x60; and &#x60;Protocol&#x60; can be
   * used to calculate a hash value; matching this hash value with the &#x60;HmacSignature&#x60;
   * will ensure that the notification body has not been tampered with or corrupted. &gt;Must be a
   * 32-byte hex-encoded string (i.e. a string containing 64 hexadecimal characters; e.g.
   * \&quot;b0ea55c2fe60d4d1d605e9c385e0e7f7e6cafbb939ce07010f31a327a0871f27\&quot;). The omission
   * of this field will preclude the provision of the &#x60;HmacSignature&#x60; and
   * &#x60;Protocol&#x60; headers in notification(s).
   *
   ...
   * [&#x60;/updateNotificationConfiguration&#x60;](https://docs.adyen.com/api-explorer/#/NotificationConfigurationService/latest/post/updateNotificationConfiguration).
   *
   ...
   */
  @ApiModelProperty(
      value = "The password to use when accessing the notifyURL with the specified username.")
   ...
   */
  @ApiModelProperty(
      value = "The SSL protocol employed by the endpoint. >Permitted values: `TLSv12`, `TLSv13`.")
  ...
  public boolean equals(Object o) {
    ...
    NotificationConfigurationDetails notificationConfigurationDetails =
        (NotificationConfigurationDetails) o;
