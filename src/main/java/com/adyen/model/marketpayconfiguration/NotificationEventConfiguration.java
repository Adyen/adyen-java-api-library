...
public class NotificationEventConfiguration {
  /**
   * The type of event. Possible values: **ACCOUNT_CLOSED**, **ACCOUNT_CREATED**,
   * **ACCOUNT_FUNDS_BELOW_THRESHOLD**, **ACCOUNT_HOLDER_CREATED**,
   * **ACCOUNT_HOLDER_LIMIT_REACHED**, **ACCOUNT_HOLDER_PAYOUT**, **ACCOUNT_HOLDER_STATUS_CHANGE**,
   * **ACCOUNT_HOLDER_STORE_STATUS_CHANGE**, **ACCOUNT_HOLDER_UPCOMING_DEADLINE**,
   * **ACCOUNT_HOLDER_UPDATED**, **ACCOUNT_HOLDER_VERIFICATION**, **ACCOUNT_UPDATED**,
   * **BENEFICIARY_SETUP**, **COMPENSATE_NEGATIVE_BALANCE**, **DIRECT_DEBIT_INITIATED**,
   * **PAYMENT_FAILURE**, **REFUND_FUNDS_TRANSFER**, **REPORT_AVAILABLE**, **SCHEDULED_REFUNDS**,
   * **TRANSFER_FUNDS**.
   */
   ...
   * Possible values: * **INCLUDE**: Send the specified &#x60;eventType&#x60;. * **EXCLUDE**: Send
   * all event types except the specified &#x60;eventType&#x60; and other event types with the
  ...
  public boolean equals(Object o) {
    ...
    NotificationEventConfiguration notificationEventConfiguration =
        (NotificationEventConfiguration) o;
   ...
   *     NotificationEventConfiguration
   */
  public static NotificationEventConfiguration fromJson(String jsonString) throws JacksonException {
