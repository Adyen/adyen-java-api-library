...
/**
   ...
   * @throws JsonProcessingException if the JSON string is invalid with respect to GetNotificationConfigurationResponse
   */
  public static GetNotificationConfigurationResponse fromJson(String jsonString) throws JsonProcessingException {
