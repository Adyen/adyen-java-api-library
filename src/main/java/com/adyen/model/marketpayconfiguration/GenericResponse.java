...
public class GenericResponse {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to GenericResponse
   */
  public static GenericResponse fromJson(String jsonString) throws JacksonException {
