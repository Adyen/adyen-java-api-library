...
public class DSPublicKeyDetail {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(brand, isSetBrand, directoryServerId, isSetDirectoryServerId, fromSDKVersion, isSetFromSDKVersion, Arrays.hashCode(publicKey), isSetPublicKey, rootCertificates, isSetRootCertificates);
  }
