...
public class DSPublicKeyDetail {
  ...
  /**
   * The version of the mobile 3D Secure 2 SDK. For the possible values, refer to the versions in
   * [Adyen 3DS2 Android](https://github.com/Adyen/adyen-3ds2-android/releases) and [Adyen 3DS2
   * iOS](https://github.com/Adyen/adyen-3ds2-ios/releases).
   *
   * @param fromSDKVersion The version of the mobile 3D Secure 2 SDK. For the possible values, refer
   *     to the versions in [Adyen 3DS2
   *     Android](https://github.com/Adyen/adyen-3ds2-android/releases) and [Adyen 3DS2
   *     iOS](https://github.com/Adyen/adyen-3ds2-ios/releases).
   * @return the current {@code DSPublicKeyDetail} instance, allowing for method chaining
   */
   ...
   * iOS](https://github.com/Adyen/adyen-3ds2-ios/releases).
   *
   * @return fromSDKVersion The version of the mobile 3D Secure 2 SDK. For the possible values,
   ...
   *
   * @param publicKey Public key. The 3D Secure 2 SDK encrypts the device information by using the
   *     DS public key.
   * @return the current {@code DSPublicKeyDetail} instance, allowing for method chaining
   */
   ...
   * Public key. The 3D Secure 2 SDK encrypts the device information by using the DS public key.
   *
   * @return publicKey Public key. The 3D Secure 2 SDK encrypts the device information by using the
   *     DS public key.
   */
  ...
  /**
   * Directory Server root certificates. The 3D Secure 2 SDK verifies the ACS signed content using
   * the rootCertificates.
   *
   * @param rootCertificates Directory Server root certificates. The 3D Secure 2 SDK verifies the
   ...
   * the rootCertificates.
   *
   * @return rootCertificates Directory Server root certificates. The 3D Secure 2 SDK verifies the
   *     ACS signed content using the rootCertificates.
   */
