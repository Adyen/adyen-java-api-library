...
public class MerchantDetails {
  ...
  **/
  ...
  public String toString() {
      String sb = "class MerchantDetails {\n" +
              "    countryCode: " + toIndentedString(countryCode) + "\n" +
              "    enrolledIn3DSecure: " + toIndentedString(enrolledIn3DSecure) + "\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (MerchantDetails.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in MerchantDetails is not found in the empty JSON string", MerchantDetails.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!MerchantDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MerchantDetails` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
