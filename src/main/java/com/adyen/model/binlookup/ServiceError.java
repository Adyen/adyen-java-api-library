...
public class ServiceError {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additionalData, isSetAdditionalData, errorCode, isSetErrorCode, errorType, isSetErrorType, message, isSetMessage, pspReference, isSetPspReference, status, isSetStatus);
  }
