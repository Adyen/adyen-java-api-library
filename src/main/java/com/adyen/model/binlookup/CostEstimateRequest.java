...
public class CostEstimateRequest {
   ...
   * &#x60;ContAuth&#x60; - Card on file and/or subscription transactions, where the card holder is
   ...
   * Either the &#x60;cardNumber&#x60; or &#x60;encryptedCardNumber&#x60; field must be provided in
   * a payment request.
   *
   * @param cardNumber The card number (4-19 characters) for PCI compliant use cases. Do not use any
   *     separators. &gt; Either the &#x60;cardNumber&#x60; or &#x60;encryptedCardNumber&#x60; field
   ...
   * a payment request.
   *
   * @return cardNumber The card number (4-19 characters) for PCI compliant use cases. Do not use
   *     any separators. &gt; Either the &#x60;cardNumber&#x60; or &#x60;encryptedCardNumber&#x60;
  ...
  /**
   * Encrypted data that stores card information for non PCI-compliant use cases. The encrypted data
   * must be created with the Checkout Card Component or Secured Fields Component, and must contain
   * the &#x60;encryptedCardNumber&#x60; field. &gt; Either the &#x60;cardNumber&#x60; or
   * &#x60;encryptedCardNumber&#x60; field must be provided in a payment request.
   *
   * @param encryptedCardNumber Encrypted data that stores card information for non PCI-compliant
   *     use cases. The encrypted data must be created with the Checkout Card Component or Secured
   *     Fields Component, and must contain the &#x60;encryptedCardNumber&#x60; field. &gt; Either
   *     the &#x60;cardNumber&#x60; or &#x60;encryptedCardNumber&#x60; field must be provided in a
   *     payment request.
   * @return the current {@code CostEstimateRequest} instance, allowing for method chaining
   */
   ...
   * &#x60;encryptedCardNumber&#x60; field must be provided in a payment request.
   *
   * @return encryptedCardNumber Encrypted data that stores card information for non PCI-compliant
   *     use cases. The encrypted data must be created with the Checkout Card Component or Secured
   *     Fields Component, and must contain the &#x60;encryptedCardNumber&#x60; field. &gt; Either
   *     the &#x60;cardNumber&#x60; or &#x60;encryptedCardNumber&#x60; field must be provided in a
   *     payment request.
  ...
  /**
   * The &#x60;recurringDetailReference&#x60; you want to use for this cost estimate. The value
   ...
   *     use for this cost estimate. The value &#x60;LATEST&#x60; can be used to select the most
   *     recently stored recurring detail.
   * @return the current {@code CostEstimateRequest} instance, allowing for method chaining
   */
   ...
   *     subscription transactions, where the card holder is known to the merchant (returning
   ...
   */
  public static CostEstimateRequest fromJson(String jsonString) throws JacksonException {
