...
public class CostEstimateAssumptions {
   ...
   *
   * @param assume3DSecureAuthenticated If true, the cardholder is expected to successfully
   *     authorise via 3D Secure.
   ...
   * If true, the cardholder is expected to successfully authorise via 3D Secure.
   *
   * @return assume3DSecureAuthenticated If true, the cardholder is expected to successfully
   *     authorise via 3D Secure.
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(
            this.assume3DSecureAuthenticated, costEstimateAssumptions.assume3DSecureAuthenticated)
        && Objects.equals(
            this.isSetAssume3DSecureAuthenticated,
            costEstimateAssumptions.isSetAssume3DSecureAuthenticated)
  ...
  public int hashCode() {
    return Objects.hash(
        assume3DSecureAuthenticated,
        isSetAssume3DSecureAuthenticated,
        assumeLevel3Data,
        isSetAssumeLevel3Data,
        installments,
        isSetInstallments);
  }
  ...
  public String toString() {
    ...
    sb.append("    assume3DSecureAuthenticated: ")
        .append(toIndentedString(assume3DSecureAuthenticated))
        .append("\n");
  ...
  public Map<String, Object> getExplicitNulls() {
    ...
    if (isSetAssume3DSecureAuthenticated) {
      addIfNull(
          nulls, JSON_PROPERTY_ASSUME3_D_SECURE_AUTHENTICATED, this.assume3DSecureAuthenticated);
    }
   ...
   * @throws JacksonException if the JSON string is invalid with respect to CostEstimateAssumptions
   */
  public static CostEstimateAssumptions fromJson(String jsonString) throws JacksonException {
