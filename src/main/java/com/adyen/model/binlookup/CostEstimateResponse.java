...
public class CostEstimateResponse {
  ...
  public String toString() {
    ...
    sb.append("    costEstimateReference: ")
        .append(toIndentedString(costEstimateReference))
        .append("\n");
   ...
   * @throws JacksonException if the JSON string is invalid with respect to CostEstimateResponse
   */
  public static CostEstimateResponse fromJson(String jsonString) throws JacksonException {
