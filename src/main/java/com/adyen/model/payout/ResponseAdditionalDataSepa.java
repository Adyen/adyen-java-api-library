...
public class ResponseAdditionalDataSepa {
  ...
  **/
  ...
  public String toString() {
      String sb = "class ResponseAdditionalDataSepa {\n" +
              "    sepadirectdebitDateOfSignature: " + toIndentedString(sepadirectdebitDateOfSignature) + "\n" +
              "    sepadirectdebitMandateId: " + toIndentedString(sepadirectdebitMandateId) + "\n" +
              "    sepadirectdebitSequenceType: " + toIndentedString(sepadirectdebitSequenceType) + "\n" +
              "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ResponseAdditionalDataSepa.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResponseAdditionalDataSepa is not found in the empty JSON string", ResponseAdditionalDataSepa.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResponseAdditionalDataSepa.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponseAdditionalDataSepa` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
