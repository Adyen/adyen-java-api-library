...
public class ModifyRequest {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to ModifyRequest
   */
  public static ModifyRequest fromJson(String jsonString) throws JacksonException {
