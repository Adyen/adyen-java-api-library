...
public class ModifyResponse {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to ModifyResponse
   */
  public static ModifyResponse fromJson(String jsonString) throws JacksonException {
