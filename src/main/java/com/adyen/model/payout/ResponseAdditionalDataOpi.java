...
public class ResponseAdditionalDataOpi {
  ...
  **/
  ...
  public String toString() {
      String sb = "class ResponseAdditionalDataOpi {\n" +
              "    opiTransToken: " + toIndentedString(opiTransToken) + "\n" +
              "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ResponseAdditionalDataOpi.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResponseAdditionalDataOpi is not found in the empty JSON string", ResponseAdditionalDataOpi.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResponseAdditionalDataOpi.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponseAdditionalDataOpi` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
