...
public class FraudCheckResultWrapper {
  ...
  private boolean isSetFraudCheckResult = false;
  ...
  public FraudCheckResultWrapper fraudCheckResult(FraudCheckResult fraudCheckResult) {
    ...
    isSetFraudCheckResult = true; // mark as set
    return this;
  }
   ...
   */
  public FraudCheckResultWrapper includeNullValues(boolean includeNullValues) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fraudCheckResult, fraudCheckResultWrapper.fraudCheckResult)
        && Objects.equals(
            this.isSetFraudCheckResult, fraudCheckResultWrapper.isSetFraudCheckResult);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fraudCheckResult, isSetFraudCheckResult);
  }
  ...
  public Map<String, Object> getExplicitNulls() {
    ...
    if (isSetFraudCheckResult) {
      addIfNull(nulls, JSON_PROPERTY_FRAUD_CHECK_RESULT, this.fraudCheckResult);
    }
   ...
   * @throws JacksonException if the JSON string is invalid with respect to FraudCheckResultWrapper
   */
  public static FraudCheckResultWrapper fromJson(String jsonString) throws JacksonException {
