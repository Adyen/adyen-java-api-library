...
public class StoreDetailAndSubmitResponse {
   ...
   *
   * @param resultCode The response:  * In case of success is payout-submit-received. * In case of an error, an informational message is returned.
   * @return the current {@code StoreDetailAndSubmitResponse} instance, allowing for method chaining
   */
  ...
  /**
   * The response:  * In case of success is payout-submit-received. * In case of an error, an informational message is returned.
   * @return resultCode The response:  * In case of success is payout-submit-received. * In case of an error, an informational message is returned.
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.additionalData, storeDetailAndSubmitResponse.additionalData) &&
        Objects.equals(this.isSetAdditionalData, storeDetailAndSubmitResponse.isSetAdditionalData) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additionalData, isSetAdditionalData, pspReference, isSetPspReference, refusalReason, isSetRefusalReason, resultCode, isSetResultCode);
  }
