...
public class ResponseAdditionalDataInstallments {
  ...
  /**
   * Type of installment. The value of &#x60;installmentType&#x60; should be **IssuerFinanced**.
   * @return installmentPaymentDataInstallmentType Type of installment. The value of &#x60;installmentType&#x60; should be **IssuerFinanced**.
   */
  ...
  /**
   * First Installment Amount in minor units.
   * @return installmentPaymentDataOptionItemNrFirstInstallmentAmount First Installment Amount in minor units.
   */
  ...
  /**
   * Interest rate for the installment period.
   * @return installmentPaymentDataOptionItemNrInterestRate Interest rate for the installment period.
   */
  ...
  /**
   * Maximum number of installments possible for this payment.
   * @return installmentPaymentDataOptionItemNrMaximumNumberOfInstallments Maximum number of installments possible for this payment.
   */
  ...
  /**
   * Minimum number of installments possible for this payment.
   * @return installmentPaymentDataOptionItemNrMinimumNumberOfInstallments Minimum number of installments possible for this payment.
   */
  ...
  /**
   * Total number of installments possible for this payment.
   * @return installmentPaymentDataOptionItemNrNumberOfInstallments Total number of installments possible for this payment.
   */
  ...
  /**
   * Subsequent Installment Amount in minor units.
   * @return installmentPaymentDataOptionItemNrSubsequentInstallmentAmount Subsequent Installment Amount in minor units.
   */
  ...
  /**
   * Possible values: * PayInInstallmentsOnly * PayInFullOnly * PayInFullOrInstallments
   * @return installmentPaymentDataPaymentOptions Possible values: * PayInInstallmentsOnly * PayInFullOnly * PayInFullOrInstallments
   */
  ...
  /**
   * The number of installments that the payment amount should be charged with.  Example: 5 &gt; Only relevant for card payments in countries that support installments.
   * @return installmentsValue The number of installments that the payment amount should be charged with.  Example: 5 &gt; Only relevant for card payments in countries that support installments.
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.installmentPaymentDataInstallmentType, responseAdditionalDataInstallments.installmentPaymentDataInstallmentType) &&
        Objects.equals(this.isSetInstallmentPaymentDataInstallmentType, responseAdditionalDataInstallments.isSetInstallmentPaymentDataInstallmentType) &&
        ...
        Objects.equals(this.isSetInstallmentPaymentDataOptionItemNrAnnualPercentageRate, responseAdditionalDataInstallments.isSetInstallmentPaymentDataOptionItemNrAnnualPercentageRate) &&
        ...
        Objects.equals(this.isSetInstallmentPaymentDataOptionItemNrFirstInstallmentAmount, responseAdditionalDataInstallments.isSetInstallmentPaymentDataOptionItemNrFirstInstallmentAmount) &&
        ...
        Objects.equals(this.isSetInstallmentPaymentDataOptionItemNrInstallmentFee, responseAdditionalDataInstallments.isSetInstallmentPaymentDataOptionItemNrInstallmentFee) &&
        ...
        Objects.equals(this.isSetInstallmentPaymentDataOptionItemNrMaximumNumberOfInstallments, responseAdditionalDataInstallments.isSetInstallmentPaymentDataOptionItemNrMaximumNumberOfInstallments) &&
        ...
        Objects.equals(this.isSetInstallmentPaymentDataOptionItemNrMinimumNumberOfInstallments, responseAdditionalDataInstallments.isSetInstallmentPaymentDataOptionItemNrMinimumNumberOfInstallments) &&
        ...
        Objects.equals(this.isSetInstallmentPaymentDataOptionItemNrNumberOfInstallments, responseAdditionalDataInstallments.isSetInstallmentPaymentDataOptionItemNrNumberOfInstallments) &&
        ...
        Objects.equals(this.isSetInstallmentPaymentDataOptionItemNrSubsequentInstallmentAmount, responseAdditionalDataInstallments.isSetInstallmentPaymentDataOptionItemNrSubsequentInstallmentAmount) &&
        ...
        Objects.equals(this.isSetInstallmentPaymentDataOptionItemNrTotalAmountDue, responseAdditionalDataInstallments.isSetInstallmentPaymentDataOptionItemNrTotalAmountDue) &&
        ...
        Objects.equals(this.isSetInstallmentPaymentDataPaymentOptions, responseAdditionalDataInstallments.isSetInstallmentPaymentDataPaymentOptions) &&
  ...
  public Map<String, Object> getExplicitNulls() {
    ...
    if (isSetInstallmentPaymentDataInstallmentType) {
      addIfNull(nulls, JSON_PROPERTY_INSTALLMENT_PAYMENT_DATA_INSTALLMENT_TYPE, this.installmentPaymentDataInstallmentType);
    }
    if (isSetInstallmentPaymentDataOptionItemNrAnnualPercentageRate) {
      addIfNull(nulls, JSON_PROPERTY_INSTALLMENT_PAYMENT_DATA_OPTION_ITEM_NR_ANNUAL_PERCENTAGE_RATE, this.installmentPaymentDataOptionItemNrAnnualPercentageRate);
    }
    if (isSetInstallmentPaymentDataOptionItemNrFirstInstallmentAmount) {
      addIfNull(nulls, JSON_PROPERTY_INSTALLMENT_PAYMENT_DATA_OPTION_ITEM_NR_FIRST_INSTALLMENT_AMOUNT, this.installmentPaymentDataOptionItemNrFirstInstallmentAmount);
    }
    if (isSetInstallmentPaymentDataOptionItemNrInstallmentFee) {
      addIfNull(nulls, JSON_PROPERTY_INSTALLMENT_PAYMENT_DATA_OPTION_ITEM_NR_INSTALLMENT_FEE, this.installmentPaymentDataOptionItemNrInstallmentFee);
    }
    if (isSetInstallmentPaymentDataOptionItemNrInterestRate) {
      addIfNull(nulls, JSON_PROPERTY_INSTALLMENT_PAYMENT_DATA_OPTION_ITEM_NR_INTEREST_RATE, this.installmentPaymentDataOptionItemNrInterestRate);
    }
    if (isSetInstallmentPaymentDataOptionItemNrMaximumNumberOfInstallments) {
      addIfNull(nulls, JSON_PROPERTY_INSTALLMENT_PAYMENT_DATA_OPTION_ITEM_NR_MAXIMUM_NUMBER_OF_INSTALLMENTS, this.installmentPaymentDataOptionItemNrMaximumNumberOfInstallments);
    }
    if (isSetInstallmentPaymentDataOptionItemNrMinimumNumberOfInstallments) {
      addIfNull(nulls, JSON_PROPERTY_INSTALLMENT_PAYMENT_DATA_OPTION_ITEM_NR_MINIMUM_NUMBER_OF_INSTALLMENTS, this.installmentPaymentDataOptionItemNrMinimumNumberOfInstallments);
    }
    if (isSetInstallmentPaymentDataOptionItemNrNumberOfInstallments) {
      addIfNull(nulls, JSON_PROPERTY_INSTALLMENT_PAYMENT_DATA_OPTION_ITEM_NR_NUMBER_OF_INSTALLMENTS, this.installmentPaymentDataOptionItemNrNumberOfInstallments);
    }
    ...
    if (isSetInstallmentPaymentDataOptionItemNrTotalAmountDue) {
      addIfNull(nulls, JSON_PROPERTY_INSTALLMENT_PAYMENT_DATA_OPTION_ITEM_NR_TOTAL_AMOUNT_DUE, this.installmentPaymentDataOptionItemNrTotalAmountDue);
    }
    if (isSetInstallmentPaymentDataPaymentOptions) {
      addIfNull(nulls, JSON_PROPERTY_INSTALLMENT_PAYMENT_DATA_PAYMENT_OPTIONS, this.installmentPaymentDataPaymentOptions);
    }
