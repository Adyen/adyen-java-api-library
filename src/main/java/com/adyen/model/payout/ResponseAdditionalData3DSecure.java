...
public class ResponseAdditionalData3DSecure {
  ...
  **/
  ...
  public String toString() {
      String sb = "class ResponseAdditionalData3DSecure {\n" +
              "    cardHolderInfo: " + toIndentedString(cardHolderInfo) + "\n" +
              "    cavv: " + toIndentedString(cavv) + "\n" +
              "    cavvAlgorithm: " + toIndentedString(cavvAlgorithm) + "\n" +
              "    scaExemptionRequested: " + toIndentedString(scaExemptionRequested) + "\n" +
              "    threeds2CardEnrolled: " + toIndentedString(threeds2CardEnrolled) + "\n" +
              "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ResponseAdditionalData3DSecure.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResponseAdditionalData3DSecure is not found in the empty JSON string", ResponseAdditionalData3DSecure.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResponseAdditionalData3DSecure.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponseAdditionalData3DSecure` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
