...
public class PayoutResponse {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PayoutResponse
   */
  public static PayoutResponse fromJson(String jsonString) throws JacksonException {
