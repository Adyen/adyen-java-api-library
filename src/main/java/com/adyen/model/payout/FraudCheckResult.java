...
public class FraudCheckResult {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to FraudCheckResult
   */
  public static FraudCheckResult fromJson(String jsonString) throws JacksonException {
