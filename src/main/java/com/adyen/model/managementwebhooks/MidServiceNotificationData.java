...
@JsonPropertyOrder({
  ...
  MidServiceNotificationData.JSON_PROPERTY_RESULT,
...
public class MidServiceNotificationData {
  ...
  **/
   ...
   * @return merchantId
  **/
  @ApiModelProperty(required = true, value = "The identifier of the merchant account.")
  ...
  **/
  ...
  public MidServiceNotificationData result(ResultEnum result) {
    this.result = result;
    return this;
  }
   ...
   * @return result
  **/
  @ApiModelProperty(required = true, value = "The result of the request to create a payment method.")
   ...
   * @return storeId
  **/
  @ApiModelProperty(value = "The identifier of the [store](https://docs.adyen.com/api-explorer/#/ManagementService/latest/post/merchants/{id}/paymentMethodSettings__reqParam_storeId), if any.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowed, midServiceNotificationData.allowed) &&
        ...
        Objects.equals(this.result, midServiceNotificationData.result) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowed, enabled, id, merchantId, reference, result, storeId, type, verificationStatus);
  }
