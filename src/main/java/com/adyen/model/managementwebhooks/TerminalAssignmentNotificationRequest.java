...
public class TerminalAssignmentNotificationRequest {
   ...
   *
   * @param assignedToAccount The unique identifier of the merchant/company account to which the terminal is assigned.
  ...
  /**
   * The unique identifier of the merchant/company account to which the terminal is assigned.
   * @return assignedToAccount The unique identifier of the merchant/company account to which the terminal is assigned.
   */
   ...
   *
   * @param assignedToStore The store that the terminal is assigned to, identified by the store reference (also known as store code).
   * @return the current {@code TerminalAssignmentNotificationRequest} instance, allowing for method chaining
   */
  ...
  /**
   * The store that the terminal is assigned to, identified by the store reference (also known as store code).
   * @return assignedToStore The store that the terminal is assigned to, identified by the store reference (also known as store code).
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.assignedToAccount, terminalAssignmentNotificationRequest.assignedToAccount) &&
        ...
        Objects.equals(this.assignedToStoreId, terminalAssignmentNotificationRequest.assignedToStoreId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(assignedToAccount, assignedToStore, assignedToStoreId, eventDate, pspReference, uniqueTerminalId);
  }
