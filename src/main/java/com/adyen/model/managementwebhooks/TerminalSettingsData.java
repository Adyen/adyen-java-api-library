...
public class TerminalSettingsData {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to TerminalSettingsData
   */
  public static TerminalSettingsData fromJson(String jsonString) throws JacksonException {
