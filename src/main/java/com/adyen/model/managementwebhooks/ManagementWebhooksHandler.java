...
public class ManagementWebhooksHandler {
    ...
    public Optional<MerchantCreatedNotificationRequest> getMerchantCreatedNotificationRequest() {
        ...
        var optionalMerchantCreatedNotificationRequest =  getOptionalField(MerchantCreatedNotificationRequest.class);
    ...
    public Optional<MerchantUpdatedNotificationRequest> getMerchantUpdatedNotificationRequest() {
        ...
        var optionalMerchantUpdatedNotificationRequest =  getOptionalField(MerchantUpdatedNotificationRequest.class);
    ...
    public Optional<PaymentMethodCreatedNotificationRequest> getPaymentMethodCreatedNotificationRequest() {
        ...
        var optionalPaymentMethodCreatedNotificationRequest =  getOptionalField(PaymentMethodCreatedNotificationRequest.class);
    ...
    public Optional<PaymentMethodRequestRemovedNotificationRequest> getPaymentMethodRequestRemovedNotificationRequest() {
        ...
        var optionalPaymentMethodRequestRemovedNotificationRequest =  getOptionalField(PaymentMethodRequestRemovedNotificationRequest.class);
    ...
    public Optional<PaymentMethodScheduledForRemovalNotificationRequest> getPaymentMethodScheduledForRemovalNotificationRequest() {
        ...
        var optionalPaymentMethodScheduledForRemovalNotificationRequest =  getOptionalField(PaymentMethodScheduledForRemovalNotificationRequest.class);
        ...
        if(optionalPaymentMethodScheduledForRemovalNotificationRequest.isPresent()) {
            ...
            for (var value : PaymentMethodScheduledForRemovalNotificationRequest.TypeEnum.values()) {
                if (value.equals(optionalPaymentMethodScheduledForRemovalNotificationRequest.get().getType())) {
                    // found matching event type
    ...
    public Optional<TerminalBoardingNotificationRequest> getTerminalBoardingNotificationRequest() {
        ...
        var optionalTerminalBoardingNotificationRequest =  getOptionalField(TerminalBoardingNotificationRequest.class);
    ...
    public Optional<TerminalSettingsNotificationRequest> getTerminalSettingsNotificationRequest() {
        ...
        var optionalTerminalSettingsNotificationRequest =  getOptionalField(TerminalSettingsNotificationRequest.class);
