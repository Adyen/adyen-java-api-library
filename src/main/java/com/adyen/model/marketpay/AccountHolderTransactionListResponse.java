...
public class AccountHolderTransactionListResponse {
    ...
    public String toString() {
        ...
        sb.append("class AccountHolderTransactionListResponse {").append(TextConstants.LINE_BREAK);

        sb.append("    accountTransactionLists: ").append(Util.toIndentedString(accountTransactionLists)).append(TextConstants.LINE_BREAK);
