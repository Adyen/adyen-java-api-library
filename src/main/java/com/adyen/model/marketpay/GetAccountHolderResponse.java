...
public class GetAccountHolderResponse {
    ...
    public String toString() {
        ...
        sb.append("class GetAccountHolderResponse {").append(TextConstants.LINE_BREAK);
        ...
        sb.append("    accounts: ").append(Util.toIndentedString(accounts)).append(TextConstants.LINE_BREAK);
        ...
        sb.append("    systemUpToDateTime: ").append(Util.toIndentedString(systemUpToDateTime)).append(TextConstants.LINE_BREAK);
        sb.append("    verification: ").append(Util.toIndentedString(verification)).append(TextConstants.LINE_BREAK);
        sb.append("}");
        return sb.toString();
    }
