...
public class Account {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(accountCode, beneficiaryAccount, beneficiaryMerchantReference, description, metadata, payoutSchedule, status, bankAccountUUID, payoutMethodCode, payoutSpeed);
    }
    ...
    public String toString() {
        ...
        String sb = "class Account {\n" +
                ...
                "    beneficiaryAccount: " + toIndentedString(beneficiaryAccount) + "\n" +
                "    beneficiaryMerchantReference: " + toIndentedString(beneficiaryMerchantReference) + "\n" +
