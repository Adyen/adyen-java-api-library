...
public class TokenizationWebhooksHandler {
    ...
    public Optional<TokenizationAlreadyExistingDetailsNotificationRequest> getTokenizationAlreadyExistingDetailsNotificationRequest() {
        ...
        var optionalTokenizationAlreadyExistingDetailsNotificationRequest =  getOptionalField(TokenizationAlreadyExistingDetailsNotificationRequest.class);
        ...
        if(optionalTokenizationAlreadyExistingDetailsNotificationRequest.isPresent()) {
            ...
            for (var value : TokenizationAlreadyExistingDetailsNotificationRequest.TypeEnum.values()) {
                if (value.equals(optionalTokenizationAlreadyExistingDetailsNotificationRequest.get().getType())) {
    ...
    public Optional<TokenizationCreatedDetailsNotificationRequest> getTokenizationCreatedDetailsNotificationRequest() {
        ...
        var optionalTokenizationCreatedDetailsNotificationRequest =  getOptionalField(TokenizationCreatedDetailsNotificationRequest.class);
    ...
    public Optional<TokenizationDisabledDetailsNotificationRequest> getTokenizationDisabledDetailsNotificationRequest() {
        ...
        var optionalTokenizationDisabledDetailsNotificationRequest =  getOptionalField(TokenizationDisabledDetailsNotificationRequest.class);
    ...
    public Optional<TokenizationUpdatedDetailsNotificationRequest> getTokenizationUpdatedDetailsNotificationRequest() {
        ...
        var optionalTokenizationUpdatedDetailsNotificationRequest =  getOptionalField(TokenizationUpdatedDetailsNotificationRequest.class);
