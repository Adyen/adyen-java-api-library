...
public class TokenizationCreatedDetailsNotificationRequest {
   ...
   * @return the current {@code TokenizationCreatedDetailsNotificationRequest} instance, allowing for method chaining
   */
  ...
  public TokenizationCreatedDetailsNotificationRequest includeNullValues(boolean includeNullValues) {
  ...
  public boolean equals(Object o) {
    ...
    TokenizationCreatedDetailsNotificationRequest tokenizationCreatedDetailsNotificationRequest = (TokenizationCreatedDetailsNotificationRequest) o;
    return Objects.equals(this.createdAt, tokenizationCreatedDetailsNotificationRequest.createdAt) &&
        ...
        Objects.equals(this.environment, tokenizationCreatedDetailsNotificationRequest.environment) &&
...
/**
   ...
   * @throws JsonProcessingException if the JSON string is invalid with respect to TokenizationCreatedDetailsNotificationRequest
   */
  public static TokenizationCreatedDetailsNotificationRequest fromJson(String jsonString) throws JsonProcessingException {
    return JSON.getMapper().readValue(jsonString, TokenizationCreatedDetailsNotificationRequest.class);
  }
/**
