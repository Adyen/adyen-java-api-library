...
import com.adyen.model.terminal.TotalFilter;
 ...
 */
@ApiModel(description = "It conveys information from the Sale System related to the scope and the format of the totals to be computed by the POI System. Content of the Get Totals Request message.")
@JsonPropertyOrder({
...
public class GetTotalsRequest {
  ...
  private List<TotalDetailsEnum> totalDetails = null;
