 ...
 */
@ApiModel(description = "If the payment receipts are printed by the Sale system and the POI or the Sale does not implement the Print exchange (Basic profile). Customer or Merchant payment receipt.")
@JsonPropertyOrder({
...
public class PaymentReceipt {
  ...
  **/
  @ApiModelProperty(value = "Type of the print integrated to other prints.")
  ...
  **/
  @ApiModelProperty(value = "Indicate that the cardholder payment receipt requires a physical signature by the Customer.")
