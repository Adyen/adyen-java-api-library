 ...
 */
@ApiModel(description = "This data structure conveys the identification of the account and the associated loyalty brand. Data related to a loyalty account processed in the transaction.")
@JsonPropertyOrder({
...
public class LoyaltyAccount {
  ...
  */ 
   ...
   * @return loyaltyBrand
  **/
  @ApiModelProperty(value = "If a card is analysed.")
