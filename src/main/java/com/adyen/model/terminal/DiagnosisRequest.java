 ...
 */
@ApiModel(description = "It conveys Information related to the target POI for which the diagnosis is requested. Content of the Diagnosis Request message.")
@JsonPropertyOrder({
...
public class DiagnosisRequest {
   ...
   * @return POIID
  **/
  @ApiModelProperty(value = "MessageHeader.POIID.")
  ...
  **/
  @ApiModelProperty(value = "Indicates if Host Diagnosis are required.")
