 ...
 */
@ApiModel(description = "It contains the result of the requested service, APDU response sent by the chip of the card in response to the APDU request. Content of the Card Reader APDU Response message.")
@JsonPropertyOrder({
...
public class CardReaderAPDUResponse {
  ...
  **/
  @ApiModelProperty(required = true, value = "Status of a smartcard response to a command (SW1-SW2).")
...
/**
   ...
   * @throws JsonProcessingException if the JSON string is invalid with respect to CardReaderAPDUResponse
   */
