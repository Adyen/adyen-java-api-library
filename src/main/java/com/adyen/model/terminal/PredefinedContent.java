 ...
 */
@ApiModel(description = "It conveys Information related to the predefined message. Reference of a predefined message to display or print.")
@JsonPropertyOrder({
...
public class PredefinedContent {
   ...
   * @return referenceID
  **/
  @ApiModelProperty(required = true, value = "Identification of a predefined message to display or print.")
  ...
  */ 
   ...
   * @return language
  **/
  @ApiModelProperty(value = "Identification of a language.")
