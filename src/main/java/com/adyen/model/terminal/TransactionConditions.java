 ...
 */
@ApiModel(description = "Conditions on which the transaction must be processed.")
@JsonPropertyOrder({
...
public class TransactionConditions {
  ...
  **/
  @ApiModelProperty(value = "The preferred type of payment is a debit transaction rather a credit transaction.")
  ...
  **/
  @ApiModelProperty(value = "Go online if data sent.")
  ...
  **/
  @ApiModelProperty(value = "The payment implies a specific MCC.")
