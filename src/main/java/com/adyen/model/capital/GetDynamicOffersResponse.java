...
public class GetDynamicOffersResponse {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to GetDynamicOffersResponse
   */
  public static GetDynamicOffersResponse fromJson(String jsonString) throws JacksonException {
