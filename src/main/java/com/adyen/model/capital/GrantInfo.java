...
public class GrantInfo {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to GrantInfo
   */
  public static GrantInfo fromJson(String jsonString) throws JacksonException {
