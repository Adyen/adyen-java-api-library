...
import com.adyen.model.capital.AdditionalBankIdentification;
...
public class NumberAndBicAccountIdentification extends BankAccountIdentification {
  ...
  private String type = "numberAndBic";
   ...
   * @return the current {@code NumberAndBicAccountIdentification} instance, allowing for method chaining
   */
  public NumberAndBicAccountIdentification type(String type) {
    this.type = type;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountNumber, additionalBankIdentification, bic, type, super.hashCode());
  }
  ...
  static {
    ...
    JSON.registerDiscriminator(NumberAndBicAccountIdentification.class, "type", mappings);
  }
/**
