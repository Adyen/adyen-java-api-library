...
public class SGLocalAccountIdentification extends BankAccountIdentification {
  ...
  public int hashCode() {
    return Objects.hash(
        accountNumber, isSetAccountNumber, bic, isSetBic, type, isSetType, super.hashCode());
  }
   ...
   *     SGLocalAccountIdentification
   */
  public static SGLocalAccountIdentification fromJson(String jsonString) throws JacksonException {
