...
public class DynamicOffer {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to DynamicOffer
   */
  public static DynamicOffer fromJson(String jsonString) throws JacksonException {
