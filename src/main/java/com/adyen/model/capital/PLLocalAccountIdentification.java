...
public class PLLocalAccountIdentification extends BankAccountIdentification {
   ...
   * rachunku](https://pl.wikipedia.org/wiki/Numer_Rachunku_Bankowego)), without separators or
   * whitespace.
   *
   * @param accountNumber The 26-digit bank account number ([Numer
   *     rachunku](https://pl.wikipedia.org/wiki/Numer_Rachunku_Bankowego)), without separators or
   *     whitespace.
   ...
   * whitespace.
   *
   * @return accountNumber The 26-digit bank account number ([Numer
   *     rachunku](https://pl.wikipedia.org/wiki/Numer_Rachunku_Bankowego)), without separators or
   *     whitespace.
   */
   ...
   *     PLLocalAccountIdentification
   */
  public static PLLocalAccountIdentification fromJson(String jsonString) throws JacksonException {
