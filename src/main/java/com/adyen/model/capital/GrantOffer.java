...
public class GrantOffer {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to GrantOffer
   */
  public static GrantOffer fromJson(String jsonString) throws JacksonException {
