...
public class GrantOffer {
   ...
   * The contract type of the grant offer. Possible values: **cashAdvance**, **loan**.
   *
   * @param contractType The contract type of the grant offer. Possible values: **cashAdvance**,
   *     **loan**.
   * @return the current {@code GrantOffer} instance, allowing for method chaining
   */
   ...
   * The contract type of the grant offer. Possible values: **cashAdvance**, **loan**.
   *
   * @return contractType The contract type of the grant offer. Possible values: **cashAdvance**,
   *     **loan**.
   */
   ...
   *
   * @param expiresAt The date when the grant offer expires.
   * @return the current {@code GrantOffer} instance, allowing for method chaining
   */
   ...
   * The date when the grant offer expires.
   *
   * @return expiresAt The date when the grant offer expires.
   */
   ...
   *
   * @param startsAt The date when the grant offer becomes available.
   * @return the current {@code GrantOffer} instance, allowing for method chaining
   */
   ...
   * The date when the grant offer becomes available.
   *
   * @return startsAt The date when the grant offer becomes available.
   */
