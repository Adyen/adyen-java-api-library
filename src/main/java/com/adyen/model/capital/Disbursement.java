...
public class Disbursement {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to Disbursement
   */
  public static Disbursement fromJson(String jsonString) throws JacksonException {
