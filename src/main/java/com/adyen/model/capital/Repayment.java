...
public class Repayment {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to Repayment
   */
  public static Repayment fromJson(String jsonString) throws JacksonException {
