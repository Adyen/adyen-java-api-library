...
@JsonTypeInfo(
    ...
    property = "type",
    visible = true)
public class HULocalAccountIdentification extends BankAccountIdentification {
   ...
   * @return the current {@code HULocalAccountIdentification} instance, allowing for method chaining
   */
  public HULocalAccountIdentification type(String type) {
    this.type = type;
  ...
  static {
    ...
    JSON.registerDiscriminator(HULocalAccountIdentification.class, "type", mappings);
  }
   ...
   *     HULocalAccountIdentification
   */
  public static HULocalAccountIdentification fromJson(String jsonString) throws JacksonException {
