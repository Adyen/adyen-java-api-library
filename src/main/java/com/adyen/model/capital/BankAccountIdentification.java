...
public class BankAccountIdentification {
  ...
  /**
   * The type of account, which depends on the country of the account and the currency of the
   * transfer.
   *
   * @param type The type of account, which depends on the country of the account and the currency
   *     of the transfer.
   ...
   * transfer.
   *
   * @return type The type of account, which depends on the country of the account and the currency
   *     of the transfer.
   */
   ...
   */
  public BankAccountIdentification includeNullValues(boolean includeNullValues) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, bankAccountIdentification.type)
        && Objects.equals(this.isSetType, bankAccountIdentification.isSetType);
  }
