...
public class ThresholdRepayment {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to ThresholdRepayment
   */
  public static ThresholdRepayment fromJson(String jsonString) throws JacksonException {
