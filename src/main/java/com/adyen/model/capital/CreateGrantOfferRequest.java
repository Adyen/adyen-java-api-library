...
public class CreateGrantOfferRequest {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to CreateGrantOfferRequest
   */
  public static CreateGrantOfferRequest fromJson(String jsonString) throws JacksonException {
