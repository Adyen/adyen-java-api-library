...
@JsonPropertyOrder({TerminalBoardingNotificationResponse.JSON_PROPERTY_NOTIFICATION_RESPONSE})
public class TerminalBoardingNotificationResponse {
   ...
   *     TerminalBoardingNotificationResponse
   */
  public static TerminalBoardingNotificationResponse fromJson(String jsonString)
