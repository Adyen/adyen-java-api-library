...
public class PaymentNotificationRequest {
  ...
  public enum TypeEnum {
    BALANCEPLATFORM_PAYMENTINSTRUMENT_CREATED(
        String.valueOf("balancePlatform.paymentInstrument.created")),

    BALANCEPLATFORM_PAYMENTINSTRUMENT_UPDATED(
        String.valueOf("balancePlatform.paymentInstrument.updated"));
   ...
   *
   * @param data
   * @return the current {@code PaymentNotificationRequest} instance, allowing for method chaining
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, paymentNotificationRequest.data)
        && Objects.equals(this.isSetData, paymentNotificationRequest.isSetData)
        && Objects.equals(this.environment, paymentNotificationRequest.environment)
        && Objects.equals(this.isSetEnvironment, paymentNotificationRequest.isSetEnvironment)
        && Objects.equals(this.timestamp, paymentNotificationRequest.timestamp)
        && Objects.equals(this.isSetTimestamp, paymentNotificationRequest.isSetTimestamp)
        && Objects.equals(this.type, paymentNotificationRequest.type)
        && Objects.equals(this.isSetType, paymentNotificationRequest.isSetType);
  }
   ...
   *     PaymentNotificationRequest
   */
  public static PaymentNotificationRequest fromJson(String jsonString)
