...
public class TransactionNotificationRequestV4 {
   ...
   *
   * @param data
   * @return the current {@code TransactionNotificationRequestV4} instance, allowing for method
   *     chaining
   */
   ...
   */
  public TransactionNotificationRequestV4 includeNullValues(boolean includeNullValues) {
  ...
  public boolean equals(Object o) {
    ...
    TransactionNotificationRequestV4 transactionNotificationRequestV4 =
        (TransactionNotificationRequestV4) o;
    return Objects.equals(this.data, transactionNotificationRequestV4.data)
        && Objects.equals(this.isSetData, transactionNotificationRequestV4.isSetData)
        && Objects.equals(this.environment, transactionNotificationRequestV4.environment)
        && Objects.equals(this.isSetEnvironment, transactionNotificationRequestV4.isSetEnvironment)
        && Objects.equals(this.timestamp, transactionNotificationRequestV4.timestamp)
        && Objects.equals(this.isSetTimestamp, transactionNotificationRequestV4.isSetTimestamp)
        && Objects.equals(this.type, transactionNotificationRequestV4.type)
        && Objects.equals(this.isSetType, transactionNotificationRequestV4.isSetType);
  }
   ...
   *     TransactionNotificationRequestV4
   */
  public static TransactionNotificationRequestV4 fromJson(String jsonString)
