...
public class TerminalSettingsNotificationResponse {
   ...
   *     webhook](https://docs.adyen.com/development-resources/webhooks/#accept-webhooks).
   * @return the current {@code TerminalSettingsNotificationResponse} instance, allowing for method
   *     chaining
   */
