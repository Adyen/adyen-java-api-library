...
public class NetworkTokenTransactionRulesResult {
   ...
   * @return the current {@code NetworkTokenTransactionRulesResult} instance, allowing for method
   *     chaining
   */
   ...
   *
   * @param allHardBlockRulesPassed Indicates whether the transaction passed all rules with
   *     &#x60;outcomeType&#x60; **hardBlock**.
   * @return the current {@code NetworkTokenTransactionRulesResult} instance, allowing for method
   *     chaining
   */
  public NetworkTokenTransactionRulesResult allHardBlockRulesPassed(
      Boolean allHardBlockRulesPassed) {
   ...
   * Indicates whether the transaction passed all rules with &#x60;outcomeType&#x60; **hardBlock**.
   *
   * @return allHardBlockRulesPassed Indicates whether the transaction passed all rules with
   *     &#x60;outcomeType&#x60; **hardBlock**.
   */
   ...
   *
   * @param triggeredTransactionRules Contains a list of all triggered transaction rules and the
   *     corresponding data.
   * @return the current {@code NetworkTokenTransactionRulesResult} instance, allowing for method
   *     chaining
   */
  public NetworkTokenTransactionRulesResult triggeredTransactionRules(
      List<NetworkTokenTriggeredRiskRule> triggeredTransactionRules) {
    this.triggeredTransactionRules = triggeredTransactionRules;
    isSetTriggeredTransactionRules = true; // mark as set
    return this;
  }

  public NetworkTokenTransactionRulesResult addTriggeredTransactionRulesItem(
      NetworkTokenTriggeredRiskRule triggeredTransactionRulesItem) {
   ...
   * Contains a list of all triggered transaction rules and the corresponding data.
   *
   * @return triggeredTransactionRules Contains a list of all triggered transaction rules and the
   *     corresponding data.
   */
  ...
  public boolean equals(Object o) {
    ...
    NetworkTokenTransactionRulesResult networkTokenTransactionRulesResult =
        (NetworkTokenTransactionRulesResult) o;
    return Objects.equals(this.advice, networkTokenTransactionRulesResult.advice)
        ...
        && Objects.equals(
            ...
            networkTokenTransactionRulesResult.allHardBlockRulesPassed)
        && Objects.equals(
            this.isSetAllHardBlockRulesPassed,
            networkTokenTransactionRulesResult.isSetAllHardBlockRulesPassed)
        && Objects.equals(this.score, networkTokenTransactionRulesResult.score)
        && Objects.equals(this.isSetScore, networkTokenTransactionRulesResult.isSetScore)
        && Objects.equals(
            this.triggeredTransactionRules,
            networkTokenTransactionRulesResult.triggeredTransactionRules)
        && Objects.equals(
            this.isSetTriggeredTransactionRules,
            networkTokenTransactionRulesResult.isSetTriggeredTransactionRules);
  }
