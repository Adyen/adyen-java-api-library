...
@JsonPropertyOrder({TerminalAssignmentNotificationResponse.JSON_PROPERTY_NOTIFICATION_RESPONSE})
public class TerminalAssignmentNotificationResponse {
   ...
   *     webhook](https://docs.adyen.com/development-resources/webhooks/#accept-webhooks).
   * @return the current {@code TerminalAssignmentNotificationResponse} instance, allowing for
   *     method chaining
   */
   ...
   */
  public TerminalAssignmentNotificationResponse includeNullValues(boolean includeNullValues) {
   ...
   *     TerminalAssignmentNotificationResponse
   */
  public static TerminalAssignmentNotificationResponse fromJson(String jsonString)
