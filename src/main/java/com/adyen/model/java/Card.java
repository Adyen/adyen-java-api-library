...
public class Card {
  ...
  /**
   * The brand variant of the physical or the virtual card. For example, **visadebit** or
   * **mcprepaid**. &gt;Reach out to your Adyen contact to get the values relevant for your
   * integration.
   *
   * @param brandVariant The brand variant of the physical or the virtual card. For example,
   *     **visadebit** or **mcprepaid**. &gt;Reach out to your Adyen contact to get the values
   ...
   * integration.
   *
   * @return brandVariant The brand variant of the physical or the virtual card. For example,
   *     **visadebit** or **mcprepaid**. &gt;Reach out to your Adyen contact to get the values
   *     relevant for your integration.
   */
   ...
   * &#x60;POST&#x60; response for single-use virtual cards.
   *
   * @param cvc The CVC2 value of the card. &gt; The CVC2 is not sent by default. This is only
   *     returned in the &#x60;POST&#x60; response for single-use virtual cards.
   * @return the current {@code Card} instance, allowing for method chaining
   */
   ...
   * &#x60;POST&#x60; response for single-use virtual cards.
   *
   * @return cvc The CVC2 value of the card. &gt; The CVC2 is not sent by default. This is only
   *     returned in the &#x60;POST&#x60; response for single-use virtual cards.
   */
  ...
  /**
   * The primary account number (PAN) of the card. &gt; The PAN is masked by default and returned
   * only for single-use virtual cards.
   *
   * @param number The primary account number (PAN) of the card. &gt; The PAN is masked by default
   *     and returned only for single-use virtual cards.
   * @return the current {@code Card} instance, allowing for method chaining
   */
   ...
   * only for single-use virtual cards.
   *
   * @return number The primary account number (PAN) of the card. &gt; The PAN is masked by default
   *     and returned only for single-use virtual cards.
   */
