...
public class AccountHolderNotificationRequest {
   ...
   *
   * @param data
   * @return the current {@code AccountHolderNotificationRequest} instance, allowing for method
   *     chaining
   */
   ...
   */
  public AccountHolderNotificationRequest includeNullValues(boolean includeNullValues) {
  ...
  public boolean equals(Object o) {
    ...
    AccountHolderNotificationRequest accountHolderNotificationRequest =
        (AccountHolderNotificationRequest) o;
    return Objects.equals(this.data, accountHolderNotificationRequest.data)
        && Objects.equals(this.isSetData, accountHolderNotificationRequest.isSetData)
        && Objects.equals(this.environment, accountHolderNotificationRequest.environment)
        && Objects.equals(this.isSetEnvironment, accountHolderNotificationRequest.isSetEnvironment)
        && Objects.equals(this.timestamp, accountHolderNotificationRequest.timestamp)
        && Objects.equals(this.isSetTimestamp, accountHolderNotificationRequest.isSetTimestamp)
        && Objects.equals(this.type, accountHolderNotificationRequest.type)
        && Objects.equals(this.isSetType, accountHolderNotificationRequest.isSetType);
  }
   ...
   *     AccountHolderNotificationRequest
   */
  public static AccountHolderNotificationRequest fromJson(String jsonString)
