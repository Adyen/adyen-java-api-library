...
public class NegativeBalanceCompensationWarningNotificationData {
  ...
  /** Mark when the attribute has been explicitly set. */
  private boolean isSetLiableBalanceAccountId = false;
  ...
  /** Mark when the attribute has been explicitly set. */
  private boolean isSetNegativeBalanceSince = false;
  ...
  /** Mark when the attribute has been explicitly set. */
  private boolean isSetScheduledCompensationAt = false;
  ...
  public NegativeBalanceCompensationWarningNotificationData liableBalanceAccountId(
    ...
    isSetLiableBalanceAccountId = true; // mark as set
    return this;
  }
  ...
  public NegativeBalanceCompensationWarningNotificationData negativeBalanceSince(
    ...
    isSetNegativeBalanceSince = true; // mark as set
    return this;
  }
  ...
  public NegativeBalanceCompensationWarningNotificationData scheduledCompensationAt(
    ...
    isSetScheduledCompensationAt = true; // mark as set
    return this;
  }
   ...
   */
  public NegativeBalanceCompensationWarningNotificationData includeNullValues(
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(
        ...
        && Objects.equals(
            this.isSetAccountHolder,
            negativeBalanceCompensationWarningNotificationData.isSetAccountHolder)
        && Objects.equals(this.amount, negativeBalanceCompensationWarningNotificationData.amount)
        && Objects.equals(
            this.isSetAmount, negativeBalanceCompensationWarningNotificationData.isSetAmount)
        && Objects.equals(
            this.balancePlatform,
            negativeBalanceCompensationWarningNotificationData.balancePlatform)
        && Objects.equals(
            this.isSetBalancePlatform,
            negativeBalanceCompensationWarningNotificationData.isSetBalancePlatform)
        && Objects.equals(
            this.creationDate, negativeBalanceCompensationWarningNotificationData.creationDate)
        && Objects.equals(
            this.isSetCreationDate,
            negativeBalanceCompensationWarningNotificationData.isSetCreationDate)
        && Objects.equals(this.id, negativeBalanceCompensationWarningNotificationData.id)
        && Objects.equals(this.isSetId, negativeBalanceCompensationWarningNotificationData.isSetId)
        && Objects.equals(
            this.liableBalanceAccountId,
            negativeBalanceCompensationWarningNotificationData.liableBalanceAccountId)
        && Objects.equals(
            this.isSetLiableBalanceAccountId,
            negativeBalanceCompensationWarningNotificationData.isSetLiableBalanceAccountId)
        && Objects.equals(
            this.negativeBalanceSince,
            negativeBalanceCompensationWarningNotificationData.negativeBalanceSince)
        && Objects.equals(
            this.isSetNegativeBalanceSince,
            negativeBalanceCompensationWarningNotificationData.isSetNegativeBalanceSince)
        && Objects.equals(
            this.scheduledCompensationAt,
            negativeBalanceCompensationWarningNotificationData.scheduledCompensationAt)
        && Objects.equals(
            this.isSetScheduledCompensationAt,
            negativeBalanceCompensationWarningNotificationData.isSetScheduledCompensationAt);
  }
  ...
  public int hashCode() {
    return Objects.hash(
        ...
        isSetLiableBalanceAccountId,
        negativeBalanceSince,
        isSetNegativeBalanceSince,
        scheduledCompensationAt,
        isSetScheduledCompensationAt);
  }
  ...
  public Map<String, Object> getExplicitNulls() {
    ...
    if (isSetLiableBalanceAccountId) {
      addIfNull(nulls, JSON_PROPERTY_LIABLE_BALANCE_ACCOUNT_ID, this.liableBalanceAccountId);
    }
    if (isSetNegativeBalanceSince) {
      addIfNull(nulls, JSON_PROPERTY_NEGATIVE_BALANCE_SINCE, this.negativeBalanceSince);
    }
    if (isSetScheduledCompensationAt) {
      addIfNull(nulls, JSON_PROPERTY_SCHEDULED_COMPENSATION_AT, this.scheduledCompensationAt);
    }
