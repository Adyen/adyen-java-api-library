...
public class TransferDataCategoryData extends AbstractOpenApiSchema {
  ...
  public static class TransferDataCategoryDataSerializer
      extends StdSerializer<TransferDataCategoryData> {
    ...
    public void serialize(
        TransferDataCategoryData value, JsonGenerator jgen, SerializationContext context)
        throws JacksonException {
      context.writeValue(jgen, value.getActualInstance());
    }
  }

  public static class TransferDataCategoryDataDeserializer
      extends StdDeserializer<TransferDataCategoryData> {
    ...
    @Override
    public TransferDataCategoryData deserialize(JsonParser jp, DeserializationContext ctxt)
        throws JacksonException {
      ...
      throw DatabindException.from(
          ctxt,
          String.format(
              "Failed deserialization for TransferDataCategoryData: %d classes match result, expected 1",
              match));
    }

    /** Handle deserialization of the 'null' value. */
    @Override
    public TransferDataCategoryData getNullValue(DeserializationContext ctxt)
        throws DatabindException {
      throw DatabindException.from(ctxt, "TransferDataCategoryData cannot be null");
    }
  }
