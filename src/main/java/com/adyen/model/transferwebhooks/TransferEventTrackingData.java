...
public class TransferEventTrackingData extends AbstractOpenApiSchema {
  ...
  public static class TransferEventTrackingDataSerializer
    ...
    public void serialize(
        TransferEventTrackingData value, JsonGenerator jgen, SerializationContext context)
  ...
  public static class TransferEventTrackingDataDeserializer
    ...
    public TransferEventTrackingData deserialize(JsonParser jp, DeserializationContext ctxt)
      ...
      try {
        ...
        if (attemptParsing) {
          ...
          if (typeMatch) {
            deserialized = ctxt.readTreeAsValue(tree, ConfirmationTrackingData.class);
      ...
      try {
        ...
        if (attemptParsing) {
          ...
          if (typeMatch) {
            deserialized = ctxt.readTreeAsValue(tree, EstimationTrackingData.class);
            // TODO: there is no validation against JSON schema constraints
            // (min, max, enum, pattern...), this does not perform a strict JSON
            // validation, which means the 'match' count may be higher than it should be.
            match++;
      ...
      try {
        ...
        if (attemptParsing) {
          ...
          if (typeMatch) {
            deserialized = ctxt.readTreeAsValue(tree, InternalReviewTrackingData.class);
            // TODO: there is no validation against JSON schema constraints
            // (min, max, enum, pattern...), this does not perform a strict JSON
            // validation, which means the 'match' count may be higher than it should be.
            match++;
    ...
    public TransferEventTrackingData getNullValue(DeserializationContext ctxt)
      ...
      throw DatabindException.from(ctxt, "TransferEventTrackingData cannot be null");
    }
  }
