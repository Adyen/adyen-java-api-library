...
public class CounterpartyV3 {
   ...
   *     account](https://docs.adyen.com/api-explorer/balanceplatform/latest/post/balanceAccounts#responses-200-id).
   * @return the current {@code CounterpartyV3} instance, allowing for method chaining
   */
   ...
   * @throws JacksonException if the JSON string is invalid with respect to CounterpartyV3
   */
  public static CounterpartyV3 fromJson(String jsonString) throws JacksonException {
