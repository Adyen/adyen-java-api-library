...
public class TransferDataTracking extends AbstractOpenApiSchema {
  ...
  public static class TransferDataTrackingSerializer extends StdSerializer<TransferDataTracking> {
    ...
    public void serialize(
        TransferDataTracking value, JsonGenerator jgen, SerializationContext context)
        throws JacksonException {
      context.writeValue(jgen, value.getActualInstance());
    }
  }

  public static class TransferDataTrackingDeserializer
      extends StdDeserializer<TransferDataTracking> {
    ...
    @Override
    public TransferDataTracking deserialize(JsonParser jp, DeserializationContext ctxt)
        throws JacksonException {
      ...
      throw DatabindException.from(
          ctxt,
          String.format(
              "Failed deserialization for TransferDataTracking: %d classes match result, expected 1",
              match));
    }

    /** Handle deserialization of the 'null' value. */
    @Override
    public TransferDataTracking getNullValue(DeserializationContext ctxt) throws DatabindException {
      throw DatabindException.from(ctxt, "TransferDataTracking cannot be null");
    }
  }
