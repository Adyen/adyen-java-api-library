...
public class StoredValueIssueResponse {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to StoredValueIssueResponse
   */
  public static StoredValueIssueResponse fromJson(String jsonString) throws JacksonException {
