...
public class StoredValueLoadRequest {
    ...
    public enum LoadTypeEnum {
        ...
        public static LoadTypeEnum fromValue(String text) {
        ...
        public static class Adapter extends TypeAdapter<LoadTypeEnum> {
            ...
            public LoadTypeEnum read(final JsonReader jsonReader) throws IOException {
                ...
                return LoadTypeEnum.fromValue(String.valueOf(value));
            }
        }
    }

    @SerializedName("loadType")
    private LoadTypeEnum loadType = null;
    ...
    public StoredValueLoadRequest paymentMethod(PaymentMethod paymentMethod) {
    ...
    public String toString() {
        ...
        String sb = "class StoredValueLoadRequest {\n" +
                "    amount: " + toIndentedString(amount) + "\n" +
                "    loadType: " + toIndentedString(loadType) + "\n" +
