...
public class BalanceTransferRequest {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to BalanceTransferRequest
   */
  public static BalanceTransferRequest fromJson(String jsonString) throws JacksonException {
