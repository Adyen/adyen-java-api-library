...
public class BalanceTransferRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amount, isSetAmount, description, isSetDescription, fromMerchant, isSetFromMerchant, reference, isSetReference, toMerchant, isSetToMerchant, type, isSetType);
  }
