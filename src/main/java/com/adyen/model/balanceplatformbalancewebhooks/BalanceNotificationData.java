...
public class BalanceNotificationData {
   ...
   *
   * @param currency TThe three-character [ISO currency code](https://docs.adyen.com/development-resources/currency-codes).
   * @return the current {@code BalanceNotificationData} instance, allowing for method chaining
   */
  ...
  /**
   * TThe three-character [ISO currency code](https://docs.adyen.com/development-resources/currency-codes).
   * @return currency TThe three-character [ISO currency code](https://docs.adyen.com/development-resources/currency-codes).
   */
