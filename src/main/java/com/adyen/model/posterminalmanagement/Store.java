...
public class Store {
   ...
   * activated. - &#x60;Active&#x60;: the store has been activated. This means you can process
   * payments for this store. - &#x60;Inactive&#x60;: the store is currently not active. -
   * &#x60;InactiveWithModifications&#x60;: the store is currently not active, but payment
   * modifications such as refunds are possible. - &#x60;Closed&#x60;: the store has been closed.
   *
   * @param status
   * @return the current {@code Store} instance, allowing for method chaining
   */
