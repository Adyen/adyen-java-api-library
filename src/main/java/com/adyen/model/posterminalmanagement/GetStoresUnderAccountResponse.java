...
@JsonPropertyOrder({GetStoresUnderAccountResponse.JSON_PROPERTY_STORES})
public class GetStoresUnderAccountResponse {
   ...
   *
   * @param stores
   * @return the current {@code GetStoresUnderAccountResponse} instance, allowing for method
   *     chaining
   */
   ...
   *     GetStoresUnderAccountResponse
   */
  public static GetStoresUnderAccountResponse fromJson(String jsonString) throws JacksonException {
