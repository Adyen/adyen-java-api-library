...
public class MerchantAccount {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to MerchantAccount
   */
  public static MerchantAccount fromJson(String jsonString) throws JacksonException {
