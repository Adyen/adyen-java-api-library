...
public class FindTerminalRequest {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to FindTerminalRequest
   */
  public static FindTerminalRequest fromJson(String jsonString) throws JacksonException {
