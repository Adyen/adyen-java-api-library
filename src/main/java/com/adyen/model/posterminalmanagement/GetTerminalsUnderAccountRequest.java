...
public class GetTerminalsUnderAccountRequest {
  ...
  /**
   * Your company account. If you only specify this parameter, the response includes all terminals
   * at all account levels.
   *
   * @param companyAccount
   * @return the current {@code GetTerminalsUnderAccountRequest} instance, allowing for method
   *     chaining
   */
  ...
  /**
   * The merchant account. This is required if you are retrieving the terminals assigned to a
   * store.If you don&#39;t specify a &#x60;store&#x60; the response includes the terminals assigned
   * to the specified merchant account and the terminals assigned to the stores under this merchant
   * account.
   *
  ...
  /**
   * The store code of the store. With this parameter, the response only includes the terminals
   * assigned to the specified store.
   *
   * @param store
   * @return the current {@code GetTerminalsUnderAccountRequest} instance, allowing for method
   *     chaining
  ...
  public boolean equals(Object o) {
    ...
    GetTerminalsUnderAccountRequest getTerminalsUnderAccountRequest =
        (GetTerminalsUnderAccountRequest) o;
