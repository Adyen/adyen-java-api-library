...
public class GetTerminalDetailsResponse {
  ...
  /**
   * The status of the terminal: - &#x60;OnlineToday&#x60;, &#x60;OnlineLast1Day&#x60;,
   * &#x60;OnlineLast2Days&#x60; etcetera to &#x60;OnlineLast7Days&#x60;: Indicates when in the past
   * week the terminal was last online. - &#x60;SwitchedOff&#x60;: Indicates it was more than a week
   * ago that the terminal was last online. - &#x60;ReAssignToInventoryPending&#x60;,
  ...
  /**
   * The company account that the terminal is associated with. If this is the only account level
   * shown in the response, the terminal is assigned to the inventory of the company account.
   *
  ...
  /**
   * The label shown on the status bar of the display. This label (if any) is specified in your
   * Customer Area.
   *
   * @param displayLabel
   * @return the current {@code GetTerminalDetailsResponse} instance, allowing for method chaining
   ...
   */
  @ApiModelProperty(
      value = "The integrated circuit card identifier (ICCID) of the SIM card in the terminal.")
   ...
   * @return the current {@code GetTerminalDetailsResponse} instance, allowing for method chaining
   */
  public GetTerminalDetailsResponse lastTransactionDateTime(
      OffsetDateTime lastTransactionDateTime) {
  ...
  /**
   * The Ethernet link negotiation that the terminal uses: - &#x60;auto&#x60;: Auto-negotiation -
  ...
  /**
   * The merchant account that the terminal is associated with. If the response doesn&#39;t contain
   * a &#x60;store&#x60; the terminal is assigned to this merchant account.
   *
  ...
  /**
   * Boolean that indicates if the terminal is assigned to the merchant inventory. This is returned
   * when the terminal is assigned to a merchant account. - If **true**, this indicates that the
   * terminal is in the merchant inventory. This also means that the terminal cannot be boarded. -
   * If **false**, this indicates that the terminal is assigned to the merchant account as an
   * in-store terminal. This means that the terminal is ready to be boarded, or is already boarded.
   *
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bluetoothIp, getTerminalDetailsResponse.bluetoothIp)
        ...
        && Objects.equals(
            this.lastActivityDateTime, getTerminalDetailsResponse.lastActivityDateTime)
        && Objects.equals(
            this.lastTransactionDateTime, getTerminalDetailsResponse.lastTransactionDateTime)
  ...
  public String toString() {
    ...
    sb.append("    lastActivityDateTime: ")
        .append(toIndentedString(lastActivityDateTime))
        .append("\n");
    sb.append("    lastTransactionDateTime: ")
        .append(toIndentedString(lastTransactionDateTime))
        .append("\n");
    ...
    sb.append("    permanentTerminalId: ")
        .append(toIndentedString(permanentTerminalId))
        .append("\n");
