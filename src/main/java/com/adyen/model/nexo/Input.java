 ...
 * which contains data entered by the user on the requested device, depending on the requested
 * InputCommand:GetConfirmation: the input is in ConfirmedFlag.GetAnyKey: there is no
 * input.GetFunctionKey: the input is in
 *
