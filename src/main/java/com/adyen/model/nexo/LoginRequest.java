...
/**
 * Definition: Content of the Login Request messageType. -- Usage: It conveys Information related to
 * the session (period between a Login and the following Logout) to process
 *
