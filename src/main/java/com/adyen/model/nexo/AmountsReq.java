 ...
 * Usage: Amounts requested by the Sale System for the payment and loyalty transaction, containing:
 * The currency which is the same for all these amounts The requested amount to pay The cash back
 * part of the requested amount for a payment with cash
 *
