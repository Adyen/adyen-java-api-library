...
/**
 * Definition: Content of the Batch Request messageType. -- Usage: Message to send Payment, Loyalty
 * and Reversal transactions to be performed without the Sale System, or to request the Payment,
 * Loyalty and Reversal transactions that has been performed without the Sale System.
 *
...
@XmlType(
    name = "BatchRequest",
    propOrder = {"transactionToPerform"})
public class BatchRequest {
   ...
   * there is not a <CODE>set</CODE> method for the transactionToPerform property.
   *
   * <p>
   *
   ...
   * <p>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link TransactionToPerform }
   *
