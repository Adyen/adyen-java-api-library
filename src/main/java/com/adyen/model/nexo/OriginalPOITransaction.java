 ...
 * Request messageType, it allows using the card of a previous CardAcquisition or Payment/Loyalty
 * request. To reverse a Payment or the Loyalty transaction. By default, the reversal is requested
 * from the same Sale
 *
