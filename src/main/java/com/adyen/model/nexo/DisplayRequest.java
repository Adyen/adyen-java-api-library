 ...
 * and the way to process the display. It contains the complete content to display. It might contain
...
public class DisplayRequest {
   ...
   * there is not a <CODE>set</CODE> method for the displayOutput property.
   *
   * <p>
   *
   ...
   * <p>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link DisplayOutput }
   *
