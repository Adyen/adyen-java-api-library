...
/**
 * Definition: Information related to the software and hardware feature of the POI Terminal --
 * Usage: Allows in a session to identify the features of the POI Terminal attached to a Sale
 * Terminal per a Login Request messageType.
 *
...
@XmlType(
    ...
    propOrder = {"poiCapabilities", "poiProfile"})
public class POITerminalData {
   ...
   * there is not a <CODE>set</CODE> method for the poiCapabilities property.
   *
   * <p>
   *
   * <p>
   ...
   * <p>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link POICapabilitiesType }
   *
