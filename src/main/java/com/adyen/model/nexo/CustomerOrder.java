...
/**
 * Definition: Customer order attached to a card, recorded in the POI system. -- Usage: Allows the
 * management of customer orders by the POI, for instance in a multi-channel or a click and collect
 * sale transaction.
 *
