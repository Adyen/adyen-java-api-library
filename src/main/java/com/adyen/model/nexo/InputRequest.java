...
/**
 * Definition: Content of the Input Request messageType. -- Usage: It conveys data to display and
 * the way to process the display, and contains the complete content to display. In addition to the
 * display on the Input Device, it might contain an operation (the DisplayOutput element) per
 * Display Device type.
 *
...
@XmlType(
    name = "InputRequest",
    propOrder = {"displayOutput", "inputData"})
