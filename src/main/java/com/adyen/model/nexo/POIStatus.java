...
/**
 * Definition: State of a POI Terminal. -- Usage: Indicate the availability of the POI Terminal
 * components. The data element is absent if the component is not part of the POI Terminal.
 *
...
public class POIStatus {
   ...
   * there is not a <CODE>set</CODE> method for the cashHandlingDevice property.
   *
   * <p>
   *
   ...
   * <p>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link CashHandlingDevice }
   *
