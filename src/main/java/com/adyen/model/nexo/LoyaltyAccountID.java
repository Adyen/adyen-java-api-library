 ...
 * message, it allows to identify the loyalty account by the Sale Terminal instead of the POI
 * Terminal (e.g. because the account identification is a bar-code read by the Cashier on a scanner
 * device). In
 *
