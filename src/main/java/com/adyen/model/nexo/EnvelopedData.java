 ...
 * structure contains: the version of the data structure (which is v0 in EPAS protocol context) the
 * protected encrytion key for every adressee (recipient) the encrypted data
 *
...
public class EnvelopedData {
   ...
   * there is not a <CODE>set</CODE> method for the keyTransportOrKEK property.
   *
   * <p>
   *
   ...
   * <p>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link KeyTransport } {@link KEK }
   *
