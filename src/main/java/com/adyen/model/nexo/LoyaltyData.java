 ...
 * Balance Inquiry Request messageType, it allows the Sale Terminal to send the identification of
 * the loyalty account or an awarded amount or an amount to redeem to the loyalty account.
 *
