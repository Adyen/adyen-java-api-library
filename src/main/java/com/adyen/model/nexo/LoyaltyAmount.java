 ...
 * the loyalty account might be sent in the Payment request messageType. The amount to apply on the
 * requested loyalty service, if not computed from the TotalAmount of the Loyalty request
 * messageType. The
 *
