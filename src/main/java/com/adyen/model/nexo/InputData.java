 ...
 * logical device, the type of input command, and possible minimum and maximum length of the input.
 * In addition, if the requestor might require to receive an Event Notification if a card is
 * inserted in a card
 *
