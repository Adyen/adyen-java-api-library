...
/**
 * Definition: Functional profile of the Sale Terminal. -- Usage: Sent in the Login Request to
 * identify the functions that might be requested by the Sale Terminal during the session. The value
 * of this data element contains: One of the generic profile: Basic, Standard or Extended, A list
 * (possibly
 *
...
public class SaleProfile {
   ...
   * there is not a <CODE>set</CODE> method for the serviceProfiles property.
   *
   * <p>
   *
   ...
   * <p>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link ServiceProfilesType }
   *
