...
/**
 * Definition: Content of the Get Totals Request messageType. -- Usage: It conveys information from
 * the Sale System related to the scope and the format of the totals to be computed by the POI
 * System.
 *
...
@XmlType(
    ...
    propOrder = {"totalDetails", "totalFilter"})
public class GetTotalsRequest {
   ...
   * there is not a <CODE>set</CODE> method for the totalDetails property.
   *
   * <p>
   *
   ...
   * <p>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link TotalDetailsType }
   *
