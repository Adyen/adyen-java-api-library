...
/**
 * Definition: Content of the Reconciliation Request messageType. -- Usage: It conveys Information
 * related to the Reconciliation requested by the Sale System: Type of reconciliation (with or
 * without closure of the reconciliation time period) The Acquirers identification if they are
 * involved and could be selected
 *
...
public class ReconciliationRequest {
   ...
   * there is not a <CODE>set</CODE> method for the acquirerID property.
   *
   * <p>
   *
