...
/**
 * Definition: Numeric value of a handwritten signature. -- Usage: Contain the value of a
 * handwritten signature, e.g. the signature of a cardholder on the merchant payment receipt. Only
 * one format of the signature is allowed, it contains: The size of the pad area where the signature
 * is written, given
 *
...
@XmlType(
    ...
    propOrder = {"areaSize", "signaturePoint"})
public class CapturedSignature {
   ...
   * there is not a <CODE>set</CODE> method for the signaturePoint property.
   *
   * <p>
   *
   ...
   * <p>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link SignaturePoint }
   *
