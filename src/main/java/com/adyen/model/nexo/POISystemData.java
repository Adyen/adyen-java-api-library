...
/**
 * Definition: Information related to the POI System -- Usage: In the Login messageType response,
 * the data structure contains information related to the POI System fixed for the session or
...
@XmlType(
    name = "POISystemData",
    propOrder = {"dateTime", "poiSoftware", "poiTerminalData", "poiStatus"})
