...
/**
 * Definition: Content to display or print. -- Usage: This is a sequence of elements if they have
 * different formats.
 *
...
@XmlType(
    name = "OutputContent",
    propOrder = {"predefinedContent", "outputText", "outputXHTML", "outputBarcode"})
public class OutputContent {
   ...
   * there is not a <CODE>set</CODE> method for the outputText property.
   *
   * <p>
   *
   ...
   * <p>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link OutputText }
   *
