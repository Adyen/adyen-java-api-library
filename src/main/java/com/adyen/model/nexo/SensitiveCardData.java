 ...
 * System. -- Usage: This data structure could be CMS protected (EnvelopedData). In this case the
 * data structure SensitiveCardData is replaced by the data structure ProtectedCardData of type
 * ContentInformationType. When this data is protected, the exact
 *
...
public class SensitiveCardData {
   ...
   * there is not a <CODE>set</CODE> method for the trackData property.
   *
   * <p>
   *
   * <p>
   ...
   * <p>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link TrackData }
   *
