...
/**
 * Definition: Content of the Card Acquisition Request messageType. -- Usage: It conveys Information
 * related to the payment and loyalty cards to read and analyse. This messageType pair is usually
 * followed by a messageType pair (e.g. payment or loyalty) which refers to this Card Acquisition
...
@XmlType(
    ...
    propOrder = {"saleData", "cardAcquisitionTransaction"})
