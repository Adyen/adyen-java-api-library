 ...
 * contains: - the identification of the stored value accounts or the stored value cards - the
 * identification of the transaction by the stored value host - the balance of the stored value
 * account if relevant
 *
