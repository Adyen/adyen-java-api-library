 ...
 * result of the payment transaction. For a card, it could also be sent in the CardAcquisition
 * response, to be processed by the Sale System. In this case, the card or type of card has to be
 * configured to have this behaviour. It is
 *
