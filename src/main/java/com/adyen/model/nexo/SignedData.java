 ...
 * the version of the data structure (which is v1 in EPAS protocol context) the identifiers of the
 * messageType digest algorithms the encapsulated content the certificates for the verification of
 * the signature
 *
