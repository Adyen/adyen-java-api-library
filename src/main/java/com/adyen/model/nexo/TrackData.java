...
/**
 * Definition: Magnetic track or magnetic ink characters line. -- Reference: ISO 7813 - ISO 4909 --
 * Usage: Generic data structure for a card track, used when the magstripe card reader is located on
 * the Sale Terminal, or for magstripe Card Reader device request. The data structure is also used
 * to store the line at the bottom of a bank check
 *
