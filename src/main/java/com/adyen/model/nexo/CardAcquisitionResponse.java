 ...
 * Information related to the payment and loyalty cards read and processed by the POI System and
 * entered by the Customer:As for the Payment request, the result of the CardAcquisition and the
 * identification of the transaction.One
 *
...
public class CardAcquisitionResponse {
   ...
   * there is not a <CODE>set</CODE> method for the paymentBrand property.
   *
   * <p>
   *
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the loyaltyAccount property.
   *
   * <p>
   *
   * <p>For example, to add a new item, do as follows:
   ...
   * <p>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link LoyaltyAccount }
   *
