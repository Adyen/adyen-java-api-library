 ...
 * display, parallel to the messageType request, except if response not required and absent.
 *
...
public class DisplayResponse {
   ...
   * there is not a <CODE>set</CODE> method for the outputResult property.
   *
   * <p>
   *
   ...
   * <p>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link OutputResult }
   *
