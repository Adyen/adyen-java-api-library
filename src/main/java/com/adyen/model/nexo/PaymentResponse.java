...
/**
 * Definition: Content of the Payment Response messageType. -- Usage: It conveys Information related
...
public class PaymentResponse {
   ...
   * there is not a <CODE>set</CODE> method for the loyaltyResult property.
   *
   * <p>
   *
   ...
   * <p>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link LoyaltyResult }
   *
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the paymentReceipt property.
   *
   * <p>
   *
   * <p>For example, to add a new item, do as follows:
   ...
   * <p>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link PaymentReceipt }
   *
