...
/**
 * Definition: Sale items of a transaction. -- Usage: In loyalty or value added payment card
 * transaction, the items of the sale are entering in the processing of the transaction. The sum of
 * the item amount could be more than the Requested amount in case of split payment without split of
 * the
 *
