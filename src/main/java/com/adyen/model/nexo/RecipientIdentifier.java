...
/**
 * Definition: Cryptographic Message Syntax (CMS) data structure containing the Recipient Identifier
 * -- Reference: RFC 3852: Cryptographic Message Syntax (CMS) -- Usage: This data structure
 * contains: the issuer name (see X.501-88) the certificate serial number (see X.509-97)
 *
...
public class RecipientIdentifier {
  ...
  @SerializedName("IssuerAndSerialNumber")
