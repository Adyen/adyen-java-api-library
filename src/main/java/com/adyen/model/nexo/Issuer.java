 ...
 * Key Infrastructure Certificate and Certificate -- Usage: The Issuer field identifies the entity
 * that has signed and issued the certificate. It contains hierarchical name composed of attributes,
 * such as country, organization, organizational-unit, common name.
 *
...
public class Issuer {
   ...
   * there is not a <CODE>set</CODE> method for the relativeDistinguishedName property.
   *
   * <p>
   *
   ...
   * <p>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link RelativeDistinguishedName }
   *
