...
/**
 * Definition: Cryptographic Message Syntax (CMS) data structure containing encrypted data and
 * integrated optional data filed keyName. -- Reference: RFC 3852: Cryptographic Message Syntax
 * (CMS) -- Usage: This data structure contains: the version of the data structure (which is v0 in
 * EPAS protocol context) the keyName the encrypred content info including the encrypted data
 *
...
@XmlType(
    ...
    propOrder = {"keyName", "encryptedContent"})
