 ...
 * progress or to request the status of a transaction from which no response has been received. It
 * identifies the messageType header of the messageType request to abort or request the status. The
 * Abort or TransactionStatus
 *
