 ...
 * complete display operation for a Display or an Input Device type. For the Input Devices,
 * Diagnosis and EnableService, ResponseRequiredFlag and MinimumDisplayTime shall be absent.
 *
...
public class DisplayOutput {
   ...
   * there is not a <CODE>set</CODE> method for the menuEntry property.
   *
   * <p>
   *
   ...
   * <p>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link MenuEntry }
   *
