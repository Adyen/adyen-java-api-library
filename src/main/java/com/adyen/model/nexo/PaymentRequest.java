 ...
 * to the Payment transaction to process
 *
...
public class PaymentRequest {
   ...
   * there is not a <CODE>set</CODE> method for the loyaltyData property.
   *
   * <p>
   *
   ...
   * <p>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link LoyaltyData }
   *
