 ...
 * Usage: In the Login Request, if a Sale Terminal is involved in the login. In other messages, when
 * a logical device is out of order (SaleCapabilites), or when the other data have changed since or
 * were not in the Login.
 *
...
public class SaleTerminalData {
   ...
   * there is not a <CODE>set</CODE> method for the saleCapabilities property.
   *
   * <p>
   *
   ...
   * <p>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link SaleCapabilitiesType }
   *
