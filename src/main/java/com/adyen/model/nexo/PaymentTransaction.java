...
/**
 * Definition: Data related to the payment and loyalty transaction. -- Usage: Elements requested by
 * the Sale System that are global to the payment or loyalty transaction.
 *
...
@XmlType(
    ...
    propOrder = {"amountsReq", "originalPOITransaction", "transactionConditions", "saleItem"})
public class PaymentTransaction {
   ...
   * there is not a <CODE>set</CODE> method for the saleItem property.
   *
   * <p>
   *
   ...
   * <p>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link SaleItem }
   *
