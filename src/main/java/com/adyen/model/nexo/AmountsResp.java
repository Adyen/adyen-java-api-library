...
/**
 * Definition: Various amounts related to the payment response from the POI System. -- Usage:
 * Amounts approved by the POI and the Acquirer for the payment and loyalty transaction, containing:
 * The authorised amount to be paid The amount of the rebates The amount of financial fees The cash
 * back part of the requested amount for a
 *
...
public class AmountsResp {
  ...
  @SerializedName("TotalRebatesAmount")
  @Schema(
      description =
