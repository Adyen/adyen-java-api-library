...
/**
 * Definition: Functional profile of the POI Terminal. -- Usage: Sent in the Login Response to
 * identify the profiles the POI Terminal support during the session. The value of this data element
 * contains: One of the generic profile: Basic, Standard or Extended, A list (possibly empty) of
 * services
 *
