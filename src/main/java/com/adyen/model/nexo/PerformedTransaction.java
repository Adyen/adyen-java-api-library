...
/**
 * Definition: Result of performed transactions. -- Usage: Contains result of transaction performed
 * without the Sale system.
 *
...
@XmlType(
    ...
    propOrder = {"response", "saleData", "poiData", "paymentResult", "loyaltyResult"})
