...
/**
 * Definition: Data related to the Sale System. -- Usage: Data associated to the Sale System, with a
 * particular value during the processing of the payment by the POI, including the cards
 * acquisition.
 *
...
public class SaleData {
   ...
   * there is not a <CODE>set</CODE> method for the sponsoredMerchant property.
   *
   * <p>
   *
   ...
   * <p>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link SponsoredMerchant }
   *
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the customerOrderReq property.
   *
   * <p>
   *
   * <p>For example, to add a new item, do as follows:
   ...
   * <p>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link CustomerOrderReqType }
   *
