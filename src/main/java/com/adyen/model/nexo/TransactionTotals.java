 ...
 * contains all the totals, classified as required by the Sale in the messageType request. At least,
 * transaction totals are provided per Acquirer, Acquirer Settlement, and Card Brand.
 *
