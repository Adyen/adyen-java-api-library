 ...
 * acquisition of the card data by the Sale System before the Payment, CardAcquisition or
 * BalanceInquiry request to the POI. It could also be sent in the CardAcquisition response, to be
 * processed by the Sale System. In this case, the
 *
...
public class CardData {
   ...
   * there is not a <CODE>set</CODE> method for the allowedProductCode property.
   *
   * <p>
   *
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the allowedProduct property.
   *
   * <p>
   *
   * <p>For example, to add a new item, do as follows:
   ...
   * <p>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link AllowedProduct }
   *
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the customerOrder property.
   *
   * <p>
   *
   * <p>For example, to add a new item, do as follows:
   ...
   * <p>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link CustomerOrder }
   *
