 ...
 * related to the Reconciliation transaction processed by the POI System
 *
...
public class ReconciliationResponse {
   ...
   * there is not a <CODE>set</CODE> method for the transactionTotals property.
   *
   * <p>
   *
   ...
   * <p>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link TransactionTotals }
   *
