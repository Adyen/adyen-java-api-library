 ...
 * that will be enabled for the POI Terminal without the request of the Sale System, and a possible
 * invitation for the Customer to start the services.
 *
...
public class EnableServiceRequest {
   ...
   * there is not a <CODE>set</CODE> method for the servicesEnabled property.
   *
   * <p>
   *
   * <p>
   ...
   * <p>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link ServicesEnabledType }
   *
