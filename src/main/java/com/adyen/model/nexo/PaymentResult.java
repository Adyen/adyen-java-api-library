 ...
 * Message Response, the result of card payment transaction.
 *
...
public class PaymentResult {
   ...
   * there is not a <CODE>set</CODE> method for the currencyConversion property.
   *
   * <p>
   *
   ...
   * <p>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link CurrencyConversion }
   *
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the authenticationMethod property.
   *
   * <p>
   *
   * <p>For example, to add a new item, do as follows:
   ...
   * <p>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link AuthenticationMethodType }
   *
