...
/**
 * Handler for processing RelayedAuthorisationWebhooks.
 *
 * <p>This class provides functionality to deserialize the payload of RelayedAuthorisationWebhooks
 * events.
 */
public class RelayedAuthorisationWebhooksHandler {

  private static final Logger LOG =
      Logger.getLogger(RelayedAuthorisationWebhooksHandler.class.getName());
   ...
   */
  public RelayedAuthorisationWebhooksHandler(String payload) {
