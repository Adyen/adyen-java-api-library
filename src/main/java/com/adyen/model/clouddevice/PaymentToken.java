...
/**
 * Definition: Surrogate of the PAN (Primary Account Number) of the payment card to identify the
 * payment mean of the customer. -- Usage: It allows, for a merchant, to identify the customer.
 *
