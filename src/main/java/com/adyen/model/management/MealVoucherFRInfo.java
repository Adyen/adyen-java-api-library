...
public class MealVoucherFRInfo {
  ...
  **/
  ...
  public String toString() {
      String sb = "class MealVoucherFRInfo {\n" +
              "    conecsId: " + toIndentedString(conecsId) + "\n" +
              "    siret: " + toIndentedString(siret) + "\n" +
              "    subTypes: " + toIndentedString(subTypes) + "\n" +
              "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (MealVoucherFRInfo.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in MealVoucherFRInfo is not found in the empty JSON string", MealVoucherFRInfo.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!MealVoucherFRInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MealVoucherFRInfo` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
