...
public class GenerateHmacKeyResponse {
  ...
  **/
  ...
  public String toString() {
      String sb = "class GenerateHmacKeyResponse {\n" +
              "    hmacKey: " + toIndentedString(hmacKey) + "\n" +
              "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (GenerateHmacKeyResponse.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateHmacKeyResponse is not found in the empty JSON string", GenerateHmacKeyResponse.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GenerateHmacKeyResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateHmacKeyResponse` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
