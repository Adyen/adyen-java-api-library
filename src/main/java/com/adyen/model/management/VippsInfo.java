...
public class VippsInfo {
  ...
  **/
  ...
  public String toString() {
      String sb = "class VippsInfo {\n" +
              "    logo: " + toIndentedString(logo) + "\n" +
              "    subscriptionCancelUrl: " + toIndentedString(subscriptionCancelUrl) + "\n" +
              "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (VippsInfo.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in VippsInfo is not found in the empty JSON string", VippsInfo.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!VippsInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VippsInfo` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
