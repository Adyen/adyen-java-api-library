...
/** VippsInfo */
@JsonPropertyOrder({VippsInfo.JSON_PROPERTY_LOGO, VippsInfo.JSON_PROPERTY_SUBSCRIPTION_CANCEL_URL})
public class VippsInfo {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to VippsInfo
   */
  public static VippsInfo fromJson(String jsonString) throws JacksonException {
