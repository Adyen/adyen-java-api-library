...
public class UpdateMerchantUserRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountGroups, isSetAccountGroups, active, isSetActive, email, isSetEmail, loginMethod, isSetLoginMethod, name, isSetName, roles, isSetRoles, timeZoneCode, isSetTimeZoneCode);
  }
