...
public class TestWebhookResponse {
  ...
  **/
  ...
  public String toString() {
      String sb = "class TestWebhookResponse {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (TestWebhookResponse.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestWebhookResponse is not found in the empty JSON string", TestWebhookResponse.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TestWebhookResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestWebhookResponse` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
