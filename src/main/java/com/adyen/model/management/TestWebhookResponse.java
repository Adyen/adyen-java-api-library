...
public class TestWebhookResponse {
   ...
   */
  public TestWebhookResponse includeNullValues(boolean includeNullValues) {
   ...
   */
  public static TestWebhookResponse fromJson(String jsonString) throws JacksonException {
