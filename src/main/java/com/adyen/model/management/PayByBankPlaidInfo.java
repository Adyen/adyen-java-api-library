...
public class PayByBankPlaidInfo {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PayByBankPlaidInfo
   */
  public static PayByBankPlaidInfo fromJson(String jsonString) throws JacksonException {
