...
public class VisaResponseInfo {
   ...
   * @return the current {@code VisaResponseInfo} instance, allowing for method chaining
   */
  public VisaResponseInfo transactionDescription(
   ...
   */
  public VisaResponseInfo includeNullValues(boolean includeNullValues) {
  ...
  /** Return true if this VisaResponseInfo object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    VisaResponseInfo visaResponseInfo = (VisaResponseInfo) o;
    return Objects.equals(this.transactionDescription, visaResponseInfo.transactionDescription)
        && Objects.equals(
            this.isSetTransactionDescription, visaResponseInfo.isSetTransactionDescription);
  }
  ...
  /**
   * Create an instance of VisaResponseInfo given an JSON string
   *
  ...
  /**
   * Convert an instance of VisaResponseInfo to an JSON string
   *
   * @return JSON string
   */
