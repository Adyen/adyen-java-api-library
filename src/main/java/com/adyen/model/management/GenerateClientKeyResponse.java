...
public class GenerateClientKeyResponse {
  ...
  **/
  ...
  public String toString() {
      String sb = "class GenerateClientKeyResponse {\n" +
  ...
  * @throws IOException if the JSON Object is invalid with respect to GenerateClientKeyResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (GenerateClientKeyResponse.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateClientKeyResponse is not found in the empty JSON string", GenerateClientKeyResponse.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GenerateClientKeyResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateClientKeyResponse` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
