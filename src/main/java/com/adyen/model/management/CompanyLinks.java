...
public class CompanyLinks {
   ...
   * @return the current {@code CompanyLinks} instance, allowing for method chaining
   */
  ...
  public CompanyLinks includeNullValues(boolean includeNullValues) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(apiCredentials, isSetApiCredentials, self, isSetSelf, users, isSetUsers, webhooks, isSetWebhooks);
  }
