...
public class PayMeResponseInfo {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PayMeResponseInfo
   */
  public static PayMeResponseInfo fromJson(String jsonString) throws JacksonException {
