...
public class Store {
  ...
  /**
   * The status of the store. Possible values are: - **active**. This value is assigned
   * automatically when a store is created. - **inactive**. The terminals under the store are
   * blocked from accepting new transactions, but capturing outstanding transactions is still
   * possible. - **closed**. This status is irreversible. The terminals under the store are
  ...
  /**
   * A reference to recognize the store by. Also known as the store code. Allowed characters:
   * lowercase and uppercase letters without diacritics, numbers 0 through 9, hyphen (-), and
   * underscore (_)
   *
   * @param reference A reference to recognize the store by. Also known as the store code. Allowed
   *     characters: lowercase and uppercase letters without diacritics, numbers 0 through 9, hyphen
   *     (-), and underscore (_)
   * @return the current {@code Store} instance, allowing for method chaining
   */
   ...
   * underscore (_)
   *
   * @return reference A reference to recognize the store by. Also known as the store code. Allowed
   *     characters: lowercase and uppercase letters without diacritics, numbers 0 through 9, hyphen
   *     (-), and underscore (_)
   */
  ...
  /**
   * The store name shown on the shopper&#39;s bank or credit card statement and on the shopper
   * receipt.
   *
   * @param shopperStatement The store name shown on the shopper&#39;s bank or credit card statement
   ...
   * receipt.
   *
   * @return shopperStatement The store name shown on the shopper&#39;s bank or credit card
   *     statement and on the shopper receipt.
   */
   ...
   * reassigned to the merchant inventory.
   *
   * @param status The status of the store. Possible values are: - **active**. This value is
   *     assigned automatically when a store is created. - **inactive**. The terminals under the
   *     store are blocked from accepting new transactions, but capturing outstanding transactions
   *     is still possible. - **closed**. This status is irreversible. The terminals under the store
   ...
   * reassigned to the merchant inventory.
   *
   * @return status The status of the store. Possible values are: - **active**. This value is
   *     assigned automatically when a store is created. - **inactive**. The terminals under the
   *     store are blocked from accepting new transactions, but capturing outstanding transactions
   *     is still possible. - **closed**. This status is irreversible. The terminals under the store
   *     are reassigned to the merchant inventory.
