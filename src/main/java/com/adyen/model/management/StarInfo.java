...
public class StarInfo {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to StarInfo
   */
  public static StarInfo fromJson(String jsonString) throws JacksonException {
