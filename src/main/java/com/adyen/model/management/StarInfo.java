...
/** StarInfo */
@JsonPropertyOrder({
  StarInfo.JSON_PROPERTY_PROCESSING_TYPE,
  StarInfo.JSON_PROPERTY_TRANSACTION_DESCRIPTION
})
public class StarInfo {
   ...
   * @return the current {@code StarInfo} instance, allowing for method chaining
   */
  public StarInfo processingType(ProcessingTypeEnum processingType) {
   ...
   */
  public StarInfo includeNullValues(boolean includeNullValues) {
  ...
  /**
   * Create an instance of StarInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StarInfo
   * @throws JsonProcessingException if the JSON string is invalid with respect to StarInfo
   */
  public static StarInfo fromJson(String jsonString) throws JsonProcessingException {
    return JSON.getMapper().readValue(jsonString, StarInfo.class);
  }

  /**
   * Convert an instance of StarInfo to an JSON string
   *
   * @return JSON string
   */
