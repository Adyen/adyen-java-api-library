...
public class CreateMerchantRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(businessLineId, isSetBusinessLineId, companyId, isSetCompanyId, description, isSetDescription, legalEntityId, isSetLegalEntityId, pricingPlan, isSetPricingPlan, reference, isSetReference, salesChannels, isSetSalesChannels);
  }
