...
public class RequestActivationResponse {
  ...
  **/
  ...
  public String toString() {
      String sb = "class RequestActivationResponse {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (RequestActivationResponse.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in RequestActivationResponse is not found in the empty JSON string", RequestActivationResponse.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!RequestActivationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RequestActivationResponse` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
