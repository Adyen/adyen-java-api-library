...
public class ListCompanyResponse {
  ...
  **/
  ...
  public String toString() {
      String sb = "class ListCompanyResponse {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ListCompanyResponse.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListCompanyResponse is not found in the empty JSON string", ListCompanyResponse.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ListCompanyResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListCompanyResponse` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
