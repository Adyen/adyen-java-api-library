...
public class ListCompanyResponse {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to ListCompanyResponse
   */
  public static ListCompanyResponse fromJson(String jsonString) throws JacksonException {
