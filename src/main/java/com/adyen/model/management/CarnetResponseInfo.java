...
public class CarnetResponseInfo {
   ...
   * @return the current {@code CarnetResponseInfo} instance, allowing for method chaining
   */
  public CarnetResponseInfo transactionDescription(
   ...
   */
  public CarnetResponseInfo includeNullValues(boolean includeNullValues) {
  ...
  /** Return true if this CarnetResponseInfo object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    CarnetResponseInfo carnetResponseInfo = (CarnetResponseInfo) o;
    return Objects.equals(this.transactionDescription, carnetResponseInfo.transactionDescription)
        && Objects.equals(
            this.isSetTransactionDescription, carnetResponseInfo.isSetTransactionDescription);
  }
  ...
  /**
   * Create an instance of CarnetResponseInfo given an JSON string
   *
  ...
  /**
   * Convert an instance of CarnetResponseInfo to an JSON string
   *
   * @return JSON string
   */
