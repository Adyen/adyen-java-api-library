...
public class AmexResponseInfo {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to AmexResponseInfo
   */
  public static AmexResponseInfo fromJson(String jsonString) throws JacksonException {
