...
public class AssociatedPaymentMethod {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to AssociatedPaymentMethod
   */
  public static AssociatedPaymentMethod fromJson(String jsonString) throws JacksonException {
