...
public class UpdateCompanyUserRequest {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to UpdateCompanyUserRequest
   */
  public static UpdateCompanyUserRequest fromJson(String jsonString) throws JacksonException {
