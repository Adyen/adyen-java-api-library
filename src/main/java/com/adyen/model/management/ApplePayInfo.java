...
public class ApplePayInfo {
  ...
  /**
   * The list of merchant domains. Maximum: 99 domains per request. For more information, see [Apple
   * Pay
   * documentation](https://docs.adyen.com/payment-methods/apple-pay/web-drop-in?tab&#x3D;adyen-certificate-live_1#going-live).
   *
   * @param domains The list of merchant domains. Maximum: 99 domains per request. For more
   ...
   * documentation](https://docs.adyen.com/payment-methods/apple-pay/web-drop-in?tab&#x3D;adyen-certificate-live_1#going-live).
   *
   * @return domains The list of merchant domains. Maximum: 99 domains per request. For more
   *     information, see [Apple Pay
   *     documentation](https://docs.adyen.com/payment-methods/apple-pay/web-drop-in?tab&#x3D;adyen-certificate-live_1#going-live).
   */
   ...
   */
  public static ApplePayInfo fromJson(String jsonString) throws JacksonException {
