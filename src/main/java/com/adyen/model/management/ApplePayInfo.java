...
public class ApplePayInfo {
  ...
  **/
  ...
  public String toString() {
      String sb = "class ApplePayInfo {\n" +
              "    domains: " + toIndentedString(domains) + "\n" +
              "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ApplePayInfo.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApplePayInfo is not found in the empty JSON string", ApplePayInfo.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ApplePayInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApplePayInfo` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
