...
@JsonPropertyOrder({GenerateApiKeyResponse.JSON_PROPERTY_API_KEY})
public class GenerateApiKeyResponse {
   ...
   */
  public GenerateApiKeyResponse includeNullValues(boolean includeNullValues) {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to GenerateApiKeyResponse
   */
  public static GenerateApiKeyResponse fromJson(String jsonString) throws JacksonException {
