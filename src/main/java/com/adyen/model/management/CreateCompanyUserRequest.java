...
public class CreateCompanyUserRequest {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to CreateCompanyUserRequest
   */
  public static CreateCompanyUserRequest fromJson(String jsonString) throws JacksonException {
