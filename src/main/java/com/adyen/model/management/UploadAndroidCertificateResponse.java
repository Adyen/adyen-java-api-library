...
@JsonPropertyOrder({UploadAndroidCertificateResponse.JSON_PROPERTY_ID})
public class UploadAndroidCertificateResponse {
   ...
   * @return the current {@code UploadAndroidCertificateResponse} instance, allowing for method
   *     chaining
   */
   ...
   */
  public UploadAndroidCertificateResponse includeNullValues(boolean includeNullValues) {
   ...
   *     UploadAndroidCertificateResponse
   */
  public static UploadAndroidCertificateResponse fromJson(String jsonString)
