...
public class BillingEntity {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to BillingEntity
   */
  public static BillingEntity fromJson(String jsonString) throws JacksonException {
