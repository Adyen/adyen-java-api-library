...
public class UninstallAndroidAppDetails {
  ...
  **/
  ...
  @Override
  public String toString() {
      String sb = "class UninstallAndroidAppDetails {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (UninstallAndroidAppDetails.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in UninstallAndroidAppDetails is not found in the empty JSON string", UninstallAndroidAppDetails.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UninstallAndroidAppDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UninstallAndroidAppDetails` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
