...
public class JCBResponseInfo {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to JCBResponseInfo
   */
  public static JCBResponseInfo fromJson(String jsonString) throws JacksonException {
