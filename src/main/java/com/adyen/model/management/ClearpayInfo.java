...
public class ClearpayInfo {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to ClearpayInfo
   */
  public static ClearpayInfo fromJson(String jsonString) throws JacksonException {
