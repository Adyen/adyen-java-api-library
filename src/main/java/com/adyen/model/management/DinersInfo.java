...
public class DinersInfo {
   ...
   * operating in Japan. Possible values: * **noContract**: Adyen holds the contract with JCB. *
  ...
  /**
   * MID (Merchant ID) number. Required for merchants operating in Japan. Format: 14 numeric
   * characters.
   *
   * @param midNumber MID (Merchant ID) number. Required for merchants operating in Japan. Format:
   ...
   * characters.
   *
   * @return midNumber MID (Merchant ID) number. Required for merchants operating in Japan. Format:
   *     14 numeric characters.
   */
   ...
   * method. The default value is **false**. For merchants operating in Japan, this field is
   * required and must be set to **true**.
   *
   * @param reuseMidNumber Indicates whether the JCB Merchant ID is reused from a previously
   *     configured JCB payment method. The default value is **false**. For merchants operating in
   *     Japan, this field is required and must be set to **true**.
   * @return the current {@code DinersInfo} instance, allowing for method chaining
   */
   ...
   *     the contract with JCB. * **gatewayContract**: JCB receives the settlement and handles
   ...
   * @throws JacksonException if the JSON string is invalid with respect to DinersInfo
   */
  public static DinersInfo fromJson(String jsonString) throws JacksonException {
