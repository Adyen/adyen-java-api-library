...
public class SepaDirectDebitInfo {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to SepaDirectDebitInfo
   */
  public static SepaDirectDebitInfo fromJson(String jsonString) throws JacksonException {
