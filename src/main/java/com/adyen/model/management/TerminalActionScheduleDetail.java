...
public class TerminalActionScheduleDetail {
   ...
   */
  public TerminalActionScheduleDetail includeNullValues(boolean includeNullValues) {
   ...
   *     TerminalActionScheduleDetail
   */
  public static TerminalActionScheduleDetail fromJson(String jsonString) throws JacksonException {
