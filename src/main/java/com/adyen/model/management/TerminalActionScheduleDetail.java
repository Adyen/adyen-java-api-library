...
public class TerminalActionScheduleDetail {
  ...
  **/
  ...
  public String toString() {
      String sb = "class TerminalActionScheduleDetail {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (TerminalActionScheduleDetail.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in TerminalActionScheduleDetail is not found in the empty JSON string", TerminalActionScheduleDetail.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TerminalActionScheduleDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TerminalActionScheduleDetail` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
