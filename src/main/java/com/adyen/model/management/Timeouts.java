...
public class Timeouts {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to Timeouts
   */
  public static Timeouts fromJson(String jsonString) throws JacksonException {
