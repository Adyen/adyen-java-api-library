...
public class Timeouts {
   ...
   *
   * @param fromActiveToSleep Indicates the number of seconds of inactivity after which the terminal display goes into sleep mode.
  ...
  /**
   * Indicates the number of seconds of inactivity after which the terminal display goes into sleep mode.
   * @return fromActiveToSleep Indicates the number of seconds of inactivity after which the terminal display goes into sleep mode.
   */
