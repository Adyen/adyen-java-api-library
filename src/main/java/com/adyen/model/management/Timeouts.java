...
public class Timeouts {
  ...
  **/
  ...
  public String toString() {
      String sb = "class Timeouts {\n" +
              "    fromActiveToSleep: " + toIndentedString(fromActiveToSleep) + "\n" +
              "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (Timeouts.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in Timeouts is not found in the empty JSON string", Timeouts.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Timeouts.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Timeouts` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
  }
