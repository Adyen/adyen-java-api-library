...
public class ValuelinkInfo {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to ValuelinkInfo
   */
  public static ValuelinkInfo fromJson(String jsonString) throws JacksonException {
