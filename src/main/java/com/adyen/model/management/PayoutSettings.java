...
public class PayoutSettings {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PayoutSettings
   */
  public static PayoutSettings fromJson(String jsonString) throws JacksonException {
