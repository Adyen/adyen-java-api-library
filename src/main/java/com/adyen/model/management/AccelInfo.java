...
public class AccelInfo {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to AccelInfo
   */
  public static AccelInfo fromJson(String jsonString) throws JacksonException {
