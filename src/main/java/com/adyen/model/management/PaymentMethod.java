...
public class PaymentMethod {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accel, affirm, afterpayTouch, alipayPlus, allowed, amex, applePay, bcmc, businessLineId, cartesBancaires, clearpay, countries, cup, currencies, customRoutingFlags, diners, discover, eftDirectdebitCA, eftposAustralia, enabled, girocard, givex, googlePay, id, ideal, interacCard, jcb, klarna, maestro, maestroUsa, mc, mealVoucherFR, nyce, paybybankPlaid, payme, paypal, payto, pulse, reference, sepadirectdebit, shopperInteraction, sodexo, sofort, star, storeIds, svs, swish, ticket, twint, type, valuelink, verificationStatus, vipps, visa, wechatpay, wechatpayPos);
  }
