...
@JsonPropertyOrder({PayoutSettingsResponse.JSON_PROPERTY_DATA})
public class PayoutSettingsResponse {
   ...
   */
  public PayoutSettingsResponse includeNullValues(boolean includeNullValues) {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PayoutSettingsResponse
   */
  public static PayoutSettingsResponse fromJson(String jsonString) throws JacksonException {
