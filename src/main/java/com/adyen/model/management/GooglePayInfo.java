...
public class GooglePayInfo {
  ...
  **/
  ...
  public String toString() {
      String sb = "class GooglePayInfo {\n" +
              "    merchantId: " + toIndentedString(merchantId) + "\n" +
              "    reuseMerchantId: " + toIndentedString(reuseMerchantId) + "\n" +
              "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (GooglePayInfo.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in GooglePayInfo is not found in the empty JSON string", GooglePayInfo.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GooglePayInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GooglePayInfo` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
