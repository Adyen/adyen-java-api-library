...
public class ListStoresResponse {
  ...
  **/
  ...
  public String toString() {
      String sb = "class ListStoresResponse {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ListStoresResponse.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListStoresResponse is not found in the empty JSON string", ListStoresResponse.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ListStoresResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListStoresResponse` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
