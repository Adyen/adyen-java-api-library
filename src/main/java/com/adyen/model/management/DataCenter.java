...
public class DataCenter {
  ...
  **/
  ...
  public String toString() {
      String sb = "class DataCenter {\n" +
              "    livePrefix: " + toIndentedString(livePrefix) + "\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (DataCenter.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataCenter is not found in the empty JSON string", DataCenter.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DataCenter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataCenter` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
