...
public class CreateMerchantUserRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountGroups, isSetAccountGroups, email, isSetEmail, loginMethod, isSetLoginMethod, name, isSetName, roles, isSetRoles, timeZoneCode, isSetTimeZoneCode, username, isSetUsername);
  }
