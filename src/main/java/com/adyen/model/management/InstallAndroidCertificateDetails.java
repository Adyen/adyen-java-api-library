...
public class InstallAndroidCertificateDetails {
  ...
  **/
  ...
  @Override
  public String toString() {
      String sb = "class InstallAndroidCertificateDetails {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (InstallAndroidCertificateDetails.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in InstallAndroidCertificateDetails is not found in the empty JSON string", InstallAndroidCertificateDetails.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!InstallAndroidCertificateDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InstallAndroidCertificateDetails` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
