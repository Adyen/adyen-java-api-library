...
public class Unreferenced {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to Unreferenced
   */
  public static Unreferenced fromJson(String jsonString) throws JacksonException {
