...
public class MaestroResponseInfo {
   ...
   * @return the current {@code MaestroResponseInfo} instance, allowing for method chaining
   */
  public MaestroResponseInfo transactionDescription(
   ...
   */
  public MaestroResponseInfo includeNullValues(boolean includeNullValues) {
  ...
  /** Return true if this MaestroResponseInfo object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    MaestroResponseInfo maestroResponseInfo = (MaestroResponseInfo) o;
    return Objects.equals(this.transactionDescription, maestroResponseInfo.transactionDescription)
        && Objects.equals(
            this.isSetTransactionDescription, maestroResponseInfo.isSetTransactionDescription);
  }
  ...
  /**
   * Create an instance of MaestroResponseInfo given an JSON string
   *
  ...
  /**
   * Convert an instance of MaestroResponseInfo to an JSON string
   *
   * @return JSON string
   */
