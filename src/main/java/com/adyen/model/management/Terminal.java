...
public class Terminal {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(assignment, isSetAssignment, connectivity, isSetConnectivity, firmwareVersion, isSetFirmwareVersion, id, isSetId, lastActivityAt, isSetLastActivityAt, lastTransactionAt, isSetLastTransactionAt, model, isSetModel, restartLocalTime, isSetRestartLocalTime, serialNumber, isSetSerialNumber);
  }
