...
public class Opi {
  ...
  **/
  ...
  public String toString() {
      String sb = "class Opi {\n" +
              "    enablePayAtTable: " + toIndentedString(enablePayAtTable) + "\n" +
              "    payAtTableStoreNumber: " + toIndentedString(payAtTableStoreNumber) + "\n" +
              "    payAtTableURL: " + toIndentedString(payAtTableURL) + "\n" +
              "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (Opi.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in Opi is not found in the empty JSON string", Opi.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Opi.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Opi` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
