...
public class PaginationLinks {
  ...
  **/
  ...
  public String toString() {
      String sb = "class PaginationLinks {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (PaginationLinks.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaginationLinks is not found in the empty JSON string", PaginationLinks.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PaginationLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaginationLinks` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
