...
public class ScheduleTerminalActionsResponse {
   ...
   *
   * @param actionDetails
   * @return the current {@code ScheduleTerminalActionsResponse} instance, allowing for method
   *     chaining
   */
  ...
  /**
   * A list containing a terminal ID and an action ID for each terminal that the action was
   * scheduled for.
   *
   * @param items A list containing a terminal ID and an action ID for each terminal that the action
   *     was scheduled for.
   * @return the current {@code ScheduleTerminalActionsResponse} instance, allowing for method
   *     chaining
   */
   ...
   * scheduled for.
   *
   * @return items A list containing a terminal ID and an action ID for each terminal that the
  ...
  /**
   * The date and time when the action should happen. Format: [RFC
   * 3339](https://www.rfc-editor.org/rfc/rfc3339), but without the **Z** before the time offset.
   * For example, **2021-11-15T12:16:21+0100** The action is sent with the first [maintenance
   * call](https://docs.adyen.com/point-of-sale/automating-terminal-management/terminal-actions-api#when-actions-take-effect)
   * after the specified date and time in the time zone of the terminal. An empty value causes the
   * action to be sent as soon as possible: at the next maintenance call.
   *
   * @param scheduledAt The date and time when the action should happen. Format: [RFC
   *     3339](https://www.rfc-editor.org/rfc/rfc3339), but without the **Z** before the time
   *     offset. For example, **2021-11-15T12:16:21+0100** The action is sent with the first
   *     [maintenance
   *     call](https://docs.adyen.com/point-of-sale/automating-terminal-management/terminal-actions-api#when-actions-take-effect)
   *     after the specified date and time in the time zone of the terminal. An empty value causes
   *     the action to be sent as soon as possible: at the next maintenance call.
   * @return the current {@code ScheduleTerminalActionsResponse} instance, allowing for method
   *     chaining
   */
   ...
   * action to be sent as soon as possible: at the next maintenance call.
   *
   * @return scheduledAt The date and time when the action should happen. Format: [RFC
   *     3339](https://www.rfc-editor.org/rfc/rfc3339), but without the **Z** before the time
   *     offset. For example, **2021-11-15T12:16:21+0100** The action is sent with the first
   *     [maintenance
   *     call](https://docs.adyen.com/point-of-sale/automating-terminal-management/terminal-actions-api#when-actions-take-effect)
   ...
   * [store](https://docs.adyen.com/api-explorer/#/ManagementService/latest/get/stores). If present,
   * all terminals in the &#x60;terminalIds&#x60; list must be assigned to this store.
   *
   * @param storeId The unique ID of the
   *     [store](https://docs.adyen.com/api-explorer/#/ManagementService/latest/get/stores). If
   *     present, all terminals in the &#x60;terminalIds&#x60; list must be assigned to this store.
   * @return the current {@code ScheduleTerminalActionsResponse} instance, allowing for method
   *     chaining
   */
   ...
   * all terminals in the &#x60;terminalIds&#x60; list must be assigned to this store.
   *
   * @return storeId The unique ID of the
   *     [store](https://docs.adyen.com/api-explorer/#/ManagementService/latest/get/stores). If
   *     present, all terminals in the &#x60;terminalIds&#x60; list must be assigned to this store.
   */
   ...
   *
   * @param terminalsWithErrors The validation errors that occurred in the list of terminals, and
   *     for each error the IDs of the terminals that the error applies to.
   * @return the current {@code ScheduleTerminalActionsResponse} instance, allowing for method
   *     chaining
   */
  ...
  public ScheduleTerminalActionsResponse putTerminalsWithErrorsItem(
      String key, List<String> terminalsWithErrorsItem) {
   ...
   * terminals that the error applies to.
   *
   * @return terminalsWithErrors The validation errors that occurred in the list of terminals, and
   *     for each error the IDs of the terminals that the error applies to.
   */
  ...
  /**
   * The number of terminals for which the action was successfully scheduled. This doesn&#39;t mean
   * the action has happened yet.
   *
   * @param totalScheduled The number of terminals for which the action was successfully scheduled.
   ...
   * the action has happened yet.
   *
   * @return totalScheduled The number of terminals for which the action was successfully scheduled.
   *     This doesn&#39;t mean the action has happened yet.
   */
  ...
  public String toString() {
    ...
    sb.append("    terminalsWithErrors: ")
        .append(toIndentedString(terminalsWithErrors))
        .append("\n");
