...
public class SupportedCardTypes {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to SupportedCardTypes
   */
  public static SupportedCardTypes fromJson(String jsonString) throws JacksonException {
