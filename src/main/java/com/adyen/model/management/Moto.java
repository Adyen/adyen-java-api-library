...
public class Moto {
   ...
   *
   * @param maxAmount The maximum amount for MOTO transactions. You need to set the currency for this amount using the [&#x60;standalone.currencyCode&#x60;](https://docs.adyen.com/api-explorer/Management/1/patch/companies/(companyId)/terminalSettings#request-standalone-currencyCode) parameter. Do not enable standalone, unless you are using a standalone solution.
   * @return the current {@code Moto} instance, allowing for method chaining
   */
  ...
  /**
   * The maximum amount for MOTO transactions. You need to set the currency for this amount using the [&#x60;standalone.currencyCode&#x60;](https://docs.adyen.com/api-explorer/Management/1/patch/companies/(companyId)/terminalSettings#request-standalone-currencyCode) parameter. Do not enable standalone, unless you are using a standalone solution.
   * @return maxAmount The maximum amount for MOTO transactions. You need to set the currency for this amount using the [&#x60;standalone.currencyCode&#x60;](https://docs.adyen.com/api-explorer/Management/1/patch/companies/(companyId)/terminalSettings#request-standalone-currencyCode) parameter. Do not enable standalone, unless you are using a standalone solution.
   */
