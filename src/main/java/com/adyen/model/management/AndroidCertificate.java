...
public class AndroidCertificate {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, isSetDescription, extension, isSetExtension, id, isSetId, name, isSetName, notAfter, isSetNotAfter, notBefore, isSetNotBefore, status, isSetStatus);
  }
