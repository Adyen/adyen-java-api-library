...
public class CartesBancairesInfo {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to CartesBancairesInfo
   */
  public static CartesBancairesInfo fromJson(String jsonString) throws JacksonException {
