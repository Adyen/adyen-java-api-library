...
public class Notification {
  ...
  /**
   * The text shown in the prompt which opens when you select the notification button. For example,
   * the description of the input box for pay-at-table.
   *
   * @param details The text shown in the prompt which opens when you select the notification
   ...
   * the description of the input box for pay-at-table.
   *
   * @return details The text shown in the prompt which opens when you select the notification
   *     button. For example, the description of the input box for pay-at-table.
   */
  ...
  /**
   * Enables sending event notifications either by pressing the Confirm key on terminals with a
   * keypad or by tapping the event notification button on the terminal screen.
   *
   * @param enabled Enables sending event notifications either by pressing the Confirm key on
   *     terminals with a keypad or by tapping the event notification button on the terminal screen.
   * @return the current {@code Notification} instance, allowing for method chaining
   */
   ...
   * keypad or by tapping the event notification button on the terminal screen.
   *
   * @return enabled Enables sending event notifications either by pressing the Confirm key on
   *     terminals with a keypad or by tapping the event notification button on the terminal screen.
   */
  ...
  /**
   * Shows or hides the event notification button on the screen of terminal models that have a
   * keypad.
   *
   * @param showButton Shows or hides the event notification button on the screen of terminal models
   *     that have a keypad.
   * @return the current {@code Notification} instance, allowing for method chaining
   */
   ...
   * keypad.
   *
   * @return showButton Shows or hides the event notification button on the screen of terminal
   ...
   */
  public static Notification fromJson(String jsonString) throws JacksonException {
