...
public class PaymentMethodResponse {
  ...
  public enum TypesWithErrorsEnum {
    ...
    public static TypesWithErrorsEnum fromValue(String value) {
      ...
      LOG.warning("TypesWithErrorsEnum: unexpected enum value '" + value + "' - Supported values are "+ Arrays.toString(TypesWithErrorsEnum.values()));
      return null;
    }
  }
   ...
   *
   * @param typesWithErrors The payment method types that were not successfully requested and their corresponding errors.
   * @return the current {@code PaymentMethodResponse} instance, allowing for method chaining
   */
  ...
  /**
   * The payment method types that were not successfully requested and their corresponding errors.
   * @return typesWithErrors The payment method types that were not successfully requested and their corresponding errors.
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, isSetLinks, data, isSetData, itemsTotal, isSetItemsTotal, pagesTotal, isSetPagesTotal, typesWithErrors, isSetTypesWithErrors);
  }
