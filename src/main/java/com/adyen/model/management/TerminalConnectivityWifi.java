...
public class TerminalConnectivityWifi {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to TerminalConnectivityWifi
   */
  public static TerminalConnectivityWifi fromJson(String jsonString) throws JacksonException {
