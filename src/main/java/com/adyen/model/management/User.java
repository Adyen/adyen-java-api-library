...
public class User {
   ...
   *
   * @param links
   * @return the current {@code User} instance, allowing for method chaining
   */
   ...
   * @throws JacksonException if the JSON string is invalid with respect to User
   */
  public static User fromJson(String jsonString) throws JacksonException {
