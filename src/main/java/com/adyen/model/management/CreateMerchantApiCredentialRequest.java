...
public class CreateMerchantApiCredentialRequest {
  ...
  **/
  ...
  public String toString() {
      String sb = "class CreateMerchantApiCredentialRequest {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CreateMerchantApiCredentialRequest.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateMerchantApiCredentialRequest is not found in the empty JSON string", CreateMerchantApiCredentialRequest.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateMerchantApiCredentialRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateMerchantApiCredentialRequest` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
