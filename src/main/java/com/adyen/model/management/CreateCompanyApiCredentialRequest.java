...
public class CreateCompanyApiCredentialRequest {
   ...
   *
   * @param allowedOrigins List of [allowed origins](https://docs.adyen.com/development-resources/client-side-authentication#allowed-origins) for the new API credential.
  ...
  /**
   * List of [allowed origins](https://docs.adyen.com/development-resources/client-side-authentication#allowed-origins) for the new API credential.
   * @return allowedOrigins List of [allowed origins](https://docs.adyen.com/development-resources/client-side-authentication#allowed-origins) for the new API credential.
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowedOrigins, createCompanyApiCredentialRequest.allowedOrigins) &&
        Objects.equals(this.isSetAllowedOrigins, createCompanyApiCredentialRequest.isSetAllowedOrigins) &&
        Objects.equals(this.associatedMerchantAccounts, createCompanyApiCredentialRequest.associatedMerchantAccounts) &&
        Objects.equals(this.isSetAssociatedMerchantAccounts, createCompanyApiCredentialRequest.isSetAssociatedMerchantAccounts) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowedOrigins, isSetAllowedOrigins, associatedMerchantAccounts, isSetAssociatedMerchantAccounts, description, isSetDescription, roles, isSetRoles);
  }
