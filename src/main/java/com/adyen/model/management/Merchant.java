...
public class Merchant {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to Merchant
   */
  public static Merchant fromJson(String jsonString) throws JacksonException {
