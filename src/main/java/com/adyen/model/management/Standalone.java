...
public class Standalone {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to Standalone
   */
  public static Standalone fromJson(String jsonString) throws JacksonException {
