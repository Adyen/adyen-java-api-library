...
public class Standalone {
  ...
  **/
  ...
  public String toString() {
      String sb = "class Standalone {\n" +
              "    currencyCode: " + toIndentedString(currencyCode) + "\n" +
              "    enableStandalone: " + toIndentedString(enableStandalone) + "\n" +
              "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (Standalone.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in Standalone is not found in the empty JSON string", Standalone.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Standalone.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Standalone` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
