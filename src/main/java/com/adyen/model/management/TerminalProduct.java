...
public class TerminalProduct {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to TerminalProduct
   */
  public static TerminalProduct fromJson(String jsonString) throws JacksonException {
