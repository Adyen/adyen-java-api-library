...
public class ScheduleTerminalActionsRequest {
   ...
   *
   * @param actionDetails
   * @return the current {@code ScheduleTerminalActionsRequest} instance, allowing for method
   *     chaining
   */
  public ScheduleTerminalActionsRequest actionDetails(
  ...
  /**
   * A list of unique IDs of the terminals to apply the action to. You can extract the IDs from the
   * [GET
   * &#x60;/terminals&#x60;](https://docs.adyen.com/api-explorer/#/ManagementService/latest/get/terminals)
   * response. Maximum length: 100 IDs.
   *
   * @param terminalIds A list of unique IDs of the terminals to apply the action to. You can
   ...
   * response. Maximum length: 100 IDs.
   *
   * @return terminalIds A list of unique IDs of the terminals to apply the action to. You can
   *     extract the IDs from the [GET
   *     &#x60;/terminals&#x60;](https://docs.adyen.com/api-explorer/#/ManagementService/latest/get/terminals)
   *     response. Maximum length: 100 IDs.
   */
   ...
   *     ScheduleTerminalActionsRequest
   */
  public static ScheduleTerminalActionsRequest fromJson(String jsonString) throws JacksonException {
