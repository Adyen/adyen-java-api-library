...
public class StoreCreationRequest {
  ...
  **/
  ...
  public String toString() {
      String sb = "class StoreCreationRequest {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (StoreCreationRequest.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in StoreCreationRequest is not found in the empty JSON string", StoreCreationRequest.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!StoreCreationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StoreCreationRequest` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
