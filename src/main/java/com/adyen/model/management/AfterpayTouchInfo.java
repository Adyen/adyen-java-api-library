...
public class AfterpayTouchInfo {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to AfterpayTouchInfo
   */
  public static AfterpayTouchInfo fromJson(String jsonString) throws JacksonException {
