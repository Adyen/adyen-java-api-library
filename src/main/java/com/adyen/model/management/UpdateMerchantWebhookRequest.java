...
public class UpdateMerchantWebhookRequest {
  ...
  **/
  ...
  @Override
  public String toString() {
    String sb = "class UpdateMerchantWebhookRequest {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (UpdateMerchantWebhookRequest.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateMerchantWebhookRequest is not found in the empty JSON string", UpdateMerchantWebhookRequest.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpdateMerchantWebhookRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateMerchantWebhookRequest` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
