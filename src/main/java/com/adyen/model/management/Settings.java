...
public class Settings {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to Settings
   */
  public static Settings fromJson(String jsonString) throws JacksonException {
