...
public class ListTerminalsResponse {
  ...
  public ListTerminalsResponse includeNullValues(boolean includeNullValues) {
...
/**
   ...
   * @throws JsonProcessingException if the JSON string is invalid with respect to ListTerminalsResponse
   */
