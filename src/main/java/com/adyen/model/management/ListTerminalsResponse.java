...
public class ListTerminalsResponse {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to ListTerminalsResponse
   */
  public static ListTerminalsResponse fromJson(String jsonString) throws JacksonException {
