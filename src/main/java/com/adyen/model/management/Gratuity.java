...
public class Gratuity {
  ...
  **/
  ...
  public String toString() {
      String sb = "class Gratuity {\n" +
              "    allowCustomAmount: " + toIndentedString(allowCustomAmount) + "\n" +
              "    currency: " + toIndentedString(currency) + "\n" +
              "    predefinedTipEntries: " + toIndentedString(predefinedTipEntries) + "\n" +
              "    usePredefinedTipEntries: " + toIndentedString(usePredefinedTipEntries) + "\n" +
              "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (Gratuity.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in Gratuity is not found in the empty JSON string", Gratuity.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Gratuity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Gratuity` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
