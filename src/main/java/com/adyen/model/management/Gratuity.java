...
public class Gratuity {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to Gratuity
   */
  public static Gratuity fromJson(String jsonString) throws JacksonException {
