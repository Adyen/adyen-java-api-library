...
public class OfflineProcessing {
  ...
  **/
  ...
  public String toString() {
      String sb = "class OfflineProcessing {\n" +
              "    chipFloorLimit: " + toIndentedString(chipFloorLimit) + "\n" +
              "    offlineSwipeLimits: " + toIndentedString(offlineSwipeLimits) + "\n" +
              "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (OfflineProcessing.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in OfflineProcessing is not found in the empty JSON string", OfflineProcessing.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!OfflineProcessing.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OfflineProcessing` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
