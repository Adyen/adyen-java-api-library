...
import com.adyen.model.management.ForceRebootDetails;
...
public class ScheduleTerminalActionsRequestActionDetails extends AbstractOpenApiSchema {
        ...
        public ScheduleTerminalActionsRequestActionDetails deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(ForceRebootDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(InstallAndroidAppDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(InstallAndroidCertificateDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(ReleaseUpdateDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(UninstallAndroidAppDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    boolean typeMatch = false;
                    if(tree.findValue("type") != null) {
                        typeMatch = Arrays.stream(UninstallAndroidCertificateDetails.TypeEnum.values()).anyMatch((t) -> t.getValue().equals(tree.findValue("type").asText()));
                    }
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be ForceRebootDetails, InstallAndroidAppDetails, InstallAndroidCertificateDetails, ReleaseUpdateDetails, UninstallAndroidAppDetails, UninstallAndroidCertificateDetails");
    }
     ...
     * ForceRebootDetails, InstallAndroidAppDetails, InstallAndroidCertificateDetails, ReleaseUpdateDetails, UninstallAndroidAppDetails, UninstallAndroidCertificateDetails
     *
     * @return The actual instance (ForceRebootDetails, InstallAndroidAppDetails, InstallAndroidCertificateDetails, ReleaseUpdateDetails, UninstallAndroidAppDetails, UninstallAndroidCertificateDetails)
     */
    @Override
