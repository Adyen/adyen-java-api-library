...
/** PayToInfo */
@JsonPropertyOrder({PayToInfo.JSON_PROPERTY_MERCHANT_NAME, PayToInfo.JSON_PROPERTY_PAY_TO_PURPOSE})
public class PayToInfo {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PayToInfo
   */
  public static PayToInfo fromJson(String jsonString) throws JacksonException {
