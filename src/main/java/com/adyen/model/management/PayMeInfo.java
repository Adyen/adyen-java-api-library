...
public class PayMeInfo {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PayMeInfo
   */
  public static PayMeInfo fromJson(String jsonString) throws JacksonException {
