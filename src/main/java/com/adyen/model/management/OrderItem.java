...
public class OrderItem {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to OrderItem
   */
  public static OrderItem fromJson(String jsonString) throws JacksonException {
