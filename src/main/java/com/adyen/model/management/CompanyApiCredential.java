...
public class CompanyApiCredential {
  ...
  /**
   * List of merchant accounts that the API credential has explicit access to.   If the credential has access to a company, this implies access to all merchant accounts and no merchants for that company will be included.
   * @return associatedMerchantAccounts List of merchant accounts that the API credential has explicit access to.   If the credential has access to a company, this implies access to all merchant accounts and no merchants for that company will be included.
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, companyApiCredential.links) &&
        ...
        Objects.equals(this.isSetAllowedIpAddresses, companyApiCredential.isSetAllowedIpAddresses) &&
        ...
        Objects.equals(this.isSetAssociatedMerchantAccounts, companyApiCredential.isSetAssociatedMerchantAccounts) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, isSetLinks, active, isSetActive, allowedIpAddresses, isSetAllowedIpAddresses, allowedOrigins, isSetAllowedOrigins, associatedMerchantAccounts, isSetAssociatedMerchantAccounts, clientKey, isSetClientKey, description, isSetDescription, id, isSetId, roles, isSetRoles, username, isSetUsername);
  }
