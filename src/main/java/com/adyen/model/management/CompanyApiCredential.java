...
public class CompanyApiCredential {
  ...
  **/
  ...
  public String toString() {
    String sb = "class CompanyApiCredential {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CompanyApiCredential.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompanyApiCredential is not found in the empty JSON string", CompanyApiCredential.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CompanyApiCredential.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CompanyApiCredential` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
