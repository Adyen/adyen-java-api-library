...
public class UninstallAndroidCertificateDetails {
  ...
  **/
  ...
  @Override
  public String toString() {
      String sb = "class UninstallAndroidCertificateDetails {\n" +
              "    certificateId: " + toIndentedString(certificateId) + "\n" +
  ...
  * @throws IOException if the JSON Object is invalid with respect to UninstallAndroidCertificateDetails
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (UninstallAndroidCertificateDetails.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in UninstallAndroidCertificateDetails is not found in the empty JSON string", UninstallAndroidCertificateDetails.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UninstallAndroidCertificateDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UninstallAndroidCertificateDetails` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UninstallAndroidCertificateDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UninstallAndroidCertificateDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UninstallAndroidCertificateDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UninstallAndroidCertificateDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<UninstallAndroidCertificateDetails>() {
           @Override
           public void write(JsonWriter out, UninstallAndroidCertificateDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UninstallAndroidCertificateDetails read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to UninstallAndroidCertificateDetails
  */
  public static UninstallAndroidCertificateDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UninstallAndroidCertificateDetails.class);
  }
