...
public class CreateCompanyUserResponse {
  ...
  **/
  ...
  public CreateCompanyUserResponse authnApps(List<String> authnApps) {
    
    this.authnApps = authnApps;
    return this;
  }

  public CreateCompanyUserResponse addAuthnAppsItem(String authnAppsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, createCompanyUserResponse.links) &&
        ...
        Objects.equals(this.authnApps, createCompanyUserResponse.authnApps) &&
  ...
  public String toString() {
    String sb = "class CreateCompanyUserResponse {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CreateCompanyUserResponse.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateCompanyUserResponse is not found in the empty JSON string", CreateCompanyUserResponse.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateCompanyUserResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateCompanyUserResponse` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
