...
public class ListMerchantResponse {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to ListMerchantResponse
   */
  public static ListMerchantResponse fromJson(String jsonString) throws JacksonException {
