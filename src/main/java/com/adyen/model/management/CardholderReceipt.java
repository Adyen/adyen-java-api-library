...
public class CardholderReceipt {
   ...
   *
   * @param headerForAuthorizedReceipt The structure of the header to show on the shopper receipt. You can define the order of one or two header lines and blank lines. For example, **header1,header2,filler**. The text of the header lines is defined in the Customer Area under **In-person payments** &gt; **Terminal settings** &gt; **Receipts** in the **Receipt lines** block.
  ...
  /**
   * The structure of the header to show on the shopper receipt. You can define the order of one or two header lines and blank lines. For example, **header1,header2,filler**. The text of the header lines is defined in the Customer Area under **In-person payments** &gt; **Terminal settings** &gt; **Receipts** in the **Receipt lines** block.
   * @return headerForAuthorizedReceipt The structure of the header to show on the shopper receipt. You can define the order of one or two header lines and blank lines. For example, **header1,header2,filler**. The text of the header lines is defined in the Customer Area under **In-person payments** &gt; **Terminal settings** &gt; **Receipts** in the **Receipt lines** block.
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.headerForAuthorizedReceipt, cardholderReceipt.headerForAuthorizedReceipt) &&
        Objects.equals(this.isSetHeaderForAuthorizedReceipt, cardholderReceipt.isSetHeaderForAuthorizedReceipt)
    ;
  }
  ...
  public Map<String, Object> getExplicitNulls() {
    ...
    if (isSetHeaderForAuthorizedReceipt) {
      addIfNull(nulls, JSON_PROPERTY_HEADER_FOR_AUTHORIZED_RECEIPT, this.headerForAuthorizedReceipt);
    }
