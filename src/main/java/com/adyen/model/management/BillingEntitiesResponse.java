...
public class BillingEntitiesResponse {
  ...
  **/
  ...
  public String toString() {
      String sb = "class BillingEntitiesResponse {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (BillingEntitiesResponse.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in BillingEntitiesResponse is not found in the empty JSON string", BillingEntitiesResponse.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!BillingEntitiesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BillingEntitiesResponse` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
