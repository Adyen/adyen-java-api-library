...
public class CreateApiCredentialResponse {
  ...
  **/
  ...
  public String toString() {
    String sb = "class CreateApiCredentialResponse {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CreateApiCredentialResponse.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateApiCredentialResponse is not found in the empty JSON string", CreateApiCredentialResponse.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateApiCredentialResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateApiCredentialResponse` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
