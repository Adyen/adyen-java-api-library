...
public class SubMerchantData {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to SubMerchantData
   */
  public static SubMerchantData fromJson(String jsonString) throws JacksonException {
