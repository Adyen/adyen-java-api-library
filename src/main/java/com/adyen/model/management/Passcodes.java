...
public class Passcodes {
  ...
  **/
  ...
  public String toString() {
      String sb = "class Passcodes {\n" +
              "    adminMenuPin: " + toIndentedString(adminMenuPin) + "\n" +
              "    refundPin: " + toIndentedString(refundPin) + "\n" +
              "    screenLockPin: " + toIndentedString(screenLockPin) + "\n" +
              "    txMenuPin: " + toIndentedString(txMenuPin) + "\n" +
              "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (Passcodes.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in Passcodes is not found in the empty JSON string", Passcodes.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Passcodes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Passcodes` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
