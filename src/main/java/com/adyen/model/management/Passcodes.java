...
public class Passcodes {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to Passcodes
   */
  public static Passcodes fromJson(String jsonString) throws JacksonException {
