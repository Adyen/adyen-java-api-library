...
public class ListMerchantApiCredentialsResponse {
  ...
  **/
  ...
  public String toString() {
      String sb = "class ListMerchantApiCredentialsResponse {\n" +
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMerchantApiCredentialsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ListMerchantApiCredentialsResponse.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMerchantApiCredentialsResponse is not found in the empty JSON string", ListMerchantApiCredentialsResponse.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ListMerchantApiCredentialsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListMerchantApiCredentialsResponse` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
      ...
      if (jsonArraydata != null) {
        ...
        for (int i = 0; i < jsonArraydata.size(); i++) {
          ApiCredential.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
        }
      }
  }
