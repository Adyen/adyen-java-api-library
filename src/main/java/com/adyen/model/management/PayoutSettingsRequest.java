...
public class PayoutSettingsRequest {
   ...
   */
  public PayoutSettingsRequest includeNullValues(boolean includeNullValues) {
   ...
   */
  public static PayoutSettingsRequest fromJson(String jsonString) throws JacksonException {
