...
public class UpdateMerchantApiCredentialRequest {
  ...
  **/
  ...
  public String toString() {
      String sb = "class UpdateMerchantApiCredentialRequest {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (UpdateMerchantApiCredentialRequest.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateMerchantApiCredentialRequest is not found in the empty JSON string", UpdateMerchantApiCredentialRequest.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpdateMerchantApiCredentialRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateMerchantApiCredentialRequest` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
