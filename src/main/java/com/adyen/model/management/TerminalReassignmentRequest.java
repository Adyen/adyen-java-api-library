...
public class TerminalReassignmentRequest {
   ...
   *
   * @param companyId The unique identifier of the company account to which the terminal is
   *     reassigned.
   ...
   * The unique identifier of the company account to which the terminal is reassigned.
   *
   * @return companyId The unique identifier of the company account to which the terminal is
   *     reassigned.
   */
   ...
   *
   * @param inventory Must be specified when reassigning terminals to a merchant account: - If set
   *     to **true**, reassigns terminals to the inventory of the merchant account and the terminals
   *     cannot process transactions. - If set to **false**, reassigns terminals directly to the
   *     merchant account and the terminals can process transactions.
   * @return the current {@code TerminalReassignmentRequest} instance, allowing for method chaining
   */
   ...
   * the terminals can process transactions.
   *
   * @return inventory Must be specified when reassigning terminals to a merchant account: - If set
   *     to **true**, reassigns terminals to the inventory of the merchant account and the terminals
   *     cannot process transactions. - If set to **false**, reassigns terminals directly to the
   *     merchant account and the terminals can process transactions.
   */
  ...
  /**
   * The unique identifier of the merchant account to which the terminal is reassigned. When
   * reassigning terminals to a merchant account, you must specify the &#x60;inventory&#x60; field.
   *
   * @param merchantId The unique identifier of the merchant account to which the terminal is
   *     reassigned. When reassigning terminals to a merchant account, you must specify the
   *     &#x60;inventory&#x60; field.
   * @return the current {@code TerminalReassignmentRequest} instance, allowing for method chaining
   */
   ...
   * reassigning terminals to a merchant account, you must specify the &#x60;inventory&#x60; field.
   *
   * @return merchantId The unique identifier of the merchant account to which the terminal is
   *     reassigned. When reassigning terminals to a merchant account, you must specify the
   *     &#x60;inventory&#x60; field.
   */
   ...
   *     TerminalReassignmentRequest
   */
  public static TerminalReassignmentRequest fromJson(String jsonString) throws JacksonException {
