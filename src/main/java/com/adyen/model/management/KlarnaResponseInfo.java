...
public class KlarnaResponseInfo {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to KlarnaResponseInfo
   */
  public static KlarnaResponseInfo fromJson(String jsonString) throws JacksonException {
