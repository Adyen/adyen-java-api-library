...
public class Hardware {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to Hardware
   */
  public static Hardware fromJson(String jsonString) throws JacksonException {
