...
public class AndroidAppError {
   ...
   *
   * @param terminalModels The list of payment terminal models to which the returned
   *     &#x60;errorCode&#x60; applies.
   * @return the current {@code AndroidAppError} instance, allowing for method chaining
   */
   ...
   * The list of payment terminal models to which the returned &#x60;errorCode&#x60; applies.
   *
   * @return terminalModels The list of payment terminal models to which the returned
   *     &#x60;errorCode&#x60; applies.
   */
   ...
   * @throws JacksonException if the JSON string is invalid with respect to AndroidAppError
   */
  public static AndroidAppError fromJson(String jsonString) throws JacksonException {
