...
public class Nexo {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(displayUrls, isSetDisplayUrls, encryptionKey, isSetEncryptionKey, eventUrls, isSetEventUrls, nexoEventUrls, isSetNexoEventUrls, notification, isSetNotification);
  }
