...
public class AlipayPlusInfo {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to AlipayPlusInfo
   */
  public static AlipayPlusInfo fromJson(String jsonString) throws JacksonException {
