...
public class ShippingLocation {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to ShippingLocation
   */
  public static ShippingLocation fromJson(String jsonString) throws JacksonException {
