...
public class EventUrl {
   ...
   *
   * @param eventLocalUrls One or more local URLs to send event notifications to when using Terminal
   *     API.
   ...
   * One or more local URLs to send event notifications to when using Terminal API.
   *
   * @return eventLocalUrls One or more local URLs to send event notifications to when using
   *     Terminal API.
   */
   ...
   *
   * @param eventPublicUrls One or more public URLs to send event notifications to when using
   *     Terminal API.
   * @return the current {@code EventUrl} instance, allowing for method chaining
   */
   ...
   * One or more public URLs to send event notifications to when using Terminal API.
   *
   * @return eventPublicUrls One or more public URLs to send event notifications to when using
   *     Terminal API.
   */
   ...
   * @throws JacksonException if the JSON string is invalid with respect to EventUrl
   */
  public static EventUrl fromJson(String jsonString) throws JacksonException {
