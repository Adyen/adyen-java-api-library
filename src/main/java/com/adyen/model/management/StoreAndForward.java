...
public class StoreAndForward {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to StoreAndForward
   */
  public static StoreAndForward fromJson(String jsonString) throws JacksonException {
