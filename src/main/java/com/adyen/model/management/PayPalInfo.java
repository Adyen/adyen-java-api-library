...
public class PayPalInfo {
  ...
  **/
  ...
  public String toString() {
      String sb = "class PayPalInfo {\n" +
              "    directCapture: " + toIndentedString(directCapture) + "\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (PayPalInfo.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayPalInfo is not found in the empty JSON string", PayPalInfo.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PayPalInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PayPalInfo` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
