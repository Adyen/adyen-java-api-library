...
public class ApiCredentialLinks {
  ...
  **/
  ...
  public String toString() {
      String sb = "class ApiCredentialLinks {\n" +
              "    allowedOrigins: " + toIndentedString(allowedOrigins) + "\n" +
              "    company: " + toIndentedString(company) + "\n" +
              "    generateApiKey: " + toIndentedString(generateApiKey) + "\n" +
              "    generateClientKey: " + toIndentedString(generateClientKey) + "\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ApiCredentialLinks.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiCredentialLinks is not found in the empty JSON string", ApiCredentialLinks.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ApiCredentialLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiCredentialLinks` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
