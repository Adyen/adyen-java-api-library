...
public class ApiCredentialLinks {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowedOrigins, isSetAllowedOrigins, company, isSetCompany, generateApiKey, isSetGenerateApiKey, generateClientKey, isSetGenerateClientKey, merchant, isSetMerchant, self, isSetSelf);
  }
