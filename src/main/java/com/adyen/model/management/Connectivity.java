...
public class Connectivity {
  ...
  public enum SimcardStatusEnum {
    ...
    public static SimcardStatusEnum fromValue(String value) {
      ...
      LOG.warning("SimcardStatusEnum: unexpected enum value '" + value + "' - Supported values are "+ Arrays.toString(SimcardStatusEnum.values()));
      return null;
    }
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(simcardStatus, isSetSimcardStatus, terminalIPAddressURL, isSetTerminalIPAddressURL);
  }
