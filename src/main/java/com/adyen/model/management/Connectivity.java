...
public class Connectivity {
  ...
  **/
  ...
  @Override
  public String toString() {
      String sb = "class Connectivity {\n" +
              "    simcardStatus: " + toIndentedString(simcardStatus) + "\n" +
              "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (Connectivity.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in Connectivity is not found in the empty JSON string", Connectivity.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Connectivity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Connectivity` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
