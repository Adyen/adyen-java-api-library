...
public class MeApiCredential {
  ...
  **/
  ...
  public String toString() {
    String sb = "class MeApiCredential {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (MeApiCredential.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in MeApiCredential is not found in the empty JSON string", MeApiCredential.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!MeApiCredential.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MeApiCredential` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
