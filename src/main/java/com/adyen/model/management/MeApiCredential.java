...
public class MeApiCredential {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to MeApiCredential
   */
  public static MeApiCredential fromJson(String jsonString) throws JacksonException {
