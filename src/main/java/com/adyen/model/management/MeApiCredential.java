...
public class MeApiCredential {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, isSetLinks, active, isSetActive, allowedIpAddresses, isSetAllowedIpAddresses, allowedOrigins, isSetAllowedOrigins, clientKey, isSetClientKey, companyName, isSetCompanyName, description, isSetDescription, id, isSetId, roles, isSetRoles, username, isSetUsername);
  }
