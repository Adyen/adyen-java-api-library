...
public class InstallAndroidAppDetails {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to InstallAndroidAppDetails
   */
  public static InstallAndroidAppDetails fromJson(String jsonString) throws JacksonException {
