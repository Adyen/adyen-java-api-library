...
public class UpdatePaymentMethodInfo {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accel, bcmc, cartesBancaires, countries, cup, currencies, customRoutingFlags, diners, discover, eftDirectdebitCA, eftposAustralia, enabled, girocard, ideal, interacCard, jcb, maestro, maestroUsa, mc, nyce, paybybankPlaid, pulse, sepadirectdebit, star, storeId, storeIds, visa);
  }
