...
public class Surcharge {
  ...
  **/
  ...
  public String toString() {
      String sb = "class Surcharge {\n" +
              "    askConfirmation: " + toIndentedString(askConfirmation) + "\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (Surcharge.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in Surcharge is not found in the empty JSON string", Surcharge.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Surcharge.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Surcharge` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
