...
public class WebhookLinks {
  ...
  **/
  ...
  public String toString() {
      String sb = "class WebhookLinks {\n" +
              "    company: " + toIndentedString(company) + "\n" +
              "    generateHmac: " + toIndentedString(generateHmac) + "\n" +
              "    merchant: " + toIndentedString(merchant) + "\n" +
              "    self: " + toIndentedString(self) + "\n" +
              "    testWebhook: " + toIndentedString(testWebhook) + "\n" +
              "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (WebhookLinks.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookLinks is not found in the empty JSON string", WebhookLinks.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookLinks` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
