...
public class PulseInfo {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to PulseInfo
   */
  public static PulseInfo fromJson(String jsonString) throws JacksonException {
