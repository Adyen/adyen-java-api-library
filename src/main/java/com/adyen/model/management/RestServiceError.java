...
public class RestServiceError {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to RestServiceError
   */
  public static RestServiceError fromJson(String jsonString) throws JacksonException {
