...
public class MinorUnitsMonetaryValue {
   ...
   *
   * @param amount The transaction amount, in [minor units](https://docs.adyen.com/development-resources/currency-codes).
  ...
  /**
   * The transaction amount, in [minor units](https://docs.adyen.com/development-resources/currency-codes).
   * @return amount The transaction amount, in [minor units](https://docs.adyen.com/development-resources/currency-codes).
   */
   ...
   *
   * @param currencyCode The three-character [ISO currency code](https://docs.adyen.com/development-resources/currency-codes).
   * @return the current {@code MinorUnitsMonetaryValue} instance, allowing for method chaining
   */
  ...
  /**
   * The three-character [ISO currency code](https://docs.adyen.com/development-resources/currency-codes).
   * @return currencyCode The three-character [ISO currency code](https://docs.adyen.com/development-resources/currency-codes).
   */
