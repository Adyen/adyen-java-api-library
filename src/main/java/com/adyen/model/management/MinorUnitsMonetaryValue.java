...
public class MinorUnitsMonetaryValue {
  ...
  **/
  ...
  public String toString() {
      String sb = "class MinorUnitsMonetaryValue {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (MinorUnitsMonetaryValue.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in MinorUnitsMonetaryValue is not found in the empty JSON string", MinorUnitsMonetaryValue.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!MinorUnitsMonetaryValue.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MinorUnitsMonetaryValue` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
