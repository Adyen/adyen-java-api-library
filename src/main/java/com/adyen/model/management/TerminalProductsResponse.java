...
public class TerminalProductsResponse {
  ...
  **/
  ...
  public String toString() {
      String sb = "class TerminalProductsResponse {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (TerminalProductsResponse.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in TerminalProductsResponse is not found in the empty JSON string", TerminalProductsResponse.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TerminalProductsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TerminalProductsResponse` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
