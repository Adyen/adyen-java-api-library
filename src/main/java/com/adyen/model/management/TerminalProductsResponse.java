...
public class TerminalProductsResponse {
   ...
   */
  public TerminalProductsResponse includeNullValues(boolean includeNullValues) {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to TerminalProductsResponse
   */
  public static TerminalProductsResponse fromJson(String jsonString) throws JacksonException {
