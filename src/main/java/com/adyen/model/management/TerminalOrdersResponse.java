...
@JsonPropertyOrder({TerminalOrdersResponse.JSON_PROPERTY_DATA})
public class TerminalOrdersResponse {
  public static final String JSON_PROPERTY_DATA = "data";
  private List<TerminalOrder> data;
   ...
   *
   * @param data List of orders for payment terminal packages and parts.
   ...
   * List of orders for payment terminal packages and parts.
   *
   * @return data List of orders for payment terminal packages and parts.
   */
   ...
   */
  public TerminalOrdersResponse includeNullValues(boolean includeNullValues) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, terminalOrdersResponse.data)
        && Objects.equals(this.isSetData, terminalOrdersResponse.isSetData);
  }
   ...
   * @throws JacksonException if the JSON string is invalid with respect to TerminalOrdersResponse
   */
  public static TerminalOrdersResponse fromJson(String jsonString) throws JacksonException {
