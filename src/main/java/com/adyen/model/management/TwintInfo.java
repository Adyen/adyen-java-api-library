...
public class TwintInfo {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to TwintInfo
   */
  public static TwintInfo fromJson(String jsonString) throws JacksonException {
