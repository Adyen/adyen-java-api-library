...
public class UploadAndroidAppResponse {
   ...
   *
   * @param id The unique identifier of the uploaded Android app.
  ...
  /**
   * The unique identifier of the uploaded Android app.
   * @return id The unique identifier of the uploaded Android app.
   */
  ...
  public UploadAndroidAppResponse includeNullValues(boolean includeNullValues) {
