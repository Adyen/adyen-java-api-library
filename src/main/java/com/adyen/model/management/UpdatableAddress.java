...
public class UpdatableAddress {
  ...
  **/
  ...
  public String toString() {
      String sb = "class UpdatableAddress {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (UpdatableAddress.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatableAddress is not found in the empty JSON string", UpdatableAddress.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpdatableAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatableAddress` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
