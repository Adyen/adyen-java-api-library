...
public class UpdatableAddress {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to UpdatableAddress
   */
  public static UpdatableAddress fromJson(String jsonString) throws JacksonException {
