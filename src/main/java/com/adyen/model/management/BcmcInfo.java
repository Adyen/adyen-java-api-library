...
public class BcmcInfo {
  ...
  **/
  ...
  public String toString() {
      String sb = "class BcmcInfo {\n" +
              "    enableBcmcMobile: " + toIndentedString(enableBcmcMobile) + "\n" +
              "}";
    return sb;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (BcmcInfo.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in BcmcInfo is not found in the empty JSON string", BcmcInfo.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!BcmcInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BcmcInfo` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
  }
