...
public class ListCompanyUsersResponse {
  ...
  **/
  ...
  public String toString() {
      String sb = "class ListCompanyUsersResponse {\n" +
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListCompanyUsersResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ListCompanyUsersResponse.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListCompanyUsersResponse is not found in the empty JSON string", ListCompanyUsersResponse.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ListCompanyUsersResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListCompanyUsersResponse` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
