...
public class CreateMerchantResponse {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(businessLineId, isSetBusinessLineId, companyId, isSetCompanyId, description, isSetDescription, id, isSetId, legalEntityId, isSetLegalEntityId, pricingPlan, isSetPricingPlan, reference, isSetReference);
  }
