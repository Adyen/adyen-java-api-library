...
public class CreateUserResponse {
  ...
  **/
  ...
  public CreateUserResponse authnApps(List<String> authnApps) {
    
    this.authnApps = authnApps;
    return this;
  }

  public CreateUserResponse addAuthnAppsItem(String authnAppsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, createUserResponse.links) &&
        ...
        Objects.equals(this.authnApps, createUserResponse.authnApps) &&
  ...
  public String toString() {
    String sb = "class CreateUserResponse {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CreateUserResponse.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateUserResponse is not found in the empty JSON string", CreateUserResponse.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateUserResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateUserResponse` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
