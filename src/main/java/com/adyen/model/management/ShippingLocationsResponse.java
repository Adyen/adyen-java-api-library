...
@JsonPropertyOrder({ShippingLocationsResponse.JSON_PROPERTY_DATA})
public class ShippingLocationsResponse {
  public static final String JSON_PROPERTY_DATA = "data";
  private List<ShippingLocation> data;
   ...
   *
   * @param data Physical locations where orders can be shipped to.
   ...
   * Physical locations where orders can be shipped to.
   *
   * @return data Physical locations where orders can be shipped to.
   */
   ...
   */
  public ShippingLocationsResponse includeNullValues(boolean includeNullValues) {
   ...
   *     ShippingLocationsResponse
   */
  public static ShippingLocationsResponse fromJson(String jsonString) throws JacksonException {
