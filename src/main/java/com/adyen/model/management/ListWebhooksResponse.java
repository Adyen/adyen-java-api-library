...
public class ListWebhooksResponse {
  ...
  **/
  ...
  public String toString() {
      String sb = "class ListWebhooksResponse {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ListWebhooksResponse.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListWebhooksResponse is not found in the empty JSON string", ListWebhooksResponse.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ListWebhooksResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListWebhooksResponse` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
