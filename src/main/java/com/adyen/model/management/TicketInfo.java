...
public class TicketInfo {
   ...
   * @throws JacksonException if the JSON string is invalid with respect to TicketInfo
   */
  public static TicketInfo fromJson(String jsonString) throws JacksonException {
