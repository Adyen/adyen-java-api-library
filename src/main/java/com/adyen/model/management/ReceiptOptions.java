...
public class ReceiptOptions {
  ...
  **/
  ...
  public String toString() {
      String sb = "class ReceiptOptions {\n" +
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ReceiptOptions.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReceiptOptions is not found in the empty JSON string", ReceiptOptions.openapiRequiredFields));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ReceiptOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReceiptOptions` properties. JSON: %s", entry.getKey(), jsonObj));
        }
      }
