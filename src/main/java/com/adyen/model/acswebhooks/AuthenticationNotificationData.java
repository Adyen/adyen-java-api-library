...
public class AuthenticationNotificationData {
   ...
   * @return the current {@code AuthenticationNotificationData} instance, allowing for method
   *     chaining
   */
   ...
   *
   * @param paymentInstrumentId The unique identifier of the payment instrument that was used for
   *     the authentication.
   * @return the current {@code AuthenticationNotificationData} instance, allowing for method
   *     chaining
   */
   ...
   * The unique identifier of the payment instrument that was used for the authentication.
   *
   * @return paymentInstrumentId The unique identifier of the payment instrument that was used for
   *     the authentication.
   */
   ...
   * Outcome of the authentication. Allowed values: * authenticated * rejected * error
   *
   * @return status Outcome of the authentication. Allowed values: * authenticated * rejected *
   *     error
   */
