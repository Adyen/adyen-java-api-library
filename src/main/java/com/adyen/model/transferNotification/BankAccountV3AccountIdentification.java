...
import com.adyen.model.transferNotification.AULocalAccountIdentification;
import com.adyen.model.transferNotification.AdditionalBankIdentification;
import com.adyen.model.transferNotification.BRLocalAccountIdentification;
import com.adyen.model.transferNotification.CALocalAccountIdentification;
import com.adyen.model.transferNotification.CZLocalAccountIdentification;
import com.adyen.model.transferNotification.DKLocalAccountIdentification;
import com.adyen.model.transferNotification.HULocalAccountIdentification;
import com.adyen.model.transferNotification.IbanAccountIdentification;
import com.adyen.model.transferNotification.NOLocalAccountIdentification;
import com.adyen.model.transferNotification.NumberAndBicAccountIdentification;
import com.adyen.model.transferNotification.PLLocalAccountIdentification;
import com.adyen.model.transferNotification.SELocalAccountIdentification;
import com.adyen.model.transferNotification.SGLocalAccountIdentification;
import com.adyen.model.transferNotification.UKLocalAccountIdentification;
import com.adyen.model.transferNotification.USLocalAccountIdentification;
...
public class BankAccountV3AccountIdentification extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<BankAccountV3AccountIdentification>() {
                ...
                public void write(JsonWriter out, BankAccountV3AccountIdentification value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: AULocalAccountIdentification, BRLocalAccountIdentification, CALocalAccountIdentification, CZLocalAccountIdentification, DKLocalAccountIdentification, HULocalAccountIdentification, IbanAccountIdentification, NOLocalAccountIdentification, NumberAndBicAccountIdentification, PLLocalAccountIdentification, SELocalAccountIdentification, SGLocalAccountIdentification, UKLocalAccountIdentification, USLocalAccountIdentification");
                }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for BankAccountV3AccountIdentification with oneOf schemas: AULocalAccountIdentification, BRLocalAccountIdentification, CALocalAccountIdentification, CZLocalAccountIdentification, DKLocalAccountIdentification, HULocalAccountIdentification, IbanAccountIdentification, NOLocalAccountIdentification, NumberAndBicAccountIdentification, PLLocalAccountIdentification, SELocalAccountIdentification, SGLocalAccountIdentification, UKLocalAccountIdentification, USLocalAccountIdentification. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }
