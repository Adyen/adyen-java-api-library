...
public final class MaskUtil {
  ...
  /**
   * Masks the given string with a fixed size string of mask characters Return an empty string in
   * case input is null or empty
   *
  ...
  /**
   * Masks the given card number Return an empty string in case input is null, empty or has too less
   * digits
   *
  ...
  public static String maskCardNumber(String cardNumber) {
    ...
    Arrays.fill(
        maskedChars,
        0,
        cardNumberOnlyDigits.length() - CARD_NUMBER_UNMASK_LAST_BLOCK_SIZE,
        MASK_CHAR);
