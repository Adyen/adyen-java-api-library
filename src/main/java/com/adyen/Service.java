...
/**
 * A generic service that provides shared functionality for all API services.
 * It handles client and configuration management.
 */
public class Service {
    ...
    /**
     * Creates the base URL for a specific API endpoint. It dynamically constructs the URL
     * based on the client's configured {@link Environment}.
     *
