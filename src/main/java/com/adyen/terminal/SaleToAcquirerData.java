...
public class SaleToAcquirerData {
    ...
    /**
     * Create an instance of SaleToAcquirerData given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of SaleToAcquirerData
     * @throws JsonProcessingException if the JSON string is invalid with respect to SaleToAcquirerData
     */
    public static SaleToAcquirerData fromJson(String jsonString) throws JsonProcessingException {
        return JSON.getMapper().readValue(jsonString, SaleToAcquirerData.class);
    }

    /**
     * Convert an instance of SaleToAcquirerData to an JSON string
     *
     * @return JSON string
     */
    ...
    public static SaleToAcquirerData fromBase64(String base64) {
        ...
        try (Reader reader = new InputStreamReader(new ByteArrayInputStream(decoded))) {
            return SaleToAcquirerData.fromJson(reader.toString());
        } catch (IOException e) {
