...
public class StoredValueApi extends Service {
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.storedvalue.StoredValueApi
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.storedvalue.StoredValueApi
  public StoredValueStatusChangeResponse changeStatus(
  ...
  @Deprecated(
      ...
      forRemoval = true) // Use instead com.adyen.service.storedvalue.StoredValueApi
  public StoredValueStatusChangeResponse changeStatus(
      StoredValueStatusChangeRequest storedValueStatusChangeRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.storedvalue.StoredValueApi
  public StoredValueBalanceCheckResponse checkBalance(
  ...
  @Deprecated(
      ...
      forRemoval = true) // Use instead com.adyen.service.storedvalue.StoredValueApi
  public StoredValueBalanceCheckResponse checkBalance(
      StoredValueBalanceCheckRequest storedValueBalanceCheckRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.storedvalue.StoredValueApi
  public StoredValueIssueResponse issue(
      StoredValueIssueRequest storedValueIssueRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.storedvalue.StoredValueApi
  public StoredValueLoadResponse load(
      StoredValueLoadRequest storedValueLoadRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.storedvalue.StoredValueApi
  public StoredValueBalanceMergeResponse mergeBalance(
  ...
  @Deprecated(
      ...
      forRemoval = true) // Use instead com.adyen.service.storedvalue.StoredValueApi
  public StoredValueBalanceMergeResponse mergeBalance(
      StoredValueBalanceMergeRequest storedValueBalanceMergeRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.storedvalue.StoredValueApi
  public StoredValueVoidResponse voidTransaction(
      StoredValueVoidRequest storedValueVoidRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
