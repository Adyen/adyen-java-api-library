...
public class PaymentApi extends Service {
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.payment.PaymentsApi
  ...
  /**
   * Alternative constructor in {@link com.adyen.service package}. Please use this constructor only
   * if you would like to pass along your own url for routing or testing purposes. The latest API
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.payment.ModificationsApi
  public ModificationResult adjustAuthorisation(
      AdjustAuthorisationRequest adjustAuthorisationRequest) throws ApiException, IOException {
  ...
  @Deprecated(
      ...
      forRemoval = true) // Use instead com.adyen.service.payment.ModificationsApi
  public ModificationResult adjustAuthorisation(
      AdjustAuthorisationRequest adjustAuthorisationRequest, RequestOptions requestOptions)
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.payment.PaymentsApi
  public PaymentResult authorise3d(PaymentRequest3d paymentRequest3d, RequestOptions requestOptions)
      throws ApiException, IOException {
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.payment.PaymentsApi
  public PaymentResult authorise3ds2(
      PaymentRequest3ds2 paymentRequest3ds2, RequestOptions requestOptions)
      throws ApiException, IOException {
  ...
  public ModificationResult cancelOrRefund(
      CancelOrRefundRequest cancelOrRefundRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.payment.PaymentsApi
  public AuthenticationResultResponse getAuthenticationResult(
      AuthenticationResultRequest authenticationResultRequest) throws ApiException, IOException {
  ...
  @Deprecated(
      ...
      forRemoval = true) // Use instead com.adyen.service.payment.PaymentsApi
  public AuthenticationResultResponse getAuthenticationResult(
      AuthenticationResultRequest authenticationResultRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.payment.PaymentsApi
  public ThreeDS2ResultResponse retrieve3ds2Result(
      ThreeDS2ResultRequest threeDS2ResultRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.payment.ModificationsApi
  public ModificationResult technicalCancel(
      TechnicalCancelRequest technicalCancelRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.payment.ModificationsApi
  public ModificationResult voidPendingRefund(
      VoidPendingRefundRequest voidPendingRefundRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
