...
public class AccountHoldersApi extends Service {
    ...
    * @throws ApiException if fails to make API call
    */
    public GetTaxFormResponse getTaxForm(String id, 
String formType, 
Integer year
) throws ApiException, IOException {
    ...
    * @param formType {@link String } Query: The type of tax form you want to retrieve. Accepted values are **US1099k** and **US1099nec** (required)
    * @param year {@link Integer } Query: The tax year in YYYY format for the tax form you want to retrieve (required)
    * @param legalEntityId {@link String } Query: The legal entity reference whose tax form you want to retrieve (optional)
    * @param requestOptions {@link RequestOptions } Object to store additional HTTP headers such as idempotency-keys (optional)
    * @return {@link GetTaxFormResponse }
    * @throws ApiException if fails to make API call
    */
    public GetTaxFormResponse getTaxForm(String id, String formType, Integer year, String legalEntityId, RequestOptions requestOptions) throws ApiException, IOException {
        //Add path params
        Map<String, String> pathParams = new HashMap<>();
        if (id == null) {
            throw new IllegalArgumentException("Please provide the id path parameter");
    ...
    * @throws ApiException if fails to make API call
    */
    public AccountHolder updateAccountHolder(String id, 
AccountHolderUpdateRequest accountHolderUpdateRequest) throws ApiException, IOException {
