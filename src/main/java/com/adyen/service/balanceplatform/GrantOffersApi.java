...
public class GrantOffersApi extends Service {
  ...
  /**
   * Grant offers constructor in {@link com.adyen.service.balanceplatform package}. Please use this
   ...
   *     API](https://docs.adyen.com/api-explorer/capital/latest/get/grantOffers) instead.
   */
  @Deprecated
   ...
   */
  @Deprecated
  public GrantOffers getAllAvailableGrantOffers(
      String accountHolderId, RequestOptions requestOptions) throws ApiException, IOException {
    // Add query params
   ...
   * @throws ApiException if fails to make API call
   * @deprecated since Configuration API v2 Use the `/grantOffers/{id}` endpoint from the [Capital
   *     API](https://docs.adyen.com/api-explorer/capital/latest/get/grantOffers/(id)) instead.
   */
  @Deprecated
   ...
   */
  @Deprecated
  public GrantOffer getGrantOffer(String grantOfferId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
