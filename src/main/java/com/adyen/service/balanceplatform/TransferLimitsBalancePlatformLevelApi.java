...
public class TransferLimitsBalancePlatformLevelApi extends Service {
  ...
  /**
   * Transfer limits - balance platform level constructor in {@link
   * com.adyen.service.balanceplatform package}.
   *
  ...
  /**
   * Transfer limits - balance platform level constructor in {@link
   * com.adyen.service.balanceplatform package}. Please use this constructor only if you would like
   * to pass along your own url for routing or testing purposes. The latest API version is defined
  ...
  public TransferLimit createTransferLimit(
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/balancePlatforms/{id}/transferLimits", null);
    String jsonResult =
  ...
  public void deletePendingTransferLimit(
    ...
    Resource resource =
        new Resource(
            this, this.baseURL + "/balancePlatforms/{id}/transferLimits/{transferLimitId}", null);
