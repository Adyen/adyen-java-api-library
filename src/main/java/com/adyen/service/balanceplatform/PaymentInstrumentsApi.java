...
public class PaymentInstrumentsApi extends Service {
    ...
    */
    public NetworkTokenActivationDataResponse createNetworkTokenActivationData(String id, NetworkTokenActivationDataRequest networkTokenActivationDataRequest) throws ApiException, IOException {
    ...
    * @throws ApiException if fails to make API call
    */
    public NetworkTokenActivationDataResponse createNetworkTokenActivationData(String id, NetworkTokenActivationDataRequest networkTokenActivationDataRequest, RequestOptions requestOptions) throws ApiException, IOException {
        //Add path params
