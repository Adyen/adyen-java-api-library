...
public class PaymentInstrumentsApi extends Service {
    ...
    */
    public NetworkTokenActivationDataResponse createNetworkTokenProvisioningData(String id, NetworkTokenActivationDataRequest networkTokenActivationDataRequest) throws ApiException, IOException {
    ...
    * @throws ApiException if fails to make API call
    */
    public NetworkTokenActivationDataResponse getNetworkTokenActivationData(String id) throws ApiException, IOException {
