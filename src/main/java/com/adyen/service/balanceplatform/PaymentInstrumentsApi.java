...
public class PaymentInstrumentsApi extends Service {
    ...
    */
    public NetworkTokenActivationDataResponse createNetworkTokenProvisioningData(String id, 
NetworkTokenActivationDataRequest networkTokenActivationDataRequest) throws ApiException, IOException {
    ...
    * @throws ApiException if fails to make API call
    */
    public NetworkTokenActivationDataResponse createNetworkTokenProvisioningData(String id, NetworkTokenActivationDataRequest networkTokenActivationDataRequest, RequestOptions requestOptions) throws ApiException, IOException {
        //Add path params
        ...
        Resource resource = new Resource(this, this.baseURL + "/paymentInstruments/{id}/networkTokenActivationData", null);
    ...
    * @throws ApiException if fails to make API call
    */
    public NetworkTokenActivationDataResponse getNetworkTokenActivationData(String id, RequestOptions requestOptions) throws ApiException, IOException {
        //Add path params
        Map<String, String> pathParams = new HashMap<>();
        if (id == null) {
            throw new IllegalArgumentException("Please provide the id path parameter");
    ...
    * @throws ApiException if fails to make API call
    */
    public ListNetworkTokensResponse listNetworkTokens(String id
) throws ApiException, IOException {
    ...
    * @throws ApiException if fails to make API call
    */
    public UpdatePaymentInstrument updatePaymentInstrument(String id, 
PaymentInstrumentUpdateRequest paymentInstrumentUpdateRequest) throws ApiException, IOException {
