...
public class PaymentInstrumentGroupsApi extends Service {
   ...
   */
  public PaymentInstrumentGroup createPaymentInstrumentGroup(
      PaymentInstrumentGroupInfo paymentInstrumentGroupInfo, RequestOptions requestOptions)
   ...
   * @throws ApiException if fails to make API call
   */
  public TransactionRulesResponse getAllTransactionRulesForPaymentInstrumentGroup(
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/paymentInstrumentGroups/{id}/transactionRules", null);
    String jsonResult =
   ...
   * @throws ApiException if fails to make API call
   */
  public PaymentInstrumentGroup getPaymentInstrumentGroup(String id, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (id == null) {
