...
public class ScaAssociationManagementApi extends Service {
    ...
    */
    public ApproveAssociationResponse approveAssociation(String wwWAuthenticate, ApproveAssociationRequest approveAssociationRequest) throws ApiException, IOException {
    ...
    *
    * @param entityType {@link ScaEntityType } The type of entity you want to retrieve a list of associations for.   Possible values: **accountHolder** or **paymentInstrument**. (required)
    * @param entityId {@link String } The unique identifier of the entity. (required)
    * @param pageSize {@link Integer } The number of items to have on a page.   Default: **5**. (required)
    * @param pageNumber {@link Integer } The index of the page to retrieve. The index of the first page is **0** (zero).   Default:  **0**. (required)
    ...
    * Get a list of devices associated with an entity
    *
    * @param entityType {@link ScaEntityType } Query: The type of entity you want to retrieve a list of associations for.   Possible values: **accountHolder** or **paymentInstrument**. (required)
    * @param entityId {@link String } Query: The unique identifier of the entity. (required)
    * @param pageSize {@link Integer } Query: The number of items to have on a page.   Default: **5**. (required)
    * @param pageNumber {@link Integer } Query: The index of the page to retrieve. The index of the first page is **0** (zero).   Default:  **0**. (required)
    * @param requestOptions {@link RequestOptions } Object to store additional data such as idempotency-keys (optional)
    * @return {@link ListAssociationsResponse }
    * @throws ApiException if fails to make API call
    */
    ...
    * @throws ApiException if fails to make API call
    */
    public void removeAssociation(String wwWAuthenticate, RemoveAssociationRequest removeAssociationRequest) throws ApiException, IOException {
