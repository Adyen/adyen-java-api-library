...
public class ScaAssociationManagementApi extends Service {
  ...
  public ApproveAssociationResponse approveAssociation(
    ...
    requestOptions =
        new RequestOptions().addAdditionalServiceHeader("WWW-Authenticate", wwwAuthenticate);
    return approveAssociation(approveAssociationRequest, requestOptions);
  }
  ...
  public ListAssociationsResponse listAssociations(
      ...
      throws ApiException, IOException {
    RequestOptions requestOptions = null;
    return listAssociations(entityType, entityId, pageSize, pageNumber, requestOptions);
  }
  ...
  public void removeAssociation(
    ...
    requestOptions =
        new RequestOptions().addAdditionalServiceHeader("WWW-Authenticate", wwwAuthenticate);
    removeAssociation(removeAssociationRequest, requestOptions);
  }
