...
public class CardOrdersApi extends Service {
  ...
  /**
   * Card orders constructor in {@link com.adyen.service.balanceplatform package}. Please use this
   ...
   *
   * @param id {@link String } The unique identifier of the card order. (required)
   * @param offset {@link Integer } Query: Specifies the position of an element in a list of card
   *     orders. The response includes a list of card order items that starts at the specified
   *     offset. **Default:** 0, which means that the response contains all the elements in the list
   ...
   * @throws ApiException if fails to make API call
   */
  public PaginatedGetCardOrderItemResponse getCardOrderItems(
      String id, Integer offset, Integer limit, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
   ...
   * @param cardManufacturingProfileId {@link String } Query: The unique identifier of the card
   *     manufacturer profile. (optional)
   * @param status {@link String } Query: The status of the card order. (optional)
   * @param txVariantCode {@link String } Query: The unique code of the card manufacturer profile.
   *     Possible values: **mcmaestro**, **mc**, **visa**, **mcdebit**. (optional)
   * @param createdSince {@link OffsetDateTime } Query: Only include card orders that have been
   *     created on or after this point in time. The value must be in ISO 8601 format. For example,
   *     **2021-05-30T15:07:40Z**. (optional)
   * @param createdUntil {@link OffsetDateTime } Query: Only include card orders that have been
   *     created on or before this point in time. The value must be in ISO 8601 format. For example,
   *     **2021-05-30T15:07:40Z**. (optional)
   * @param lockedSince {@link OffsetDateTime } Query: Only include card orders that have been
   *     locked on or after this point in time. The value must be in ISO 8601 format. For example,
   *     **2021-05-30T15:07:40Z**. (optional)
   * @param lockedUntil {@link OffsetDateTime } Query: Only include card orders that have been
   *     locked on or before this point in time. The value must be in ISO 8601 format. For example,
   *     **2021-05-30T15:07:40Z**. (optional)
   * @param serviceCenter {@link String } Query: The service center at which the card is issued. The
   *     value is case-sensitive. (optional)
   * @param offset {@link Integer } Query: Specifies the position of an element in a list of card
   *     orders. The response includes a list of card orders that starts at the specified offset.
   *     **Default:** 0, which means that the response contains all the elements in the list of card
   *     orders. (optional)
   ...
   * @throws ApiException if fails to make API call
   */
  public PaginatedGetCardOrderResponse listCardOrders(
      String id,
