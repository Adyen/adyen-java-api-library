...
public class CustomPayoutSchedulesSweepsApi extends Service {
  ...
  /**
   * Custom payout schedules (sweeps) constructor in {@link com.adyen.service.balanceplatform
   * package}.
   *
   * @param client {@link Client } (required)
   */
  public CustomPayoutSchedulesSweepsApi(Client client) {
    super(client);
   ...
   */
  public CustomPayoutSchedulesSweepsApi(Client client, String baseURL) {
    super(client);
