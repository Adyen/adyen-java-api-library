...
public class BalanceAccountsApi extends Service {
  ...
  public SweepConfigurationV2 createSweep(
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/balanceAccounts/{balanceAccountId}/sweeps", null);
    String jsonResult =
   ...
   * @throws ApiException if fails to make API call
   */
  public void deleteSweep(String balanceAccountId, String sweepId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (balanceAccountId == null) {
    ...
    Resource resource =
        new Resource(
            this, this.baseURL + "/balanceAccounts/{balanceAccountId}/sweeps/{sweepId}", null);
   ...
   * @throws ApiException if fails to make API call
   */
  public BalanceSweepConfigurationsResponse getAllSweepsForBalanceAccount(
      String balanceAccountId, Integer offset, Integer limit, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (balanceAccountId == null) {
  ...
  public SweepConfigurationV2 getSweep(
      String balanceAccountId, String sweepId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (balanceAccountId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public SweepConfigurationV2 updateSweep(
      String balanceAccountId,
      String sweepId,
