...
public class ScaDeviceManagementApi extends Service {
  ...
  /**
   * SCA device management constructor in {@link com.adyen.service.balanceplatform package}. Please
   ...
   */
  public BeginScaDeviceRegistrationResponse beginScaDeviceRegistration(
      BeginScaDeviceRegistrationRequest beginScaDeviceRegistrationRequest)
      throws ApiException, IOException {
    RequestOptions requestOptions = null;
    return beginScaDeviceRegistration(beginScaDeviceRegistrationRequest, requestOptions);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public FinishScaDeviceRegistrationResponse finishScaDeviceRegistration(
      String deviceId, FinishScaDeviceRegistrationRequest finishScaDeviceRegistrationRequest)
      throws ApiException, IOException {
    RequestOptions requestOptions = null;
    return finishScaDeviceRegistration(
        deviceId, finishScaDeviceRegistrationRequest, requestOptions);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public SubmitScaAssociationResponse submitScaAssociation(
      String deviceId, SubmitScaAssociationRequest submitScaAssociationRequest)
      throws ApiException, IOException {
    RequestOptions requestOptions = null;
    return submitScaAssociation(deviceId, submitScaAssociationRequest, requestOptions);
  }
  ...
  public SubmitScaAssociationResponse submitScaAssociation(
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/scaDevices/{deviceId}/scaAssociations", null);
    String jsonResult =
