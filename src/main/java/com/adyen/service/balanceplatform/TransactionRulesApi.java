...
public class TransactionRulesApi extends Service {
  ...
  /**
   * Transaction rules constructor in {@link com.adyen.service.balanceplatform package}. Please use
   ...
   * @throws ApiException if fails to make API call
   */
  public TransactionRule createTransactionRule(
      TransactionRuleInfo transactionRuleInfo, RequestOptions requestOptions)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public TransactionRule deleteTransactionRule(
      String transactionRuleId, RequestOptions requestOptions) throws ApiException, IOException {
    // Add path params
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/transactionRules/{transactionRuleId}", null);
    String jsonResult =
