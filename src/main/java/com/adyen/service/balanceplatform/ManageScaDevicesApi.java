...
public class ManageScaDevicesApi extends Service {
    ...
    */
    public AssociationFinaliseResponse completeAssociationBetweenScaDeviceAndResource(String deviceId, 
AssociationFinaliseRequest associationFinaliseRequest) throws ApiException, IOException {
    ...
    * @throws ApiException if fails to make API call
    */
    public RegisterSCAFinalResponse completeRegistrationOfScaDevice(String id, 
RegisterSCARequest registerSCARequest) throws ApiException, IOException {
    ...
    * @throws ApiException if fails to make API call
    */
    public void deleteRegistrationOfScaDevice(String id, 
String paymentInstrumentId
    ...
    * @throws ApiException if fails to make API call
    */
    public AssociationInitiateResponse initiateAssociationBetweenScaDeviceAndResource(String deviceId, 
AssociationInitiateRequest associationInitiateRequest) throws ApiException, IOException {
