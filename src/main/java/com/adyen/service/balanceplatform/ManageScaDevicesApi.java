...
public class ManageScaDevicesApi extends Service {
  ...
  /**
   * Manage SCA devices constructor in {@link com.adyen.service.balanceplatform package}. Please use
  ...
  public AssociationFinaliseResponse completeAssociationBetweenScaDeviceAndResource(
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/registeredDevices/{deviceId}/associations", null);
    String jsonResult =
   ...
   *
   * @param id {@link String } The unique identifier of the SCA device. You obtain this
   *     &#x60;id&#x60; in the response of a
   ...
   */
  public RegisterSCAFinalResponse completeRegistrationOfScaDevice(
      String id, RegisterSCARequest registerSCARequest, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (id == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public void deleteRegistrationOfScaDevice(
      String id, String paymentInstrumentId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (id == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public RegisterSCAResponse initiateRegistrationOfScaDevice(
      RegisterSCARequest registerSCARequest, RequestOptions requestOptions)
      throws ApiException, IOException {
    String requestBody = registerSCARequest.toJson();
   ...
   * @throws ApiException if fails to make API call
   */
  public SearchRegisteredDevicesResponse listRegisteredScaDevices(
