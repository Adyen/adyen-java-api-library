...
public class ManageCardPinApi extends Service {
  ...
  /**
   * Manage card PIN constructor in {@link com.adyen.service.balanceplatform package}. Please use
   ...
   * @throws ApiException if fails to make API call
   */
  public PinChangeResponse changeCardPin(
      PinChangeRequest pinChangeRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
   ...
   * Get an RSA public key
   *
   * @param purpose {@link String } Query: The purpose of the public key. Possible values:
   ...
   * @throws ApiException if fails to make API call
   */
  public PublicKeyResponse publicKey(String purpose, String format, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add query params
   ...
   * @throws ApiException if fails to make API call
   */
  public RevealPinResponse revealCardPin(
      RevealPinRequest revealPinRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
