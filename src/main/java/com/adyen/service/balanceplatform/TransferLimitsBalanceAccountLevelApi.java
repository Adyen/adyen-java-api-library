...
public class TransferLimitsBalanceAccountLevelApi extends Service {
  ...
  /**
   * Transfer limits - balance account level constructor in {@link com.adyen.service.balanceplatform
   * package}.
   *
  ...
  public void approvePendingTransferLimits(
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/balanceAccounts/{id}/transferLimits/approve", null);
  ...
  public TransferLimit createTransferLimit(
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/balanceAccounts/{id}/transferLimits", null);
    String jsonResult =
        resource.request(requestBody, requestOptions, ApiConstants.HttpMethod.POST, pathParams);
  ...
  public void deletePendingTransferLimit(
    ...
    Resource resource =
        new Resource(
            this, this.baseURL + "/balanceAccounts/{id}/transferLimits/{transferLimitId}", null);
   ...
   * @throws ApiException if fails to make API call
   */
  public TransferLimitListResponse getCurrentTransferLimits(String id)
      throws ApiException, IOException {
   ...
   *
   * @param id {@link String } The unique identifier of the balance account. (required)
   * @param scope {@link Scope } Query: The scope to which the transfer limit applies. Possible
   *     values: * **perTransaction**: you set a maximum amount for each transfer made from the
   *     balance account or balance platform. * **perDay**: you set a maximum total amount for all
   *     transfers made from the balance account or balance platform in a day. (optional)
   ...
   * @throws ApiException if fails to make API call
   */
  public TransferLimitListResponse getCurrentTransferLimits(
      String id, Scope scope, TransferType transferType, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (id == null) {
    ...
    String requestBody = null;
    Resource resource =
        new Resource(this, this.baseURL + "/balanceAccounts/{id}/transferLimits/current", null);
    String jsonResult =
        resource.request(
   ...
   *     applies. Possible values: * **instant**: the limit applies to transfers with an **instant**
   *     priority. * **all**: the limit applies to all transfers, regardless of priority. (optional)
   * @param status {@link LimitStatus } Query: The status of the transfer limit. Possible values: *
   ...
   * @throws ApiException if fails to make API call
   */
  public TransferLimitListResponse getTransferLimits(
      String id,
      Scope scope,
