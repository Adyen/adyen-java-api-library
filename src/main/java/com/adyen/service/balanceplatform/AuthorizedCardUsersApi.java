...
public class AuthorizedCardUsersApi extends Service {
    ...
    */
    public void createAuthorisedCardUsers(String paymentInstrumentId, 

AuthorisedCardUsers authorisedCardUsers) throws ApiException, IOException {
    ...
    * @throws ApiException if fails to make API call
    */
    public void updateAuthorisedCardUsers(String paymentInstrumentId, 
