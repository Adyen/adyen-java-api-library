...
public class GrantsApi extends Service {
  ...
  /**
   * Grants constructor in {@link com.adyen.service.capital package}. Please use this constructor
   ...
   * @throws ApiException if fails to make API call
   */
  public Disbursements getAllGrantDisbursements(String grantId, RequestOptions requestOptions)
   ...
   *
   * @param counterpartyAccountHolderId {@link String } Query: The unique identifier of the account
   *     holder that received the grants. (required)
   * @return {@link Grants }
   * @throws ApiException if fails to make API call
   */
   ...
   * @throws ApiException if fails to make API call
   */
  public Grants getAllGrants(String counterpartyAccountHolderId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add query params
   ...
   * @throws ApiException if fails to make API call
   */
  public Grant getGrant(String grantId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (grantId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public Disbursement getGrantDisbursement(String grantId, String disbursementId)
      throws ApiException, IOException {
    return getGrantDisbursement(grantId, disbursementId, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public Disbursement getGrantDisbursement(
      String grantId, String disbursementId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (grantId == null) {
    ...
    String requestBody = null;
    Resource resource =
        new Resource(this, this.baseURL + "/grants/{grantId}/disbursements/{disbursementId}", null);
    String jsonResult =
        resource.request(requestBody, requestOptions, ApiConstants.HttpMethod.GET, pathParams);
   ...
   * @throws ApiException if fails to make API call
   */
  public Grant requestGrant(GrantInfo grantInfo, RequestOptions requestOptions)
      throws ApiException, IOException {
   ...
   * @param grantId {@link String } The unique identifier of the grant reference. (required)
   * @param disbursementId {@link String } The unique identifier of the disbursement. (required)
   * @param disbursementInfoUpdate {@link DisbursementInfoUpdate } (required)
   * @return {@link Disbursement }
   * @throws ApiException if fails to make API call
   */
  public Disbursement updateGrantDisbursement(
      String grantId, String disbursementId, DisbursementInfoUpdate disbursementInfoUpdate)
      throws ApiException, IOException {
    return updateGrantDisbursement(grantId, disbursementId, disbursementInfoUpdate, null);
  }
