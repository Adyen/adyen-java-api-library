...
public class GrantAccountsApi extends Service {
    ...
    */
    public GrantAccount getGrantAccount(String id) throws ApiException, IOException {
    ...
    * @throws ApiException if fails to make API call
    */
    public GrantAccount getGrantAccount(String id, RequestOptions requestOptions) throws ApiException, IOException {
        //Add path params
