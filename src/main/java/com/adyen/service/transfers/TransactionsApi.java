...
public class TransactionsApi extends Service {
    ...
    * @param sortOrder {@link String } Query: The transactions sorting order.  Possible values:   - **asc**: Ascending order, from older to most recent.  - **desc**: Descending order, from most recent to older. (optional)
