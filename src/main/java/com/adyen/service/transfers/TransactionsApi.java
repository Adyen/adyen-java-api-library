...
public class TransactionsApi extends Service {
  ...
  /**
   * Transactions constructor in {@link com.adyen.service.transfers package}. Please use this
   ...
   * @throws ApiException if fails to make API call
   */
  public Transaction getTransaction(String id, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
