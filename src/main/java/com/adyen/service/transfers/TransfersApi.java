...
public class TransfersApi extends Service {
    ...
    * @param sortOrder {@link String } Query: The transfers sorting order.  Possible values:   - **asc**: Ascending order, from older to most recent.  - **desc**: Descending order, from most recent to older. (optional)
