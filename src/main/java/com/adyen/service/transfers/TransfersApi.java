...
public class TransfersApi extends Service {
  ...
  /**
   * Transfers constructor in {@link com.adyen.service.transfers package}. Please use this
   ...
   */
  public void approveInitiatedTransfers(ApproveTransfersRequest approveTransfersRequest)
   ...
   * @throws ApiException if fails to make API call
   */
  public void approveInitiatedTransfers(
      ApproveTransfersRequest approveTransfersRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public void cancelInitiatedTransfers(CancelTransfersRequest cancelTransfersRequest)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public void cancelInitiatedTransfers(
      CancelTransfersRequest cancelTransfersRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public FindTransfersResponse getAllTransfers(
      OffsetDateTime createdSince, OffsetDateTime createdUntil) throws ApiException, IOException {
    return getAllTransfers(
        null, null, null, null, null, null, createdSince, createdUntil, null, null, null, null);
  }

  /**
   * Get all transfers
   *
   * @param balancePlatform {@link String } Query: The unique identifier of the [balance
   ...
   *     &#x60;accountHolderId&#x60;. (optional)
   * @param accountHolderId {@link String } Query: The unique identifier of the [account
   *     holder](https://docs.adyen.com/api-explorer/#/balanceplatform/latest/get/accountHolders/{id}__queryParam_id).
   *     Required if you don&#39;t provide a &#x60;balanceAccountId&#x60; or
   *     &#x60;balancePlatform&#x60;. If you provide a &#x60;balanceAccountId&#x60;, the
   *     &#x60;accountHolderId&#x60; must be related to the &#x60;balanceAccountId&#x60;. (optional)
   * @param balanceAccountId {@link String } Query: The unique identifier of the [balance
   ...
   *     &#x60;balancePlatform&#x60;. If you provide an &#x60;accountHolderId&#x60;, the
   *     &#x60;balanceAccountId&#x60; must be related to the &#x60;accountHolderId&#x60;. (optional)
   ...
   *     &#x60;accountHolderId&#x60;, or &#x60;balancePlatform&#x60;. The
   *     &#x60;paymentInstrumentId&#x60; must be related to the &#x60;balanceAccountId&#x60; or
   *     &#x60;accountHolderId&#x60; that you provide. (optional)
   ...
   * @throws ApiException if fails to make API call
   */
  public TransferData getTransfer(String id, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
   ...
   * @throws ApiException if fails to make API call
   */
  public ReturnTransferResponse returnTransfer(
   ...
   */
  public ReturnTransferResponse returnTransfer(
      String transferId, ReturnTransferRequest returnTransferRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (transferId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public Transfer transferFunds(TransferInfo transferInfo, RequestOptions requestOptions)
      throws ApiException, IOException {
