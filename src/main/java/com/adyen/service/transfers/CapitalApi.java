...
public class CapitalApi extends Service {
   ...
   * @deprecated since Transfers API v4 Use the `/grants` endpoint from the [Capital
   *     API](https://docs.adyen.com/api-explorer/capital/latest/get/grants) instead.
   */
  @Deprecated
   ...
   */
  @Deprecated
  public CapitalGrants getCapitalAccount(
      String counterpartyAccountHolderId, RequestOptions requestOptions)
   ...
   * @throws ApiException if fails to make API call
   * @deprecated since Transfers API v4 Use the `/grants/{grantId}` endpoint from the [Capital
   *     API](https://docs.adyen.com/api-explorer/capital/latest/get/grants/(grantId)) instead.
   */
  @Deprecated
   ...
   */
  @Deprecated
  public CapitalGrant getGrantReferenceDetails(String id, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
   ...
   * @throws ApiException if fails to make API call
   * @deprecated since Transfers API v4 Use the `/grants` endpoint from the [Capital
   *     API](https://docs.adyen.com/api-explorer/capital/latest/post/grants) instead.
   */
  @Deprecated
  public CapitalGrant requestGrantPayout(CapitalGrantInfo capitalGrantInfo)
      throws ApiException, IOException {
   ...
   */
  @Deprecated
  public CapitalGrant requestGrantPayout(
      CapitalGrantInfo capitalGrantInfo, RequestOptions requestOptions)
      throws ApiException, IOException {
