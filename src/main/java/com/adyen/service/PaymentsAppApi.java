...
public class PaymentsAppApi extends Service {
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.paymentsapp.PaymentsAppApi
  ...
  public BoardingTokenResponse generatePaymentsAppBoardingTokenForMerchant(
    ...
    Resource resource =
        new Resource(
            this, this.baseURL + "/merchants/{merchantId}/generatePaymentsAppBoardingToken", null);
    String jsonResult =
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.paymentsapp.PaymentsAppApi
  public BoardingTokenResponse generatePaymentsAppBoardingTokenForStore(
      String merchantId, String storeId, BoardingTokenRequest boardingTokenRequest)
      throws ApiException, IOException {
    return generatePaymentsAppBoardingTokenForStore(
        merchantId, storeId, boardingTokenRequest, null);
  }
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.paymentsapp.PaymentsAppApi
  public PaymentsAppResponse listPaymentsAppForMerchant(String merchantId)
      throws ApiException, IOException {
   ...
   *
   * @param merchantId {@link String } The unique identifier of the merchant account. (required)
   * @param statuses {@link String } Query: The status of the Payments App. Comma-separated list of
   *     one or more values. If no value is provided, the list returns all statuses. Possible
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.paymentsapp.PaymentsAppApi
  public PaymentsAppResponse listPaymentsAppForMerchant(
      String merchantId, String statuses, Integer limit, Long offset, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (merchantId == null) {
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/merchants/{merchantId}/paymentsApps", null);
    String jsonResult =
        resource.request(
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.paymentsapp.PaymentsAppApi
  public PaymentsAppResponse listPaymentsAppForStore(String merchantId, String storeId)
      throws ApiException, IOException {
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.paymentsapp.PaymentsAppApi
  public PaymentsAppResponse listPaymentsAppForStore(
      String merchantId,
      String storeId,
      String statuses,
      Integer limit,
    ...
    Resource resource =
        new Resource(
            this, this.baseURL + "/merchants/{merchantId}/stores/{storeId}/paymentsApps", null);
    String jsonResult =
        resource.request(
            requestBody, requestOptions, ApiConstants.HttpMethod.GET, pathParams, queryParams);
    return PaymentsAppResponse.fromJson(jsonResult);
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.paymentsapp.PaymentsAppApi
  public void revokePaymentsApp(String merchantId, String installationId)
      throws ApiException, IOException {
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.paymentsapp.PaymentsAppApi
  public void revokePaymentsApp(
      String merchantId, String installationId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (merchantId == null) {
    ...
    Resource resource =
        new Resource(
            this,
            this.baseURL + "/merchants/{merchantId}/paymentsApps/{installationId}/revoke",
            null);
    resource.request(requestBody, requestOptions, ApiConstants.HttpMethod.POST, pathParams);
  }
}
