...
public class RecurringApi extends Service {
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.recurring.RecurringApi
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.recurring.RecurringApi
  public CreatePermitResult createPermit(
      CreatePermitRequest createPermitRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.recurring.RecurringApi
  public DisablePermitResult disablePermit(
      DisablePermitRequest disablePermitRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
