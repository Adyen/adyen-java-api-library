...
public class PciQuestionnairesApi extends Service {
   ...
   */
  public CalculatePciStatusResponse calculatePciStatusOfLegalEntity(
   ...
   */
  public CalculatePciStatusResponse calculatePciStatusOfLegalEntity(
      String id, CalculatePciStatusRequest calculatePciStatusRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    ...
    Resource resource =
        new Resource(
            this, this.baseURL + "/legalEntities/{id}/pciQuestionnaires/signingRequired", null);
    String jsonResult =
   ...
   * @throws ApiException if fails to make API call
   */
  public GeneratePciDescriptionResponse generatePciQuestionnaire(
  ...
  public GeneratePciDescriptionResponse generatePciQuestionnaire(
    ...
    Resource resource =
        new Resource(
            this,
            this.baseURL + "/legalEntities/{id}/pciQuestionnaires/generatePciTemplates",
            null);
    String jsonResult =
        resource.request(requestBody, requestOptions, ApiConstants.HttpMethod.POST, pathParams);
   ...
   * @throws ApiException if fails to make API call
   */
  public GetPciQuestionnaireResponse getPciQuestionnaire(String id, String pciid)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public GetPciQuestionnaireResponse getPciQuestionnaire(
      String id, String pciid, RequestOptions requestOptions) throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (id == null) {
      throw new IllegalArgumentException("Please provide the id path parameter");
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/legalEntities/{id}/pciQuestionnaires/{pciid}", null);
    String jsonResult =
   ...
   * @throws ApiException if fails to make API call
   */
  public GetPciQuestionnaireInfosResponse getPciQuestionnaireDetails(String id)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public GetPciQuestionnaireInfosResponse getPciQuestionnaireDetails(
    ...
    String requestBody = null;
    Resource resource =
        new Resource(this, this.baseURL + "/legalEntities/{id}/pciQuestionnaires", null);
    String jsonResult =
        resource.request(requestBody, requestOptions, ApiConstants.HttpMethod.GET, pathParams);
   ...
   * @throws ApiException if fails to make API call
   */
  public PciSigningResponse signPciQuestionnaire(String id, PciSigningRequest pciSigningRequest)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public PciSigningResponse signPciQuestionnaire(
      String id, PciSigningRequest pciSigningRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (id == null) {
    ...
    Resource resource =
        new Resource(
            this, this.baseURL + "/legalEntities/{id}/pciQuestionnaires/signPciTemplates", null);
    String jsonResult =
        resource.request(requestBody, requestOptions, ApiConstants.HttpMethod.POST, pathParams);
