...
public class BusinessLinesApi extends Service {
  ...
  /**
   * Business lines constructor in {@link com.adyen.service.legalentitymanagement package}. Please
   ...
   */
  public BusinessLine createBusinessLine(BusinessLineInfo businessLineInfo)
  ...
  public BusinessLine createBusinessLine(
      BusinessLineInfo businessLineInfo, RequestOptions requestOptions)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public void deleteBusinessLine(String id, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
   ...
   * @throws ApiException if fails to make API call
   */
  public BusinessLine getBusinessLine(String id, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (id == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public BusinessLine updateBusinessLine(String id, BusinessLineInfoUpdate businessLineInfoUpdate)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public BusinessLine updateBusinessLine(
      String id, BusinessLineInfoUpdate businessLineInfoUpdate, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (id == null) {
