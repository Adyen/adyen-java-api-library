...
public class BusinessLinesApi extends Service {
    ...
    * @throws ApiException if fails to make API call
    */
    public void deleteBusinessLine(String id
    ...
    * @throws ApiException if fails to make API call
    */
    public BusinessLine getBusinessLine(String id
) throws ApiException, IOException {
    ...
    * @throws ApiException if fails to make API call
    */
    public BusinessLine updateBusinessLine(String id, 
BusinessLineInfoUpdate businessLineInfoUpdate) throws ApiException, IOException {
