...
public class TransferInstrumentsApi extends Service {
   ...
   */
  public TransferInstrument createTransferInstrument(TransferInstrumentInfo transferInstrumentInfo)
   ...
   * @throws ApiException if fails to make API call
   */
  public TransferInstrument createTransferInstrument(
      TransferInstrumentInfo transferInstrumentInfo, RequestOptions requestOptions)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public void deleteTransferInstrument(String id, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
   ...
   * @throws ApiException if fails to make API call
   */
  public TransferInstrument getTransferInstrument(String id, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (id == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public TransferInstrument updateTransferInstrument(
      String id, TransferInstrumentInfo transferInstrumentInfo) throws ApiException, IOException {
   ...
   */
  public TransferInstrument updateTransferInstrument(
      String id, TransferInstrumentInfo transferInstrumentInfo, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (id == null) {
