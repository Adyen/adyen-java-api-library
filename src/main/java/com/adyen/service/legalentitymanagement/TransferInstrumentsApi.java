...
public class TransferInstrumentsApi extends Service {
    ...
    * @throws ApiException if fails to make API call
    */
    public void deleteTransferInstrument(String id
    ...
    * @throws ApiException if fails to make API call
    */
    public TransferInstrument getTransferInstrument(String id
) throws ApiException, IOException {
    ...
    * @throws ApiException if fails to make API call
    */
    public TransferInstrument updateTransferInstrument(String id, 
TransferInstrumentInfo transferInstrumentInfo) throws ApiException, IOException {
