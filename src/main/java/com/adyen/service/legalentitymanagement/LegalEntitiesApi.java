...
public class LegalEntitiesApi extends Service {
    ...
    * @throws ApiException if fails to make API call
    */
    public void requestPeriodicReview(String id
) throws ApiException, IOException {
    ...
    * @throws ApiException if fails to make API call
    */
    public void requestPeriodicReview(String id, RequestOptions requestOptions) throws ApiException, IOException {
        //Add path params
        Map<String, String> pathParams = new HashMap<>();
        if (id == null) {
            throw new IllegalArgumentException("Please provide the id path parameter");
        ...
        String requestBody = null;
        Resource resource = new Resource(this, this.baseURL + "/legalEntities/{id}/requestPeriodicReview", null);
    ...
    * @throws ApiException if fails to make API call
    */
    public LegalEntity updateLegalEntity(String id, 
LegalEntityInfo legalEntityInfo) throws ApiException, IOException {
