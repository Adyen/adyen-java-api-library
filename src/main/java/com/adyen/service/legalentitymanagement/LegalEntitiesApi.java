...
public class LegalEntitiesApi extends Service {
  ...
  /**
   * Legal entities constructor in {@link com.adyen.service.legalentitymanagement package}. Please
   ...
   */
  public VerificationErrors checkLegalEntitysVerificationErrors(String id)
   ...
   * @throws ApiException if fails to make API call
   */
  public VerificationErrors checkLegalEntitysVerificationErrors(
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/legalEntities/{id}/checkVerificationErrors", null);
    String jsonResult =
   ...
   * @throws ApiException if fails to make API call
   */
  public DataReviewConfirmationResponse confirmDataReview(String id)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public DataReviewConfirmationResponse confirmDataReview(String id, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (id == null) {
    ...
    String requestBody = null;
    Resource resource =
        new Resource(this, this.baseURL + "/legalEntities/{id}/confirmDataReview", null);
    String jsonResult =
        resource.request(requestBody, requestOptions, ApiConstants.HttpMethod.POST, pathParams);
   ...
   * @throws ApiException if fails to make API call
   */
  public LegalEntity createLegalEntity(LegalEntityInfoRequiredType legalEntityInfoRequiredType)
      throws ApiException, IOException {
  ...
  public LegalEntity createLegalEntity(
      LegalEntityInfoRequiredType legalEntityInfoRequiredType, RequestOptions requestOptions)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public BusinessLines getAllBusinessLinesUnderLegalEntity(String id)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public BusinessLines getAllBusinessLinesUnderLegalEntity(String id, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (id == null) {
    ...
    String requestBody = null;
    Resource resource =
        new Resource(this, this.baseURL + "/legalEntities/{id}/businessLines", null);
    String jsonResult =
   ...
   * @throws ApiException if fails to make API call
   */
  public LegalEntity getLegalEntity(String id, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (id == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public LegalEntity updateLegalEntity(String id, LegalEntityInfo legalEntityInfo)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public LegalEntity updateLegalEntity(
      String id, LegalEntityInfo legalEntityInfo, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (id == null) {
