...
public class TaxEDeliveryConsentApi extends Service {
  ...
  public CheckTaxElectronicDeliveryConsentResponse
      checkStatusOfConsentForElectronicDeliveryOfTaxForms(String id)
   ...
   */
  public CheckTaxElectronicDeliveryConsentResponse
      checkStatusOfConsentForElectronicDeliveryOfTaxForms(String id, RequestOptions requestOptions)
          throws ApiException, IOException {
    // Add path params
    ...
    Resource resource =
        new Resource(
            this, this.baseURL + "/legalEntities/{id}/checkTaxElectronicDeliveryConsent", null);
    String jsonResult =
   ...
   * @throws ApiException if fails to make API call
   */
  public void setConsentStatusForElectronicDeliveryOfTaxForms(
    ...
    setConsentStatusForElectronicDeliveryOfTaxForms(
        id, setTaxElectronicDeliveryConsentRequest, null);
  }
  ...
  public void setConsentStatusForElectronicDeliveryOfTaxForms(
    ...
    Resource resource =
        new Resource(
            this, this.baseURL + "/legalEntities/{id}/setTaxElectronicDeliveryConsent", null);
    resource.request(requestBody, requestOptions, ApiConstants.HttpMethod.POST, pathParams);
  }
}
