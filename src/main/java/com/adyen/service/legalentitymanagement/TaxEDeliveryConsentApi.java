...
public class TaxEDeliveryConsentApi extends Service {
    ...
    */
    public CheckTaxElectronicDeliveryConsentResponse checkStatusOfConsentForElectronicDeliveryOfTaxForms(String id
    ...
    * @throws ApiException if fails to make API call
    */
    public void setConsentStatusForElectronicDeliveryOfTaxForms(String id, 
SetTaxElectronicDeliveryConsentRequest setTaxElectronicDeliveryConsentRequest) throws ApiException, IOException {
