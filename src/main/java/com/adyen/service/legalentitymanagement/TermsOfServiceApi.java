...
public class TermsOfServiceApi extends Service {
    ...
    */
    public AcceptTermsOfServiceResponse acceptTermsOfService(String id, 
String termsofservicedocumentid, 
AcceptTermsOfServiceRequest acceptTermsOfServiceRequest) throws ApiException, IOException {
    ...
    * @throws ApiException if fails to make API call
    */
    public GetAcceptedTermsOfServiceDocumentResponse getAcceptedTermsOfServiceDocument(String id, 
String termsofserviceacceptancereference
    ...
    * @throws ApiException if fails to make API call
    */
    public GetTermsOfServiceDocumentResponse getTermsOfServiceDocument(String id, 
GetTermsOfServiceDocumentRequest getTermsOfServiceDocumentRequest) throws ApiException, IOException {
    ...
    * @throws ApiException if fails to make API call
    */
    public GetTermsOfServiceAcceptanceInfosResponse getTermsOfServiceInformationForLegalEntity(String id
) throws ApiException, IOException {
