...
public class DocumentsApi extends Service {
  ...
  /**
   * Documents constructor in {@link com.adyen.service.legalentitymanagement package}. Please use
   ...
   * @throws ApiException if fails to make API call
   */
  public Document getDocument(String id, Boolean skipContent, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (id == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public Document updateDocument(String id, Document document, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (id == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public Document uploadDocumentForVerificationChecks(Document document)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public Document uploadDocumentForVerificationChecks(
      Document document, RequestOptions requestOptions) throws ApiException, IOException {
    String requestBody = document.toJson();
