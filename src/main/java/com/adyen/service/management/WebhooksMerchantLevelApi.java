...
public class WebhooksMerchantLevelApi extends Service {
  ...
  /**
   * Webhooks - merchant level constructor in {@link com.adyen.service.management package}. Please
   ...
   */
  public GenerateHmacKeyResponse generateHmacKey(String merchantId, String webhookId)
  ...
  public GenerateHmacKeyResponse generateHmacKey(
      String merchantId, String webhookId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    ...
    Resource resource =
        new Resource(
            this, this.baseURL + "/merchants/{merchantId}/webhooks/{webhookId}/generateHmac", null);
    String jsonResult =
   ...
   * @throws ApiException if fails to make API call
   */
  public Webhook getWebhook(String merchantId, String webhookId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (merchantId == null) {
    ...
    String requestBody = null;
    Resource resource =
        new Resource(this, this.baseURL + "/merchants/{merchantId}/webhooks/{webhookId}", null);
    String jsonResult =
  ...
  public ListWebhooksResponse listAllWebhooks(
      String merchantId, Integer pageNumber, Integer pageSize, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (merchantId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public void removeWebhook(String merchantId, String webhookId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (merchantId == null) {
  ...
  public TestWebhookResponse testWebhook(
    ...
    Resource resource =
        new Resource(
            this, this.baseURL + "/merchants/{merchantId}/webhooks/{webhookId}/test", null);
    String jsonResult =
        resource.request(requestBody, requestOptions, ApiConstants.HttpMethod.POST, pathParams);
