...
public class WebhooksMerchantLevelApi extends Service {
    ...
    */
    public GenerateHmacKeyResponse generateHmacKey(String merchantId, 
String webhookId
...
String webhookId
    ...
    * @throws ApiException if fails to make API call
    */
    public Webhook setUpWebhook(String merchantId, 
CreateMerchantWebhookRequest createMerchantWebhookRequest) throws ApiException, IOException {
    ...
    * @throws ApiException if fails to make API call
    */
    public TestWebhookResponse testWebhook(String merchantId, 
String webhookId, 
TestWebhookRequest testWebhookRequest) throws ApiException, IOException {
...
String webhookId, 
UpdateMerchantWebhookRequest updateMerchantWebhookRequest) throws ApiException, IOException {
