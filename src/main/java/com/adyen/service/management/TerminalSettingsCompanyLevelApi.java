...
public class TerminalSettingsCompanyLevelApi extends Service {
    ...
    */
    public Logo getTerminalLogo(String companyId, 
String model
    ...
    * @throws ApiException if fails to make API call
    */
    public TerminalSettings getTerminalSettings(String companyId
) throws ApiException, IOException {
    ...
    * @throws ApiException if fails to make API call
    */
    public Logo updateTerminalLogo(String companyId, 
String model, 
Logo logo) throws ApiException, IOException {
    ...
    * @throws ApiException if fails to make API call
    */
    public TerminalSettings updateTerminalSettings(String companyId, 
TerminalSettings terminalSettings) throws ApiException, IOException {
