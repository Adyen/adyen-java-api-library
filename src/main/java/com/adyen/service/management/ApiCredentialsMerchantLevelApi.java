...
public class ApiCredentialsMerchantLevelApi extends Service {
   ...
   */
  public CreateApiCredentialResponse createApiCredential(
  ...
  public CreateApiCredentialResponse createApiCredential(
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/merchants/{merchantId}/apiCredentials", null);
    String jsonResult =
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiCredential getApiCredential(String merchantId, String apiCredentialId)
      throws ApiException, IOException {
  ...
  public ApiCredential getApiCredential(
      String merchantId, String apiCredentialId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (merchantId == null) {
    ...
    Resource resource =
        new Resource(
            this, this.baseURL + "/merchants/{merchantId}/apiCredentials/{apiCredentialId}", null);
    String jsonResult =
   ...
   * @throws ApiException if fails to make API call
   */
  public ListMerchantApiCredentialsResponse listApiCredentials(
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiCredential updateApiCredential(
      String merchantId,
      String apiCredentialId,
      UpdateMerchantApiCredentialRequest updateMerchantApiCredentialRequest)
      throws ApiException, IOException {
    return updateApiCredential(
        merchantId, apiCredentialId, updateMerchantApiCredentialRequest, null);
  }
