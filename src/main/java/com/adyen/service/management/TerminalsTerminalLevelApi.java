...
public class TerminalsTerminalLevelApi extends Service {
  ...
  /**
   * Terminals - terminal level constructor in {@link com.adyen.service.management package}. Please
   ...
   * Get a list of terminals
   *
   * @param searchQuery {@link String } Query: Returns terminals with an ID that contains the
   *     specified string. If present, other query parameters are ignored. (optional)
   * @param otpQuery {@link String } Query: Returns one or more terminals associated with the
   *     one-time passwords specified in the request. If this query parameter is used, other query
   *     parameters are ignored. (optional)
   * @param countries {@link String } Query: Returns terminals located in the countries specified by
   *     their [two-letter country code](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2).
   *     (optional)
   * @param merchantIds {@link String } Query: Returns terminals that belong to the merchant
   *     accounts specified by their unique merchant account ID. (optional)
   * @param storeIds {@link String } Query: Returns terminals that are assigned to the
   *     [stores](https://docs.adyen.com/api-explorer/#/ManagementService/latest/get/stores)
   *     specified by their unique store ID. (optional)
   * @param brandModels {@link String } Query: Returns terminals of the
   *     [models](https://docs.adyen.com/api-explorer/#/ManagementService/latest/get/companies/{companyId}/terminalModels)
   *     specified in the format *brand.model*. (optional)
