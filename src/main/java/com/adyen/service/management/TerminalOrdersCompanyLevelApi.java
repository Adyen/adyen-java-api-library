...
public class TerminalOrdersCompanyLevelApi extends Service {
  ...
  /**
   * Terminal orders - company level constructor in {@link com.adyen.service.management package}.
   *
   ...
   */
  public TerminalOrder cancelOrder(String companyId, String orderId)
   ...
   * @throws ApiException if fails to make API call
   */
  public TerminalOrder cancelOrder(String companyId, String orderId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    ...
    Resource resource =
        new Resource(
            this, this.baseURL + "/companies/{companyId}/terminalOrders/{orderId}/cancel", null);
    String jsonResult =
   ...
   * @throws ApiException if fails to make API call
   */
  public TerminalOrder createOrder(String companyId, TerminalOrderRequest terminalOrderRequest)
      throws ApiException, IOException {
  ...
  public TerminalOrder createOrder(
      String companyId, TerminalOrderRequest terminalOrderRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (companyId == null) {
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/companies/{companyId}/terminalOrders", null);
    String jsonResult =
        resource.request(requestBody, requestOptions, ApiConstants.HttpMethod.POST, pathParams);
    return TerminalOrder.fromJson(jsonResult);
  }
  ...
  public ShippingLocation createShippingLocation(
      String companyId, ShippingLocation shippingLocation) throws ApiException, IOException {
   ...
   */
  public ShippingLocation createShippingLocation(
      String companyId, ShippingLocation shippingLocation, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (companyId == null) {
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/companies/{companyId}/shippingLocations", null);
    String jsonResult =
        resource.request(requestBody, requestOptions, ApiConstants.HttpMethod.POST, pathParams);
   ...
   * @throws ApiException if fails to make API call
   */
  public TerminalOrder getOrder(String companyId, String orderId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (companyId == null) {
    ...
    String requestBody = null;
    Resource resource =
        new Resource(this, this.baseURL + "/companies/{companyId}/terminalOrders/{orderId}", null);
    String jsonResult =
   ...
   * @throws ApiException if fails to make API call
   */
  public BillingEntitiesResponse listBillingEntities(String companyId)
      throws ApiException, IOException {
  ...
  public BillingEntitiesResponse listBillingEntities(
      String companyId, String name, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (companyId == null) {
    ...
    String requestBody = null;
    Resource resource =
        new Resource(this, this.baseURL + "/companies/{companyId}/billingEntities", null);
    String jsonResult =
        resource.request(
  ...
  public ShippingLocationsResponse listShippingLocations(
      String companyId, String name, Integer offset, Integer limit, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (companyId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public TerminalModelsResponse listTerminalModels(String companyId)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public TerminalModelsResponse listTerminalModels(String companyId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (companyId == null) {
    ...
    String requestBody = null;
    Resource resource =
        new Resource(this, this.baseURL + "/companies/{companyId}/terminalModels", null);
    String jsonResult =
        resource.request(requestBody, requestOptions, ApiConstants.HttpMethod.GET, pathParams);
   ...
   * @throws ApiException if fails to make API call
   */
  public TerminalProductsResponse listTerminalProducts(String companyId, String country)
      throws ApiException, IOException {
   ...
   *     &#x60;/terminalModels&#x60;](https://docs.adyen.com/api-explorer/#/ManagementService/latest/get/companies/{companyId}/terminalModels)
  ...
  public TerminalProductsResponse listTerminalProducts(
    ...
    String requestBody = null;
    Resource resource =
        new Resource(this, this.baseURL + "/companies/{companyId}/terminalProducts", null);
    String jsonResult =
        resource.request(
            requestBody, requestOptions, ApiConstants.HttpMethod.GET, pathParams, queryParams);
