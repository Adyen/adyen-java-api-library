...
public class ApiCredentialsCompanyLevelApi extends Service {
   ...
   */
  public CreateCompanyApiCredentialResponse createApiCredential(
  ...
  public CreateCompanyApiCredentialResponse createApiCredential(
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/companies/{companyId}/apiCredentials", null);
    String jsonResult =
   ...
   * @throws ApiException if fails to make API call
   */
  public CompanyApiCredential getApiCredential(String companyId, String apiCredentialId)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompanyApiCredential getApiCredential(
      String companyId, String apiCredentialId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (companyId == null) {
    ...
    Resource resource =
        new Resource(
            this, this.baseURL + "/companies/{companyId}/apiCredentials/{apiCredentialId}", null);
    String jsonResult =
   ...
   * @throws ApiException if fails to make API call
   */
  public ListCompanyApiCredentialsResponse listApiCredentials(String companyId)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ListCompanyApiCredentialsResponse listApiCredentials(
   ...
   * @throws ApiException if fails to make API call
   */
  public CompanyApiCredential updateApiCredential(
      String companyId,
