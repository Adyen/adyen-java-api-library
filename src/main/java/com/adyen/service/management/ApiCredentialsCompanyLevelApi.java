...
public class ApiCredentialsCompanyLevelApi extends Service {
    ...
    */
    public CreateCompanyApiCredentialResponse createApiCredential(String companyId, 
CreateCompanyApiCredentialRequest createCompanyApiCredentialRequest) throws ApiException, IOException {
    ...
    * @throws ApiException if fails to make API call
    */
    public CompanyApiCredential getApiCredential(String companyId, 
String apiCredentialId
    ...
    * @throws ApiException if fails to make API call
    */
    public CompanyApiCredential updateApiCredential(String companyId, 
String apiCredentialId, 
UpdateCompanyApiCredentialRequest updateCompanyApiCredentialRequest) throws ApiException, IOException {
