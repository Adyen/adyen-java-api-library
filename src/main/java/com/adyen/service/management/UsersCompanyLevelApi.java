...
public class UsersCompanyLevelApi extends Service {
  ...
  /**
   * Users - company level constructor in {@link com.adyen.service.management package}. Please use
   ...
   */
  public CreateCompanyUserResponse createNewUser(
   ...
   * @throws ApiException if fails to make API call
   */
  public CompanyUser getUserDetails(String companyId, String userId)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompanyUser getUserDetails(String companyId, String userId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (companyId == null) {
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/companies/{companyId}/users/{userId}", null);
    String jsonResult =
   ...
   * @param pageSize {@link Integer } Query: The number of items to have on a page. Maximum value is
   ...
   * @throws ApiException if fails to make API call
   */
  public ListCompanyUsersResponse listUsers(
      String companyId,
      Integer pageNumber,
      Integer pageSize,
      String username,
   ...
   * @throws ApiException if fails to make API call
   */
  public CompanyUser updateUserDetails(
