...
public class UsersCompanyLevelApi extends Service {
    ...
    */
    public CreateCompanyUserResponse createNewUser(String companyId, 
CreateCompanyUserRequest createCompanyUserRequest) throws ApiException, IOException {
    ...
    * @throws ApiException if fails to make API call
    */
    public CompanyUser getUserDetails(String companyId, 
String userId
    ...
    * @throws ApiException if fails to make API call
    */
    public ListCompanyUsersResponse listUsers(String companyId
) throws ApiException, IOException {
    ...
    * @throws ApiException if fails to make API call
    */
    public CompanyUser updateUserDetails(String companyId, 
String userId, 
UpdateCompanyUserRequest updateCompanyUserRequest) throws ApiException, IOException {
