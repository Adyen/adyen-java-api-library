...
public class AccountStoreLevelApi extends Service {
  ...
  /**
   * Account - store level constructor in {@link com.adyen.service.management package}. Please use
   ...
   * @throws ApiException if fails to make API call
   */
  public Store createStoreByMerchantId(String merchantId, StoreCreationRequest storeCreationRequest)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public Store createStoreByMerchantId(
      String merchantId, StoreCreationRequest storeCreationRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
   ...
   * @throws ApiException if fails to make API call
   */
  public Store getStore(String merchantId, String storeId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (merchantId == null) {
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/merchants/{merchantId}/stores/{storeId}", null);
    String jsonResult =
   ...
   * @throws ApiException if fails to make API call
   */
  public Store getStoreById(String storeId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (storeId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public ListStoresResponse listStores(
      Integer pageNumber,
      Integer pageSize,
      String reference,
      String merchantId,
   ...
   * @throws ApiException if fails to make API call
   */
  public ListStoresResponse listStoresByMerchantId(String merchantId)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ListStoresResponse listStoresByMerchantId(
      String merchantId,
      Integer pageNumber,
      Integer pageSize,
      String reference,
   ...
   * @throws ApiException if fails to make API call
   */
  public Store updateStore(String merchantId, String storeId, UpdateStoreRequest updateStoreRequest)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public Store updateStoreById(String storeId, UpdateStoreRequest updateStoreRequest)
      throws ApiException, IOException {
  ...
  public Store updateStoreById(
      String storeId, UpdateStoreRequest updateStoreRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (storeId == null) {
