...
public class TerminalSettingsStoreLevelApi extends Service {
   ...
   */
  public Logo getTerminalLogo(String merchantId, String reference, String model)
   ...
   * @throws ApiException if fails to make API call
   */
  public Logo getTerminalLogo(
      String merchantId, String reference, String model, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    ...
    Resource resource =
        new Resource(
            this, this.baseURL + "/merchants/{merchantId}/stores/{reference}/terminalLogos", null);
    String jsonResult =
        resource.request(
   ...
   * @throws ApiException if fails to make API call
   */
  public Logo getTerminalLogoByStoreId(String storeId, String model)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public Logo getTerminalLogoByStoreId(String storeId, String model, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (storeId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public TerminalSettings getTerminalSettings(String merchantId, String reference)
      throws ApiException, IOException {
  ...
  public TerminalSettings getTerminalSettings(
      String merchantId, String reference, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (merchantId == null) {
    ...
    Resource resource =
        new Resource(
            this,
            this.baseURL + "/merchants/{merchantId}/stores/{reference}/terminalSettings",
            null);
    String jsonResult =
   ...
   * @throws ApiException if fails to make API call
   */
  public TerminalSettings getTerminalSettingsByStoreId(String storeId)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public TerminalSettings getTerminalSettingsByStoreId(
      String storeId, RequestOptions requestOptions) throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (storeId == null) {
      throw new IllegalArgumentException("Please provide the storeId path parameter");
    ...
    String requestBody = null;
    Resource resource =
        new Resource(this, this.baseURL + "/stores/{storeId}/terminalSettings", null);
    String jsonResult =
        resource.request(requestBody, requestOptions, ApiConstants.HttpMethod.GET, pathParams);
    return TerminalSettings.fromJson(jsonResult);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public Logo updateTerminalLogo(String merchantId, String reference, String model, Logo logo)
      throws ApiException, IOException {
  ...
  public Logo updateTerminalLogo(
      String merchantId, String reference, String model, Logo logo, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (merchantId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public Logo updateTerminalLogoByStoreId(String storeId, String model, Logo logo)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public Logo updateTerminalLogoByStoreId(
      String storeId, String model, Logo logo, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (storeId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public TerminalSettings updateTerminalSettingsByStoreId(
      String storeId, TerminalSettings terminalSettings) throws ApiException, IOException {
   ...
   */
  public TerminalSettings updateTerminalSettingsByStoreId(
      String storeId, TerminalSettings terminalSettings, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (storeId == null) {
