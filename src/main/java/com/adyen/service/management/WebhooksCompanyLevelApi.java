...
public class WebhooksCompanyLevelApi extends Service {
  ...
  /**
   * Webhooks - company level constructor in {@link com.adyen.service.management package}. Please
   ...
   */
  public GenerateHmacKeyResponse generateHmacKey(String companyId, String webhookId)
   ...
   * @throws ApiException if fails to make API call
   */
  public GenerateHmacKeyResponse generateHmacKey(
      String companyId, String webhookId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    ...
    Resource resource =
        new Resource(
            this, this.baseURL + "/companies/{companyId}/webhooks/{webhookId}/generateHmac", null);
    String jsonResult =
   ...
   * @throws ApiException if fails to make API call
   */
  public Webhook getWebhook(String companyId, String webhookId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (companyId == null) {
    ...
    String requestBody = null;
    Resource resource =
        new Resource(this, this.baseURL + "/companies/{companyId}/webhooks/{webhookId}", null);
    String jsonResult =
   ...
   * @throws ApiException if fails to make API call
   */
  public ListWebhooksResponse listAllWebhooks(
      String companyId, Integer pageNumber, Integer pageSize, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (companyId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public void removeWebhook(String companyId, String webhookId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (companyId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public TestWebhookResponse testWebhook(
  ...
  public TestWebhookResponse testWebhook(
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/companies/{companyId}/webhooks/{webhookId}/test", null);
    String jsonResult =
        resource.request(requestBody, requestOptions, ApiConstants.HttpMethod.POST, pathParams);
