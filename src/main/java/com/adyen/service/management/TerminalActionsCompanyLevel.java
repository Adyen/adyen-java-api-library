...
public class TerminalActionsCompanyLevel extends ApiKeyAuthenticatedService {
     ...
     */
    public AndroidAppsResponse getListOfAndroidApps(String companyId, Map<String, String> queryParams) throws ApiException, IOException {
        if (companyId == null) {
     ...
     * @throws ApiException if fails to make API call
     */
    public AndroidCertificatesResponse getListOfAndroidCertificates(String companyId, Map<String, String> queryParams) throws ApiException, IOException {
        if (companyId == null) {
            throw new ApiException("Missing the required parameter 'companyId'", 400);
        }
     ...
     * @throws ApiException if fails to make API call
     */
    public ListExternalTerminalActionsResponse getListOfTerminalActions(String companyId, Map<String, String> queryParams) throws ApiException, IOException {
        if (companyId == null) {
            throw new ApiException("Missing the required parameter 'companyId'", 400);
        }
