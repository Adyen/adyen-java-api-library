...
public class TerminalOrdersMerchantLevelApi extends Service {
   ...
   */
  public TerminalOrder cancelOrder(String merchantId, String orderId)
   ...
   * @throws ApiException if fails to make API call
   */
  public TerminalOrder cancelOrder(String merchantId, String orderId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    ...
    Resource resource =
        new Resource(
            this, this.baseURL + "/merchants/{merchantId}/terminalOrders/{orderId}/cancel", null);
    String jsonResult =
   ...
   * @throws ApiException if fails to make API call
   */
  public TerminalOrder createOrder(String merchantId, TerminalOrderRequest terminalOrderRequest)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public TerminalOrder createOrder(
      String merchantId, TerminalOrderRequest terminalOrderRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (merchantId == null) {
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/merchants/{merchantId}/terminalOrders", null);
    String jsonResult =
        resource.request(requestBody, requestOptions, ApiConstants.HttpMethod.POST, pathParams);
    return TerminalOrder.fromJson(jsonResult);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ShippingLocation createShippingLocation(
      String merchantId, ShippingLocation shippingLocation) throws ApiException, IOException {
   ...
   */
  public ShippingLocation createShippingLocation(
      String merchantId, ShippingLocation shippingLocation, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (merchantId == null) {
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/merchants/{merchantId}/shippingLocations", null);
    String jsonResult =
        resource.request(requestBody, requestOptions, ApiConstants.HttpMethod.POST, pathParams);
   ...
   * @throws ApiException if fails to make API call
   */
  public TerminalOrder getOrder(String merchantId, String orderId)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public TerminalOrder getOrder(String merchantId, String orderId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (merchantId == null) {
    ...
    String requestBody = null;
    Resource resource =
        new Resource(this, this.baseURL + "/merchants/{merchantId}/terminalOrders/{orderId}", null);
    String jsonResult =
   ...
   * @throws ApiException if fails to make API call
   */
  public BillingEntitiesResponse listBillingEntities(String merchantId)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public BillingEntitiesResponse listBillingEntities(
      String merchantId, String name, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (merchantId == null) {
    ...
    String requestBody = null;
    Resource resource =
        new Resource(this, this.baseURL + "/merchants/{merchantId}/billingEntities", null);
    String jsonResult =
        resource.request(
   ...
   * @param status {@link String } Query: The order status. Possible values (not case-sensitive):
   ...
   * @throws ApiException if fails to make API call
   */
  public TerminalOrdersResponse listOrders(
      String merchantId,
   ...
   * @throws ApiException if fails to make API call
   */
  public ShippingLocationsResponse listShippingLocations(String merchantId)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ShippingLocationsResponse listShippingLocations(
      String merchantId, String name, Integer offset, Integer limit, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (merchantId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public TerminalModelsResponse listTerminalModels(String merchantId)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public TerminalModelsResponse listTerminalModels(String merchantId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (merchantId == null) {
    ...
    String requestBody = null;
    Resource resource =
        new Resource(this, this.baseURL + "/merchants/{merchantId}/terminalModels", null);
    String jsonResult =
        resource.request(requestBody, requestOptions, ApiConstants.HttpMethod.GET, pathParams);
   ...
   * @throws ApiException if fails to make API call
   */
  public TerminalProductsResponse listTerminalProducts(String merchantId, String country)
      throws ApiException, IOException {
   ...
   *     alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) format. For example, **US**
   *     (required)
   * @param terminalModelId {@link String } Query: The terminal model to return products for. Use
   *     the ID returned in the [GET
   *     &#x60;/terminalModels&#x60;](https://docs.adyen.com/api-explorer/#/ManagementService/latest/get/merchants/{merchantId}/terminalModels)
   ...
   * @throws ApiException if fails to make API call
   */
  public TerminalProductsResponse listTerminalProducts(
      String merchantId,
      String country,
    ...
    String requestBody = null;
    Resource resource =
        new Resource(this, this.baseURL + "/merchants/{merchantId}/terminalProducts", null);
    String jsonResult =
        resource.request(
            requestBody, requestOptions, ApiConstants.HttpMethod.GET, pathParams, queryParams);
   ...
   * @throws ApiException if fails to make API call
   */
  public TerminalOrder updateOrder(
