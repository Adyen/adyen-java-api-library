...
public class MyApiCredentialApi extends Service {
  ...
  /**
   * My API credential constructor in {@link com.adyen.service.management package}. Please use this
   ...
   */
  public AllowedOrigin addAllowedOrigin(CreateAllowedOriginRequest createAllowedOriginRequest)
   ...
   * @throws ApiException if fails to make API call
   */
  public AllowedOrigin addAllowedOrigin(
      CreateAllowedOriginRequest createAllowedOriginRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public GenerateClientKeyResponse generateClientKey(RequestOptions requestOptions)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public AllowedOrigin getAllowedOriginDetails(String originId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
   ...
   * @throws ApiException if fails to make API call
   */
  public AllowedOriginsResponse getAllowedOrigins(RequestOptions requestOptions)
      throws ApiException, IOException {
    String requestBody = null;
    Resource resource = new Resource(this, this.baseURL + "/me/allowedOrigins", null);
    String jsonResult =
        resource.request(requestBody, requestOptions, ApiConstants.HttpMethod.GET, null);
   ...
   * @throws ApiException if fails to make API call
   */
  public MeApiCredential getApiCredentialDetails(RequestOptions requestOptions)
      throws ApiException, IOException {
    String requestBody = null;
   ...
   * @throws ApiException if fails to make API call
   */
  public void removeAllowedOrigin(String originId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (originId == null) {
