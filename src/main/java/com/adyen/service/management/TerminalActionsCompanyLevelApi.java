...
public class TerminalActionsCompanyLevelApi extends Service {
   ...
   */
  public ExternalTerminalAction getTerminalAction(String companyId, String actionId)
   ...
   * @throws ApiException if fails to make API call
   */
  public ExternalTerminalAction getTerminalAction(
      String companyId, String actionId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    ...
    Resource resource =
        new Resource(
            this, this.baseURL + "/companies/{companyId}/terminalActions/{actionId}", null);
    String jsonResult =
   ...
   * @param status {@link String } Query: Returns terminal actions with the specified status.
   ...
   * @throws ApiException if fails to make API call
   */
  public ListExternalTerminalActionsResponse listTerminalActions(
      String companyId,
      Integer pageNumber,
      Integer pageSize,
      String status,
    ...
    String requestBody = null;
    Resource resource =
        new Resource(this, this.baseURL + "/companies/{companyId}/terminalActions", null);
    String jsonResult =
        resource.request(
