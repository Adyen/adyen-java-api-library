...
public class TerminalSettingsTerminalLevelApi extends Service {
    ...
    */
    public Logo getTerminalLogo(String terminalId
    ...
    * @throws ApiException if fails to make API call
    */
    public TerminalSettings getTerminalSettings(String terminalId
) throws ApiException, IOException {
    ...
    * @throws ApiException if fails to make API call
    */
    public Logo updateLogo(String terminalId, 
Logo logo) throws ApiException, IOException {
    ...
    * @throws ApiException if fails to make API call
    */
    public TerminalSettings updateTerminalSettings(String terminalId, 
