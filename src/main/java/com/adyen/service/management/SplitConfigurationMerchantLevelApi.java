...
public class SplitConfigurationMerchantLevelApi extends Service {
    ...
    * @param merchantId {@link String } The unique identifier of the merchant account. (required)
    * @param splitConfigurationId {@link String } The unique identifier of the split configuration. (required)
    * @param splitConfigurationRuleId {@link String }  (required)
    * @return {@link SplitConfiguration }
    * @throws ApiException if fails to make API call
    */
    public SplitConfiguration deleteSplitConfigurationRule(String merchantId, String splitConfigurationId, String splitConfigurationRuleId) throws ApiException, IOException {
        return deleteSplitConfigurationRule(merchantId, splitConfigurationId, splitConfigurationRuleId, null);
    }
    ...
    * @throws ApiException if fails to make API call
    */
    public SplitConfiguration deleteSplitConfigurationRule(String merchantId, String splitConfigurationId, String splitConfigurationRuleId, RequestOptions requestOptions) throws ApiException, IOException {
        //Add path params
        Map<String, String> pathParams = new HashMap<>();
        if (merchantId == null) {
            throw new IllegalArgumentException("Please provide the merchantId path parameter");
        ...
        pathParams.put("splitConfigurationId", splitConfigurationId);
        if (splitConfigurationRuleId == null) {
            throw new IllegalArgumentException("Please provide the splitConfigurationRuleId path parameter");
        }
        pathParams.put("splitConfigurationRuleId", splitConfigurationRuleId);

        String requestBody = null;
        Resource resource = new Resource(this, this.baseURL + "/merchants/{merchantId}/splitConfigurations/{splitConfigurationId}/rules/{splitConfigurationRuleId}", null);
        String jsonResult = resource.request(requestBody, requestOptions, ApiConstants.HttpMethod.DELETE, pathParams);
        return SplitConfiguration.fromJson(jsonResult);
    }
