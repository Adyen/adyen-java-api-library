...
public class AccountCompanyLevelApi extends Service {
  ...
  /**
   * Account - company level constructor in {@link com.adyen.service.management package}. Please use
   ...
   * @throws ApiException if fails to make API call
   */
  public Company getCompanyAccount(String companyId, RequestOptions requestOptions)
   ...
   * @throws ApiException if fails to make API call
   */
  public ListCompanyResponse listCompanyAccounts(
