...
public class AndroidFilesCompanyLevelApi extends Service {
   ...
   * @throws ApiException if fails to make API call
   */
  public AndroidApp getAndroidApp(String companyId, String id, RequestOptions requestOptions)
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/companies/{companyId}/androidApps/{id}", null);
    String jsonResult =
   ...
   * @throws ApiException if fails to make API call
   */
  public AndroidAppsResponse listAndroidApps(
      String companyId,
      Integer pageNumber,
      Integer pageSize,
      String packageName,
    ...
    String requestBody = null;
    Resource resource =
        new Resource(this, this.baseURL + "/companies/{companyId}/androidApps", null);
    String jsonResult =
        resource.request(
   ...
   * @throws ApiException if fails to make API call
   */
  public AndroidCertificatesResponse listAndroidCertificates(
      String companyId,
      Integer pageNumber,
      Integer pageSize,
    ...
    String requestBody = null;
    Resource resource =
        new Resource(this, this.baseURL + "/companies/{companyId}/androidCertificates", null);
    String jsonResult =
        resource.request(
            requestBody, requestOptions, ApiConstants.HttpMethod.GET, pathParams, queryParams);
   ...
   * @throws ApiException if fails to make API call
   */
  public ReprocessAndroidAppResponse reprocessAndroidApp(String companyId, String id)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ReprocessAndroidAppResponse reprocessAndroidApp(
   ...
   * @throws ApiException if fails to make API call
   */
  public UploadAndroidAppResponse uploadAndroidApp(String companyId)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public UploadAndroidAppResponse uploadAndroidApp(String companyId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (companyId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public UploadAndroidCertificateResponse uploadAndroidCertificate(String companyId)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public UploadAndroidCertificateResponse uploadAndroidCertificate(
