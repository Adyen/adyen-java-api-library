...
public class AllowedOriginsCompanyLevelApi extends Service {
   ...
   */
  public AllowedOrigin createAllowedOrigin(
  ...
  public AllowedOrigin createAllowedOrigin(
    ...
    Resource resource =
        new Resource(
            this,
            this.baseURL + "/companies/{companyId}/apiCredentials/{apiCredentialId}/allowedOrigins",
            null);
    String jsonResult =
   ...
   * @throws ApiException if fails to make API call
   */
  public void deleteAllowedOrigin(String companyId, String apiCredentialId, String originId)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public void deleteAllowedOrigin(
      String companyId, String apiCredentialId, String originId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (companyId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public AllowedOrigin getAllowedOrigin(String companyId, String apiCredentialId, String originId)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public AllowedOriginsResponse listAllowedOrigins(String companyId, String apiCredentialId)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public AllowedOriginsResponse listAllowedOrigins(
