...
public class PaymentMethodsMerchantLevelApi extends Service {
   ...
   *
   * @param merchantId {@link String } The unique identifier of the merchant account. (required)
   * @param storeId {@link String } Query: The unique identifier of the store for which to return
   *     the payment methods. (optional)
   * @param businessLineId {@link String } Query: The unique identifier of the Business Line for
   *     which to return the payment methods. (optional)
   ...
   * @throws ApiException if fails to make API call
   */
  public PaymentMethodResponse getAllPaymentMethods(
      String merchantId,
      String storeId,
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/merchants/{merchantId}/paymentMethodSettings", null);
    String jsonResult =
        resource.request(
   ...
   * @throws ApiException if fails to make API call
   */
  public PaymentMethod getPaymentMethodDetails(String merchantId, String paymentMethodId)
      throws ApiException, IOException {
  ...
  public PaymentMethod getPaymentMethodDetails(
    ...
    Resource resource =
        new Resource(
            this,
            this.baseURL + "/merchants/{merchantId}/paymentMethodSettings/{paymentMethodId}",
            null);
    String jsonResult =
        resource.request(requestBody, requestOptions, ApiConstants.HttpMethod.GET, pathParams);
