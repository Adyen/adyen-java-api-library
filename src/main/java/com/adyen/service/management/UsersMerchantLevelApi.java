...
public class UsersMerchantLevelApi extends Service {
    ...
    */
    public CreateUserResponse createNewUser(String merchantId, 
CreateMerchantUserRequest createMerchantUserRequest) throws ApiException, IOException {
    ...
    * @throws ApiException if fails to make API call
    */
    public User getUserDetails(String merchantId, 
String userId
    ...
    * @throws ApiException if fails to make API call
    */
    public ListMerchantUsersResponse listUsers(String merchantId
) throws ApiException, IOException {
    ...
    * @throws ApiException if fails to make API call
    */
    public User updateUser(String merchantId, 
String userId, 
UpdateMerchantUserRequest updateMerchantUserRequest) throws ApiException, IOException {
