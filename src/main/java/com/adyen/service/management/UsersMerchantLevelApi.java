...
public class UsersMerchantLevelApi extends Service {
  ...
  /**
   * Users - merchant level constructor in {@link com.adyen.service.management package}. Please use
   ...
   */
  public CreateUserResponse createNewUser(
   ...
   * @throws ApiException if fails to make API call
   */
  public User getUserDetails(String merchantId, String userId, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
    Map<String, String> pathParams = new HashMap<>();
    if (merchantId == null) {
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/merchants/{merchantId}/users/{userId}", null);
    String jsonResult =
   ...
   * @throws ApiException if fails to make API call
   */
  public ListMerchantUsersResponse listUsers(
      String merchantId,
      Integer pageNumber,
      Integer pageSize,
      String username,
