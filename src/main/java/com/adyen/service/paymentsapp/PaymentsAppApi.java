...
BoardingTokenRequest boardingTokenRequest) throws ApiException, IOException {
    ...
    * @throws ApiException if fails to make API call
    */
    public BoardingTokenResponse generatePaymentsAppBoardingTokenForStore(String merchantId, 
String storeId, 
...
BoardingTokenRequest boardingTokenRequest) throws ApiException, IOException {
    ...
    * @throws ApiException if fails to make API call
    */
    public PaymentsAppResponse listPaymentsAppForStore(String merchantId, 
String storeId
) throws ApiException, IOException {
    ...
    * @throws ApiException if fails to make API call
    */
    public void revokePaymentsApp(String merchantId, 
