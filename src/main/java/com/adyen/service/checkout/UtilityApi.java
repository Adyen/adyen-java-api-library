...
public class UtilityApi extends Service {
  ...
  /**
   * Utility constructor in {@link com.adyen.service.checkout package}. Please use this constructor
   ...
   */
  public ApplePaySessionResponse getApplePaySession(ApplePaySessionRequest applePaySessionRequest)
   ...
   * @throws ApiException if fails to make API call
   */
  public ApplePaySessionResponse getApplePaySession(
      ApplePaySessionRequest applePaySessionRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
   ...
   */
  @Deprecated
  public UtilityResponse originKeys(UtilityRequest utilityRequest)
      throws ApiException, IOException {
   ...
   */
  @Deprecated
  public UtilityResponse originKeys(UtilityRequest utilityRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public PaypalUpdateOrderResponse updatesOrderForPaypalExpressCheckout(
      PaypalUpdateOrderRequest paypalUpdateOrderRequest) throws ApiException, IOException {
   ...
   */
  public PaypalUpdateOrderResponse updatesOrderForPaypalExpressCheckout(
      PaypalUpdateOrderRequest paypalUpdateOrderRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
