...
import com.adyen.model.checkout.DefaultErrorResponseEntity;
...
public class UtilityApi extends Service {
    ...
    * @throws ApiException if fails to make API call
    */
    public ValidateShopperIdResponse validateShopperId(ValidateShopperIdRequest validateShopperIdRequest) throws ApiException, IOException {
    ...
    * @throws ApiException if fails to make API call
    */
    public ValidateShopperIdResponse validateShopperId(ValidateShopperIdRequest validateShopperIdRequest, RequestOptions requestOptions) throws ApiException, IOException {
