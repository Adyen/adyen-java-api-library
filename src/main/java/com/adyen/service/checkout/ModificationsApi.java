...
public class ModificationsApi extends Service {
  ...
  /**
   * Modifications constructor in {@link com.adyen.service.checkout package}. Please use this
   ...
   */
  public StandalonePaymentCancelResponse cancelAuthorisedPayment(
   ...
   */
  public StandalonePaymentCancelResponse cancelAuthorisedPayment(
      StandalonePaymentCancelRequest standalonePaymentCancelRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public PaymentAmountUpdateResponse updateAuthorisedAmount(
  ...
  public PaymentAmountUpdateResponse updateAuthorisedAmount(
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/payments/{paymentPspReference}/amountUpdates", null);
    String jsonResult =
   ...
   * @throws ApiException if fails to make API call
   */
  public PaymentCancelResponse cancelAuthorisedPaymentByPspReference(
  ...
  public PaymentCancelResponse cancelAuthorisedPaymentByPspReference(
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/payments/{paymentPspReference}/cancels", null);
    String jsonResult =
        resource.request(requestBody, requestOptions, ApiConstants.HttpMethod.POST, pathParams);
   ...
   * @throws ApiException if fails to make API call
   */
  public PaymentCaptureResponse captureAuthorisedPayment(
  ...
  public PaymentCaptureResponse captureAuthorisedPayment(
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/payments/{paymentPspReference}/captures", null);
    String jsonResult =
        resource.request(requestBody, requestOptions, ApiConstants.HttpMethod.POST, pathParams);
   ...
   * @throws ApiException if fails to make API call
   */
  public PaymentRefundResponse refundCapturedPayment(
  ...
  public PaymentRefundResponse refundCapturedPayment(
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/payments/{paymentPspReference}/refunds", null);
    String jsonResult =
        resource.request(requestBody, requestOptions, ApiConstants.HttpMethod.POST, pathParams);
   ...
   * @throws ApiException if fails to make API call
   */
  public PaymentReversalResponse refundOrCancelPayment(
  ...
  public PaymentReversalResponse refundOrCancelPayment(
    ...
    Resource resource =
        new Resource(this, this.baseURL + "/payments/{paymentPspReference}/reversals", null);
    String jsonResult =
        resource.request(requestBody, requestOptions, ApiConstants.HttpMethod.POST, pathParams);
