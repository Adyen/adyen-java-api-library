...
public class ModificationsApi extends Service {
    ...
    * Cancel an authorised payment
    *
    * @param paymentPspReference {@link String } The [&#x60;pspReference&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments#responses-200-pspReference) of the payment that you want to cancel.  (required)
    * @param paymentCancelRequest {@link PaymentCancelRequest }  (required)
    
    * @return {@link PaymentCancelResponse }
    * @throws ApiException if fails to make API call
    */
    public PaymentCancelResponse cancelAuthorisedPaymentByPspReference(String paymentPspReference, 
PaymentCancelRequest paymentCancelRequest) throws ApiException, IOException {
    ...
    *
    * @param paymentPspReference {@link String } The [&#x60;pspReference&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments#responses-200-pspReference) of the payment that you want to capture. (required)
    * @param paymentCaptureRequest {@link PaymentCaptureRequest }  (required)
    
    * @return {@link PaymentCaptureResponse }
    * @throws ApiException if fails to make API call
    */
    public PaymentCaptureResponse captureAuthorisedPayment(String paymentPspReference, 
PaymentCaptureRequest paymentCaptureRequest) throws ApiException, IOException {
    ...
    *
    * @param paymentPspReference {@link String } The [&#x60;pspReference&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments#responses-200-pspReference) of the payment that you want to refund. (required)
    * @param paymentRefundRequest {@link PaymentRefundRequest }  (required)
    
    * @return {@link PaymentRefundResponse }
    * @throws ApiException if fails to make API call
    */
    public PaymentRefundResponse refundCapturedPayment(String paymentPspReference, 
PaymentRefundRequest paymentRefundRequest) throws ApiException, IOException {
    ...
    *
    * @param paymentPspReference {@link String } The [&#x60;pspReference&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments#responses-200-pspReference) of the payment that you want to reverse.  (required)
    * @param paymentReversalRequest {@link PaymentReversalRequest }  (required)
    
    * @return {@link PaymentReversalResponse }
    * @throws ApiException if fails to make API call
    */
    public PaymentReversalResponse refundOrCancelPayment(String paymentPspReference, 
PaymentReversalRequest paymentReversalRequest) throws ApiException, IOException {
    ...
    *
    * @param paymentPspReference {@link String } The [&#x60;pspReference&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments#responses-200-pspReference) of the payment. (required)
    * @param paymentAmountUpdateRequest {@link PaymentAmountUpdateRequest }  (required)
    
    * @return {@link PaymentAmountUpdateResponse }
    * @throws ApiException if fails to make API call
    */
    public PaymentAmountUpdateResponse updateAuthorisedAmount(String paymentPspReference, 
PaymentAmountUpdateRequest paymentAmountUpdateRequest) throws ApiException, IOException {
