...
public class PaymentLinksApi extends Service {
  ...
  /**
   * Payment links constructor in {@link com.adyen.service.checkout package}. Please use this
   ...
   * @throws ApiException if fails to make API call
   */
  public PaymentLinkResponse getPaymentLink(String linkId, RequestOptions requestOptions)
   ...
   * @throws ApiException if fails to make API call
   */
  public PaymentLinkResponse paymentLinks(PaymentLinkRequest paymentLinkRequest)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public PaymentLinkResponse paymentLinks(
      PaymentLinkRequest paymentLinkRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
