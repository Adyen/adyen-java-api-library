...
public class PaymentsApi extends Service {
  ...
  public static final String API_VERSION = "72";
  ...
  public PaymentsApi(Client client) {
    super(client);
    this.baseURL = createBaseURL("https://checkout-test.adyen.com/v72");
  }

  /**
   * Payments constructor in {@link com.adyen.service.checkout package}. Please use this constructor
   ...
   */
  public SessionResultResponse getResultOfPaymentSession(String sessionId, String sessionResult)
   ...
   * @throws ApiException if fails to make API call
   */
  public SessionResultResponse getResultOfPaymentSession(
      String sessionId, String sessionResult, RequestOptions requestOptions)
      throws ApiException, IOException {
    // Add path params
  ...
  public CardDetailsResponse cardDetails(
      CardDetailsRequest cardDetailsRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
  ...
  public PaymentMethodsResponse paymentMethods(
      PaymentMethodsRequest paymentMethodsRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public PaymentResponse payments(PaymentRequest paymentRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public PaymentDetailsResponse paymentsDetails(PaymentDetailsRequest paymentDetailsRequest)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public PaymentDetailsResponse paymentsDetails(
      PaymentDetailsRequest paymentDetailsRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public CreateCheckoutSessionResponse sessions(
      CreateCheckoutSessionRequest createCheckoutSessionRequest) throws ApiException, IOException {
   ...
   */
  public CreateCheckoutSessionResponse sessions(
      CreateCheckoutSessionRequest createCheckoutSessionRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
