...
public class DisputesApi extends Service {
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.disputes.DisputesApi
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.disputes.DisputesApi
  public AcceptDisputeResponse acceptDispute(AcceptDisputeRequest acceptDisputeRequest)
  ...
  public AcceptDisputeResponse acceptDispute(
      AcceptDisputeRequest acceptDisputeRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.disputes.DisputesApi
  public DefendDisputeResponse defendDispute(DefendDisputeRequest defendDisputeRequest)
      throws ApiException, IOException {
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.disputes.DisputesApi
  public DefendDisputeResponse defendDispute(
      DefendDisputeRequest defendDisputeRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.disputes.DisputesApi
  public DeleteDefenseDocumentResponse deleteDisputeDefenseDocument(
      DeleteDefenseDocumentRequest deleteDefenseDocumentRequest) throws ApiException, IOException {
  ...
  @Deprecated(
      ...
      forRemoval = true) // Use instead com.adyen.service.disputes.DisputesApi
  public DeleteDefenseDocumentResponse deleteDisputeDefenseDocument(
      DeleteDefenseDocumentRequest deleteDefenseDocumentRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.disputes.DisputesApi
  public DefenseReasonsResponse retrieveApplicableDefenseReasons(
      DefenseReasonsRequest defenseReasonsRequest) throws ApiException, IOException {
  ...
  @Deprecated(
      ...
      forRemoval = true) // Use instead com.adyen.service.disputes.DisputesApi
  public DefenseReasonsResponse retrieveApplicableDefenseReasons(
      DefenseReasonsRequest defenseReasonsRequest, RequestOptions requestOptions)
      throws ApiException, IOException {

    String requestBody = defenseReasonsRequest.toJson();
    Resource resource =
        new Resource(this, this.baseURL + "/retrieveApplicableDefenseReasons", null);
    String jsonResult =
        resource.request(requestBody, requestOptions, ApiConstants.HttpMethod.POST, null);
  ...
  @Deprecated(
      since = "v37.0.0",
      forRemoval = true) // Use instead com.adyen.service.disputes.DisputesApi
  public SupplyDefenseDocumentResponse supplyDefenseDocument(
      SupplyDefenseDocumentRequest supplyDefenseDocumentRequest) throws ApiException, IOException {
  ...
  @Deprecated(
      ...
      forRemoval = true) // Use instead com.adyen.service.disputes.DisputesApi
  public SupplyDefenseDocumentResponse supplyDefenseDocument(
      SupplyDefenseDocumentRequest supplyDefenseDocumentRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
