...
public class PosTerminalManagementApi extends Service {
   ...
   * @deprecated since POS Terminal Management API v1 Use [Management
   ...
   */
  @Deprecated(since = "v37.0.0", forRemoval = true) // use instead Management API
  public AssignTerminalsResponse assignTerminals(
      AssignTerminalsRequest assignTerminalsRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
   ...
   */
  @Deprecated(since = "v37.0.0", forRemoval = true) // use instead Management API
  public FindTerminalResponse findTerminal(
      FindTerminalRequest findTerminalRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
   ...
   */
  @Deprecated(since = "v37.0.0", forRemoval = true) // use instead Management API
  public GetStoresUnderAccountResponse getStoresUnderAccount(
      GetStoresUnderAccountRequest getStoresUnderAccountRequest) throws ApiException, IOException {
  ...
  @Deprecated(since = "v37.0.0", forRemoval = true) // use instead Management API
  public GetStoresUnderAccountResponse getStoresUnderAccount(
      GetStoresUnderAccountRequest getStoresUnderAccountRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
  ...
  public GetTerminalDetailsResponse getTerminalDetails(
      GetTerminalDetailsRequest getTerminalDetailsRequest) throws ApiException, IOException {
  ...
  @Deprecated(since = "v37.0.0", forRemoval = true) // use instead Management API
  public GetTerminalDetailsResponse getTerminalDetails(
      GetTerminalDetailsRequest getTerminalDetailsRequest, RequestOptions requestOptions)
      throws ApiException, IOException {
   ...
   */
  @Deprecated(since = "v37.0.0", forRemoval = true) // use instead Management API
  public GetTerminalsUnderAccountResponse getTerminalsUnderAccount(
