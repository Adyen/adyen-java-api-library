...
public class InstantPayoutsApi extends Service {
  ...
  /**
   * Instant payouts constructor in {@link com.adyen.service.payout package}.
   *
  ...
  /**
   * Instant payouts constructor in {@link com.adyen.service.payout package}. Please use this
   ...
   */
  public InstantPayoutsApi(Client client, String baseURL) {
    super(client);
   ...
   * @throws ApiException if fails to make API call
   */
  public PayoutResponse payout(PayoutRequest payoutRequest, RequestOptions requestOptions)
