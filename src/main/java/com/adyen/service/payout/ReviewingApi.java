...
public class ReviewingApi extends Service {
  ...
  /**
   * Reviewing constructor in {@link com.adyen.service.payout package}. Please use this constructor
   ...
   */
  public ModifyResponse confirmThirdParty(ModifyRequest modifyRequest)
   ...
   * @throws ApiException if fails to make API call
   */
  public ModifyResponse confirmThirdParty(
      ModifyRequest modifyRequest, RequestOptions requestOptions) throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ModifyResponse declineThirdParty(ModifyRequest modifyRequest)
      throws ApiException, IOException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ModifyResponse declineThirdParty(
      ModifyRequest modifyRequest, RequestOptions requestOptions) throws ApiException, IOException {
    String requestBody = modifyRequest.toJson();
