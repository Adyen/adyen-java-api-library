...
| [Capital API](https://docs.adyen.com/api-explorer/capital/latest/overview)                                                   | Adyen Capital allows you to build an embedded financing offering for your users to serve their operational needs.                                                                                                                                                                                                                                                                                                                                                      | Capital                                  | **v1**            |
