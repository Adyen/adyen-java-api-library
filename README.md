...
| [Open Banking API](https://docs.adyen.com/api-explorer/Management/3/overview)                                                | The Open Banking API provides secure endpoints to share financial data and services with third parties.                                                                                                                                                                                                                                                                                                                                                 | openbanking package subclasses           | **v1**            |
