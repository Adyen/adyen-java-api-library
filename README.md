...
| [Session Authentication API](https://docs.adyen.com/api-explorer/sessionauthentication/1/overview)                             | Create and manage the JSON Web Tokens (JWT) required for integrating the 'Adyen for Platform' web components.                                                                                                                                                                                                                                                                                                                                             | SessionAuthentication                    | **v1**            |
